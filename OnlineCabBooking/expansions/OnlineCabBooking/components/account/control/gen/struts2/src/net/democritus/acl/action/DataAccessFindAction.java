...
import net.democritus.acl.DataAccessFindDetails;
...
public class DataAccessFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.acl.action.DataAccessFindAction");

  private SearchDetails<? extends DataAccessFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.acl", "DataAccess", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    DataAccessAgent dataAccessAgent = createDataAccessAgent();
    ...
    searchResult = dataAccessAgent.find(searchDetails);
  ...
  private DataAccessAgent createDataAccessAgent() {
