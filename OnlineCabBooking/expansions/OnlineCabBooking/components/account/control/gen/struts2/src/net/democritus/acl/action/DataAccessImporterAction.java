...
public class DataAccessImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(DataAccessImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    DataAccessAgent dataAccessAgent = DataAccessAgent.getDataAccessAgent(ContextRetriever.getContext());
    result = dataAccessAgent.importFile(importFile);
