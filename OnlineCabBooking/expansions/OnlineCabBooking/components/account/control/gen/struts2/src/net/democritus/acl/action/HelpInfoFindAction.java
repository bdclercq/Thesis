...
import net.democritus.acl.HelpInfoFindDetails;
...
public class HelpInfoFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.acl.action.HelpInfoFindAction");

  private SearchDetails<? extends HelpInfoFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.acl", "HelpInfo", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    HelpInfoAgent helpInfoAgent = createHelpInfoAgent();
    ...
    searchResult = helpInfoAgent.find(searchDetails);
  ...
  private HelpInfoAgent createHelpInfoAgent() {
