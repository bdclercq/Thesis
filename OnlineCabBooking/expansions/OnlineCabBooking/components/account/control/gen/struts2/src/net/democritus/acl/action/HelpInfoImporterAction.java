...
public class HelpInfoImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(HelpInfoImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    HelpInfoAgent helpInfoAgent = HelpInfoAgent.getHelpInfoAgent(ContextRetriever.getContext());
    result = helpInfoAgent.importFile(importFile);
