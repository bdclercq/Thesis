...
import net.democritus.component.ComponentFindDetails;
...
public class ComponentFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.component.action.ComponentFindAction");

  private SearchDetails<? extends ComponentFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.component", "Component", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllComponents";
    }
  ...
  public String execute() throws Exception {
    ...
    ComponentAgent componentAgent = createComponentAgent();
    ...
    searchResult = componentAgent.find(searchDetails);
  ...
  private ComponentAgent createComponentAgent() {
