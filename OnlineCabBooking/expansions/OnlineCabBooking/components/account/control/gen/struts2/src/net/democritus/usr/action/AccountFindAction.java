...
import net.democritus.usr.AccountFindDetails;
...
public class AccountFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.usr.action.AccountFindAction");

  private SearchDetails<? extends AccountFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.usr", "Account", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    AccountAgent accountAgent = createAccountAgent();
    ...
    searchResult = accountAgent.find(searchDetails);
  ...
  private AccountAgent createAccountAgent() {
