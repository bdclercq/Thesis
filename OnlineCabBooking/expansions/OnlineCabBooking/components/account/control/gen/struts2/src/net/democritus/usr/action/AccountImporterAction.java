...
public class AccountImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(AccountImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    AccountAgent accountAgent = AccountAgent.getAccountAgent(ContextRetriever.getContext());
    result = accountAgent.importFile(importFile);
