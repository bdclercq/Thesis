...
import net.democritus.usr.PortalFindDetails;
...
public class PortalFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.usr.action.PortalFindAction");

  private SearchDetails<? extends PortalFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.usr", "Portal", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    PortalAgent portalAgent = createPortalAgent();
    ...
    searchResult = portalAgent.find(searchDetails);
  ...
  private PortalAgent createPortalAgent() {
