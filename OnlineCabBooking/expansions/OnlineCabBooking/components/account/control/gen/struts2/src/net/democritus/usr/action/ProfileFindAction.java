...
import net.democritus.usr.ProfileFindDetails;
...
public class ProfileFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.usr.action.ProfileFindAction");

  private SearchDetails<? extends ProfileFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.usr", "Profile", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    ProfileAgent profileAgent = createProfileAgent();
    ...
    searchResult = profileAgent.find(searchDetails);
  ...
  private ProfileAgent createProfileAgent() {
