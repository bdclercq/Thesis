...
public class ProfileImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(ProfileImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    ProfileAgent profileAgent = ProfileAgent.getProfileAgent(ContextRetriever.getContext());
    result = profileAgent.importFile(importFile);
