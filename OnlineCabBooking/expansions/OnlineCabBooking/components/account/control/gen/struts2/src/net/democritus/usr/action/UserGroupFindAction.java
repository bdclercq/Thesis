...
import net.democritus.usr.UserGroupFindDetails;
...
public class UserGroupFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.usr.action.UserGroupFindAction");

  private SearchDetails<? extends UserGroupFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.usr", "UserGroup", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllUserGroups";
    }
  ...
  public String execute() throws Exception {
    ...
    UserGroupAgent userGroupAgent = createUserGroupAgent();
    ...
    searchResult = userGroupAgent.find(searchDetails);
  ...
  private UserGroupAgent createUserGroupAgent() {
