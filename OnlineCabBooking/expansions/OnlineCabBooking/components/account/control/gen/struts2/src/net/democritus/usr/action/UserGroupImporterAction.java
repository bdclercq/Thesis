...
public class UserGroupImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(UserGroupImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    UserGroupAgent userGroupAgent = UserGroupAgent.getUserGroupAgent(ContextRetriever.getContext());
    result = userGroupAgent.importFile(importFile);
