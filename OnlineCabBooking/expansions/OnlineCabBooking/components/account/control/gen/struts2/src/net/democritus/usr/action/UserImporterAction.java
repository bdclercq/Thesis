...
public class UserImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(UserImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    UserAgent userAgent = UserAgent.getUserAgent(ContextRetriever.getContext());
    result = userAgent.importFile(importFile);
