...
import net.democritus.usr.menu.MenuFindDetails;
...
public class MenuFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.usr.menu.action.MenuFindAction");

  private SearchDetails<? extends MenuFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.usr.menu", "Menu", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    MenuAgent menuAgent = createMenuAgent();
    ...
    searchResult = menuAgent.find(searchDetails);
  ...
  private MenuAgent createMenuAgent() {
