...
import net.democritus.usr.menu.MenuItemFindDetails;
...
public class MenuItemFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.usr.menu.action.MenuItemFindAction");

  private SearchDetails<? extends MenuItemFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.usr.menu", "MenuItem", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    MenuItemAgent menuItemAgent = createMenuItemAgent();
    ...
    searchResult = menuItemAgent.find(searchDetails);
  ...
  private MenuItemAgent createMenuItemAgent() {
