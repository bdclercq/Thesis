...
import net.democritus.usr.menu.ScreenFindDetails;
...
public class ScreenFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.usr.menu.action.ScreenFindAction");

  private SearchDetails<? extends ScreenFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.usr.menu", "Screen", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    ScreenAgent screenAgent = createScreenAgent();
    ...
    searchResult = screenAgent.find(searchDetails);
  ...
  private ScreenAgent createScreenAgent() {
