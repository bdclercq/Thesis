...
public class DataAccessQueryProjector implements IDataElementProjector<DataAccessData, DataAccessQuery>, IDataProjectorRequired<DataAccessQuery> {
  ...
  public DataAccessQueryProjector(DataAccessCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public DataAccessQuery project(ParameterContext<DataAccessData> dataParameter) {

    DataAccessQuery projection = new DataAccessQuery();
  ...
  public void toData(DataAccessData data, ParameterContext<DataAccessQuery> projectionParameter) {
    // don't set the data id
    DataAccessQuery projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(DataAccessQuery projection) {
  ...
  public Class<DataAccessQuery> getProjectionClass() {
    return DataAccessQuery.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<DataAccessQuery> projectionParameter) {
