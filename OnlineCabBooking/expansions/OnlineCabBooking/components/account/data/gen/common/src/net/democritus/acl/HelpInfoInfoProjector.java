...
public class HelpInfoInfoProjector implements IDataElementProjector<HelpInfoData, HelpInfoInfo>, IDataProjectorRequired<HelpInfoInfo> {
  ...
  public HelpInfoInfoProjector(HelpInfoCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public HelpInfoInfo project(ParameterContext<HelpInfoData> dataParameter) {

    HelpInfoInfo projection = new HelpInfoInfo();
  ...
  public void toData(HelpInfoData data, ParameterContext<HelpInfoInfo> projectionParameter) {
    // don't set the data id
    HelpInfoInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(HelpInfoInfo projection) {
  ...
  public Class<HelpInfoInfo> getProjectionClass() {
    return HelpInfoInfo.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<HelpInfoInfo> projectionParameter) {
