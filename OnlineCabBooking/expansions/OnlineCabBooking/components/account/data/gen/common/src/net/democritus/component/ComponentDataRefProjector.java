...
public class ComponentDataRefProjector implements IDataElementProjector<ComponentData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public ComponentDataRefProjector(ComponentCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<ComponentData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("account");
    projection.setPackName("net.democritus.component");
    projection.setClassName("Component");
  ...
  // anchor:toData:start
  public void toData(ComponentData data, ParameterContext<DataRef> projectionParameter) {
