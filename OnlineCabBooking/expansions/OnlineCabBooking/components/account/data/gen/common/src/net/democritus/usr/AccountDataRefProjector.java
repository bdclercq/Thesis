...
public class AccountDataRefProjector implements IDataElementProjector<AccountData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(AccountData data, ParameterContext<DataRef> projectionParameter) {
