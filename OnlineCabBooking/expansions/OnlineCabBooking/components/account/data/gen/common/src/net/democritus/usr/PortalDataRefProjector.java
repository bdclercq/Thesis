...
public class PortalDataRefProjector implements IDataElementProjector<PortalData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(PortalData data, ParameterContext<DataRef> projectionParameter) {
