...
public class PortalInfoProjector implements IDataElementProjector<PortalData, PortalInfo>, IDataProjectorRequired<PortalInfo> {
  ...
  public PortalInfoProjector(PortalCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public PortalInfo project(ParameterContext<PortalData> dataParameter) {

    PortalInfo projection = new PortalInfo();
  ...
  public void toData(PortalData data, ParameterContext<PortalInfo> projectionParameter) {
    // don't set the data id
    PortalInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(PortalInfo projection) {
  ...
  public Class<PortalInfo> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<PortalInfo> projectionParameter) {
