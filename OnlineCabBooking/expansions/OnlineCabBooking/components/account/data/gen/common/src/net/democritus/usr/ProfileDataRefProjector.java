...
public class ProfileDataRefProjector implements IDataElementProjector<ProfileData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(ProfileData data, ParameterContext<DataRef> projectionParameter) {
