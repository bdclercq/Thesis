...
public class ProfileInfoProjector implements IDataElementProjector<ProfileData, ProfileInfo>, IDataProjectorRequired<ProfileInfo> {
  ...
  public ProfileInfoProjector(ProfileCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public ProfileInfo project(ParameterContext<ProfileData> dataParameter) {

    ProfileInfo projection = new ProfileInfo();
  ...
  public void toData(ProfileData data, ParameterContext<ProfileInfo> projectionParameter) {
    // don't set the data id
    ProfileInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(ProfileInfo projection) {
  ...
  public Class<ProfileInfo> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<ProfileInfo> projectionParameter) {
