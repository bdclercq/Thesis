...
public class UserDataRefProjector implements IDataElementProjector<UserData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(UserData data, ParameterContext<DataRef> projectionParameter) {
