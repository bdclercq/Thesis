...
public class UserGroupInfoProjector implements IDataElementProjector<UserGroupData, UserGroupInfo>, IDataProjectorRequired<UserGroupInfo> {
  ...
  public UserGroupInfoProjector(UserGroupCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public UserGroupInfo project(ParameterContext<UserGroupData> dataParameter) {

    UserGroupInfo projection = new UserGroupInfo();
  ...
  public void toData(UserGroupData data, ParameterContext<UserGroupInfo> projectionParameter) {
    // don't set the data id
    UserGroupInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(UserGroupInfo projection) {
  ...
  public Class<UserGroupInfo> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<UserGroupInfo> projectionParameter) {
