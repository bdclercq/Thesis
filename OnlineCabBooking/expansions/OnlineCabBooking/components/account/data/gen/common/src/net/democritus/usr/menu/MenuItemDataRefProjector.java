...
public class MenuItemDataRefProjector implements IDataElementProjector<MenuItemData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(MenuItemData data, ParameterContext<DataRef> projectionParameter) {
