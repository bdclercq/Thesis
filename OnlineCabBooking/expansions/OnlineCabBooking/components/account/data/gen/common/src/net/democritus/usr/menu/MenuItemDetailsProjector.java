...
public class MenuItemDetailsProjector implements IDataElementProjector<MenuItemData, MenuItemDetails>, IDataProjectorRequired<MenuItemDetails> {
  ...
  public MenuItemDetailsProjector(MenuItemCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public MenuItemDetails project(ParameterContext<MenuItemData> dataParameter) {

    MenuItemDetails projection = new MenuItemDetails();
    ...
    if (data != null) {
      ...
      projection.setScreenDetails(crudsInternal.getScreenDetails(dataParameter.construct(projection.getScreen())).getValueOrElse(null));
      projection.setSubmenuItemsDetails(crudsInternal.getSubmenuItemsDetails(dataParameter.construct(data)).getValue());
  ...
  public void toData(MenuItemData data, ParameterContext<MenuItemDetails> projectionParameter) {
    // don't set the data id
    MenuItemDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(MenuItemDetails projection) {
  ...
  public Class<MenuItemDetails> getProjectionClass() {
    return MenuItemDetails.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<MenuItemDetails> projectionParameter) {
