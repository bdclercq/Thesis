...
public class ScreenDataRefProjector implements IDataElementProjector<ScreenData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(ScreenData data, ParameterContext<DataRef> projectionParameter) {
