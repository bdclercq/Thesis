...
public class ScreenProfileDataRefProjector implements IDataElementProjector<ScreenProfileData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public ScreenProfileDataRefProjector(ScreenProfileCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<ScreenProfileData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("account");
    projection.setPackName("net.democritus.usr.menu");
    projection.setClassName("ScreenProfile");
  ...
  // anchor:toData:start
  public void toData(ScreenProfileData data, ParameterContext<DataRef> projectionParameter) {
