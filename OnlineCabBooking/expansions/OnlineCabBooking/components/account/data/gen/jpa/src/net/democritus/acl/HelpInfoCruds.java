...
@Local({HelpInfoCrudsLocal.class, HelpInfoCrudsInternal.class})
// @anchor:annotations:end
public class HelpInfoCruds /*@anchor:interfaces:start@*/implements HelpInfoCrudsLocal, HelpInfoCrudsInternal/*@anchor:interfaces:end@*/ {

  private final DiagnosticHelper diagnosticHelper = new DiagnosticHelper("account", "HelpInfo");
  private final DiagnosticFactory diagnosticFactory = diagnosticHelper.getDiagnosticFactory();

  public static final String DISABLED_ERROR_MSG_KEY = "account.helpInfo.alreadyDisabled";
  ...
  private HelpInfoFinderLocal helpInfoFinder;
  ...
  private static final Logger logger = LoggerFactory.getLogger(HelpInfoCruds.class);
  ...
  private HelpInfoDataRefProjector dataRefProjector;
  private HelpInfoDetailsProjector detailsProjector;
  private HelpInfoInfoProjector infoProjector;

  private DataElementProjectorManager<HelpInfoData> elementProjectorManager;
  ...
  private void initProjectorMapping() {
    HelpInfoCrudsInternal helpInfoCrudsInternal = sessionContext.getBusinessObject(HelpInfoCrudsInternal.class);

    detailsProjector = new HelpInfoDetailsProjector(helpInfoCrudsInternal);
    infoProjector = new HelpInfoInfoProjector(helpInfoCrudsInternal);
    dataRefProjector = new HelpInfoDataRefProjector(helpInfoCrudsInternal);

    elementProjectorManager = new DataElementProjectorManager<HelpInfoData>();
  ...
  private void initFinder() {
    helpInfoFinder = new HelpInfoFinderBean(entityManager);
  }
  ...
  public CrudsResult<DataRef> create(ParameterContext<HelpInfoDetails> detailsParameter) {
    ...
    HelpInfoDetails details = detailsParameter.getValue();
    ...
    try {
      ...
      detailsProjector.toData(helpInfoData, detailsParameter);
    ...
    try {
      entityManager.persist(helpInfoData);
      ...
      if (helpInfoData != null) {
        if (logger.isDebugEnabled()) {
          logger.debug(
              "Created HelpInfoCruds with { id : " + helpInfoData.getId() + ", name: " + helpInfoData.getName() + " }"
          );
        }
      }
    } catch (Exception e) {
    ...
    CrudsResult<DataRef> result = getDataRefFromData(detailsParameter.construct(helpInfoData));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<HelpInfoDetails> detailsParameter) {
    ...
    Context context = detailsParameter.getContext();
    HelpInfoDetails helpInfoDetails = detailsParameter.getValue();
    DataRef dataRef = helpInfoDetails.getDataRef();
    ...
    try {
      CrudsResult<HelpInfoData> dataResult = getData(context.withParameter(dataRef));
      if (dataResult.isError()) {
        return dataResult.convertError();
      }
      HelpInfoData helpInfoData = dataResult.getValue();
      ...
      if (helpInfoData != null) {
        if (logger.isDebugEnabled()) {
          logger.debug(
              "Modified HelpInfoCruds with { id : " + helpInfoData.getId() + ", name: " + helpInfoData.getName() + " }"
          );
        }
      }
    ...
    // @anchor:modify-exceptions:end
      ...
      if (logger.isErrorEnabled()) {
        logger.error(
            "HelpInfoCruds.modify() failed with ID = " + dataRef.getId(), e
        );
      }
      return getDiagnosticHelper().createCrudsError(MODIFY_ERROR_MSG_KEY);
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    if (projection instanceof HelpInfoDetails) {
      HelpInfoDetails details = (HelpInfoDetails) projection;
  ...
  public CrudsResult<Void> delete(ParameterContext<DataRef> dataRefParameter) {
    ...
    try {
      ...
      // @anchor:delete:start
      entityManager.remove(helpInfoData);
      // @anchor:delete:end
      ...
      if (helpInfoData != null) {
        if (logger.isDebugEnabled()) {
          logger.debug(
              "Deleted HelpInfoCruds with { id : " + helpInfoData.getId() + ", name: " + helpInfoData.getName() + " }"
          );
        }
      }
  ...
  public CrudsResult<DataRef> getDataRefFromData(ParameterContext<HelpInfoData> dataParameter) {
  ...
  public CrudsResult<DataRef> getDataRefFromId(ParameterContext<Long> idParameter) {
    ...
    try {
      HelpInfoData helpInfoData = entityManager.find(HelpInfoData.class, id);
      ...
      return getDataRefFromData(idParameter.construct(helpInfoData));
    } catch (Exception e) {
      sessionContext.setRollbackOnly();
      if (logger.isErrorEnabled()) {
        logger.error(
  ...
  private CrudsResult<HelpInfoData> getDataById(ParameterContext<Long> idParameter) {
    HelpInfoData data = entityManager.find(HelpInfoData.class, idParameter.getValue());
    if (data == null) {
      return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
    }
  ...
  public CrudsResult<DataRef> getDataRefFromName(ParameterContext<String> nameParameter) {
    ...
    CrudsResult<HelpInfoData> dataResult = getDataByName(nameParameter);
    if (dataResult.isError()) {
      return dataResult.convertError();
    }
  ...
  private CrudsResult<HelpInfoData> getDataByName(ParameterContext<String> nameParameter) {
    String name = nameParameter.getValue();
    if (name == null || name.trim().equals("")) {
      return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
    }
    ...
    try {
      HelpInfoFindByNameEqDetails findByNameEqDetails = new HelpInfoFindByNameEqDetails();
      findByNameEqDetails.setName(name);

      SearchDetails<HelpInfoFindByNameEqDetails> searchDetails =
        new SearchDetails<>(findByNameEqDetails);

      ParameterContext<SearchDetails<HelpInfoFindByNameEqDetails>> searchParameter =
        nameParameter.construct(searchDetails);

      SearchResult<HelpInfoData> searchResult = findData(searchParameter);

      if (searchResult.isError()) {
        return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
      }

      List<HelpInfoData> list = searchResult.getResults();
      if (list.isEmpty()) {
        return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
      }
  ...
  public CrudsResult<HelpInfoData> getData(ParameterContext<DataRef> dataRefParameter) {
    DataRef dataRef = dataRefParameter.getValue();
    if (dataRef == null) {
      return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
    }
    ...
    CrudsResult<HelpInfoData> result;
  ...
  private CrudsResult<HelpInfoData> getDataFromStrategy(ParameterContext<DataRef> dataRefParameter) {
    DataRef dataRef = dataRefParameter.getValue();
    Long id = dataRef.getId();
    CrudsResult<HelpInfoData> result = getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
  ...
  public <S extends HelpInfoFindDetails> SearchResult<HelpInfoData> findData(ParameterContext<SearchDetails<S>> searchParameter) {
    return helpInfoFinder.find(searchParameter);
  }

  public <S extends HelpInfoFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    SearchResult<HelpInfoData> dataResult = findData(searchParameter);
    ...
    IDataElementProjector<HelpInfoData, T> projector = getElementProjector(projection);
   ...
   */
  private <T> List<T> project(Context context, List<HelpInfoData> fromItems, IDataElementProjector<HelpInfoData, T> projector) {
   ...
   */
  @Deprecated
  private <T> List<T> project(UserContext userContext, List<HelpInfoData> fromItems, IDataElementProjector<HelpInfoData, T> projector) {
    return project(Context.from(userContext), fromItems, projector);
  }

  @Override
  public <P> SearchResult<P> project(ParameterContext<List<HelpInfoData>> listParameter, String projection) {
    IDataElementProjector<HelpInfoData, P> elementProjector = getElementProjector(projection);
    List<HelpInfoData> list = listParameter.getValue();
  ...
  private <P> IDataElementProjector<HelpInfoData, P> getElementProjector(P projection) {
  ...
  @Override
  public String getDisplayName(ParameterContext<HelpInfoData> dataParameter) {
  ...
  private Option<String> getCustomDisplayName(ParameterContext<HelpInfoData> dataParameter) {
  ...
  private <T> IDataElementProjector<HelpInfoData, T> getElementProjector(String projectionName) {
    IDataElementProjector<HelpInfoData, T> projector = elementProjectorManager.getProjector(projectionName);
    if (projector == null) {
      throw new InvalidProjectionException(new ElementRef("account", "HelpInfo"), projectionName);
    }
    return projector;
  }
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    CrudsResult<HelpInfoData> dataResult = getData(projectionRefParameter.construct(dataRef));
    HelpInfoData helpInfoData;
    if (dataResult.isSuccess()) {
      helpInfoData = dataResult.getValue();
    } else {
      helpInfoData = new HelpInfoData();
    }

    // anchor:custom-preProject:start
    // anchor:custom-preProject:end

    IDataElementProjector<HelpInfoData, T> projector = getElementProjector(projectionRef.getProjection());
    T projection = projector.project(projectionRefParameter.construct(helpInfoData));

    if (helpInfoData != null) {
      if (logger.isDebugEnabled()) {
        logger.debug(
            "Retrieved HelpInfoCruds:" + projectionRef.getProjection() + " { id : " + helpInfoData.getId() + ", name: " + helpInfoData.getName() + " }"
        );
      }
    }
  ...
  public CrudsResult<HelpInfoDetails> getDetails(ParameterContext<DataRef> dataRefParameter) {
    CrudsResult<HelpInfoData> result = getData(dataRefParameter);
    if (result.isError()) {
      return result.convertError();
    }

    HelpInfoData helpInfoData = result.getValue();
    HelpInfoDetails helpInfoDetails = detailsProjector.project(dataRefParameter.construct(helpInfoData));

    return CrudsResult.success(helpInfoDetails);
  }

  public CrudsResult<List<HelpInfoDetails>> getDetailsListFromData(ParameterContext<Collection<HelpInfoData>> dataListParameter) {
    Collection<HelpInfoData> dataList = dataListParameter.getValue();
    List<HelpInfoDetails> list = new ArrayList<>(dataList.size());

    for (HelpInfoData helpInfoData: dataList) {
      HelpInfoDetails helpInfoDetails = detailsProjector.project(dataListParameter.construct(helpInfoData));
      list.add(helpInfoDetails);
    }
  ...
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    ...
    CrudsResult<HelpInfoData> dataResult = getData(dataRefParameter);
    if (dataResult.isError()) {
      return dataResult.convertError();
    }
    HelpInfoData data = dataResult.getValue();
