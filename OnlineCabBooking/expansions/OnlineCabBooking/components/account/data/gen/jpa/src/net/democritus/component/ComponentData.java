...
/**
 * Persistency pojo class for the entity Component,
 */

@Entity(name=ComponentData.ENTITY_NAME)
// @anchor:annotations:start
@Table(name="Component", schema="ACCOUNT")
// @anchor:annotations:end
@NamedQueries({
  @NamedQuery(name=ComponentData.QUERY_FINDALL, query="select o FROM " + ComponentData.ENTITY_NAME + " o")
...
public class ComponentData implements java.io.Serializable {
  ...
  public static final String ENTITY_NAME = "net.democritus.component.Component";
  public static final String QUERY_FINDALL = "net.democritus.component.Component.findAll";
