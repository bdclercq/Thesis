...
/**
 * Local interface for the entity bean DataAccess,
...
public interface DataAccessLocal {
  ...
  DataAccessInfo getInfo(Long id);
  DataAccessDetails getDetails(DataRef dataRef);
  DataAccessDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<DataAccessDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<DataAccessDetails> detailsParameter);
  ...
  CrudsResult<DataAccessInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<DataAccessDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<DataAccessDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends DataAccessFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
