...
/**
 * Local interface for the entity bean Component,
 * representing a known Component
 */
public interface ComponentLocal {
  ...
  ComponentInfo getInfo(Long id);
  ComponentDetails getDetails(DataRef dataRef);
  ComponentDetails getDetails(Long id);
  ...
  CrudsResult<ComponentInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<ComponentDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<ComponentDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends ComponentFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
