...
import net.democritus.usr.AccountCsvImporterImpl;
...
public class AccountBean /*@anchor:interfaces:start@*/implements AccountRemote, AccountLocal/*@anchor:interfaces:end@*/{
  ...
  @EJB
  AccountCrudsLocal accountCrudsLocal;
  ...
  public CrudsResult<DataRef> create(ParameterContext<AccountDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = accountCrudsLocal.create(context.withParameter(details));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<AccountDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = accountCrudsLocal.modify(context.withParameter(details));
    if (result.isError()) {
      return result;
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    CrudsResult<DataRef> result = accountCrudsLocal.createOrModify(projectionParameter);
    if (result.isError()) {
      return result;
    }
  ...
  public CrudsResult<Void> delete(ParameterContext<Long> idParameter) {
    ...
    try {
      ...
      CrudsResult<Void> result = accountCrudsLocal.delete(context.withParameter(dataRef));
  ...
  public CrudsResult<DataRef> getId(ParameterContext<String> nameParameter) {
    return accountCrudsLocal.getDataRefFromName(nameParameter);
  }

  public CrudsResult<String> getName(ParameterContext<Long> idParameter) {
    // @anchor:before-getName:start
    // @anchor:before-getName:end
    CrudsResult<DataRef> dataRefResult = accountCrudsLocal.getDataRefFromId(idParameter);
  ...
  public DataRef getDataRef(Long id) {
    return accountCrudsLocal.getDataRefFromId(ParameterContext.create(null, id)).getValue();
  }
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public AccountDetails getDetails(DataRef dataRef) {
  ...
  public CrudsResult<DataRef> getDataRef(ParameterContext<Long> idParameter) {
    return accountCrudsLocal.getDataRefFromId(idParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    return accountCrudsLocal.resolveDataRef(dataRefParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<AccountInfo> getInfo(ParameterContext<Long> idParameter) {
    DataRef dataRef = idToDataRef(idParameter.getValue());
  ...
  public CrudsResult<AccountDetails> getDetails(ParameterContext<Long> idParameter) {
    ...
    CrudsResult<AccountDetails> result = getDetailsFromDataRef(idParameter.construct(dataRef));
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<AccountDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRefParameter) {
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    result = accountCrudsLocal.getProjection(projectionRefParameter);
  ...
  public <S extends AccountFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    ...
    result = accountCrudsLocal.find(searchParameter);
  ...
  public ImportResult importFile(ParameterContext<ImportFile> parameter) {
    ...
    // @anchor:import-implementations:start
      ...
      importResult = new AccountCsvImporterImpl().importFile(parameter);
  ...
  public CrudsResult<Void> compareAndSetStatus(ParameterContext<StateUpdate> parameter) {
    return accountCrudsLocal.compareAndSetStatus(parameter);
  }
