...
/**
 * Local interface for the entity bean Portal,
 * representing a known Portal
 */
public interface PortalLocal {
  ...
  PortalInfo getInfo(Long id);
  PortalDetails getDetails(DataRef dataRef);
  PortalDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<PortalDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<PortalDetails> detailsParameter);
  ...
  CrudsResult<PortalInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<PortalDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<PortalDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends PortalFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
