...
/**
 * Local interface for the entity bean UserGroup,
...
public interface UserGroupLocal {
  ...
  UserGroupInfo getInfo(Long id);
  UserGroupDetails getDetails(DataRef dataRef);
  UserGroupDetails getDetails(Long id);
