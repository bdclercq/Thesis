...
/**
 * Local interface for the entity bean MenuItem,
 * representing a known MenuItem
 */
public interface MenuItemLocal {
  ...
  MenuItemInfo getInfo(Long id);
  MenuItemDetails getDetails(DataRef dataRef);
  MenuItemDetails getDetails(Long id);
