...
/**
 * Local interface for the entity bean Menu,
...
public interface MenuLocal {
  ...
  MenuDetails getDetails(DataRef dataRef);
  MenuDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<MenuDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<MenuDetails> detailsParameter);
  ...
  CrudsResult<MenuInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<MenuDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<MenuDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends MenuFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
