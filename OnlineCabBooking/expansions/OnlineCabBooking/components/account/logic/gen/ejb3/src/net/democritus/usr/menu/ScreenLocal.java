...
/**
 * Local interface for the entity bean Screen,
 * representing a known Screen
 */
public interface ScreenLocal {
  ...
  ScreenInfo getInfo(Long id);
  ScreenDetails getDetails(DataRef dataRef);
  ScreenDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<ScreenDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<ScreenDetails> detailsParameter);
  ...
  CrudsResult<ScreenInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<ScreenDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<ScreenDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends ScreenFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
