...
// anchor:imports:start
import net.democritus.usr.menu.ScreenLocal;
...
@Remote(ScreenProfileRemote.class)
@Local(ScreenProfileLocal.class)
// @anchor:annotations:end
@DeclareRoles({
// anchor:custom-declare-roles:start
// anchor:custom-declare-roles:end
})
public class ScreenProfileBean /*@anchor:interfaces:start@*/implements ScreenProfileRemote, ScreenProfileLocal/*@anchor:interfaces:end@*/{
  ...
  @EJB private ScreenLocal screenLocal;
  ...
  private static final Logger logger = LoggerFactory.getLogger(ScreenProfileBean.class);
  @Deprecated
  @PersistenceContext(unitName="OnlineCabBooking_account")
  private EntityManager entityManager;

  @EJB
  ScreenProfileCrudsLocal screenProfileCrudsLocal;
  ...
  public CrudsResult<DataRef> create(ParameterContext<ScreenProfileDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = screenProfileCrudsLocal.create(context.withParameter(details));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<ScreenProfileDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = screenProfileCrudsLocal.modify(context.withParameter(details));
    if (result.isError()) {
      return result;
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    CrudsResult<DataRef> result = screenProfileCrudsLocal.createOrModify(projectionParameter);
    if (result.isError()) {
      return result;
    }
  ...
  public CrudsResult<Void> delete(ParameterContext<Long> idParameter) {
    ...
    try {
      ...
      CrudsResult<Void> result = screenProfileCrudsLocal.delete(context.withParameter(dataRef));
  ...
  public CrudsResult<DataRef> getId(ParameterContext<String> nameParameter) {
    return screenProfileCrudsLocal.getDataRefFromName(nameParameter);
  }

  public CrudsResult<String> getName(ParameterContext<Long> idParameter) {
    // @anchor:before-getName:start
    // @anchor:before-getName:end
    CrudsResult<DataRef> dataRefResult = screenProfileCrudsLocal.getDataRefFromId(idParameter);
  ...
  public DataRef getDataRef(Long id) {
    return screenProfileCrudsLocal.getDataRefFromId(ParameterContext.create(null, id)).getValue();
  }

  @Deprecated
  public ScreenProfileInfo getInfo(Long id) {
    return getInfo(ParameterContext.create(null, id)).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public ScreenProfileDetails getDetails(Long id) {
    return getDetailsFromDataRef(ParameterContext.create(null, idToDataRef(id))).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public ScreenProfileDetails getDetails(DataRef dataRef) {
  ...
  public CrudsResult<DataRef> getDataRef(ParameterContext<Long> idParameter) {
    return screenProfileCrudsLocal.getDataRefFromId(idParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    return screenProfileCrudsLocal.resolveDataRef(dataRefParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<ScreenProfileInfo> getInfo(ParameterContext<Long> idParameter) {
    DataRef dataRef = idToDataRef(idParameter.getValue());
  ...
  public CrudsResult<ScreenProfileDetails> getDetails(ParameterContext<Long> idParameter) {
    ...
    CrudsResult<ScreenProfileDetails> result = getDetailsFromDataRef(idParameter.construct(dataRef));
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<ScreenProfileDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRefParameter) {
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    result = screenProfileCrudsLocal.getProjection(projectionRefParameter);
  ...
  public <S extends ScreenProfileFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    ...
    result = screenProfileCrudsLocal.find(searchParameter);
