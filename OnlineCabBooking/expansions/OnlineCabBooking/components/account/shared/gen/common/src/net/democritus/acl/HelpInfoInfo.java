...
/**
 * Transport detailed class for the entity bean HelpInfo,
 */

public class HelpInfoInfo
  ...
  public DataRef getDataRef() {
    return new DataRef(mId, mName, "account", "net.democritus.acl", "HelpInfo");
  }
}
