...
public class ComponentDataRefConverter implements IConverter<DataRef> {
  ...
  public Result<DataRef> fromString(String value) {
    try {
      ...
      if (value == null || value.isEmpty()) {
        ...
        result = Result.success(new DataRef(0L, value, "account", "net.democritus.component", "Component"));
      }
