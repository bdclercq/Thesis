...
/**
 * Transport detailed class for the entity bean Component,
 */
...
public class ComponentDetails
  ...
  public ComponentDetails(Long id
  ...
  public String getElementPackage() {
    return "net.democritus.component";
  }
  ...
  public DataRef getDataRef() {
    return new DataRef(mId, mName, "account", "net.democritus.component", "Component");
  }
}
