...
/**
 * interface for the entity bean MenuItemBean,
 * representing a known MenuItem
 */
public interface MenuItemAgentIf {
  ...
  CrudsResult<DataRef> create(MenuItemDetails menuItemDetails);
  CrudsResult<DataRef> modify(MenuItemDetails menuItemDetails);
  ...
  CrudsResult<MenuItemDetails> getDetails(DataRef dataRef);
  ...
  <S extends MenuItemFindDetails, T> SearchResult<T> find(SearchDetails<S> searchDetails);
  // anchor:search-methods:end

  // anchor:data-only-methods:start
  CrudsResult<MenuItemDetails> getDetails(Long menuItemId);
  CrudsResult<DataRef> getDataRef(String name);

  SearchResult<DataRef> findAllDataRefs();
  SearchResult<MenuItemInfo> findAllInfos();
