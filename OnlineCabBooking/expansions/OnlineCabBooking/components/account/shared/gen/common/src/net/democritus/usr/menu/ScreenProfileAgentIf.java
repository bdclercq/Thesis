...
/**
 * interface for the entity bean ScreenProfileBean,
 * representing a known ScreenProfile
 */
public interface ScreenProfileAgentIf {
  ...
  CrudsResult<DataRef> create(ScreenProfileDetails screenProfileDetails);
  CrudsResult<DataRef> modify(ScreenProfileDetails screenProfileDetails);
  ...
  CrudsResult<ScreenProfileDetails> getDetails(DataRef dataRef);
  ...
  <S extends ScreenProfileFindDetails, T> SearchResult<T> find(SearchDetails<S> searchDetails);
  // anchor:search-methods:end

  // anchor:data-only-methods:start
  CrudsResult<ScreenProfileDetails> getDetails(Long screenProfileId);
  CrudsResult<DataRef> getDataRef(String name);

  SearchResult<DataRef> findAllDataRefs();
  SearchResult<ScreenProfileInfo> findAllInfos();
