...
/**
 * Local interface for the session bean DataAuthorization.
 */

public interface DataAuthorizationLocal extends TaskPerformer<DataAccessRights,DataAccessQuery>, TaskPerformerByDataRef<DataAccessRights> {
