...
/**
 * Remote interface for the entity bean MenuItem,
 * representing a known MenuItem
 */
public interface MenuItemRemote {

  // anchor:custom-variables:start
  // anchor:custom-variables:end

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<MenuItemDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<MenuItemDetails> detailsParameter);
  ...
  CrudsResult<MenuItemInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<MenuItemDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<MenuItemDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends MenuItemFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
