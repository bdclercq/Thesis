...
define(function (require) {
  ...
  var AccountTableView = require('account/account/account-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.Account.page.title")
    };
    var viewModel = {};
    var title = translate("account.Account.menu.title");
    ...
    var table = AccountTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
