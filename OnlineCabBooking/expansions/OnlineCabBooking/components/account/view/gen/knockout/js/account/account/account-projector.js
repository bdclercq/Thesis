...
define(function(require) {
  ...
  var accountMetaData = require("dataElement!account.account");
  var accountAgent = accountMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "account.account.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = AccountEvents.defineCreateUpdateListener();
    var dataEdit = AccountEvents.defineEditUpdateListener();
    var dataRefresh = AccountEvents.defineRefreshUpdateListener();
    var dataDelete = AccountEvents.defineDeleteUpdateListener();
    var dataFinder = AccountEvents.defineFinderUpdateListener();
