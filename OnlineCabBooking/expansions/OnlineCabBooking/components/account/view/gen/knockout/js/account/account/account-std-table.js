...
define(function (require) {
  ...
  var AccountSorting = require('account/account/account-sorting');
  var AccountInfoModel = require('account/account/account-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = AccountSorting.defineSorting();
    var dataUpdate = AccountEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: AccountInfoModel
    });

    var infoListView = "account/account-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
