...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Account!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = AccountEvents.defineViewIntentListener();

      var config = {
        title: 'Account',
        projection: 'details',
        projector: 'account/account/account-projector',
        modeller: 'account/account/account-details-instance-model',
