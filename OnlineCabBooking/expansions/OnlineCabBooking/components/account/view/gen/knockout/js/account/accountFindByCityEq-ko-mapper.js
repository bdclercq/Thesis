...
define(function(require) {
  ...
  var accountFindByCityEqElement = nsxApplication.getElement("account", "accountFindByCityEq");
  ...
  var fieldOptions = {
    ...
    city: {
      ...
      key: "account.AccountFindByCityEq.city",
      isValueType: false
    }
  ...
  function jsToFormModel(accountFindByCityEq, fieldFilter) {
    var detailModel = jsToViewModel(accountFindByCityEq);
    var form = {
  ...
  function jsToViewModel(accountFindByCityEq) {
    var accountFindByCityEqViewModel = {
      // anchor:value-fields-to-model:start
      city: ko.observable(accountFindByCityEq.city),
    ...
    return accountFindByCityEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(accountFindByCityEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      city: accountFindByCityEqViewModel.city(),
  ...
  return accountFindByCityEqMapper;
});
