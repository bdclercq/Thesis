...
define(function(require) {
  ...
  var accountFindByRefIdEqElement = nsxApplication.getElement("account", "accountFindByRefIdEq");
  ...
  var fieldOptions = {
    ...
    refId: {
      ...
      key: "account.AccountFindByRefIdEq.refId",
      isValueType: false
    }
  ...
  function jsToFormModel(accountFindByRefIdEq, fieldFilter) {
    var detailModel = jsToViewModel(accountFindByRefIdEq);
    var form = {
  ...
  function jsToViewModel(accountFindByRefIdEq) {
    var accountFindByRefIdEqViewModel = {
      // anchor:value-fields-to-model:start
      refId: ko.observable(accountFindByRefIdEq.refId),
    ...
    return accountFindByRefIdEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(accountFindByRefIdEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      refId: accountFindByRefIdEqViewModel.refId(),
  ...
  var accountFindByRefIdEqMapper = {
  ...
  return accountFindByRefIdEqMapper;
});
