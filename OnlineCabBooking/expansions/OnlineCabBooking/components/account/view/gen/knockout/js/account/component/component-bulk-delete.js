...
define(function (require) {
  ...
  const ComponentActions = require('account/component/component-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = ComponentEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = ComponentActions.deleteMultipleAction();
