  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        forUserGroup: defineLink(UserGroupEvents)
    ...
    function updateViewmodel(dataAccessDetails) {
      if (!!dataAccessDetails) {
        ...
        viewmodel.name(dataAccessDetails.name);
        viewmodel.forProfile.value(dataAccessDetails.forProfile);
        viewmodel.forUser.value(dataAccessDetails.forUser);
        viewmodel.userGroups(dataAccessDetails.userGroups);
        ...
        viewmodel.lastModifiedAt(dataAccessDetails.lastModifiedAt);
        viewmodel.enteredAt(dataAccessDetails.enteredAt);
        viewmodel.disabled(dataAccessDetails.disabled);
        viewmodel.forUserGroup.value(dataAccessDetails.forUserGroup);
