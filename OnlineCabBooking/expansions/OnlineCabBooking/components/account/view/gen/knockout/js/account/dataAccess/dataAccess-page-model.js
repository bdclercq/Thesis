...
define(function (require) {
  ...
  var DataAccessTableView = require('account/dataAccess/dataAccess-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.DataAccess.page.title")
    };
    var viewModel = {};
    var title = translate("account.DataAccess.menu.title");
    ...
    var table = DataAccessTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
