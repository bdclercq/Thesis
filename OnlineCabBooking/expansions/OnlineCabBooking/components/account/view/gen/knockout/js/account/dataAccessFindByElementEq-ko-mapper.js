...
define(function(require) {
  ...
  var dataAccessFindByElementEqElement = nsxApplication.getElement("account", "dataAccessFindByElementEq");
  ...
  var fieldOptions = {
    ...
    element: {
      ...
      key: "account.DataAccessFindByElementEq.element",
      isValueType: false
    }
  ...
  function jsToFormModel(dataAccessFindByElementEq, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindByElementEq);
    var form = {
  ...
  function jsToViewModel(dataAccessFindByElementEq) {
    var dataAccessFindByElementEqViewModel = {
      // anchor:value-fields-to-model:start
      element: ko.observable(dataAccessFindByElementEq.element),
    ...
    return dataAccessFindByElementEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(dataAccessFindByElementEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      element: dataAccessFindByElementEqViewModel.element(),
  ...
  var dataAccessFindByElementEqMapper = {
  ...
  return dataAccessFindByElementEqMapper;
});
