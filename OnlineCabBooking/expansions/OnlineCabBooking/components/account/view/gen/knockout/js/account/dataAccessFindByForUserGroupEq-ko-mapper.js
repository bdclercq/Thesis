...
define(function(require) {
  ...
  var dataAccessFindByForUserGroupEqElement = nsxApplication.getElement("account", "dataAccessFindByForUserGroupEq");
  ...
  var fieldOptions = {
    ...
    forUserGroup: {
      ...
      key: "account.DataAccessFindByForUserGroupEq.forUserGroup",
      isValueType: false
    }
  ...
  function jsToFormModel(dataAccessFindByForUserGroupEq, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindByForUserGroupEq);
    var form = {
  ...
  function jsToViewModel(dataAccessFindByForUserGroupEq) {
    var dataAccessFindByForUserGroupEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      forUserGroup: ko.observable(dataAccessFindByForUserGroupEq.forUserGroup),
    ...
    return dataAccessFindByForUserGroupEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(dataAccessFindByForUserGroupEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      forUserGroup: dataAccessFindByForUserGroupEqViewModel.forUserGroup(),
  ...
  var dataAccessFindByForUserGroupEqMapper = {
  ...
  return dataAccessFindByForUserGroupEqMapper;
});
