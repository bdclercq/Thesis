...
define(function(require) {
  ...
  var dataAccessFindByTargetEqElement = nsxApplication.getElement("account", "dataAccessFindByTargetEq");
  ...
  var fieldOptions = {
    ...
    target: {
      ...
      key: "account.DataAccessFindByTargetEq.target",
      isValueType: false
    }
  ...
  function jsToFormModel(dataAccessFindByTargetEq, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindByTargetEq);
    var form = {
  ...
  function jsToViewModel(dataAccessFindByTargetEq) {
    var dataAccessFindByTargetEqViewModel = {
      // anchor:value-fields-to-model:start
      target: ko.observable(dataAccessFindByTargetEq.target),
    ...
    return dataAccessFindByTargetEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(dataAccessFindByTargetEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      target: dataAccessFindByTargetEqViewModel.target(),
  ...
  var dataAccessFindByTargetEqMapper = {
  ...
  return dataAccessFindByTargetEqMapper;
});
