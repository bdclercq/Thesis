...
define(function (require) {
  ...
  var HelpInfoTableView = require('account/helpInfo/helpInfo-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.HelpInfo.page.title")
    };
    var viewModel = {};
    var title = translate("account.HelpInfo.menu.title");
    ...
    var table = HelpInfoTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
