...
define(function (require) {
  ...
  var HelpInfoFinders = require('account/helpInfo/helpInfo-finders');
  var HelpInfoStdTable = require('account/helpInfo/helpInfo-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = HelpInfoFinders.finderWith(constantFields);
    var finderOptions = HelpInfoFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = HelpInfoEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineHelpInfoList(widget, input) {
    return HelpInfoStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: HelpInfoEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: HelpInfoEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: HelpInfoEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: HelpInfoEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: HelpInfoEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var helpInfoList = defineHelpInfoList(widget, listOptions);

    tableContext.selection = helpInfoList.selection;
    ...
    var pagination = definePagination(toolbar, helpInfoList.listModel);
    ...
    return {
      injector: widget,
      selection: helpInfoList.selection
    };
  }
