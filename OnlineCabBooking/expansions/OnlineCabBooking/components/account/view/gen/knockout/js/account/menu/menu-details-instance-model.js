  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        name: ko.observable(),
        portal: defineLink(PortalEvents),
    ...
    function updateViewmodel(menuDetails) {
      if (!!menuDetails) {
        viewmodel.id(menuDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(menuDetails.name);
        viewmodel.portal.value(menuDetails.portal);
        viewmodel.profile.value(menuDetails.profile);
        viewmodel.menuItems(menuDetails.menuItems);
