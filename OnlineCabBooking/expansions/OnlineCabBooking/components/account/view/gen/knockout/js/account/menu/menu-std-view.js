...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Menu!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = MenuEvents.defineViewIntentListener();

      var config = {
        title: 'Menu',
        projection: 'details',
        projector: 'account/menu/menu-projector',
        modeller: 'account/menu/menu-details-instance-model',
        view: 'account/menu-details-instance'
      };
