...
define(function(require) {
  ...
  var menuFindByNameEqElement = nsxApplication.getElement("account", "menuFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.MenuFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(menuFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(menuFindByNameEq);
    var form = {
  ...
  function jsToViewModel(menuFindByNameEq) {
    var menuFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(menuFindByNameEq.name),
    ...
    return menuFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: menuFindByNameEqViewModel.name(),
