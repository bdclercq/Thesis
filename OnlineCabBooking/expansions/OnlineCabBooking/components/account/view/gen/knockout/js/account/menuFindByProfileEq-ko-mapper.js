...
define(function(require) {
  ...
  var menuFindByProfileEqElement = nsxApplication.getElement("account", "menuFindByProfileEq");
  ...
  var fieldOptions = {
    ...
    profile: {
      ...
      key: "account.MenuFindByProfileEq.profile",
      isValueType: false
    }
  ...
  function jsToFormModel(menuFindByProfileEq, fieldFilter) {
    var detailModel = jsToViewModel(menuFindByProfileEq);
    var form = {
  ...
  function jsToViewModel(menuFindByProfileEq) {
    var menuFindByProfileEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      profile: ko.observable(menuFindByProfileEq.profile),
  ...
  return menuFindByProfileEqMapper;
});
