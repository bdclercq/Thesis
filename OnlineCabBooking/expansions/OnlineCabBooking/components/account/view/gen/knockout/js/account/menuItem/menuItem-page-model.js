...
define(function (require) {
  ...
  var MenuItemTableView = require('account/menuItem/menuItem-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.MenuItem.page.title")
    };
    var viewModel = {};
    var title = translate("account.MenuItem.menu.title");
    ...
    var table = MenuItemTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
