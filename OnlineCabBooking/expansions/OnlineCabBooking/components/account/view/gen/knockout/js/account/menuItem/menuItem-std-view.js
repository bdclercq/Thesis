...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) MenuItem!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = MenuItemEvents.defineViewIntentListener();

      var config = {
        title: 'MenuItem',
        projection: 'details',
        projector: 'account/menuItem/menuItem-projector',
        modeller: 'account/menuItem/menuItem-details-instance-model',
        view: 'account/menuItem-details-instance'
      };
