...
define(function(require) {
  ...
  var menuItemFindByNameEqElement = nsxApplication.getElement("account", "menuItemFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.MenuItemFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(menuItemFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(menuItemFindByNameEq);
    var form = {
  ...
  function jsToViewModel(menuItemFindByNameEq) {
    var menuItemFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(menuItemFindByNameEq.name),
    ...
    return menuItemFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuItemFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: menuItemFindByNameEqViewModel.name(),
  ...
  var menuItemFindByNameEqMapper = {
  ...
  return menuItemFindByNameEqMapper;
});
