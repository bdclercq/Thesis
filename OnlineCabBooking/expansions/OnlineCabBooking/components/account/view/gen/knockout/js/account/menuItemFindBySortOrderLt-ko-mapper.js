...
define(function(require) {
  ...
  var menuItemFindBySortOrderLtElement = nsxApplication.getElement("account", "menuItemFindBySortOrderLt");
  ...
  var fieldOptions = {
    ...
    sortOrder: {
      ...
      key: "account.MenuItemFindBySortOrderLt.sortOrder",
      isValueType: false
    }
  ...
  function jsToFormModel(menuItemFindBySortOrderLt, fieldFilter) {
    var detailModel = jsToViewModel(menuItemFindBySortOrderLt);
    var form = {
  ...
  function jsToViewModel(menuItemFindBySortOrderLt) {
    var menuItemFindBySortOrderLtViewModel = {
      // anchor:value-fields-to-model:start
      sortOrder: ko.observable(menuItemFindBySortOrderLt.sortOrder),
    ...
    return menuItemFindBySortOrderLtViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuItemFindBySortOrderLtViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      sortOrder: menuItemFindBySortOrderLtViewModel.sortOrder(),
  ...
  var menuItemFindBySortOrderLtMapper = {
  ...
  return menuItemFindBySortOrderLtMapper;
});
