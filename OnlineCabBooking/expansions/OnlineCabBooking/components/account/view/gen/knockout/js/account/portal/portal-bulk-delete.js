...
define(function (require) {
  ...
  const PortalActions = require('account/portal/portal-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = PortalEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = PortalActions.deleteMultipleAction();
