...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) Portal element!")
    });

    function render() {
      var createIntent = PortalEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: PortalActions.createAction()
      };
