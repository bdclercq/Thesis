...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Portal!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = PortalEvents.defineViewIntentListener();

      var config = {
        title: 'Portal',
        projection: 'details',
        projector: 'account/portal/portal-projector',
        modeller: 'account/portal/portal-details-instance-model',
        view: 'account/portal-details-instance'
      };
