...
define(function (require) {
  ...
  var PortalFinders = require('account/portal/portal-finders');
  var PortalStdTable = require('account/portal/portal-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = PortalFinders.finderWith(constantFields);
    var finderOptions = PortalFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = PortalEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function definePortalList(widget, input) {
    return PortalStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: PortalEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: PortalEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: PortalEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: PortalEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: PortalEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var portalList = definePortalList(widget, listOptions);

    tableContext.selection = portalList.selection;
    ...
    var pagination = definePagination(toolbar, portalList.listModel);
    ...
    return {
      injector: widget,
      selection: portalList.selection
    };
  }
