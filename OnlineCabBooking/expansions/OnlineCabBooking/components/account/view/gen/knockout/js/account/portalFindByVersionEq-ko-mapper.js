...
define(function(require) {
  ...
  var portalFindByVersionEqElement = nsxApplication.getElement("account", "portalFindByVersionEq");
  ...
  var fieldOptions = {
    ...
    version: {
      ...
      key: "account.PortalFindByVersionEq.version",
      isValueType: false
    }
  ...
  function jsToFormModel(portalFindByVersionEq, fieldFilter) {
    var detailModel = jsToViewModel(portalFindByVersionEq);
    var form = {
  ...
  function jsToViewModel(portalFindByVersionEq) {
    var portalFindByVersionEqViewModel = {
      // anchor:value-fields-to-model:start
      version: ko.observable(portalFindByVersionEq.version),
    ...
    return portalFindByVersionEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(portalFindByVersionEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      version: portalFindByVersionEqViewModel.version(),
  ...
  var portalFindByVersionEqMapper = {
  ...
  return portalFindByVersionEqMapper;
});
