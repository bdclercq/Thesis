...
define(function (require) {
  ...
  var ProfileFinders = require('account/profile/profile-finders');
  var ProfileStdTable = require('account/profile/profile-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ProfileFinders.finderWith(constantFields);
    var finderOptions = ProfileFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ProfileEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineProfileList(widget, input) {
    return ProfileStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ProfileEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ProfileEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ProfileEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ProfileEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ProfileEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var profileList = defineProfileList(widget, listOptions);

    tableContext.selection = profileList.selection;
    ...
    var pagination = definePagination(toolbar, profileList.listModel);
    ...
    return {
      injector: widget,
      selection: profileList.selection
    };
  }
