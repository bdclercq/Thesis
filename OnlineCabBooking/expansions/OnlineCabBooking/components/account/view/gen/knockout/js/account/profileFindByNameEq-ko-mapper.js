...
define(function(require) {
  ...
  var profileFindByNameEqElement = nsxApplication.getElement("account", "profileFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.ProfileFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(profileFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(profileFindByNameEq);
    var form = {
  ...
  function jsToViewModel(profileFindByNameEq) {
    var profileFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(profileFindByNameEq.name),
    ...
    return profileFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(profileFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: profileFindByNameEqViewModel.name(),
  ...
  return profileFindByNameEqMapper;
});
