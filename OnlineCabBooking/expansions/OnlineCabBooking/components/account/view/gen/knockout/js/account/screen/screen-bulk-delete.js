...
define(function (require) {
  ...
  const ScreenActions = require('account/screen/screen-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = ScreenEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = ScreenActions.deleteMultipleAction();
