...
define(function (require) {
  ...
  var ScreenSorting = require('account/screen/screen-sorting');
  var ScreenInfoModel = require('account/screen/screen-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ScreenSorting.defineSorting();
    var dataUpdate = ScreenEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ScreenInfoModel
    });

    var infoListView = "account/screen-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
