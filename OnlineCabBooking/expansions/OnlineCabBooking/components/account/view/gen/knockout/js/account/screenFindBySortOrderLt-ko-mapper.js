...
define(function(require) {
  ...
  var screenFindBySortOrderLtElement = nsxApplication.getElement("account", "screenFindBySortOrderLt");
  ...
  var fieldOptions = {
    ...
    sortOrder: {
      ...
      key: "account.ScreenFindBySortOrderLt.sortOrder",
      isValueType: false
    }
  ...
  function jsToFormModel(screenFindBySortOrderLt, fieldFilter) {
    var detailModel = jsToViewModel(screenFindBySortOrderLt);
    var form = {
  ...
  function jsToViewModel(screenFindBySortOrderLt) {
    var screenFindBySortOrderLtViewModel = {
      // anchor:value-fields-to-model:start
      sortOrder: ko.observable(screenFindBySortOrderLt.sortOrder),
    ...
    return screenFindBySortOrderLtViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(screenFindBySortOrderLtViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      sortOrder: screenFindBySortOrderLtViewModel.sortOrder(),
  ...
  var screenFindBySortOrderLtMapper = {
  ...
  return screenFindBySortOrderLtMapper;
});
