...
define(function (require) {
  ...
  const ScreenProfileActions = require('account/screenProfile/screenProfile-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = ScreenProfileEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = ScreenProfileActions.deleteMultipleAction();
