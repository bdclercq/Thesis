...
define(function (require) {
  ...
  var ScreenProfileSorting = require('account/screenProfile/screenProfile-sorting');
  var ScreenProfileInfoModel = require('account/screenProfile/screenProfile-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ScreenProfileSorting.defineSorting();
    var dataUpdate = ScreenProfileEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ScreenProfileInfoModel
    });

    var infoListView = "account/screenProfile-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
