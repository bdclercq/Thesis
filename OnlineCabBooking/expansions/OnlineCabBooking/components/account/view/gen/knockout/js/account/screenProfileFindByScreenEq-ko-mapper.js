...
define(function(require) {
  ...
  var screenProfileFindByScreenEqElement = nsxApplication.getElement("account", "screenProfileFindByScreenEq");
  ...
  var fieldOptions = {
    ...
    screen: {
      ...
      key: "account.ScreenProfileFindByScreenEq.screen",
      isValueType: false
    }
  ...
  function jsToFormModel(screenProfileFindByScreenEq, fieldFilter) {
    var detailModel = jsToViewModel(screenProfileFindByScreenEq);
    var form = {
  ...
  function jsToViewModel(screenProfileFindByScreenEq) {
    var screenProfileFindByScreenEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      screen: ko.observable(screenProfileFindByScreenEq.screen),
  ...
  var screenProfileFindByScreenEqMapper = {
  ...
  return screenProfileFindByScreenEqMapper;
});
