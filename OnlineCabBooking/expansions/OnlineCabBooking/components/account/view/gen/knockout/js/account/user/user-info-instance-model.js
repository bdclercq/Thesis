  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        account: defineLink(AccountEvents),
    ...
    function updateViewmodel(userDetails) {
      if (!!userDetails) {
        ...
        viewmodel.account.value(userDetails.account);
        viewmodel.profile.value(userDetails.profile);
        viewmodel.userGroups(userDetails.userGroups);
