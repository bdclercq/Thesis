...
define(function (require) {
  ...
  var UserFinders = require('account/user/user-finders');
  var UserStdTable = require('account/user/user-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = UserFinders.finderWith(constantFields);
    var finderOptions = UserFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineUserList(widget, input) {
    return UserStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: UserEvents.defineCreateIntentTrigger({
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: UserEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: UserEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: UserEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var userList = defineUserList(widget, listOptions);

    tableContext.selection = userList.selection;
    ...
    var pagination = definePagination(toolbar, userList.listModel);
