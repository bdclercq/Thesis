...
define(function(require) {
  ...
  var userFindByFullNameEqElement = nsxApplication.getElement("account", "userFindByFullNameEq");
  ...
  var fieldOptions = {
    ...
    fullName: {
      ...
      key: "account.UserFindByFullNameEq.fullName",
      isValueType: false
    }
  ...
  function jsToFormModel(userFindByFullNameEq, fieldFilter) {
    var detailModel = jsToViewModel(userFindByFullNameEq);
    var form = {
  ...
  function jsToViewModel(userFindByFullNameEq) {
    var userFindByFullNameEqViewModel = {
      // anchor:value-fields-to-model:start
      fullName: ko.observable(userFindByFullNameEq.fullName),
    ...
    return userFindByFullNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userFindByFullNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      fullName: userFindByFullNameEqViewModel.fullName(),
  ...
  var userFindByFullNameEqMapper = {
  ...
  return userFindByFullNameEqMapper;
});
