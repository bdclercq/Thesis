...
define(function(require) {
  ...
  var userFindByNameEqElement = nsxApplication.getElement("account", "userFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.UserFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(userFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(userFindByNameEq);
    var form = {
  ...
  function jsToViewModel(userFindByNameEq) {
    var userFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(userFindByNameEq.name),
    ...
    return userFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: userFindByNameEqViewModel.name(),
