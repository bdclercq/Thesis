...
define(function(require) {
  ...
  var userFindByNameEq_ProfileEqElement = nsxApplication.getElement("account", "userFindByNameEq_ProfileEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.UserFindByNameEq_ProfileEq.name",
      isValueType: false
    },
    profile: {
      fieldName: "profile",
      type: FieldType.DATAREF,
      key: "account.UserFindByNameEq_ProfileEq.profile",
      isValueType: false
    }
  ...
  function jsToFormModel(userFindByNameEq_ProfileEq, fieldFilter) {
    var detailModel = jsToViewModel(userFindByNameEq_ProfileEq);
    var form = {
  ...
  function jsToViewModel(userFindByNameEq_ProfileEq) {
    var userFindByNameEq_ProfileEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(userFindByNameEq_ProfileEq.name),
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      profile: ko.observable(userFindByNameEq_ProfileEq.profile),
    ...
    return userFindByNameEq_ProfileEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userFindByNameEq_ProfileEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: userFindByNameEq_ProfileEqViewModel.name(),
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      profile: userFindByNameEq_ProfileEqViewModel.profile(),
  ...
  var userFindByNameEq_ProfileEqMapper = {
  ...
  return userFindByNameEq_ProfileEqMapper;
});
