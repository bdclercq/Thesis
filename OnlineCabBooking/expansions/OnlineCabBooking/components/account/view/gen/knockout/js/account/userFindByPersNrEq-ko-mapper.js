...
define(function(require) {
  ...
  var userFindByPersNrEqElement = nsxApplication.getElement("account", "userFindByPersNrEq");
  ...
  var fieldOptions = {
    ...
    persNr: {
      ...
      key: "account.UserFindByPersNrEq.persNr",
      isValueType: false
    }
  ...
  function jsToFormModel(userFindByPersNrEq, fieldFilter) {
    var detailModel = jsToViewModel(userFindByPersNrEq);
    var form = {
  ...
  function jsToViewModel(userFindByPersNrEq) {
    var userFindByPersNrEqViewModel = {
      // anchor:value-fields-to-model:start
      persNr: ko.observable(userFindByPersNrEq.persNr),
    ...
    return userFindByPersNrEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userFindByPersNrEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      persNr: userFindByPersNrEqViewModel.persNr(),
  ...
  return userFindByPersNrEqMapper;
});
