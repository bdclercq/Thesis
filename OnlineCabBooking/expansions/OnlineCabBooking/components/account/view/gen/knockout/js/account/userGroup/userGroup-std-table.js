...
define(function (require) {
  ...
  var UserGroupSorting = require('account/userGroup/userGroup-sorting');
  var UserGroupInfoModel = require('account/userGroup/userGroup-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = UserGroupSorting.defineSorting();
    var dataUpdate = UserGroupEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: UserGroupInfoModel
    });

    var infoListView = "account/userGroup-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
