...
import net.democritus.assets.AssetFindDetails;
...
public class AssetFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.assets.action.AssetFindAction");

  private SearchDetails<? extends AssetFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.assets", "Asset", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    AssetAgent assetAgent = createAssetAgent();
    ...
    searchResult = assetAgent.find(searchDetails);
  ...
  private AssetAgent createAssetAgent() {
