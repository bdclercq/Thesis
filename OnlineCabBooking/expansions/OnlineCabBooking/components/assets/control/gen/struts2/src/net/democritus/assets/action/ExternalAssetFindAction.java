...
import net.democritus.assets.ExternalAssetFindDetails;
...
public class ExternalAssetFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.assets.action.ExternalAssetFindAction");

  private SearchDetails<? extends ExternalAssetFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.assets", "ExternalAsset", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllExternalAssets";
    }
  ...
  public String execute() throws Exception {
    ...
    ExternalAssetAgent externalAssetAgent = createExternalAssetAgent();
    ...
    searchResult = externalAssetAgent.find(searchDetails);
  ...
  private ExternalAssetAgent createExternalAssetAgent() {
