...
import net.democritus.assets.FileAssetFindDetails;
...
public class FileAssetFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.assets.action.FileAssetFindAction");

  private SearchDetails<? extends FileAssetFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.assets", "FileAsset", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllFileAssets";
    }
  ...
  public String execute() throws Exception {
    ...
    FileAssetAgent fileAssetAgent = createFileAssetAgent();
    ...
    searchResult = fileAssetAgent.find(searchDetails);
  ...
  private FileAssetAgent createFileAssetAgent() {
