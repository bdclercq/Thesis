...
import net.democritus.assets.InternalAssetChunkFindDetails;
...
public class InternalAssetChunkFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.assets.action.InternalAssetChunkFindAction");

  private SearchDetails<? extends InternalAssetChunkFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.assets", "InternalAssetChunk", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    searchResult = internalAssetChunkAgent.find(searchDetails);
  ...
  private InternalAssetChunkAgent createInternalAssetChunkAgent() {
