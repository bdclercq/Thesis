...
import net.democritus.assets.InternalAssetFindDetails;
...
public class InternalAssetFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.assets.action.InternalAssetFindAction");

  private SearchDetails<? extends InternalAssetFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.assets", "InternalAsset", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    InternalAssetAgent internalAssetAgent = createInternalAssetAgent();
    ...
    searchResult = internalAssetAgent.find(searchDetails);
  ...
  private InternalAssetAgent createInternalAssetAgent() {
