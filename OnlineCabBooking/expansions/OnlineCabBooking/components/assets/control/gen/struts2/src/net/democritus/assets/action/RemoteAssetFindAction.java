...
import net.democritus.assets.RemoteAssetFindDetails;
...
public class RemoteAssetFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.assets.action.RemoteAssetFindAction");

  private SearchDetails<? extends RemoteAssetFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.assets", "RemoteAsset", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllRemoteAssets";
    }
  ...
  public String execute() throws Exception {
    ...
    RemoteAssetAgent remoteAssetAgent = createRemoteAssetAgent();
    ...
    searchResult = remoteAssetAgent.find(searchDetails);
  ...
  private RemoteAssetAgent createRemoteAssetAgent() {
