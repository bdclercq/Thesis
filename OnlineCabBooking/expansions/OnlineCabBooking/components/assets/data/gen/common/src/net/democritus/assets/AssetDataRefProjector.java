...
public class AssetDataRefProjector implements IDataElementProjector<AssetData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(AssetData data, ParameterContext<DataRef> projectionParameter) {
