...
public class AssetInfoProjector implements IDataElementProjector<AssetData, AssetInfo>, IDataProjectorRequired<AssetInfo> {
  ...
  public AssetInfoProjector(AssetCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public AssetInfo project(ParameterContext<AssetData> dataParameter) {

    AssetInfo projection = new AssetInfo();
  ...
  public void toData(AssetData data, ParameterContext<AssetInfo> projectionParameter) {
    // don't set the data id
    AssetInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(AssetInfo projection) {
  ...
  public Class<AssetInfo> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<AssetInfo> projectionParameter) {
