...
public class ExternalAssetDataRefProjector implements IDataElementProjector<ExternalAssetData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public ExternalAssetDataRefProjector(ExternalAssetCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<ExternalAssetData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("assets");
    projection.setPackName("net.democritus.assets");
    projection.setClassName("ExternalAsset");
  ...
  // anchor:toData:start
  public void toData(ExternalAssetData data, ParameterContext<DataRef> projectionParameter) {
