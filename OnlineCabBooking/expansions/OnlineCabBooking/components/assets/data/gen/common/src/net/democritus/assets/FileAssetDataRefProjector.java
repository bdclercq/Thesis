...
public class FileAssetDataRefProjector implements IDataElementProjector<FileAssetData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public FileAssetDataRefProjector(FileAssetCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<FileAssetData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("assets");
    projection.setPackName("net.democritus.assets");
    projection.setClassName("FileAsset");
  ...
  // anchor:toData:start
  public void toData(FileAssetData data, ParameterContext<DataRef> projectionParameter) {
