...
public class FileAssetDetailsProjector implements IDataElementProjector<FileAssetData, FileAssetDetails>, IDataProjectorRequired<FileAssetDetails> {
  ...
  public FileAssetDetailsProjector(FileAssetCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public FileAssetDetails project(ParameterContext<FileAssetData> dataParameter) {

    FileAssetDetails projection = new FileAssetDetails();
  ...
  public void toData(FileAssetData data, ParameterContext<FileAssetDetails> projectionParameter) {
    // don't set the data id
    FileAssetDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(FileAssetDetails projection) {
  ...
  public Class<FileAssetDetails> getProjectionClass() {
    return FileAssetDetails.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<FileAssetDetails> projectionParameter) {
