...
public class InternalAssetChunkDataRefProjector implements IDataElementProjector<InternalAssetChunkData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public InternalAssetChunkDataRefProjector(InternalAssetChunkCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<InternalAssetChunkData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("assets");
    projection.setPackName("net.democritus.assets");
    projection.setClassName("InternalAssetChunk");
  ...
  // anchor:toData:start
  public void toData(InternalAssetChunkData data, ParameterContext<DataRef> projectionParameter) {
