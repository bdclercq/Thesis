...
public class InternalAssetDataRefProjector implements IDataElementProjector<InternalAssetData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public InternalAssetDataRefProjector(InternalAssetCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<InternalAssetData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("assets");
    projection.setPackName("net.democritus.assets");
    projection.setClassName("InternalAsset");
  ...
  // anchor:toData:start
  public void toData(InternalAssetData data, ParameterContext<DataRef> projectionParameter) {
