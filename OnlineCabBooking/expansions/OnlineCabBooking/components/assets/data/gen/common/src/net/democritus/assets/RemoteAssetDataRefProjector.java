...
public class RemoteAssetDataRefProjector implements IDataElementProjector<RemoteAssetData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public RemoteAssetDataRefProjector(RemoteAssetCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<RemoteAssetData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("assets");
    projection.setPackName("net.democritus.assets");
    projection.setClassName("RemoteAsset");
  ...
  // anchor:toData:start
  public void toData(RemoteAssetData data, ParameterContext<DataRef> projectionParameter) {
