...
public class RemoteAssetInfoProjector implements IDataElementProjector<RemoteAssetData, RemoteAssetInfo>, IDataProjectorRequired<RemoteAssetInfo> {
  ...
  public RemoteAssetInfoProjector(RemoteAssetCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public RemoteAssetInfo project(ParameterContext<RemoteAssetData> dataParameter) {

    RemoteAssetInfo projection = new RemoteAssetInfo();
  ...
  public void toData(RemoteAssetData data, ParameterContext<RemoteAssetInfo> projectionParameter) {
    // don't set the data id
    RemoteAssetInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(RemoteAssetInfo projection) {
  ...
  public Class<RemoteAssetInfo> getProjectionClass() {
    return RemoteAssetInfo.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<RemoteAssetInfo> projectionParameter) {
