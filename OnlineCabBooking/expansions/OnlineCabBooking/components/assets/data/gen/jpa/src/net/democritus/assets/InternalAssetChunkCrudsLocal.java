...
public interface InternalAssetChunkCrudsLocal {
  ...
  <S extends InternalAssetChunkFindDetails, P> SearchResult<P> find(ParameterContext<SearchDetails<S>> searchParameter);
