...
/**
 * Persistency pojo class for the entity InternalAsset,
 */

@Entity(name=InternalAssetData.ENTITY_NAME)
// @anchor:annotations:start
@Table(name="InternalAsset", schema="ASSETS")
// @anchor:annotations:end
@NamedQueries({
  @NamedQuery(name=InternalAssetData.QUERY_FINDALL, query="select o FROM " + InternalAssetData.ENTITY_NAME + " o")
  // @anchor:queries:start
  // @anchor:queries:end
  // anchor:custom-queries:start
  // anchor:custom-queries:end
})
public class InternalAssetData implements java.io.Serializable {

  // @anchor:constants:start
  public static final String ENTITY_NAME = "net.democritus.assets.InternalAsset";
  public static final String QUERY_FINDALL = "net.democritus.assets.InternalAsset.findAll";
  ...
  public InternalAssetData(Long id
