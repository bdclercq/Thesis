...
/**
 * Persistency pojo class for the entity RemoteAsset,
 */

@Entity(name=RemoteAssetData.ENTITY_NAME)
// @anchor:annotations:start
@Table(name="RemoteAsset", schema="ASSETS")
// @anchor:annotations:end
@NamedQueries({
  @NamedQuery(name=RemoteAssetData.QUERY_FINDALL, query="select o FROM " + RemoteAssetData.ENTITY_NAME + " o")
  // @anchor:queries:start
  // @anchor:queries:end
  // anchor:custom-queries:start
  // anchor:custom-queries:end
})
public class RemoteAssetData implements java.io.Serializable {

  // @anchor:constants:start
  public static final String ENTITY_NAME = "net.democritus.assets.RemoteAsset";
  public static final String QUERY_FINDALL = "net.democritus.assets.RemoteAsset.findAll";
  ...
  public RemoteAssetData(Long id
  ...
  // @anchor:annotations-getter-url:start
  // @anchor:annotations-getter-url:end
  // anchor:custom-annotations-getter-url:start
  // anchor:custom-annotations-getter-url:end
  public String getUrl() {
    return this.mUrl;
  }

  // @anchor:annotations-setter-url:start
  // @anchor:annotations-setter-url:end
  // anchor:custom-annotations-setter-url:start
  // anchor:custom-annotations-setter-url:end
