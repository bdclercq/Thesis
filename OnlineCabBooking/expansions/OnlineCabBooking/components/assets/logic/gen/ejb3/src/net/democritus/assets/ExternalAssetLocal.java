...
/**
 * Local interface for the entity bean ExternalAsset,
 * representing a known ExternalAsset
 */
public interface ExternalAssetLocal {
  ...
  ExternalAssetInfo getInfo(Long id);
  ExternalAssetDetails getDetails(DataRef dataRef);
  ExternalAssetDetails getDetails(Long id);
