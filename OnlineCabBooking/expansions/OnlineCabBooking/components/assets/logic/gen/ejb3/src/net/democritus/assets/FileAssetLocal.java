...
/**
 * Local interface for the entity bean FileAsset,
 * representing a known FileAsset
 */
public interface FileAssetLocal {
  ...
  FileAssetInfo getInfo(Long id);
  FileAssetDetails getDetails(DataRef dataRef);
  FileAssetDetails getDetails(Long id);
