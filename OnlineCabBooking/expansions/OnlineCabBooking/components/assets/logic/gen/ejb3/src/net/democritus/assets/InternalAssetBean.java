...
@Remote(InternalAssetRemote.class)
@Local(InternalAssetLocal.class)
// @anchor:annotations:end
@DeclareRoles({
// anchor:custom-declare-roles:start
// anchor:custom-declare-roles:end
})
public class InternalAssetBean /*@anchor:interfaces:start@*/implements InternalAssetRemote, InternalAssetLocal/*@anchor:interfaces:end@*/{
  ...
  private static final Logger logger = LoggerFactory.getLogger(InternalAssetBean.class);
  @Deprecated
  @PersistenceContext(unitName="OnlineCabBooking_assets")
  private EntityManager entityManager;

  @EJB
  InternalAssetCrudsLocal internalAssetCrudsLocal;
  ...
  public CrudsResult<DataRef> create(ParameterContext<InternalAssetDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = internalAssetCrudsLocal.create(context.withParameter(details));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<InternalAssetDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = internalAssetCrudsLocal.modify(context.withParameter(details));
    if (result.isError()) {
      return result;
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    CrudsResult<DataRef> result = internalAssetCrudsLocal.createOrModify(projectionParameter);
    if (result.isError()) {
      return result;
    }
  ...
  public CrudsResult<Void> delete(ParameterContext<Long> idParameter) {
    ...
    try {
      ...
      CrudsResult<Void> result = internalAssetCrudsLocal.delete(context.withParameter(dataRef));
  ...
  public CrudsResult<DataRef> getId(ParameterContext<String> nameParameter) {
    return internalAssetCrudsLocal.getDataRefFromName(nameParameter);
  }

  public CrudsResult<String> getName(ParameterContext<Long> idParameter) {
    // @anchor:before-getName:start
    // @anchor:before-getName:end
    CrudsResult<DataRef> dataRefResult = internalAssetCrudsLocal.getDataRefFromId(idParameter);
  ...
  public DataRef getDataRef(Long id) {
    return internalAssetCrudsLocal.getDataRefFromId(ParameterContext.create(null, id)).getValue();
  }

  @Deprecated
  public InternalAssetInfo getInfo(Long id) {
    return getInfo(ParameterContext.create(null, id)).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public InternalAssetDetails getDetails(Long id) {
    return getDetailsFromDataRef(ParameterContext.create(null, idToDataRef(id))).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public InternalAssetDetails getDetails(DataRef dataRef) {
  ...
  public CrudsResult<DataRef> getDataRef(ParameterContext<Long> idParameter) {
    return internalAssetCrudsLocal.getDataRefFromId(idParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    return internalAssetCrudsLocal.resolveDataRef(dataRefParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<InternalAssetInfo> getInfo(ParameterContext<Long> idParameter) {
    DataRef dataRef = idToDataRef(idParameter.getValue());
  ...
  public CrudsResult<InternalAssetDetails> getDetails(ParameterContext<Long> idParameter) {
    ...
    CrudsResult<InternalAssetDetails> result = getDetailsFromDataRef(idParameter.construct(dataRef));
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<InternalAssetDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRefParameter) {
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    result = internalAssetCrudsLocal.getProjection(projectionRefParameter);
  ...
  public <S extends InternalAssetFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    ...
    result = internalAssetCrudsLocal.find(searchParameter);
