...
/**
 * Local interface for the entity bean InternalAsset,
 * representing a known InternalAsset
 */
public interface InternalAssetLocal {
  ...
  InternalAssetInfo getInfo(Long id);
  InternalAssetDetails getDetails(DataRef dataRef);
  InternalAssetDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<InternalAssetDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<InternalAssetDetails> detailsParameter);
  ...
  CrudsResult<InternalAssetInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<InternalAssetDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<InternalAssetDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends InternalAssetFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
