...
@Remote(RemoteAssetRemote.class)
@Local(RemoteAssetLocal.class)
// @anchor:annotations:end
@DeclareRoles({
// anchor:custom-declare-roles:start
// anchor:custom-declare-roles:end
})
public class RemoteAssetBean /*@anchor:interfaces:start@*/implements RemoteAssetRemote, RemoteAssetLocal/*@anchor:interfaces:end@*/{
  ...
  private static final Logger logger = LoggerFactory.getLogger(RemoteAssetBean.class);
  @Deprecated
  @PersistenceContext(unitName="OnlineCabBooking_assets")
  private EntityManager entityManager;

  @EJB
  RemoteAssetCrudsLocal remoteAssetCrudsLocal;
  ...
  public CrudsResult<DataRef> create(ParameterContext<RemoteAssetDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = remoteAssetCrudsLocal.create(context.withParameter(details));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<RemoteAssetDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = remoteAssetCrudsLocal.modify(context.withParameter(details));
    if (result.isError()) {
      return result;
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    CrudsResult<DataRef> result = remoteAssetCrudsLocal.createOrModify(projectionParameter);
    if (result.isError()) {
      return result;
    }
  ...
  public CrudsResult<Void> delete(ParameterContext<Long> idParameter) {
    ...
    try {
      ...
      CrudsResult<Void> result = remoteAssetCrudsLocal.delete(context.withParameter(dataRef));
  ...
  public CrudsResult<DataRef> getId(ParameterContext<String> nameParameter) {
    return remoteAssetCrudsLocal.getDataRefFromName(nameParameter);
  }

  public CrudsResult<String> getName(ParameterContext<Long> idParameter) {
    // @anchor:before-getName:start
    // @anchor:before-getName:end
    CrudsResult<DataRef> dataRefResult = remoteAssetCrudsLocal.getDataRefFromId(idParameter);
  ...
  public DataRef getDataRef(Long id) {
    return remoteAssetCrudsLocal.getDataRefFromId(ParameterContext.create(null, id)).getValue();
  }

  @Deprecated
  public RemoteAssetInfo getInfo(Long id) {
    return getInfo(ParameterContext.create(null, id)).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public RemoteAssetDetails getDetails(Long id) {
    return getDetailsFromDataRef(ParameterContext.create(null, idToDataRef(id))).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public RemoteAssetDetails getDetails(DataRef dataRef) {
  ...
  public CrudsResult<DataRef> getDataRef(ParameterContext<Long> idParameter) {
    return remoteAssetCrudsLocal.getDataRefFromId(idParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    return remoteAssetCrudsLocal.resolveDataRef(dataRefParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<RemoteAssetInfo> getInfo(ParameterContext<Long> idParameter) {
    DataRef dataRef = idToDataRef(idParameter.getValue());
  ...
  public CrudsResult<RemoteAssetDetails> getDetails(ParameterContext<Long> idParameter) {
    ...
    CrudsResult<RemoteAssetDetails> result = getDetailsFromDataRef(idParameter.construct(dataRef));
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<RemoteAssetDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRefParameter) {
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    result = remoteAssetCrudsLocal.getProjection(projectionRefParameter);
  ...
  public <S extends RemoteAssetFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    ...
    result = remoteAssetCrudsLocal.find(searchParameter);
