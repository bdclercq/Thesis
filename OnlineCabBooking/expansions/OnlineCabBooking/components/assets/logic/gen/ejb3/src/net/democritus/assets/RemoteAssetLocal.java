...
/**
 * Local interface for the entity bean RemoteAsset,
 * representing a known RemoteAsset
 */
public interface RemoteAssetLocal {
  ...
  RemoteAssetInfo getInfo(Long id);
  RemoteAssetDetails getDetails(DataRef dataRef);
  RemoteAssetDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<RemoteAssetDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<RemoteAssetDetails> detailsParameter);
  ...
  CrudsResult<RemoteAssetInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<RemoteAssetDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<RemoteAssetDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends RemoteAssetFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
