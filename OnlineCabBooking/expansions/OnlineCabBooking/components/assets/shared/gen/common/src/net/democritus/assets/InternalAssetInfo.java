...
/**
 * Transport detailed class for the entity bean InternalAsset,
 */
...
public class InternalAssetInfo
  ...
  public InternalAssetInfo(Long id
  ...
  public DataRef getDataRef() {
    return new DataRef(mId, mName, "assets", "net.democritus.assets", "InternalAsset");
  }
}
