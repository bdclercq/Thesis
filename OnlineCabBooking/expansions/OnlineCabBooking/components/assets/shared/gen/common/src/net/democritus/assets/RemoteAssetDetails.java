...
/**
 * Transport detailed class for the entity bean RemoteAsset,
 */

public class RemoteAssetDetails
  ...
  public RemoteAssetDetails(Long id
  ...
  public DataRef getDataRef() {
    return new DataRef(mId, mName, "assets", "net.democritus.assets", "RemoteAsset");
  }
}
