...
define(function (require) {
  ...
  const AssetActions = require('assets/asset/asset-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = AssetEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = AssetActions.deleteMultipleAction();
