...
define(function (require) {
  ...
  var AssetTableView = require('assets/asset/asset-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("assets.Asset.page.title")
    };
    var viewModel = {};
    var title = translate("assets.Asset.menu.title");
    ...
    var table = AssetTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
