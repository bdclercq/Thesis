...
define(function(require) {
  ...
  var assetFindAllAssetsElement = nsxApplication.getElement("assets", "assetFindAllAssets");
  ...
  function jsToFormModel(assetFindAllAssets, fieldFilter) {
    var detailModel = jsToViewModel(assetFindAllAssets);
    var form = {
  ...
  function jsToViewModel(assetFindAllAssets) {
    var assetFindAllAssetsViewModel = {
    ...
    return assetFindAllAssetsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(assetFindAllAssetsViewModel) {
    var jsData = {
  ...
  return assetFindAllAssetsMapper;
});
