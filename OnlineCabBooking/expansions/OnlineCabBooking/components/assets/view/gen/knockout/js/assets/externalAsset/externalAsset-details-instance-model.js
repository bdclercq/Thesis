...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(externalAssetDetails) {
      if (!!externalAssetDetails) {
        viewmodel.id(externalAssetDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(externalAssetDetails.name);
        viewmodel.uri(externalAssetDetails.uri);
        viewmodel.byteSize(externalAssetDetails.byteSize);
        viewmodel.contentType(externalAssetDetails.contentType);
