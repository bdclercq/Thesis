...
define(function (require) {
  ...
  var ExternalAssetTableView = require('assets/externalAsset/externalAsset-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("assets.ExternalAsset.page.title")
    };
    var viewModel = {};
    var title = translate("assets.ExternalAsset.menu.title");
    ...
    var table = ExternalAssetTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
