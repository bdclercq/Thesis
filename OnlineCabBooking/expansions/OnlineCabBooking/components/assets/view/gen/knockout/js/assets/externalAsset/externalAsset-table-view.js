...
define(function (require) {
  ...
  var ExternalAssetFinders = require('assets/externalAsset/externalAsset-finders');
  var ExternalAssetStdTable = require('assets/externalAsset/externalAsset-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ExternalAssetFinders.finderWith(constantFields);
    var finderOptions = ExternalAssetFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ExternalAssetEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineExternalAssetList(widget, input) {
    return ExternalAssetStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ExternalAssetEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ExternalAssetEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ExternalAssetEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ExternalAssetEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ExternalAssetEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var externalAssetList = defineExternalAssetList(widget, listOptions);

    tableContext.selection = externalAssetList.selection;
    ...
    var pagination = definePagination(toolbar, externalAssetList.listModel);
    ...
    return {
      injector: widget,
      selection: externalAssetList.selection
    };
  }
