...
define(function (require) {
  ...
  const FileAssetActions = require('assets/fileAsset/fileAsset-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = FileAssetEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = FileAssetActions.deleteMultipleAction();
