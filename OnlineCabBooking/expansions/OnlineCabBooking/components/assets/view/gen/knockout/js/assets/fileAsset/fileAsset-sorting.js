...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.uploadUri = SortableColumn.defineSortableColumn({
      fieldName: "uploadUri"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "uploadUri";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.uploadUri.select);
