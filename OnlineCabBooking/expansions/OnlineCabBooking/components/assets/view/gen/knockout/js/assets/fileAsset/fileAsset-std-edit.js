...
define(function (require) {
  ...
  var FileAssetProjector = require('assets/fileAsset/fileAsset-projector');
  ...
  function defineEditDialog(options) {
    ...
    when(editRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to edit a(n) FileAsset element!")
    });

    function render() {
      var editIntent = FileAssetEvents.defineEditIntentListener();
      var showDialog = Trigger.defineTrigger();

      var constants = ko.observable();
      var selection = ko.observable();
      var formView = "assets/fileAsset-form";
      var title = "Edit FileAsset";
      var layoutConfig = initLayoutConfig(constants)
      var formOptions = {
        resetOn: editIntent,
        action: FileAssetActions.editAction()
      };

      var detailsProjection = FileAssetProjector.defineProjector(selection, {
        projection: "details"
      });
