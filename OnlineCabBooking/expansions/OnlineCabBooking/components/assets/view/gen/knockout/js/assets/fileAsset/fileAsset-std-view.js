...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) FileAsset!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = FileAssetEvents.defineViewIntentListener();

      var config = {
        title: 'FileAsset',
        projection: 'details',
        projector: 'assets/fileAsset/fileAsset-projector',
        modeller: 'assets/fileAsset/fileAsset-details-instance-model',
        view: 'assets/fileAsset-details-instance'
      };
