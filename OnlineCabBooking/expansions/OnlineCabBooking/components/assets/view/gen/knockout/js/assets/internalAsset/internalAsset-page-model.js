...
define(function (require) {
  ...
  var InternalAssetTableView = require('assets/internalAsset/internalAsset-table-view');
  ...
  var InternalAssetWaterfall = require('assets/internalAsset/internalAsset-waterfall');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("assets.InternalAsset.page.title")
    };
    var viewModel = {};
    var title = translate("assets.InternalAsset.menu.title");
    ...
    var table = InternalAssetTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
    ...
    var waterfall = InternalAssetWaterfall.defineWaterfall({
      target: table.selection,
      injector: page,
      selector: "widgets"
    });

    // anchor:custom-waterfall-after:start
    // anchor:custom-waterfall-after:end
