...
define(function (require) {
  ...
  var InternalAssetFinders = require('assets/internalAsset/internalAsset-finders');
  var InternalAssetStdTable = require('assets/internalAsset/internalAsset-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = InternalAssetFinders.finderWith(constantFields);
    var finderOptions = InternalAssetFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = InternalAssetEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineInternalAssetList(widget, input) {
    return InternalAssetStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: InternalAssetEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: InternalAssetEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: InternalAssetEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: InternalAssetEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: InternalAssetEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var internalAssetList = defineInternalAssetList(widget, listOptions);

    tableContext.selection = internalAssetList.selection;
    ...
    var pagination = definePagination(toolbar, internalAssetList.listModel);
    ...
    return {
      injector: widget,
      selection: internalAssetList.selection
    };
  }
