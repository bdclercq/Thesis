...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "assets.InternalAssetChunk.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "assets.InternalAssetChunk.name",
      isValueType: false
    },
    {
      fieldName: "content",
      type: FieldType.VALUE,
      key: "assets.InternalAssetChunk.content",
      isValueType: false
    },
    {
      fieldName: "internalAsset",
      type: FieldType.DATAREF,
      key: "assets.InternalAssetChunk.internalAsset",
      isValueType: false
    },
    {
      fieldName: "byteSize",
      type: FieldType.VALUE,
      key: "assets.InternalAssetChunk.byteSize",
      isValueType: false
    },
    {
      fieldName: "position",
      type: FieldType.VALUE,
      key: "assets.InternalAssetChunk.position",
      isValueType: false
    },
    {
      fieldName: "isLast",
      type: FieldType.VALUE,
      key: "assets.InternalAssetChunk.isLast",
      isValueType: false
    }
   ...
   *   action: InternalAssetChunkAction<any>
   * }} options
   * @return {{
   *    instance: NsxForm,
   *    submit: Trigger<void>
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || InternalAssetChunkActions.editAction();
