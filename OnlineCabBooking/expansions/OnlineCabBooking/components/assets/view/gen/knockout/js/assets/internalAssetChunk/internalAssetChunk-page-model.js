...
define(function (require) {
  ...
  var InternalAssetChunkTableView = require('assets/internalAssetChunk/internalAssetChunk-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("assets.InternalAssetChunk.page.title")
    };
    var viewModel = {};
    var title = translate("assets.InternalAssetChunk.menu.title");
