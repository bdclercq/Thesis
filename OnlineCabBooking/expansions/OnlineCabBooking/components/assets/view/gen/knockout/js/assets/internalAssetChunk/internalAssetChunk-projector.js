...
define(function(require) {
  ...
  var internalAssetChunkMetaData = require("dataElement!assets.internalAssetChunk");
  var internalAssetChunkAgent = internalAssetChunkMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "assets.internalAssetChunk.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = InternalAssetChunkEvents.defineCreateUpdateListener();
    var dataEdit = InternalAssetChunkEvents.defineEditUpdateListener();
    var dataRefresh = InternalAssetChunkEvents.defineRefreshUpdateListener();
    var dataDelete = InternalAssetChunkEvents.defineDeleteUpdateListener();
    var dataFinder = InternalAssetChunkEvents.defineFinderUpdateListener();
