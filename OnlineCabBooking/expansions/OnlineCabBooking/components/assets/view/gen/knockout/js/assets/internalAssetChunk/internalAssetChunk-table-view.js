...
define(function (require) {
  ...
  var InternalAssetChunkFinders = require('assets/internalAssetChunk/internalAssetChunk-finders');
  var InternalAssetChunkStdTable = require('assets/internalAssetChunk/internalAssetChunk-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = InternalAssetChunkFinders.finderWith(constantFields);
    var finderOptions = InternalAssetChunkFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineInternalAssetChunkList(widget, input) {
    return InternalAssetChunkStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: InternalAssetChunkEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: InternalAssetChunkEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: InternalAssetChunkEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: InternalAssetChunkEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: InternalAssetChunkEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var internalAssetChunkList = defineInternalAssetChunkList(widget, listOptions);

    tableContext.selection = internalAssetChunkList.selection;
    ...
    var pagination = definePagination(toolbar, internalAssetChunkList.listModel);
    ...
    return {
      injector: widget,
      selection: internalAssetChunkList.selection
    };
  }
