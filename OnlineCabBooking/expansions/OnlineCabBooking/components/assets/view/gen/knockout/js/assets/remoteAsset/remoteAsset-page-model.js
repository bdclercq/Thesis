...
define(function (require) {
  ...
  var RemoteAssetTableView = require('assets/remoteAsset/remoteAsset-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("assets.RemoteAsset.page.title")
    };
    var viewModel = {};
    var title = translate("assets.RemoteAsset.menu.title");
    ...
    var table = RemoteAssetTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
