...
define(function(require) {
  ...
  var remoteAssetMetaData = require("dataElement!assets.remoteAsset");
  var remoteAssetAgent = remoteAssetMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "assets.remoteAsset.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = RemoteAssetEvents.defineCreateUpdateListener();
    var dataEdit = RemoteAssetEvents.defineEditUpdateListener();
    var dataRefresh = RemoteAssetEvents.defineRefreshUpdateListener();
    var dataDelete = RemoteAssetEvents.defineDeleteUpdateListener();
    var dataFinder = RemoteAssetEvents.defineFinderUpdateListener();
