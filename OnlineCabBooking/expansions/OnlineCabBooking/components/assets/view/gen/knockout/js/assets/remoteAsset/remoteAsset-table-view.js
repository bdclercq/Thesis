...
define(function (require) {
  ...
  var RemoteAssetEvents = require('assets/remoteAsset/remoteAsset-events');
  var RemoteAssetFinders = require('assets/remoteAsset/remoteAsset-finders');
  var RemoteAssetStdTable = require('assets/remoteAsset/remoteAsset-std-table');

  var RemoteAssetElement = require('nsx/nsx-application').getElement('assets', 'remoteAsset');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = RemoteAssetFinders.finderWith(constantFields);
    var finderOptions = RemoteAssetFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = RemoteAssetEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineRemoteAssetList(widget, input) {
    return RemoteAssetStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: RemoteAssetEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: RemoteAssetEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: RemoteAssetEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: RemoteAssetEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: RemoteAssetEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var remoteAssetList = defineRemoteAssetList(widget, listOptions);

    tableContext.selection = remoteAssetList.selection;
    ...
    var pagination = definePagination(toolbar, remoteAssetList.listModel);
    ...
    return {
      injector: widget,
      selection: remoteAssetList.selection
    };
  }
