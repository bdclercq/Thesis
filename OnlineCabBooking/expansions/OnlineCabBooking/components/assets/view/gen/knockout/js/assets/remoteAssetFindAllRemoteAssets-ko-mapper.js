...
define(function(require) {
  ...
  var remoteAssetFindAllRemoteAssetsElement = nsxApplication.getElement("assets", "remoteAssetFindAllRemoteAssets");
  ...
  function jsToFormModel(remoteAssetFindAllRemoteAssets, fieldFilter) {
    var detailModel = jsToViewModel(remoteAssetFindAllRemoteAssets);
    var form = {
  ...
  function jsToViewModel(remoteAssetFindAllRemoteAssets) {
    var remoteAssetFindAllRemoteAssetsViewModel = {
    ...
    return remoteAssetFindAllRemoteAssetsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(remoteAssetFindAllRemoteAssetsViewModel) {
    var jsData = {
  ...
  var remoteAssetFindAllRemoteAssetsMapper = {
  ...
  return remoteAssetFindAllRemoteAssetsMapper;
});
