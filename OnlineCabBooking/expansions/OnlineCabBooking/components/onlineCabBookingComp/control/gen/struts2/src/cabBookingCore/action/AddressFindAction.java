...
import cabBookingCore.AddressFindDetails;
...
public class AddressFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.AddressFindAction");

  private SearchDetails<? extends AddressFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "Address", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    AddressAgent addressAgent = createAddressAgent();
    ...
    searchResult = addressAgent.find(searchDetails);
  ...
  private AddressAgent createAddressAgent() {
