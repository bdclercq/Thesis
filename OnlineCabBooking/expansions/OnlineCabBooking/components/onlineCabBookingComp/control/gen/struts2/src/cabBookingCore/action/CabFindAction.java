...
import cabBookingCore.CabFindDetails;
...
public class CabFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.CabFindAction");

  private SearchDetails<? extends CabFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "Cab", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    CabAgent cabAgent = createCabAgent();
    ...
    searchResult = cabAgent.find(searchDetails);
  ...
  private CabAgent createCabAgent() {
