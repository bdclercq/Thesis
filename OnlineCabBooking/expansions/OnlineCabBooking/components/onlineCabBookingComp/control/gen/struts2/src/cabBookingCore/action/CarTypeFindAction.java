...
import cabBookingCore.CarTypeFindDetails;
...
public class CarTypeFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.CarTypeFindAction");

  private SearchDetails<? extends CarTypeFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "CarType", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    CarTypeAgent carTypeAgent = createCarTypeAgent();
    ...
    searchResult = carTypeAgent.find(searchDetails);
  ...
  private CarTypeAgent createCarTypeAgent() {
