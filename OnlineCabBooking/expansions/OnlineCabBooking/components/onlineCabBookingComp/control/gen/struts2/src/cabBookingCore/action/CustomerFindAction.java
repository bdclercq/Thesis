...
import cabBookingCore.CustomerFindDetails;
...
public class CustomerFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.CustomerFindAction");

  private SearchDetails<? extends CustomerFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "Customer", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    CustomerAgent customerAgent = createCustomerAgent();
    ...
    searchResult = customerAgent.find(searchDetails);
  ...
  private CustomerAgent createCustomerAgent() {
