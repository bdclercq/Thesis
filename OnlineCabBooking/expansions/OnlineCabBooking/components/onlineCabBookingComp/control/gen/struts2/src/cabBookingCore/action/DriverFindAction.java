...
import cabBookingCore.DriverFindDetails;
...
public class DriverFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.DriverFindAction");

  private SearchDetails<? extends DriverFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "Driver", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    DriverAgent driverAgent = createDriverAgent();
    ...
    searchResult = driverAgent.find(searchDetails);
  ...
  private DriverAgent createDriverAgent() {
