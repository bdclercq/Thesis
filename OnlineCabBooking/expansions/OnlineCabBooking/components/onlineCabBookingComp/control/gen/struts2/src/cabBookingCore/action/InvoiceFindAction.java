...
import cabBookingCore.InvoiceFindDetails;
...
public class InvoiceFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.InvoiceFindAction");

  private SearchDetails<? extends InvoiceFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "Invoice", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    InvoiceAgent invoiceAgent = createInvoiceAgent();
    ...
    searchResult = invoiceAgent.find(searchDetails);
  ...
  private InvoiceAgent createInvoiceAgent() {
