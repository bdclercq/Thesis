...
import cabBookingCore.PaymentFindDetails;
...
public class PaymentFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.PaymentFindAction");

  private SearchDetails<? extends PaymentFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "Payment", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    PaymentAgent paymentAgent = createPaymentAgent();
    ...
    searchResult = paymentAgent.find(searchDetails);
