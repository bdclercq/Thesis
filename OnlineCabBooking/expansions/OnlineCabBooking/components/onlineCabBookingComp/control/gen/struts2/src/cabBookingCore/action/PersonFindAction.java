...
import cabBookingCore.PersonFindDetails;
...
public class PersonFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.PersonFindAction");

  private SearchDetails<? extends PersonFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "Person", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    PersonAgent personAgent = createPersonAgent();
    ...
    searchResult = personAgent.find(searchDetails);
  ...
  private PersonAgent createPersonAgent() {
