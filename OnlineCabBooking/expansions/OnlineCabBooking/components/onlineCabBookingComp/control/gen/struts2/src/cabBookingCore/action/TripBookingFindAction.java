...
import cabBookingCore.TripBookingFindDetails;
...
public class TripBookingFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.TripBookingFindAction");

  private SearchDetails<? extends TripBookingFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "TripBooking", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    TripBookingAgent tripBookingAgent = createTripBookingAgent();
    ...
    searchResult = tripBookingAgent.find(searchDetails);
  ...
  private TripBookingAgent createTripBookingAgent() {
