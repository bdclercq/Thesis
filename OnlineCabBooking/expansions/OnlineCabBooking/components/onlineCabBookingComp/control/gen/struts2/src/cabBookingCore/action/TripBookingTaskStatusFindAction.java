...
import cabBookingCore.TripBookingTaskStatusFindDetails;
...
public class TripBookingTaskStatusFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("cabBookingCore.action.TripBookingTaskStatusFindAction");

  private SearchDetails<? extends TripBookingTaskStatusFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("cabBookingCore", "TripBookingTaskStatus", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    searchResult = tripBookingTaskStatusAgent.find(searchDetails);
  ...
  private TripBookingTaskStatusAgent createTripBookingTaskStatusAgent() {
