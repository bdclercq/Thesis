...
public class AddressDataRefProjector implements IDataElementProjector<AddressData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public AddressDataRefProjector(AddressCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<AddressData> dataParameter) {
    ...
    projection.setClassName("Address");
  ...
  // anchor:toData:start
  public void toData(AddressData data, ParameterContext<DataRef> projectionParameter) {
