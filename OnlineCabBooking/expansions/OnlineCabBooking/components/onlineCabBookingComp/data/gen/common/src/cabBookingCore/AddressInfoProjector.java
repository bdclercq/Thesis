...
public class AddressInfoProjector implements IDataElementProjector<AddressData, AddressInfo>, IDataProjectorRequired<AddressInfo> {
  ...
  public AddressInfoProjector(AddressCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public AddressInfo project(ParameterContext<AddressData> dataParameter) {

    AddressInfo projection = new AddressInfo();
  ...
  public void toData(AddressData data, ParameterContext<AddressInfo> projectionParameter) {
    // don't set the data id
    AddressInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(AddressInfo projection) {
  ...
  public Class<AddressInfo> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<AddressInfo> projectionParameter) {
