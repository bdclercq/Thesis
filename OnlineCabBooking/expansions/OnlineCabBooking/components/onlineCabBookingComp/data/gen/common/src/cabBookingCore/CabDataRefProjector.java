...
public class CabDataRefProjector implements IDataElementProjector<CabData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public CabDataRefProjector(CabCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<CabData> dataParameter) {
  ...
  // anchor:toData:start
  public void toData(CabData data, ParameterContext<DataRef> projectionParameter) {
