...
public class CabDetailsProjector implements IDataElementProjector<CabData, CabDetails>, IDataProjectorRequired<CabDetails> {
  ...
  public CabDetailsProjector(CabCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public CabDetails project(ParameterContext<CabData> dataParameter) {

    CabDetails projection = new CabDetails();
  ...
  public void toData(CabData data, ParameterContext<CabDetails> projectionParameter) {
    // don't set the data id
    CabDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(CabDetails projection) {
  ...
  public Class<CabDetails> getProjectionClass() {
    return CabDetails.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<CabDetails> projectionParameter) {
