...
public class CarTypeDataRefProjector implements IDataElementProjector<CarTypeData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public CarTypeDataRefProjector(CarTypeCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<CarTypeData> dataParameter) {
    ...
    projection.setClassName("CarType");
  ...
  // anchor:toData:start
  public void toData(CarTypeData data, ParameterContext<DataRef> projectionParameter) {
