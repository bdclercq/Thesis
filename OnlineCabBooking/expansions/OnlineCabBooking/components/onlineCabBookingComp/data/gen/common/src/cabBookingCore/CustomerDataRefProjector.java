...
public class CustomerDataRefProjector implements IDataElementProjector<CustomerData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public CustomerDataRefProjector(CustomerCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<CustomerData> dataParameter) {
    ...
    projection.setClassName("Customer");
  ...
  // anchor:toData:start
  public void toData(CustomerData data, ParameterContext<DataRef> projectionParameter) {
