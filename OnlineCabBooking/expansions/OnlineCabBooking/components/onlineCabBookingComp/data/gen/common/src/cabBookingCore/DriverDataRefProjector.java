...
public class DriverDataRefProjector implements IDataElementProjector<DriverData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public DriverDataRefProjector(DriverCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<DriverData> dataParameter) {
    ...
    projection.setClassName("Driver");
  ...
  // anchor:toData:start
  public void toData(DriverData data, ParameterContext<DataRef> projectionParameter) {
