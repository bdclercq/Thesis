...
public class InvoiceDataRefProjector implements IDataElementProjector<InvoiceData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public InvoiceDataRefProjector(InvoiceCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<InvoiceData> dataParameter) {
    ...
    projection.setClassName("Invoice");
  ...
  // anchor:toData:start
  public void toData(InvoiceData data, ParameterContext<DataRef> projectionParameter) {
