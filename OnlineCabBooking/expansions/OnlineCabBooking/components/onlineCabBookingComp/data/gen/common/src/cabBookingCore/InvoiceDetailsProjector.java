...
public class InvoiceDetailsProjector implements IDataElementProjector<InvoiceData, InvoiceDetails>, IDataProjectorRequired<InvoiceDetails> {

  private static final List<DataRef> EMPTY_DATA_REF_COLLECTION = new ArrayList<>();

  private final InvoiceCrudsInternal crudsInternal;

  // anchor:custom-variables:start
  // anchor:custom-variables:end

  public InvoiceDetailsProjector(InvoiceCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public InvoiceDetails project(ParameterContext<InvoiceData> dataParameter) {

    InvoiceDetails projection = new InvoiceDetails();
  ...
  public void toData(InvoiceData data, ParameterContext<InvoiceDetails> projectionParameter) {
    // don't set the data id
    InvoiceDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(InvoiceDetails projection) {
  ...
  public Class<InvoiceDetails> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<InvoiceDetails> projectionParameter) {
