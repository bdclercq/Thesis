...
public class InvoiceInfoProjector implements IDataElementProjector<InvoiceData, InvoiceInfo>, IDataProjectorRequired<InvoiceInfo> {
  ...
  public InvoiceInfoProjector(InvoiceCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public InvoiceInfo project(ParameterContext<InvoiceData> dataParameter) {

    InvoiceInfo projection = new InvoiceInfo();
  ...
  public void toData(InvoiceData data, ParameterContext<InvoiceInfo> projectionParameter) {
    // don't set the data id
    InvoiceInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(InvoiceInfo projection) {
  ...
  public Class<InvoiceInfo> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<InvoiceInfo> projectionParameter) {
