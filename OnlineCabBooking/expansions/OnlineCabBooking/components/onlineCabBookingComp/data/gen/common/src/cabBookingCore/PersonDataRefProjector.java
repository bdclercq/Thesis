...
public class PersonDataRefProjector implements IDataElementProjector<PersonData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public PersonDataRefProjector(PersonCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<PersonData> dataParameter) {
    ...
    projection.setClassName("Person");
  ...
  // anchor:toData:start
  public void toData(PersonData data, ParameterContext<DataRef> projectionParameter) {
