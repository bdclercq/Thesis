...
public class PersonInfoProjector implements IDataElementProjector<PersonData, PersonInfo>, IDataProjectorRequired<PersonInfo> {
  ...
  public PersonInfoProjector(PersonCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public PersonInfo project(ParameterContext<PersonData> dataParameter) {

    PersonInfo projection = new PersonInfo();
  ...
  public void toData(PersonData data, ParameterContext<PersonInfo> projectionParameter) {
    // don't set the data id
    PersonInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(PersonInfo projection) {
  ...
  public Class<PersonInfo> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<PersonInfo> projectionParameter) {
