...
public class TripBookingDataRefProjector implements IDataElementProjector<TripBookingData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public TripBookingDataRefProjector(TripBookingCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<TripBookingData> dataParameter) {
    ...
    projection.setClassName("TripBooking");
  ...
  // anchor:toData:start
  public void toData(TripBookingData data, ParameterContext<DataRef> projectionParameter) {
