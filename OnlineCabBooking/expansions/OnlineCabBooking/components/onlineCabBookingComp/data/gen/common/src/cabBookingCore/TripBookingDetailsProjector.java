...
public class TripBookingDetailsProjector implements IDataElementProjector<TripBookingData, TripBookingDetails>, IDataProjectorRequired<TripBookingDetails> {
  ...
  public TripBookingDetailsProjector(TripBookingCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public TripBookingDetails project(ParameterContext<TripBookingData> dataParameter) {

    TripBookingDetails projection = new TripBookingDetails();
  ...
  public void toData(TripBookingData data, ParameterContext<TripBookingDetails> projectionParameter) {
    // don't set the data id
    TripBookingDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(TripBookingDetails projection) {
  ...
  public Class<TripBookingDetails> getProjectionClass() {
    return TripBookingDetails.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<TripBookingDetails> projectionParameter) {
