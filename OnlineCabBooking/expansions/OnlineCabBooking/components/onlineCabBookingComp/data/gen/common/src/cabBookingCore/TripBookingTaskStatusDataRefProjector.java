...
public class TripBookingTaskStatusDataRefProjector implements IDataElementProjector<TripBookingTaskStatusData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public TripBookingTaskStatusDataRefProjector(TripBookingTaskStatusCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<TripBookingTaskStatusData> dataParameter) {
    ...
    projection.setClassName("TripBookingTaskStatus");
  ...
  // anchor:toData:start
  public void toData(TripBookingTaskStatusData data, ParameterContext<DataRef> projectionParameter) {
