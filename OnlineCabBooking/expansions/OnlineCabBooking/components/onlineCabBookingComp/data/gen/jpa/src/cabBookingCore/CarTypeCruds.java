...
@Local({CarTypeCrudsLocal.class, CarTypeCrudsInternal.class})
// @anchor:annotations:end
public class CarTypeCruds /*@anchor:interfaces:start@*/implements CarTypeCrudsLocal, CarTypeCrudsInternal/*@anchor:interfaces:end@*/ {

  private final DiagnosticHelper diagnosticHelper = new DiagnosticHelper("onlineCabBookingComp", "CarType");
  private final DiagnosticFactory diagnosticFactory = diagnosticHelper.getDiagnosticFactory();

  public static final String DISABLED_ERROR_MSG_KEY = "onlineCabBookingComp.carType.alreadyDisabled";
  ...
  private CarTypeFinderLocal carTypeFinder;
  ...
  private static final Logger logger = LoggerFactory.getLogger(CarTypeCruds.class);
  ...
  private CarTypeDataRefProjector dataRefProjector;
  private CarTypeDetailsProjector detailsProjector;
  private CarTypeInfoProjector infoProjector;

  private DataElementProjectorManager<CarTypeData> elementProjectorManager;
  ...
  private void initProjectorMapping() {
    CarTypeCrudsInternal carTypeCrudsInternal = sessionContext.getBusinessObject(CarTypeCrudsInternal.class);

    detailsProjector = new CarTypeDetailsProjector(carTypeCrudsInternal);
    infoProjector = new CarTypeInfoProjector(carTypeCrudsInternal);
    dataRefProjector = new CarTypeDataRefProjector(carTypeCrudsInternal);

    elementProjectorManager = new DataElementProjectorManager<CarTypeData>();
  ...
  private void initFinder() {
    carTypeFinder = new CarTypeFinderBean(entityManager);
  }
  ...
  public CrudsResult<DataRef> create(ParameterContext<CarTypeDetails> detailsParameter) {
    ...
    CarTypeDetails details = detailsParameter.getValue();
    ...
    try {
      ...
      detailsProjector.toData(carTypeData, detailsParameter);
    ...
    try {
      entityManager.persist(carTypeData);
      ...
      if (carTypeData != null) {
        if (logger.isDebugEnabled()) {
          logger.debug(
              "Created CarTypeCruds with { id : " + carTypeData.getId() + ", name: " + carTypeData.getName() + " }"
          );
        }
      }
    } catch (Exception e) {
    ...
    CrudsResult<DataRef> result = getDataRefFromData(detailsParameter.construct(carTypeData));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<CarTypeDetails> detailsParameter) {
    ...
    Context context = detailsParameter.getContext();
    CarTypeDetails carTypeDetails = detailsParameter.getValue();
    DataRef dataRef = carTypeDetails.getDataRef();
    ...
    try {
      CrudsResult<CarTypeData> dataResult = getData(context.withParameter(dataRef));
      if (dataResult.isError()) {
        return dataResult.convertError();
      }
      CarTypeData carTypeData = dataResult.getValue();
      ...
      if (carTypeData != null) {
        if (logger.isDebugEnabled()) {
          logger.debug(
              "Modified CarTypeCruds with { id : " + carTypeData.getId() + ", name: " + carTypeData.getName() + " }"
          );
        }
      }
    ...
    // @anchor:modify-exceptions:end
      ...
      if (logger.isErrorEnabled()) {
        logger.error(
            "CarTypeCruds.modify() failed with ID = " + dataRef.getId(), e
        );
      }
      return getDiagnosticHelper().createCrudsError(MODIFY_ERROR_MSG_KEY);
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    if (projection instanceof CarTypeDetails) {
      CarTypeDetails details = (CarTypeDetails) projection;
  ...
  public CrudsResult<Void> delete(ParameterContext<DataRef> dataRefParameter) {
    ...
    try {
      ...
      // @anchor:delete:start
      entityManager.remove(carTypeData);
      // @anchor:delete:end
      ...
      if (carTypeData != null) {
        if (logger.isDebugEnabled()) {
          logger.debug(
              "Deleted CarTypeCruds with { id : " + carTypeData.getId() + ", name: " + carTypeData.getName() + " }"
          );
        }
      }
  ...
  public CrudsResult<DataRef> getDataRefFromData(ParameterContext<CarTypeData> dataParameter) {
  ...
  public CrudsResult<DataRef> getDataRefFromId(ParameterContext<Long> idParameter) {
    ...
    try {
      CarTypeData carTypeData = entityManager.find(CarTypeData.class, id);
      ...
      return getDataRefFromData(idParameter.construct(carTypeData));
    } catch (Exception e) {
      sessionContext.setRollbackOnly();
      if (logger.isErrorEnabled()) {
        logger.error(
  ...
  private CrudsResult<CarTypeData> getDataById(ParameterContext<Long> idParameter) {
    CarTypeData data = entityManager.find(CarTypeData.class, idParameter.getValue());
    if (data == null) {
      return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
    }
  ...
  public CrudsResult<DataRef> getDataRefFromName(ParameterContext<String> nameParameter) {
    ...
    CrudsResult<CarTypeData> dataResult = getDataByName(nameParameter);
    if (dataResult.isError()) {
      return dataResult.convertError();
    }
  ...
  private CrudsResult<CarTypeData> getDataByName(ParameterContext<String> nameParameter) {
    String name = nameParameter.getValue();
    if (name == null || name.trim().equals("")) {
      return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
    }
    ...
    try {
      CarTypeFindByNameEqDetails findByNameEqDetails = new CarTypeFindByNameEqDetails();
      findByNameEqDetails.setName(name);

      SearchDetails<CarTypeFindByNameEqDetails> searchDetails =
        new SearchDetails<>(findByNameEqDetails);

      ParameterContext<SearchDetails<CarTypeFindByNameEqDetails>> searchParameter =
        nameParameter.construct(searchDetails);

      SearchResult<CarTypeData> searchResult = findData(searchParameter);

      if (searchResult.isError()) {
        return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
      }

      List<CarTypeData> list = searchResult.getResults();
      if (list.isEmpty()) {
        return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
      }
  ...
  public CrudsResult<CarTypeData> getData(ParameterContext<DataRef> dataRefParameter) {
    DataRef dataRef = dataRefParameter.getValue();
    if (dataRef == null) {
      return getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
    }
    ...
    CrudsResult<CarTypeData> result;
  ...
  private CrudsResult<CarTypeData> getDataFromStrategy(ParameterContext<DataRef> dataRefParameter) {
    DataRef dataRef = dataRefParameter.getValue();
    Long id = dataRef.getId();
    CrudsResult<CarTypeData> result = getDiagnosticHelper().createCrudsError(SEARCH_ERROR_MSG_KEY);
  ...
  public <S extends CarTypeFindDetails> SearchResult<CarTypeData> findData(ParameterContext<SearchDetails<S>> searchParameter) {
    return carTypeFinder.find(searchParameter);
  }

  public <S extends CarTypeFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    SearchResult<CarTypeData> dataResult = findData(searchParameter);
    ...
    IDataElementProjector<CarTypeData, T> projector = getElementProjector(projection);
   ...
   */
  private <T> List<T> project(Context context, List<CarTypeData> fromItems, IDataElementProjector<CarTypeData, T> projector) {
   ...
   */
  @Deprecated
  private <T> List<T> project(UserContext userContext, List<CarTypeData> fromItems, IDataElementProjector<CarTypeData, T> projector) {
    return project(Context.from(userContext), fromItems, projector);
  }

  @Override
  public <P> SearchResult<P> project(ParameterContext<List<CarTypeData>> listParameter, String projection) {
    IDataElementProjector<CarTypeData, P> elementProjector = getElementProjector(projection);
    List<CarTypeData> list = listParameter.getValue();
  ...
  private <P> IDataElementProjector<CarTypeData, P> getElementProjector(P projection) {
  ...
  @Override
  public String getDisplayName(ParameterContext<CarTypeData> dataParameter) {
    ...
    CarTypeData data = dataParameter.getValue();
    String displayName;
  ...
  private Option<String> getCustomDisplayName(ParameterContext<CarTypeData> dataParameter) {
  ...
  private <T> IDataElementProjector<CarTypeData, T> getElementProjector(String projectionName) {
    IDataElementProjector<CarTypeData, T> projector = elementProjectorManager.getProjector(projectionName);
    if (projector == null) {
      throw new InvalidProjectionException(new ElementRef("onlineCabBookingComp", "CarType"), projectionName);
    }
    return projector;
  }
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    CrudsResult<CarTypeData> dataResult = getData(projectionRefParameter.construct(dataRef));
    CarTypeData carTypeData;
    if (dataResult.isSuccess()) {
      carTypeData = dataResult.getValue();
    } else {
    ...
    IDataElementProjector<CarTypeData, T> projector = getElementProjector(projectionRef.getProjection());
    T projection = projector.project(projectionRefParameter.construct(carTypeData));

    if (carTypeData != null) {
      if (logger.isDebugEnabled()) {
        logger.debug(
            "Retrieved CarTypeCruds:" + projectionRef.getProjection() + " { id : " + carTypeData.getId() + ", name: " + carTypeData.getName() + " }"
        );
      }
    }
  ...
  public CrudsResult<CarTypeDetails> getDetails(ParameterContext<DataRef> dataRefParameter) {
    CrudsResult<CarTypeData> result = getData(dataRefParameter);
    if (result.isError()) {
      return result.convertError();
    }

    CarTypeData carTypeData = result.getValue();
    CarTypeDetails carTypeDetails = detailsProjector.project(dataRefParameter.construct(carTypeData));

    return CrudsResult.success(carTypeDetails);
  }

  public CrudsResult<List<CarTypeDetails>> getDetailsListFromData(ParameterContext<Collection<CarTypeData>> dataListParameter) {
    Collection<CarTypeData> dataList = dataListParameter.getValue();
    List<CarTypeDetails> list = new ArrayList<>(dataList.size());

    for (CarTypeData carTypeData: dataList) {
      CarTypeDetails carTypeDetails = detailsProjector.project(dataListParameter.construct(carTypeData));
      list.add(carTypeDetails);
    }
  ...
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    ...
    CrudsResult<CarTypeData> dataResult = getData(dataRefParameter);
    if (dataResult.isError()) {
      return dataResult.convertError();
    }
    CarTypeData data = dataResult.getValue();
