...
/**
 * Persistency pojo class for the entity CarType,
 */

@Entity(name=CarTypeData.ENTITY_NAME)
// @anchor:annotations:start
@Table(name="CarType", schema="ONLINECABBOOKINGCOMP")
// @anchor:annotations:end
@NamedQueries({
  @NamedQuery(name=CarTypeData.QUERY_FINDALL, query="select o FROM " + CarTypeData.ENTITY_NAME + " o")
  // @anchor:queries:start
  // @anchor:queries:end
  // anchor:custom-queries:start
  // anchor:custom-queries:end
})
public class CarTypeData implements java.io.Serializable {

  // @anchor:constants:start
  public static final String ENTITY_NAME = "cabBookingCore.CarType";
  public static final String QUERY_FINDALL = "cabBookingCore.CarType.findAll";
