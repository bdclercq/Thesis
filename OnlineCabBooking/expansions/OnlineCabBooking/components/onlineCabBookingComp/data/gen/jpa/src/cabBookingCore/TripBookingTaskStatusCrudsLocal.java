...
public interface TripBookingTaskStatusCrudsLocal {
  ...
  <S extends TripBookingTaskStatusFindDetails, P> SearchResult<P> find(ParameterContext<SearchDetails<S>> searchParameter);
