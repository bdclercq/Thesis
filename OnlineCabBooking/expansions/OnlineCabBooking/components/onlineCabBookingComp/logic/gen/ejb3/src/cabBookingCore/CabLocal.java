...
/**
 * Local interface for the entity bean Cab,
 * representing a known Cab
 */
public interface CabLocal {
  ...
  CabInfo getInfo(Long id);
  CabDetails getDetails(DataRef dataRef);
  CabDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<CabDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<CabDetails> detailsParameter);
  ...
  CrudsResult<CabInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<CabDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<CabDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends CabFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
