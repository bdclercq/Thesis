...
/**
 * Local interface for the entity bean Customer,
 * representing a known Customer
 */
public interface CustomerLocal {
  ...
  CustomerInfo getInfo(Long id);
  CustomerDetails getDetails(DataRef dataRef);
  CustomerDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<CustomerDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<CustomerDetails> detailsParameter);
  ...
  CrudsResult<CustomerInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<CustomerDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<CustomerDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends CustomerFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
