...
/**
 * Local interface for the entity bean Invoice,
 * representing a known Invoice
 */
public interface InvoiceLocal {
  ...
  InvoiceInfo getInfo(Long id);
  InvoiceDetails getDetails(DataRef dataRef);
  InvoiceDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<InvoiceDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<InvoiceDetails> detailsParameter);
  ...
  CrudsResult<InvoiceInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<InvoiceDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<InvoiceDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends InvoiceFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
