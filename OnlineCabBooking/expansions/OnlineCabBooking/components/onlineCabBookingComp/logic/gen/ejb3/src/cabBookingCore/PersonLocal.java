...
/**
 * Local interface for the entity bean Person,
 * representing a known Person
 */
public interface PersonLocal {
  ...
  PersonInfo getInfo(Long id);
  PersonDetails getDetails(DataRef dataRef);
  PersonDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<PersonDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<PersonDetails> detailsParameter);
  ...
  CrudsResult<PersonInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<PersonDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<PersonDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends PersonFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
