...
/**
 * Local interface for the entity bean TripBooking,
 * representing a known TripBooking
 */
public interface TripBookingLocal {
  ...
  TripBookingInfo getInfo(Long id);
  TripBookingDetails getDetails(DataRef dataRef);
  TripBookingDetails getDetails(Long id);
