...
// anchor:imports:start
import net.democritus.workflow.StateTaskLocal;
...
@Remote(TripBookingTaskStatusRemote.class)
@Local(TripBookingTaskStatusLocal.class)
// @anchor:annotations:end
@DeclareRoles({
// anchor:custom-declare-roles:start
// anchor:custom-declare-roles:end
})
public class TripBookingTaskStatusBean /*@anchor:interfaces:start@*/implements TripBookingTaskStatusRemote, TripBookingTaskStatusLocal/*@anchor:interfaces:end@*/{
  ...
  @EJB private StateTaskLocal stateTaskLocal;
  ...
  private static final Logger logger = LoggerFactory.getLogger(TripBookingTaskStatusBean.class);
  @Deprecated
  @PersistenceContext(unitName="OnlineCabBooking_onlineCabBookingComp")
  private EntityManager entityManager;

  @EJB
  TripBookingTaskStatusCrudsLocal tripBookingTaskStatusCrudsLocal;
  ...
  public CrudsResult<DataRef> create(ParameterContext<TripBookingTaskStatusDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = tripBookingTaskStatusCrudsLocal.create(context.withParameter(details));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<TripBookingTaskStatusDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = tripBookingTaskStatusCrudsLocal.modify(context.withParameter(details));
    if (result.isError()) {
      return result;
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    CrudsResult<DataRef> result = tripBookingTaskStatusCrudsLocal.createOrModify(projectionParameter);
    if (result.isError()) {
      return result;
    }
  ...
  public CrudsResult<Void> delete(ParameterContext<Long> idParameter) {
    ...
    try {
      ...
      CrudsResult<Void> result = tripBookingTaskStatusCrudsLocal.delete(context.withParameter(dataRef));
  ...
  public CrudsResult<DataRef> getId(ParameterContext<String> nameParameter) {
    return tripBookingTaskStatusCrudsLocal.getDataRefFromName(nameParameter);
  }

  public CrudsResult<String> getName(ParameterContext<Long> idParameter) {
    // @anchor:before-getName:start
    // @anchor:before-getName:end
    CrudsResult<DataRef> dataRefResult = tripBookingTaskStatusCrudsLocal.getDataRefFromId(idParameter);
  ...
  public DataRef getDataRef(Long id) {
    return tripBookingTaskStatusCrudsLocal.getDataRefFromId(ParameterContext.create(null, id)).getValue();
  }

  @Deprecated
  public TripBookingTaskStatusInfo getInfo(Long id) {
    return getInfo(ParameterContext.create(null, id)).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public TripBookingTaskStatusDetails getDetails(Long id) {
    return getDetailsFromDataRef(ParameterContext.create(null, idToDataRef(id))).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public TripBookingTaskStatusDetails getDetails(DataRef dataRef) {
  ...
  public CrudsResult<DataRef> getDataRef(ParameterContext<Long> idParameter) {
    return tripBookingTaskStatusCrudsLocal.getDataRefFromId(idParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    return tripBookingTaskStatusCrudsLocal.resolveDataRef(dataRefParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<TripBookingTaskStatusInfo> getInfo(ParameterContext<Long> idParameter) {
    DataRef dataRef = idToDataRef(idParameter.getValue());
  ...
  public CrudsResult<TripBookingTaskStatusDetails> getDetails(ParameterContext<Long> idParameter) {
    ...
    CrudsResult<TripBookingTaskStatusDetails> result = getDetailsFromDataRef(idParameter.construct(dataRef));
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<TripBookingTaskStatusDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRefParameter) {
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    result = tripBookingTaskStatusCrudsLocal.getProjection(projectionRefParameter);
  ...
  public <S extends TripBookingTaskStatusFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    ...
    result = tripBookingTaskStatusCrudsLocal.find(searchParameter);
  ...
  public CrudsResult<Void> compareAndSetStatus(ParameterContext<StateUpdate> parameter) {
    return tripBookingTaskStatusCrudsLocal.compareAndSetStatus(parameter);
  }
