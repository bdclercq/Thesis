...
/**
 * Local interface for the entity bean TripBookingTaskStatus,
 * representing a known TripBookingTaskStatus
 */
public interface TripBookingTaskStatusLocal {
  ...
  TripBookingTaskStatusInfo getInfo(Long id);
  TripBookingTaskStatusDetails getDetails(DataRef dataRef);
  TripBookingTaskStatusDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<TripBookingTaskStatusDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<TripBookingTaskStatusDetails> detailsParameter);
  ...
  CrudsResult<TripBookingTaskStatusInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<TripBookingTaskStatusDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<TripBookingTaskStatusDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends TripBookingTaskStatusFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
