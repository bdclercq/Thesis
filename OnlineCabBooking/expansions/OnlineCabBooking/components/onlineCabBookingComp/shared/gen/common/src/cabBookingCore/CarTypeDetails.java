...
/**
 * Transport detailed class for the entity bean CarType,
 */
...
public class CarTypeDetails
  ...
  public DataRef getDataRef() {
    return new DataRef(mId, mName, "onlineCabBookingComp", "cabBookingCore", "CarType");
  }
}
