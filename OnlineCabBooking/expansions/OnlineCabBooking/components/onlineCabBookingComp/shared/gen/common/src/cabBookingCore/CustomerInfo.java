...
/**
 * Transport detailed class for the entity bean Customer,
 */
...
public class CustomerInfo
  ...
  public CustomerInfo() {
    ...
    this.mJourneyStatus = Boolean.FALSE;
    this.mPerson = DataRef.withId(0L);
  ...
  public DataRef getPerson() {
    return this.mPerson;
  }

  public void setPerson(DataRef person) {
    this.mPerson = person;
  }
  ...
  public List<String> getFieldOrder() {
    ...
    fieldOrder.add("JourneyStatus");
    fieldOrder.add("Person");
    // anchor:field-order:end
    return fieldOrder;
  }

  public DataRef getDataRef() {
    return new DataRef(mId, mName, "onlineCabBookingComp", "cabBookingCore", "Customer");
  }
}
