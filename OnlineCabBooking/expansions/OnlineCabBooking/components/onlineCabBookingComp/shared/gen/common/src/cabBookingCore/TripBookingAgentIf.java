...
/**
 * interface for the entity bean TripBookingBean,
 * representing a known TripBooking
 */
public interface TripBookingAgentIf {
  ...
  CrudsResult<DataRef> create(TripBookingDetails tripBookingDetails);
  CrudsResult<DataRef> modify(TripBookingDetails tripBookingDetails);
  ...
  CrudsResult<TripBookingDetails> getDetails(DataRef dataRef);
  ...
  <S extends TripBookingFindDetails, T> SearchResult<T> find(SearchDetails<S> searchDetails);
  // anchor:search-methods:end

  // anchor:data-only-methods:start
  CrudsResult<TripBookingDetails> getDetails(Long tripBookingId);
  CrudsResult<DataRef> getDataRef(String name);

  SearchResult<DataRef> findAllDataRefs();
  SearchResult<TripBookingInfo> findAllInfos();
