...
public class TripBookingTaskStatusInfo
  ...
  public TripBookingTaskStatusInfo() {
    this.mId = 0L;
  ...
  public TripBookingTaskStatusInfo(Long id
  ...
  public List<String> getFieldOrder() {
    ...
    fieldOrder.add("Name");
    fieldOrder.add("StartedAt");
    fieldOrder.add("FinishedAt");
    fieldOrder.add("Status");
    fieldOrder.add("StateTask");
