...
define(function(require) {
  ...
  var addressFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "addressFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.AddressFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(addressFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(addressFindByNameEq);
    var form = {
  ...
  function jsToViewModel(addressFindByNameEq) {
    var addressFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(addressFindByNameEq.name),
    ...
    return addressFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(addressFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: addressFindByNameEqViewModel.name(),
  ...
  return addressFindByNameEqMapper;
});
