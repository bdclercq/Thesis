...
define(function(require) {
  ...
  var addressFindByPincodeEqElement = nsxApplication.getElement("onlineCabBookingComp", "addressFindByPincodeEq");
  ...
  var fieldOptions = {
    ...
    pincode: {
      ...
      key: "onlineCabBookingComp.AddressFindByPincodeEq.pincode",
      isValueType: false
    }
  ...
  function jsToFormModel(addressFindByPincodeEq, fieldFilter) {
    var detailModel = jsToViewModel(addressFindByPincodeEq);
    var form = {
  ...
  function jsToViewModel(addressFindByPincodeEq) {
    var addressFindByPincodeEqViewModel = {
      // anchor:value-fields-to-model:start
      pincode: ko.observable(addressFindByPincodeEq.pincode),
    ...
    return addressFindByPincodeEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(addressFindByPincodeEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      pincode: addressFindByPincodeEqViewModel.pincode(),
  ...
  var addressFindByPincodeEqMapper = {
  ...
  return addressFindByPincodeEqMapper;
});
