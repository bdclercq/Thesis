...
define(function(require) {
  ...
  var addressFindByStateEqElement = nsxApplication.getElement("onlineCabBookingComp", "addressFindByStateEq");
  ...
  var fieldOptions = {
    ...
    state: {
      ...
      key: "onlineCabBookingComp.AddressFindByStateEq.state",
      isValueType: false
    }
  ...
  function jsToFormModel(addressFindByStateEq, fieldFilter) {
    var detailModel = jsToViewModel(addressFindByStateEq);
    var form = {
  ...
  function jsToViewModel(addressFindByStateEq) {
    var addressFindByStateEqViewModel = {
      // anchor:value-fields-to-model:start
      state: ko.observable(addressFindByStateEq.state),
    ...
    return addressFindByStateEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(addressFindByStateEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      state: addressFindByStateEqViewModel.state(),
  ...
  var addressFindByStateEqMapper = {
  ...
  return addressFindByStateEqMapper;
});
