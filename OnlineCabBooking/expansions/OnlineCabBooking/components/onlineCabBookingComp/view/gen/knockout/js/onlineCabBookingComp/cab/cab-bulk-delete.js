...
define(function (require) {
  ...
  const CabActions = require('onlineCabBookingComp/cab/cab-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = CabEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = CabActions.deleteMultipleAction();
