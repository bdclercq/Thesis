...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) Cab element!")
    });

    function render() {
      var createIntent = CabEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: CabActions.createAction()
      };
