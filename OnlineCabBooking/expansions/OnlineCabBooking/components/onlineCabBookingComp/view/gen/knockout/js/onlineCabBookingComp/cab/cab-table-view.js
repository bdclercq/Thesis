...
define(function (require) {
  ...
  var CabFinders = require('onlineCabBookingComp/cab/cab-finders');
  var CabStdTable = require('onlineCabBookingComp/cab/cab-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = CabFinders.finderWith(constantFields);
    var finderOptions = CabFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = CabEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineCabList(widget, input) {
    return CabStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: CabEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: CabEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: CabEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: CabEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: CabEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var cabList = defineCabList(widget, listOptions);

    tableContext.selection = cabList.selection;
    ...
    var pagination = definePagination(toolbar, cabList.listModel);
