...
define(function(require) {
  ...
  var cabFindAllCabElement = nsxApplication.getElement("onlineCabBookingComp", "cabFindAllCab");
  ...
  function jsToFormModel(cabFindAllCab, fieldFilter) {
    var detailModel = jsToViewModel(cabFindAllCab);
    var form = {
  ...
  function jsToViewModel(cabFindAllCab) {
    var cabFindAllCabViewModel = {
    ...
    return cabFindAllCabViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(cabFindAllCabViewModel) {
    var jsData = {
