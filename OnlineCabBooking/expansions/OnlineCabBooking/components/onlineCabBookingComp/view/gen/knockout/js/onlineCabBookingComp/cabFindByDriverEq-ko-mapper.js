...
define(function(require) {
  ...
  var cabFindByDriverEqElement = nsxApplication.getElement("onlineCabBookingComp", "cabFindByDriverEq");
  ...
  var fieldOptions = {
    ...
    driver: {
      ...
      key: "onlineCabBookingComp.CabFindByDriverEq.driver",
      isValueType: false
    }
  ...
  function jsToFormModel(cabFindByDriverEq, fieldFilter) {
    var detailModel = jsToViewModel(cabFindByDriverEq);
    var form = {
  ...
  function jsToViewModel(cabFindByDriverEq) {
    var cabFindByDriverEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      driver: ko.observable(cabFindByDriverEq.driver),
  ...
  return cabFindByDriverEqMapper;
});
