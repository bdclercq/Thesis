...
define(function (require) {
  ...
  const CarTypeActions = require('onlineCabBookingComp/carType/carType-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = CarTypeEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = CarTypeActions.deleteMultipleAction();
