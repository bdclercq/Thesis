...
define(function(require) {
  ...
  var carTypeFindAllCarTypesElement = nsxApplication.getElement("onlineCabBookingComp", "carTypeFindAllCarTypes");
  ...
  function jsToFormModel(carTypeFindAllCarTypes, fieldFilter) {
    var detailModel = jsToViewModel(carTypeFindAllCarTypes);
    var form = {
  ...
  function jsToViewModel(carTypeFindAllCarTypes) {
    var carTypeFindAllCarTypesViewModel = {
    ...
    return carTypeFindAllCarTypesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(carTypeFindAllCarTypesViewModel) {
    var jsData = {
  ...
  var carTypeFindAllCarTypesMapper = {
  ...
  return carTypeFindAllCarTypesMapper;
});
