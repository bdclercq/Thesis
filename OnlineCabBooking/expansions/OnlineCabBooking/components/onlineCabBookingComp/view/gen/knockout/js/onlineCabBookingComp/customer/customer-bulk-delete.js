...
define(function (require) {
  ...
  const CustomerActions = require('onlineCabBookingComp/customer/customer-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = CustomerEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = CustomerActions.deleteMultipleAction();
