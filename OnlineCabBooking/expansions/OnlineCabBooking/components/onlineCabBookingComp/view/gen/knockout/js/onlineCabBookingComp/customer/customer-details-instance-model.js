  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        name: ko.observable(),
        journeyStatus: ko.observable(),
        person: defineLink(PersonEvents)
    ...
    function updateViewmodel(customerDetails) {
      if (!!customerDetails) {
        viewmodel.id(customerDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(customerDetails.name);
        viewmodel.journeyStatus(customerDetails.journeyStatus);
        viewmodel.person.value(customerDetails.person);
