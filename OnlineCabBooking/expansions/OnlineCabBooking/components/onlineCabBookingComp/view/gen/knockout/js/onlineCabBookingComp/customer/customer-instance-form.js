...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "onlineCabBookingComp.Customer.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "onlineCabBookingComp.Customer.name",
      isValueType: false
    },
    {
      fieldName: "journeyStatus",
      type: FieldType.VALUE,
      key: "onlineCabBookingComp.Customer.journeyStatus",
      isValueType: false
    },
    {
      fieldName: "person",
      type: FieldType.DATAREF,
      key: "onlineCabBookingComp.Customer.person",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || CustomerActions.editAction();
