...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Customer!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = CustomerEvents.defineViewIntentListener();

      var config = {
        title: 'Customer',
        projection: 'details',
        projector: 'onlineCabBookingComp/customer/customer-projector',
        modeller: 'onlineCabBookingComp/customer/customer-details-instance-model',
        view: 'onlineCabBookingComp/customer-details-instance'
      };
