...
define(function(require) {
  ...
  var customerFindByUsernameElement = nsxApplication.getElement("onlineCabBookingComp", "customerFindByUsername");
  ...
  function jsToFormModel(customerFindByUsername, fieldFilter) {
    var detailModel = jsToViewModel(customerFindByUsername);
    var form = {
  ...
  function jsToViewModel(customerFindByUsername) {
    var customerFindByUsernameViewModel = {
    ...
    return customerFindByUsernameViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(customerFindByUsernameViewModel) {
    var jsData = {
  ...
  var customerFindByUsernameMapper = {
  ...
  return customerFindByUsernameMapper;
});
