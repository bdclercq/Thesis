...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "onlineCabBookingComp.Driver.id",
      isValueType: false
    },
    {
      fieldName: "licenseNo",
    ...
    },
    {
      fieldName: "rating",
      type: FieldType.VALUE,
      key: "onlineCabBookingComp.Driver.rating",
      isValueType: false
    },
    {
      fieldName: "isAvailable",
      type: FieldType.VALUE,
      key: "onlineCabBookingComp.Driver.isAvailable",
      isValueType: false
    },
    {
      fieldName: "cab",
      type: FieldType.DATAREF,
      key: "onlineCabBookingComp.Driver.cab",
      isValueType: false
    },
    {
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || DriverActions.editAction();
