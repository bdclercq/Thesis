...
define(function (require) {
  ...
  var DriverTableView = require('onlineCabBookingComp/driver/driver-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.Driver.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.Driver.menu.title");
    ...
    var table = DriverTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
