...
define(function (require) {
  ...
  var DriverFinders = require('onlineCabBookingComp/driver/driver-finders');
  var DriverStdTable = require('onlineCabBookingComp/driver/driver-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = DriverFinders.finderWith(constantFields);
    var finderOptions = DriverFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineDriverList(widget, input) {
    return DriverStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: DriverEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: DriverEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: DriverEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: DriverEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: DriverEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var driverList = defineDriverList(widget, listOptions);

    tableContext.selection = driverList.selection;
    ...
    var pagination = definePagination(toolbar, driverList.listModel);
    ...
    return {
      injector: widget,
      selection: driverList.selection
    };
  }
