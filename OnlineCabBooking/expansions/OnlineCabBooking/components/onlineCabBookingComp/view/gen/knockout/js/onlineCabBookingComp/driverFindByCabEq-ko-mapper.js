...
define(function(require) {
  ...
  var driverFindByCabEqElement = nsxApplication.getElement("onlineCabBookingComp", "driverFindByCabEq");
  ...
  var fieldOptions = {
    ...
    cab: {
      ...
      key: "onlineCabBookingComp.DriverFindByCabEq.cab",
      isValueType: false
    }
  ...
  function jsToFormModel(driverFindByCabEq, fieldFilter) {
    var detailModel = jsToViewModel(driverFindByCabEq);
    var form = {
  ...
  function jsToViewModel(driverFindByCabEq) {
    var driverFindByCabEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      cab: ko.observable(driverFindByCabEq.cab),
  ...
  return driverFindByCabEqMapper;
});
