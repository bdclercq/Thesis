...
define(function(require) {
  ...
  var driverFindByRatingEqElement = nsxApplication.getElement("onlineCabBookingComp", "driverFindByRatingEq");
  ...
  var fieldOptions = {
    ...
    rating: {
      ...
      key: "onlineCabBookingComp.DriverFindByRatingEq.rating",
      isValueType: false
    }
  ...
  function jsToFormModel(driverFindByRatingEq, fieldFilter) {
    var detailModel = jsToViewModel(driverFindByRatingEq);
    var form = {
  ...
  function jsToViewModel(driverFindByRatingEq) {
    var driverFindByRatingEqViewModel = {
      // anchor:value-fields-to-model:start
      rating: ko.observable(driverFindByRatingEq.rating),
    ...
    return driverFindByRatingEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(driverFindByRatingEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      rating: driverFindByRatingEqViewModel.rating(),
  ...
  var driverFindByRatingEqMapper = {
  ...
  return driverFindByRatingEqMapper;
});
