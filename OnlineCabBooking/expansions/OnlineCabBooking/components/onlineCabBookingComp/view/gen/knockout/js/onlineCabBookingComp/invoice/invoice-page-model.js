...
define(function (require) {
  ...
  var InvoiceTableView = require('onlineCabBookingComp/invoice/invoice-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.Invoice.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.Invoice.menu.title");
    ...
    var table = InvoiceTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
