...
define(function (require) {
  ...
  var InvoiceFinders = require('onlineCabBookingComp/invoice/invoice-finders');
  var InvoiceStdTable = require('onlineCabBookingComp/invoice/invoice-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = InvoiceFinders.finderWith(constantFields);
    var finderOptions = InvoiceFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = InvoiceEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineInvoiceList(widget, input) {
    return InvoiceStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: InvoiceEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: InvoiceEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: InvoiceEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: InvoiceEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: InvoiceEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var invoiceList = defineInvoiceList(widget, listOptions);

    tableContext.selection = invoiceList.selection;
    ...
    var pagination = definePagination(toolbar, invoiceList.listModel);
    ...
    return {
      injector: widget,
      selection: invoiceList.selection
    };
  }
