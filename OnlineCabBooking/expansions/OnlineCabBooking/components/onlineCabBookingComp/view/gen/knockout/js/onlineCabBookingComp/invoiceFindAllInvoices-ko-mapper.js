...
define(function(require) {
  ...
  var invoiceFindAllInvoicesElement = nsxApplication.getElement("onlineCabBookingComp", "invoiceFindAllInvoices");
  ...
  function jsToFormModel(invoiceFindAllInvoices, fieldFilter) {
    var detailModel = jsToViewModel(invoiceFindAllInvoices);
    var form = {
  ...
  function jsToViewModel(invoiceFindAllInvoices) {
    var invoiceFindAllInvoicesViewModel = {
    ...
    return invoiceFindAllInvoicesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(invoiceFindAllInvoicesViewModel) {
    var jsData = {
  ...
  var invoiceFindAllInvoicesMapper = {
  ...
  return invoiceFindAllInvoicesMapper;
});
