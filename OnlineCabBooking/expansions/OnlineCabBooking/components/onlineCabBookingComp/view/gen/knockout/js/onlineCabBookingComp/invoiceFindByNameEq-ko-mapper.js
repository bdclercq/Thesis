...
define(function(require) {
  ...
  var invoiceFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "invoiceFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.InvoiceFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(invoiceFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(invoiceFindByNameEq);
    var form = {
  ...
  function jsToViewModel(invoiceFindByNameEq) {
    var invoiceFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(invoiceFindByNameEq.name),
    ...
    return invoiceFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(invoiceFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: invoiceFindByNameEqViewModel.name(),
  ...
  return invoiceFindByNameEqMapper;
});
