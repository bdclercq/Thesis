...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "onlineCabBookingComp.Payment.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "onlineCabBookingComp.Payment.name",
      isValueType: false
    },
    {
      fieldName: "statusPayed",
      type: FieldType.VALUE,
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || PaymentActions.editAction();
