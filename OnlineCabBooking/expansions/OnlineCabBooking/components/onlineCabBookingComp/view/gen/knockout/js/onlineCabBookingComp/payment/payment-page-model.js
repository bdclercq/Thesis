...
define(function (require) {
  ...
  var PaymentTableView = require('onlineCabBookingComp/payment/payment-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.Payment.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.Payment.menu.title");
    ...
    var table = PaymentTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
