...
define(function (require) {
  ...
  var PaymentFinders = require('onlineCabBookingComp/payment/payment-finders');
  var PaymentStdTable = require('onlineCabBookingComp/payment/payment-std-table');

  var PaymentElement = require('nsx/nsx-application').getElement('onlineCabBookingComp', 'payment');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = PaymentFinders.finderWith(constantFields);
    var finderOptions = PaymentFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = PaymentEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function definePaymentList(widget, input) {
    return PaymentStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: PaymentEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: PaymentEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: PaymentEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: PaymentEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: PaymentEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var paymentList = definePaymentList(widget, listOptions);

    tableContext.selection = paymentList.selection;
    ...
    var pagination = definePagination(toolbar, paymentList.listModel);
    ...
    return {
      injector: widget,
      selection: paymentList.selection
    };
  }
