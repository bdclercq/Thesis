...
define(function(require) {
  ...
  var paymentFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "paymentFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.PaymentFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(paymentFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(paymentFindByNameEq);
    var form = {
  ...
  function jsToViewModel(paymentFindByNameEq) {
    var paymentFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(paymentFindByNameEq.name),
    ...
    return paymentFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(paymentFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: paymentFindByNameEqViewModel.name(),
  ...
  return paymentFindByNameEqMapper;
});
