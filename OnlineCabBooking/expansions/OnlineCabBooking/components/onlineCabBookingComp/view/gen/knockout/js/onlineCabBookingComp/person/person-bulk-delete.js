...
define(function (require) {
  ...
  const PersonActions = require('onlineCabBookingComp/person/person-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = PersonEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = PersonActions.deleteMultipleAction();
