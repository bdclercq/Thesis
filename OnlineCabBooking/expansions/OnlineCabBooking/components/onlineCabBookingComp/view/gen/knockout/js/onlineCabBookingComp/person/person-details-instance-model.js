  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        address: defineLink(AddressEvents)
    ...
    function updateViewmodel(personDetails) {
      if (!!personDetails) {
        viewmodel.id(personDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(personDetails.name);
        viewmodel.username(personDetails.username);
        viewmodel.password(personDetails.password);
        viewmodel.email(personDetails.email);
        viewmodel.mobile(personDetails.mobile);
        viewmodel.address.value(personDetails.address);
