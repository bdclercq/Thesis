...
define(function(require) {
  ...
  var personMetaData = require("dataElement!onlineCabBookingComp.person");
  var personAgent = personMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "onlineCabBookingComp.person.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = PersonEvents.defineCreateUpdateListener();
    var dataEdit = PersonEvents.defineEditUpdateListener();
    var dataRefresh = PersonEvents.defineRefreshUpdateListener();
    var dataDelete = PersonEvents.defineDeleteUpdateListener();
    var dataFinder = PersonEvents.defineFinderUpdateListener();
