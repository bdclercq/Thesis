...
define(function (require) {
  ...
  var PersonSorting = require('onlineCabBookingComp/person/person-sorting');
  var PersonInfoModel = require('onlineCabBookingComp/person/person-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = PersonSorting.defineSorting();
    var dataUpdate = PersonEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: PersonInfoModel
    });

    var infoListView = "onlineCabBookingComp/person-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
