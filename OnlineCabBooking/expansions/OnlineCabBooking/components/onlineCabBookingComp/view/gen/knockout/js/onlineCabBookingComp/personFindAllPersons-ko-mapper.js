...
define(function(require) {
  ...
  var personFindAllPersonsElement = nsxApplication.getElement("onlineCabBookingComp", "personFindAllPersons");
  ...
  function jsToFormModel(personFindAllPersons, fieldFilter) {
    var detailModel = jsToViewModel(personFindAllPersons);
    var form = {
  ...
  function jsToViewModel(personFindAllPersons) {
    var personFindAllPersonsViewModel = {
    ...
    return personFindAllPersonsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(personFindAllPersonsViewModel) {
    var jsData = {
  ...
  var personFindAllPersonsMapper = {
  ...
  return personFindAllPersonsMapper;
});
