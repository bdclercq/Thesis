...
define(function(require) {
  ...
  var personFindByAddressEqElement = nsxApplication.getElement("onlineCabBookingComp", "personFindByAddressEq");
  ...
  var fieldOptions = {
    ...
    address: {
      ...
      key: "onlineCabBookingComp.PersonFindByAddressEq.address",
      isValueType: false
    }
  ...
  function jsToFormModel(personFindByAddressEq, fieldFilter) {
    var detailModel = jsToViewModel(personFindByAddressEq);
    var form = {
  ...
  function jsToViewModel(personFindByAddressEq) {
    var personFindByAddressEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      address: ko.observable(personFindByAddressEq.address),
  ...
  var personFindByAddressEqMapper = {
  ...
  return personFindByAddressEqMapper;
});
