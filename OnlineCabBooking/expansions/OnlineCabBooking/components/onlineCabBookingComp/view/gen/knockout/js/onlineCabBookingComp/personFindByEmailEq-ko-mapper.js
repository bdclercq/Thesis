...
define(function(require) {
  ...
  var personFindByEmailEqElement = nsxApplication.getElement("onlineCabBookingComp", "personFindByEmailEq");
  ...
  var fieldOptions = {
    ...
    email: {
      ...
      key: "onlineCabBookingComp.PersonFindByEmailEq.email",
      isValueType: false
    }
  ...
  function jsToFormModel(personFindByEmailEq, fieldFilter) {
    var detailModel = jsToViewModel(personFindByEmailEq);
    var form = {
  ...
  function jsToViewModel(personFindByEmailEq) {
    var personFindByEmailEqViewModel = {
      // anchor:value-fields-to-model:start
      email: ko.observable(personFindByEmailEq.email),
    ...
    return personFindByEmailEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(personFindByEmailEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      email: personFindByEmailEqViewModel.email(),
  ...
  return personFindByEmailEqMapper;
});
