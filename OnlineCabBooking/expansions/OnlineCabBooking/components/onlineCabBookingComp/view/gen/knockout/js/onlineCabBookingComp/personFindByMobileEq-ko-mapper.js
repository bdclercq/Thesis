...
define(function(require) {
  ...
  var personFindByMobileEqElement = nsxApplication.getElement("onlineCabBookingComp", "personFindByMobileEq");
  ...
  var fieldOptions = {
    ...
    mobile: {
      ...
      key: "onlineCabBookingComp.PersonFindByMobileEq.mobile",
      isValueType: false
    }
  ...
  function jsToFormModel(personFindByMobileEq, fieldFilter) {
    var detailModel = jsToViewModel(personFindByMobileEq);
    var form = {
  ...
  function jsToViewModel(personFindByMobileEq) {
    var personFindByMobileEqViewModel = {
      // anchor:value-fields-to-model:start
      mobile: ko.observable(personFindByMobileEq.mobile),
    ...
    return personFindByMobileEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(personFindByMobileEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      mobile: personFindByMobileEqViewModel.mobile(),
  ...
  var personFindByMobileEqMapper = {
  ...
  return personFindByMobileEqMapper;
});
