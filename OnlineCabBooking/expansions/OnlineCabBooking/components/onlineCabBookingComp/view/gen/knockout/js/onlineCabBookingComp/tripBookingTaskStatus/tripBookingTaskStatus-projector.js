...
define(function(require) {
  ...
  var tripBookingTaskStatusMetaData = require("dataElement!onlineCabBookingComp.tripBookingTaskStatus");
  var tripBookingTaskStatusAgent = tripBookingTaskStatusMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "onlineCabBookingComp.tripBookingTaskStatus.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = TripBookingTaskStatusEvents.defineCreateUpdateListener();
    var dataEdit = TripBookingTaskStatusEvents.defineEditUpdateListener();
    var dataRefresh = TripBookingTaskStatusEvents.defineRefreshUpdateListener();
    var dataDelete = TripBookingTaskStatusEvents.defineDeleteUpdateListener();
    var dataFinder = TripBookingTaskStatusEvents.defineFinderUpdateListener();
