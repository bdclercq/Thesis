...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) TripBookingTaskStatus!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = TripBookingTaskStatusEvents.defineViewIntentListener();

      var config = {
        title: 'TripBookingTaskStatus',
        projection: 'details',
        projector: 'onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-projector',
        modeller: 'onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-details-instance-model',
        view: 'onlineCabBookingComp/tripBookingTaskStatus-details-instance'
      };
