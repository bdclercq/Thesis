...
define(function(require) {
  ...
  var tripBookingTaskStatusFindAllTripBookingTaskStatussElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingTaskStatusFindAllTripBookingTaskStatuss");
  ...
  function jsToFormModel(tripBookingTaskStatusFindAllTripBookingTaskStatuss, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingTaskStatusFindAllTripBookingTaskStatuss);
    var form = {
  ...
  function jsToViewModel(tripBookingTaskStatusFindAllTripBookingTaskStatuss) {
    var tripBookingTaskStatusFindAllTripBookingTaskStatussViewModel = {
    ...
    return tripBookingTaskStatusFindAllTripBookingTaskStatussViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingTaskStatusFindAllTripBookingTaskStatussViewModel) {
    var jsData = {
  ...
  var tripBookingTaskStatusFindAllTripBookingTaskStatussMapper = {
  ...
  return tripBookingTaskStatusFindAllTripBookingTaskStatussMapper;
});
