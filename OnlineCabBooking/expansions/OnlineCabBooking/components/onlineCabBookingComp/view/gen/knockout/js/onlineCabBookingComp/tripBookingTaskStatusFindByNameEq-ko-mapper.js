...
define(function(require) {
  ...
  var tripBookingTaskStatusFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingTaskStatusFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.TripBookingTaskStatusFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(tripBookingTaskStatusFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingTaskStatusFindByNameEq);
    var form = {
  ...
  function jsToViewModel(tripBookingTaskStatusFindByNameEq) {
    var tripBookingTaskStatusFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(tripBookingTaskStatusFindByNameEq.name),
    ...
    return tripBookingTaskStatusFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingTaskStatusFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: tripBookingTaskStatusFindByNameEqViewModel.name(),
  ...
  var tripBookingTaskStatusFindByNameEqMapper = {
  ...
  return tripBookingTaskStatusFindByNameEqMapper;
});
