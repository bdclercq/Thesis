...
define(function(require) {
  ...
  var tripBookingTaskStatusFindByStatusEqElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingTaskStatusFindByStatusEq");
  ...
  var fieldOptions = {
    ...
    status: {
      ...
      key: "onlineCabBookingComp.TripBookingTaskStatusFindByStatusEq.status",
      isValueType: false
    }
  ...
  function jsToFormModel(tripBookingTaskStatusFindByStatusEq, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingTaskStatusFindByStatusEq);
    var form = {
  ...
  function jsToViewModel(tripBookingTaskStatusFindByStatusEq) {
    var tripBookingTaskStatusFindByStatusEqViewModel = {
      // anchor:value-fields-to-model:start
      status: ko.observable(tripBookingTaskStatusFindByStatusEq.status),
    ...
    return tripBookingTaskStatusFindByStatusEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingTaskStatusFindByStatusEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      status: tripBookingTaskStatusFindByStatusEqViewModel.status(),
  ...
  var tripBookingTaskStatusFindByStatusEqMapper = {
  ...
  return tripBookingTaskStatusFindByStatusEqMapper;
});
