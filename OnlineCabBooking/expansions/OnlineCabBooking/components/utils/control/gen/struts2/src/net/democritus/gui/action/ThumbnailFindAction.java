...
import net.democritus.gui.ThumbnailFindDetails;
...
public class ThumbnailFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.gui.action.ThumbnailFindAction");

  private SearchDetails<? extends ThumbnailFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.gui", "Thumbnail", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    ThumbnailAgent thumbnailAgent = createThumbnailAgent();
    ...
    searchResult = thumbnailAgent.find(searchDetails);
  ...
  private ThumbnailAgent createThumbnailAgent() {
