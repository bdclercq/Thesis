...
import net.democritus.sys.ExecutionFindDetails;
...
public class ExecutionFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.sys.action.ExecutionFindAction");

  private SearchDetails<? extends ExecutionFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.sys", "Execution", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllExecutions";
    }
  ...
  public String execute() throws Exception {
    ...
    ExecutionAgent executionAgent = createExecutionAgent();
    ...
    searchResult = executionAgent.find(searchDetails);
  ...
  private ExecutionAgent createExecutionAgent() {
