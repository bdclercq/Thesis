...
public class ExecutionImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(ExecutionImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    ExecutionAgent executionAgent = ExecutionAgent.getExecutionAgent(ContextRetriever.getContext());
    result = executionAgent.importFile(importFile);
