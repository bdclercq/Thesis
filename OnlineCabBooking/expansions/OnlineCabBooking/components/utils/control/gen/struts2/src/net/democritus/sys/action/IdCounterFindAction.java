...
import net.democritus.sys.IdCounterFindDetails;
...
public class IdCounterFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.sys.action.IdCounterFindAction");

  private SearchDetails<? extends IdCounterFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.sys", "IdCounter", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllIdCounters";
    }
  ...
  public String execute() throws Exception {
    ...
    IdCounterAgent idCounterAgent = createIdCounterAgent();
    ...
    searchResult = idCounterAgent.find(searchDetails);
  ...
  private IdCounterAgent createIdCounterAgent() {
