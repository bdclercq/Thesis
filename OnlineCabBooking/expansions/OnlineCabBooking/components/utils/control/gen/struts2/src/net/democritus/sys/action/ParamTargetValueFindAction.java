...
import net.democritus.sys.ParamTargetValueFindDetails;
...
public class ParamTargetValueFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.sys.action.ParamTargetValueFindAction");

  private SearchDetails<? extends ParamTargetValueFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.sys", "ParamTargetValue", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    ParamTargetValueAgent paramTargetValueAgent = createParamTargetValueAgent();
    ...
    searchResult = paramTargetValueAgent.find(searchDetails);
  ...
  private ParamTargetValueAgent createParamTargetValueAgent() {
