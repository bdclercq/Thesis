...
public class ParamTargetValueImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(ParamTargetValueImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    ParamTargetValueAgent paramTargetValueAgent = ParamTargetValueAgent.getParamTargetValueAgent(ContextRetriever.getContext());
    result = paramTargetValueAgent.importFile(importFile);
