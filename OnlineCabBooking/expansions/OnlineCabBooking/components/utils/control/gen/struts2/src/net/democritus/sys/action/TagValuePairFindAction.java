...
import net.democritus.sys.TagValuePairFindDetails;
...
public class TagValuePairFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.sys.action.TagValuePairFindAction");

  private SearchDetails<? extends TagValuePairFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.sys", "TagValuePair", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    TagValuePairAgent tagValuePairAgent = createTagValuePairAgent();
    ...
    searchResult = tagValuePairAgent.find(searchDetails);
  ...
  private TagValuePairAgent createTagValuePairAgent() {
