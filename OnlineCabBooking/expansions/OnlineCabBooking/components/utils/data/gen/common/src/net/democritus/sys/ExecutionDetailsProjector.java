...
public class ExecutionDetailsProjector implements IDataElementProjector<ExecutionData, ExecutionDetails>, IDataProjectorRequired<ExecutionDetails> {
  ...
  public ExecutionDetailsProjector(ExecutionCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public ExecutionDetails project(ParameterContext<ExecutionData> dataParameter) {

    ExecutionDetails projection = new ExecutionDetails();
  ...
  public void toData(ExecutionData data, ParameterContext<ExecutionDetails> projectionParameter) {
    // don't set the data id
    ExecutionDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(ExecutionDetails projection) {
  ...
  public Class<ExecutionDetails> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<ExecutionDetails> projectionParameter) {
