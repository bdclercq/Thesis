...
public class ParamTargetValueDataRefProjector implements IDataElementProjector<ParamTargetValueData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public ParamTargetValueDataRefProjector(ParamTargetValueCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<ParamTargetValueData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("utils");
    projection.setPackName("net.democritus.sys");
    projection.setClassName("ParamTargetValue");
  ...
  // anchor:toData:start
  public void toData(ParamTargetValueData data, ParameterContext<DataRef> projectionParameter) {
