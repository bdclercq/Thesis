...
public class TagValuePairInfoProjector implements IDataElementProjector<TagValuePairData, TagValuePairInfo>, IDataProjectorRequired<TagValuePairInfo> {
  ...
  public TagValuePairInfoProjector(TagValuePairCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public TagValuePairInfo project(ParameterContext<TagValuePairData> dataParameter) {

    TagValuePairInfo projection = new TagValuePairInfo();
  ...
  public void toData(TagValuePairData data, ParameterContext<TagValuePairInfo> projectionParameter) {
    // don't set the data id
    TagValuePairInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(TagValuePairInfo projection) {
  ...
  public Class<TagValuePairInfo> getProjectionClass() {
    return TagValuePairInfo.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<TagValuePairInfo> projectionParameter) {
