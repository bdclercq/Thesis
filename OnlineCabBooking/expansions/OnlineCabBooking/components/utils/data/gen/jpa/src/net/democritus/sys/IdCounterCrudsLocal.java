...
public interface IdCounterCrudsLocal {
  ...
  <S extends IdCounterFindDetails, P> SearchResult<P> find(ParameterContext<SearchDetails<S>> searchParameter);
  ...
  Long getNextCount(String aName);
