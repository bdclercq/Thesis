...
public interface ParamTargetValueCrudsLocal {
  ...
  <S extends ParamTargetValueFindDetails, P> SearchResult<P> find(ParameterContext<SearchDetails<S>> searchParameter);
