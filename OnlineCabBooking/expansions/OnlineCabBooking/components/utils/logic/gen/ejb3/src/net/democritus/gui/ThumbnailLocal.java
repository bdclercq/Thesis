...
/**
 * Local interface for the entity bean Thumbnail,
 * representing a known Thumbnail
 */
public interface ThumbnailLocal {
  ...
  ThumbnailInfo getInfo(Long id);
  ThumbnailDetails getDetails(DataRef dataRef);
  ThumbnailDetails getDetails(Long id);
