...
/**
 * Local interface for the entity bean TagValuePair,
 * representing a known TagValuePair
 */
public interface TagValuePairLocal {
  ...
  TagValuePairInfo getInfo(Long id);
  TagValuePairDetails getDetails(DataRef dataRef);
  TagValuePairDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<TagValuePairDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<TagValuePairDetails> detailsParameter);
  ...
  CrudsResult<TagValuePairInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<TagValuePairDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<TagValuePairDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends TagValuePairFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
