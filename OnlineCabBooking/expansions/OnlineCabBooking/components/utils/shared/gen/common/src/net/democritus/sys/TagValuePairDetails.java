...
/**
 * Transport detailed class for the entity bean TagValuePair,
 */

public class TagValuePairDetails
  ...
  public TagValuePairDetails(Long id
      , String name
  ...
  public DataRef getDataRef() {
    return new DataRef(mId, "", "utils", "net.democritus.sys", "TagValuePair");
  }
}
