...
define(function(require) {
  ...
  var executionMetaData = require("dataElement!utils.execution");
  var executionAgent = executionMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "utils.execution.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = ExecutionEvents.defineCreateUpdateListener();
    var dataEdit = ExecutionEvents.defineEditUpdateListener();
    var dataRefresh = ExecutionEvents.defineRefreshUpdateListener();
    var dataDelete = ExecutionEvents.defineDeleteUpdateListener();
    var dataFinder = ExecutionEvents.defineFinderUpdateListener();
