...
define(function (require) {
  ...
  var ExecutionProjector = require('utils/execution/execution-projector');
  ...
  function defineEditDialog(options) {
    ...
    when(editRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to edit a(n) Execution element!")
    });

    function render() {
      var editIntent = ExecutionEvents.defineEditIntentListener();
      var showDialog = Trigger.defineTrigger();

      var constants = ko.observable();
      var selection = ko.observable();
      var formView = "utils/execution-form";
      var title = "Edit Execution";
      var layoutConfig = initLayoutConfig(constants)
      var formOptions = {
        resetOn: editIntent,
        action: ExecutionActions.editAction()
      };

      var detailsProjection = ExecutionProjector.defineProjector(selection, {
        projection: "details"
      });
