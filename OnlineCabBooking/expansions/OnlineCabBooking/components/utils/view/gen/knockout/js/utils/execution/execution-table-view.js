...
define(function (require) {
  ...
  var ExecutionFinders = require('utils/execution/execution-finders');
  var ExecutionStdTable = require('utils/execution/execution-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ExecutionFinders.finderWith(constantFields);
    var finderOptions = ExecutionFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ExecutionEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineExecutionList(widget, input) {
    return ExecutionStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ExecutionEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ExecutionEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ExecutionEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ExecutionEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ExecutionEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var executionList = defineExecutionList(widget, listOptions);

    tableContext.selection = executionList.selection;
    ...
    var pagination = definePagination(toolbar, executionList.listModel);
    ...
    return {
      injector: widget,
      selection: executionList.selection
    };
  }
