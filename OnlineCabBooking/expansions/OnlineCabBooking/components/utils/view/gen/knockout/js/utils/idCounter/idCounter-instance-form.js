...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "utils.IdCounter.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "utils.IdCounter.name",
      isValueType: false
    },
    {
      fieldName: "counter",
      type: FieldType.VALUE,
      key: "utils.IdCounter.counter",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || IdCounterActions.editAction();
