...
define(function (require) {
  ...
  var IdCounterSorting = require('utils/idCounter/idCounter-sorting');
  var IdCounterInfoModel = require('utils/idCounter/idCounter-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = IdCounterSorting.defineSorting();
    var dataUpdate = IdCounterEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: IdCounterInfoModel
    });

    var infoListView = "utils/idCounter-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
