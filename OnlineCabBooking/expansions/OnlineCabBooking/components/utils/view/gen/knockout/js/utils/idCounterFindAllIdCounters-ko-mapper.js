...
define(function(require) {
  ...
  var idCounterFindAllIdCountersElement = nsxApplication.getElement("utils", "idCounterFindAllIdCounters");
  ...
  function jsToFormModel(idCounterFindAllIdCounters, fieldFilter) {
    var detailModel = jsToViewModel(idCounterFindAllIdCounters);
    var form = {
  ...
  function jsToViewModel(idCounterFindAllIdCounters) {
    var idCounterFindAllIdCountersViewModel = {
    ...
    return idCounterFindAllIdCountersViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(idCounterFindAllIdCountersViewModel) {
    var jsData = {
  ...
  var idCounterFindAllIdCountersMapper = {
  ...
  return idCounterFindAllIdCountersMapper;
});
