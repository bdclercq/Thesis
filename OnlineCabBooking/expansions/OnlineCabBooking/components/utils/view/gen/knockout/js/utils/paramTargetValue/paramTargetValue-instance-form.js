...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "utils.ParamTargetValue.id",
      isValueType: false
    },
    {
      fieldName: "param",
      type: FieldType.VALUE,
      key: "utils.ParamTargetValue.param",
      isValueType: false
    },
    {
      fieldName: "target",
      type: FieldType.VALUE,
      key: "utils.ParamTargetValue.target",
      isValueType: false
    },
    {
      fieldName: "value",
      type: FieldType.VALUE,
      key: "utils.ParamTargetValue.value",
      isValueType: false
    }
   ...
   *   action: ParamTargetValueAction<any>
   * }} options
   * @return {{
   *    instance: NsxForm,
   *    submit: Trigger<void>
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || ParamTargetValueActions.editAction();
