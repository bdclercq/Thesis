...
define(function (require) {
  ...
  var ParamTargetValueSorting = require('utils/paramTargetValue/paramTargetValue-sorting');
  var ParamTargetValueInfoModel = require('utils/paramTargetValue/paramTargetValue-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ParamTargetValueSorting.defineSorting();
    var dataUpdate = ParamTargetValueEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ParamTargetValueInfoModel
    });

    var infoListView = "utils/paramTargetValue-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
