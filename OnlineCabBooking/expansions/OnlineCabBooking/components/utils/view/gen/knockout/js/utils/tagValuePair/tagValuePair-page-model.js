...
define(function (require) {
  ...
  var TagValuePairTableView = require('utils/tagValuePair/tagValuePair-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("utils.TagValuePair.page.title")
    };
    var viewModel = {};
    var title = translate("utils.TagValuePair.menu.title");
    ...
    var table = TagValuePairTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
