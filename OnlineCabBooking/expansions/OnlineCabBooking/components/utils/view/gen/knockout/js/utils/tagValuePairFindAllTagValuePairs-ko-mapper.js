...
define(function(require) {
  ...
  var tagValuePairFindAllTagValuePairsElement = nsxApplication.getElement("utils", "tagValuePairFindAllTagValuePairs");
  ...
  function jsToFormModel(tagValuePairFindAllTagValuePairs, fieldFilter) {
    var detailModel = jsToViewModel(tagValuePairFindAllTagValuePairs);
    var form = {
  ...
  function jsToViewModel(tagValuePairFindAllTagValuePairs) {
    var tagValuePairFindAllTagValuePairsViewModel = {
    ...
    return tagValuePairFindAllTagValuePairsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tagValuePairFindAllTagValuePairsViewModel) {
    var jsData = {
  ...
  var tagValuePairFindAllTagValuePairsMapper = {
  ...
  return tagValuePairFindAllTagValuePairsMapper;
});
