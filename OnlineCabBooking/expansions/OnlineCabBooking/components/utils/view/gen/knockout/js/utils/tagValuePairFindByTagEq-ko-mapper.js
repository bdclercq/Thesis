...
define(function(require) {
  ...
  var tagValuePairFindByTagEqElement = nsxApplication.getElement("utils", "tagValuePairFindByTagEq");
  ...
  var fieldOptions = {
    ...
    tag: {
      ...
      key: "utils.TagValuePairFindByTagEq.tag",
      isValueType: false
    }
  ...
  function jsToFormModel(tagValuePairFindByTagEq, fieldFilter) {
    var detailModel = jsToViewModel(tagValuePairFindByTagEq);
    var form = {
  ...
  function jsToViewModel(tagValuePairFindByTagEq) {
    var tagValuePairFindByTagEqViewModel = {
      // anchor:value-fields-to-model:start
      tag: ko.observable(tagValuePairFindByTagEq.tag),
    ...
    return tagValuePairFindByTagEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tagValuePairFindByTagEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      tag: tagValuePairFindByTagEqViewModel.tag(),
  ...
  var tagValuePairFindByTagEqMapper = {
  ...
  return tagValuePairFindByTagEqMapper;
});
