...
define(function (require) {
  ...
  var ThumbnailTableView = require('utils/thumbnail/thumbnail-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("utils.Thumbnail.page.title")
    };
    var viewModel = {};
    var title = translate("utils.Thumbnail.menu.title");
    ...
    var table = ThumbnailTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
