...
define(function (require) {
  ...
  var ThumbnailSorting = require('utils/thumbnail/thumbnail-sorting');
  var ThumbnailInfoModel = require('utils/thumbnail/thumbnail-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ThumbnailSorting.defineSorting();
    var dataUpdate = ThumbnailEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ThumbnailInfoModel
    });

    var infoListView = "utils/thumbnail-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
