...
define(function(require) {
  ...
  var thumbnailFindByDepthEqElement = nsxApplication.getElement("utils", "thumbnailFindByDepthEq");
  ...
  var fieldOptions = {
    ...
    depth: {
      ...
      key: "utils.ThumbnailFindByDepthEq.depth",
      isValueType: false
    }
  ...
  function jsToFormModel(thumbnailFindByDepthEq, fieldFilter) {
    var detailModel = jsToViewModel(thumbnailFindByDepthEq);
    var form = {
  ...
  function jsToViewModel(thumbnailFindByDepthEq) {
    var thumbnailFindByDepthEqViewModel = {
      // anchor:value-fields-to-model:start
      depth: ko.observable(thumbnailFindByDepthEq.depth),
    ...
    return thumbnailFindByDepthEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(thumbnailFindByDepthEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      depth: thumbnailFindByDepthEqViewModel.depth(),
  ...
  var thumbnailFindByDepthEqMapper = {
  ...
  return thumbnailFindByDepthEqMapper;
});
