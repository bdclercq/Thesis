...
define(function(require) {
  ...
  var thumbnailFindByThumbTypeEqElement = nsxApplication.getElement("utils", "thumbnailFindByThumbTypeEq");
  ...
  var fieldOptions = {
    ...
    thumbType: {
      ...
      key: "utils.ThumbnailFindByThumbTypeEq.thumbType",
      isValueType: false
    }
  ...
  function jsToFormModel(thumbnailFindByThumbTypeEq, fieldFilter) {
    var detailModel = jsToViewModel(thumbnailFindByThumbTypeEq);
    var form = {
  ...
  function jsToViewModel(thumbnailFindByThumbTypeEq) {
    var thumbnailFindByThumbTypeEqViewModel = {
      // anchor:value-fields-to-model:start
      thumbType: ko.observable(thumbnailFindByThumbTypeEq.thumbType),
    ...
    return thumbnailFindByThumbTypeEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(thumbnailFindByThumbTypeEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      thumbType: thumbnailFindByThumbTypeEqViewModel.thumbType(),
  ...
  var thumbnailFindByThumbTypeEqMapper = {
  ...
  return thumbnailFindByThumbTypeEqMapper;
});
