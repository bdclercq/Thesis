...
import net.democritus.validation.ValidationFindDetails;
...
public class ValidationFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.validation.action.ValidationFindAction");

  private SearchDetails<? extends ValidationFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.validation", "Validation", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  private static Option<Class> getFinderClass(String packageName, String elementName, String searchMethod) {
    if (searchMethod.equals("findAll")) {
      searchMethod = "findAllValidations";
    }
  ...
  public String execute() throws Exception {
    ...
    ValidationAgent validationAgent = createValidationAgent();
    ...
    searchResult = validationAgent.find(searchDetails);
  ...
  private ValidationAgent createValidationAgent() {
