...
public class StrutsCreditcardNumberValidator extends FieldValidatorSupport {

    private final IFieldValidator fieldValidator = new net.democritus.valuetype.basic.CreditcardNumberValidator();
