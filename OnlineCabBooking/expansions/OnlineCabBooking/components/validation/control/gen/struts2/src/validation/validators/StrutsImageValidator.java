...
public class StrutsImageValidator extends FieldValidatorSupport {

    private final IFieldValidator fieldValidator = new net.democritus.valuetype.basic.ImageValidator();
