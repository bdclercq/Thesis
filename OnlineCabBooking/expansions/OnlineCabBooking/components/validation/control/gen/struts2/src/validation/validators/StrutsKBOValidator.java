...
public class StrutsKBOValidator extends FieldValidatorSupport {

    private final IFieldValidator fieldValidator = new net.democritus.valuetype.basic.KBOValidator();
