...
public class StrutsRijksRegisterNummerValidator extends FieldValidatorSupport {

    private final IFieldValidator fieldValidator = new net.democritus.valuetype.basic.RijksRegisterNummerValidator();
