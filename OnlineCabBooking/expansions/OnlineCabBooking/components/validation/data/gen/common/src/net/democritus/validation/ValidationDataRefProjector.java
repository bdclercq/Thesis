...
public class ValidationDataRefProjector implements IDataElementProjector<ValidationData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public ValidationDataRefProjector(ValidationCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<ValidationData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("validation");
    projection.setPackName("net.democritus.validation");
    projection.setClassName("Validation");
  ...
  // anchor:toData:start
  public void toData(ValidationData data, ParameterContext<DataRef> projectionParameter) {
