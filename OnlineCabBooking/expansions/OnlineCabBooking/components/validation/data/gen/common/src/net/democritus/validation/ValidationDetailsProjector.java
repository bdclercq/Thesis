...
public class ValidationDetailsProjector implements IDataElementProjector<ValidationData, ValidationDetails>, IDataProjectorRequired<ValidationDetails> {
  ...
  public ValidationDetailsProjector(ValidationCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public ValidationDetails project(ParameterContext<ValidationData> dataParameter) {

    ValidationDetails projection = new ValidationDetails();
  ...
  public void toData(ValidationData data, ParameterContext<ValidationDetails> projectionParameter) {
    // don't set the data id
    ValidationDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(ValidationDetails projection) {
  ...
  public Class<ValidationDetails> getProjectionClass() {
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<ValidationDetails> projectionParameter) {
