...
/**
 * Persistency pojo class for the entity Validation,
 */

@Entity(name=ValidationData.ENTITY_NAME)
// @anchor:annotations:start
@Table(name="Validation", schema="VALIDATION")
// @anchor:annotations:end
@NamedQueries({
  @NamedQuery(name=ValidationData.QUERY_FINDALL, query="select o FROM " + ValidationData.ENTITY_NAME + " o")
  // @anchor:queries:start
  // @anchor:queries:end
  // anchor:custom-queries:start
  // anchor:custom-queries:end
})
public class ValidationData implements java.io.Serializable {

  // @anchor:constants:start
  public static final String ENTITY_NAME = "net.democritus.validation.Validation";
  public static final String QUERY_FINDALL = "net.democritus.validation.Validation.findAll";
