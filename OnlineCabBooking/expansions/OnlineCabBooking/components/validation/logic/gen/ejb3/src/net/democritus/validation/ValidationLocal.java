...
/**
 * Local interface for the entity bean Validation,
 * representing a known Validation
 */
public interface ValidationLocal {
  ...
  ValidationInfo getInfo(Long id);
  ValidationDetails getDetails(DataRef dataRef);
  ValidationDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<ValidationDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<ValidationDetails> detailsParameter);
  ...
  CrudsResult<ValidationInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<ValidationDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<ValidationDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends ValidationFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
