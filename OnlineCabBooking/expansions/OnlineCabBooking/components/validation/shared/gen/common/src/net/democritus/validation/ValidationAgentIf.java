...
/**
 * interface for the entity bean ValidationBean,
 * representing a known Validation
 */
public interface ValidationAgentIf {
  ...
  CrudsResult<DataRef> create(ValidationDetails validationDetails);
  CrudsResult<DataRef> modify(ValidationDetails validationDetails);
  ...
  CrudsResult<ValidationDetails> getDetails(DataRef dataRef);
  ...
  <S extends ValidationFindDetails, T> SearchResult<T> find(SearchDetails<S> searchDetails);
  // anchor:search-methods:end

  // anchor:data-only-methods:start
  CrudsResult<ValidationDetails> getDetails(Long validationId);
  CrudsResult<DataRef> getDataRef(String name);

  SearchResult<DataRef> findAllDataRefs();
  SearchResult<ValidationInfo> findAllInfos();
