...
/**
 * Transport detailed class for the entity bean Validation,
 */
...
public class ValidationDetails
  ...
  public ValidationDetails(Long id
  ...
  public String getElementPackage() {
    return "net.democritus.validation";
  }
  ...
  public DataRef getDataRef() {
    return new DataRef(mId, mName, "validation", "net.democritus.validation", "Validation");
  }
}
