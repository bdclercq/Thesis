...
define(function (require) {
  ...
  var ValidationSorting = require('validation/validation/validation-sorting');
  var ValidationInfoModel = require('validation/validation/validation-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ValidationSorting.defineSorting();
    var dataUpdate = ValidationEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ValidationInfoModel
    });

    var infoListView = "validation/validation-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
