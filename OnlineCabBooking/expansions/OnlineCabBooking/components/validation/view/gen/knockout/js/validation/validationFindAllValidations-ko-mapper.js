...
define(function(require) {
  ...
  var validationFindAllValidationsElement = nsxApplication.getElement("validation", "validationFindAllValidations");
  ...
  function jsToFormModel(validationFindAllValidations, fieldFilter) {
    var detailModel = jsToViewModel(validationFindAllValidations);
    var form = {
  ...
  function jsToViewModel(validationFindAllValidations) {
    var validationFindAllValidationsViewModel = {
    ...
    return validationFindAllValidationsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(validationFindAllValidationsViewModel) {
    var jsData = {
  ...
  var validationFindAllValidationsMapper = {
  ...
  return validationFindAllValidationsMapper;
});
