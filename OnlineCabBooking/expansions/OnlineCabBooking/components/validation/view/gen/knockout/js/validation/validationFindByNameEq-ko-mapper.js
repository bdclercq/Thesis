...
define(function(require) {
  ...
  var validationFindByNameEqElement = nsxApplication.getElement("validation", "validationFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "validation.ValidationFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(validationFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(validationFindByNameEq);
    var form = {
  ...
  function jsToViewModel(validationFindByNameEq) {
    var validationFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(validationFindByNameEq.name),
    ...
    return validationFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(validationFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: validationFindByNameEqViewModel.name(),
  ...
  var validationFindByNameEqMapper = {
  ...
  return validationFindByNameEqMapper;
});
