...
import net.democritus.wfe.EngineNodeFindDetails;
...
public class EngineNodeFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.wfe.action.EngineNodeFindAction");

  private SearchDetails<? extends EngineNodeFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.wfe", "EngineNode", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    EngineNodeAgent engineNodeAgent = createEngineNodeAgent();
    ...
    searchResult = engineNodeAgent.find(searchDetails);
  ...
  private EngineNodeAgent createEngineNodeAgent() {
