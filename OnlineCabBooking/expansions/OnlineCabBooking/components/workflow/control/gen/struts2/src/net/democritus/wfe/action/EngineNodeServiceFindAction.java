...
import net.democritus.wfe.EngineNodeServiceFindDetails;
...
public class EngineNodeServiceFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.wfe.action.EngineNodeServiceFindAction");

  private SearchDetails<? extends EngineNodeServiceFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.wfe", "EngineNodeService", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    EngineNodeServiceAgent engineNodeServiceAgent = createEngineNodeServiceAgent();
    ...
    searchResult = engineNodeServiceAgent.find(searchDetails);
  ...
  private EngineNodeServiceAgent createEngineNodeServiceAgent() {
