...
import net.democritus.wfe.EngineServiceFindDetails;
...
public class EngineServiceFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.wfe.action.EngineServiceFindAction");

  private SearchDetails<? extends EngineServiceFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.wfe", "EngineService", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    EngineServiceAgent engineServiceAgent = createEngineServiceAgent();
    ...
    searchResult = engineServiceAgent.find(searchDetails);
  ...
  private EngineServiceAgent createEngineServiceAgent() {
