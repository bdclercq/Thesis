...
public class EngineServiceImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(EngineServiceImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    EngineServiceAgent engineServiceAgent = EngineServiceAgent.getEngineServiceAgent(ContextRetriever.getContext());
    result = engineServiceAgent.importFile(importFile);
