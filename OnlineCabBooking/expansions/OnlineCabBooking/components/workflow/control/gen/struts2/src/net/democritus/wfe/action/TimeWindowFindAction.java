...
import net.democritus.wfe.TimeWindowFindDetails;
...
public class TimeWindowFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.wfe.action.TimeWindowFindAction");

  private SearchDetails<? extends TimeWindowFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.wfe", "TimeWindow", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    TimeWindowAgent timeWindowAgent = createTimeWindowAgent();
    ...
    searchResult = timeWindowAgent.find(searchDetails);
  ...
  private TimeWindowAgent createTimeWindowAgent() {
