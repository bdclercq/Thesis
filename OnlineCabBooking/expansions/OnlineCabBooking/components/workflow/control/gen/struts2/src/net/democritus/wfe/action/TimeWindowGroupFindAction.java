...
import net.democritus.wfe.TimeWindowGroupFindDetails;
...
public class TimeWindowGroupFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.wfe.action.TimeWindowGroupFindAction");

  private SearchDetails<? extends TimeWindowGroupFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.wfe", "TimeWindowGroup", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    TimeWindowGroupAgent timeWindowGroupAgent = createTimeWindowGroupAgent();
    ...
    searchResult = timeWindowGroupAgent.find(searchDetails);
  ...
  private TimeWindowGroupAgent createTimeWindowGroupAgent() {
