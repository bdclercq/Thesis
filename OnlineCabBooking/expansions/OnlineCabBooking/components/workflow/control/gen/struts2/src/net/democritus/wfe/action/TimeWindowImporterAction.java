...
public class TimeWindowImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(TimeWindowImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    TimeWindowAgent timeWindowAgent = TimeWindowAgent.getTimeWindowAgent(ContextRetriever.getContext());
    result = timeWindowAgent.importFile(importFile);
