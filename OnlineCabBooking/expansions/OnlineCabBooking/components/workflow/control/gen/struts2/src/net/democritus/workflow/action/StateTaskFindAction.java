...
import net.democritus.workflow.StateTaskFindDetails;
...
public class StateTaskFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.workflow.action.StateTaskFindAction");

  private SearchDetails<? extends StateTaskFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.workflow", "StateTask", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    StateTaskAgent stateTaskAgent = createStateTaskAgent();
    ...
    searchResult = stateTaskAgent.find(searchDetails);
  ...
  private StateTaskAgent createStateTaskAgent() {
