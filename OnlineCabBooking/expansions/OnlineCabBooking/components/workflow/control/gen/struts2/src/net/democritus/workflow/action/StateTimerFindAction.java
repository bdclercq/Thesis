...
import net.democritus.workflow.StateTimerFindDetails;
...
public class StateTimerFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.workflow.action.StateTimerFindAction");

  private SearchDetails<? extends StateTimerFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.workflow", "StateTimer", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    StateTimerAgent stateTimerAgent = createStateTimerAgent();
    ...
    searchResult = stateTimerAgent.find(searchDetails);
  ...
  private StateTimerAgent createStateTimerAgent() {
