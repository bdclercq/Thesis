...
import net.democritus.workflow.TimeTaskFindDetails;
...
public class TimeTaskFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.workflow.action.TimeTaskFindAction");

  private SearchDetails<? extends TimeTaskFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.workflow", "TimeTask", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    TimeTaskAgent timeTaskAgent = createTimeTaskAgent();
    ...
    searchResult = timeTaskAgent.find(searchDetails);
  ...
  private TimeTaskAgent createTimeTaskAgent() {
