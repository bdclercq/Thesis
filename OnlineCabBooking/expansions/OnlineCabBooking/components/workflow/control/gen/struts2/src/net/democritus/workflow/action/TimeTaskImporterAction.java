...
public class TimeTaskImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(TimeTaskImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    TimeTaskAgent timeTaskAgent = TimeTaskAgent.getTimeTaskAgent(ContextRetriever.getContext());
    result = timeTaskAgent.importFile(importFile);
