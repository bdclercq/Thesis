...
import net.democritus.workflow.WorkflowFindDetails;
...
public class WorkflowFindAction extends ActionSupport implements Preparable {

  private static final long serialVersionUID = 1L;

  @SuppressWarnings("unused")
  private static Logger logger = LoggerFactory.getLogger("net.democritus.workflow.action.WorkflowFindAction");

  private SearchDetails<? extends WorkflowFindDetails> searchDetails;
  ...
  public void prepare() throws Exception {
    ...
    Option<Class> optClazz = getFinderClass("net.democritus.workflow", "Workflow", searchMethod);
    if (optClazz.isEmpty()) {
  ...
  public String execute() throws Exception {
    ...
    searchResult = workflowAgent.find(searchDetails);
  ...
  private WorkflowAgent createWorkflowAgent() {
