...
public class WorkflowImporterAction extends ActionSupport {
  private static final Logger logger = LoggerFactory.getLogger(WorkflowImporterAction.class);
  ...
  public String execute() throws Exception {
    ...
    WorkflowAgent workflowAgent = WorkflowAgent.getWorkflowAgent(ContextRetriever.getContext());
    result = workflowAgent.importFile(importFile);
