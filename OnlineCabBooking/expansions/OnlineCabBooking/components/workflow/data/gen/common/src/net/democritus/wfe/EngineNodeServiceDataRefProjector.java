...
public class EngineNodeServiceDataRefProjector implements IDataElementProjector<EngineNodeServiceData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public EngineNodeServiceDataRefProjector(EngineNodeServiceCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<EngineNodeServiceData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("workflow");
    projection.setPackName("net.democritus.wfe");
    projection.setClassName("EngineNodeService");
  ...
  // anchor:toData:start
  public void toData(EngineNodeServiceData data, ParameterContext<DataRef> projectionParameter) {
