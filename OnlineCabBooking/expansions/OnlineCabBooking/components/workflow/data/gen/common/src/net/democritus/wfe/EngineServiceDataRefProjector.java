...
public class EngineServiceDataRefProjector implements IDataElementProjector<EngineServiceData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  public EngineServiceDataRefProjector(EngineServiceCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  // anchor:project:start
  public DataRef project(ParameterContext<EngineServiceData> dataParameter) {

    DataRef projection = DataRef.withId(0L);
    projection.setComponentName("workflow");
    projection.setPackName("net.democritus.wfe");
    projection.setClassName("EngineService");
  ...
  // anchor:toData:start
  public void toData(EngineServiceData data, ParameterContext<DataRef> projectionParameter) {
