...
public class TimeWindowGroupDetailsProjector implements IDataElementProjector<TimeWindowGroupData, TimeWindowGroupDetails>, IDataProjectorRequired<TimeWindowGroupDetails> {
  ...
  public TimeWindowGroupDetailsProjector(TimeWindowGroupCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public TimeWindowGroupDetails project(ParameterContext<TimeWindowGroupData> dataParameter) {

    TimeWindowGroupDetails projection = new TimeWindowGroupDetails();
  ...
  public void toData(TimeWindowGroupData data, ParameterContext<TimeWindowGroupDetails> projectionParameter) {
    // don't set the data id
    TimeWindowGroupDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(TimeWindowGroupDetails projection) {
  ...
  public Class<TimeWindowGroupDetails> getProjectionClass() {
    return TimeWindowGroupDetails.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<TimeWindowGroupDetails> projectionParameter) {
