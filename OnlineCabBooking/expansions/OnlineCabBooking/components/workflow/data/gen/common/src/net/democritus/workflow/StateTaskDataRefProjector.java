...
public class StateTaskDataRefProjector implements IDataElementProjector<StateTaskData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(StateTaskData data, ParameterContext<DataRef> projectionParameter) {
