...
public class StateTaskDetailsProjector implements IDataElementProjector<StateTaskData, StateTaskDetails>, IDataProjectorRequired<StateTaskDetails> {
  ...
  public StateTaskDetailsProjector(StateTaskCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public StateTaskDetails project(ParameterContext<StateTaskData> dataParameter) {

    StateTaskDetails projection = new StateTaskDetails();
  ...
  public void toData(StateTaskData data, ParameterContext<StateTaskDetails> projectionParameter) {
    // don't set the data id
    StateTaskDetails projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(StateTaskDetails projection) {
  ...
  public Class<StateTaskDetails> getProjectionClass() {
    return StateTaskDetails.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<StateTaskDetails> projectionParameter) {
