...
public class StateTaskInfoProjector implements IDataElementProjector<StateTaskData, StateTaskInfo>, IDataProjectorRequired<StateTaskInfo> {
  ...
  public StateTaskInfoProjector(StateTaskCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public StateTaskInfo project(ParameterContext<StateTaskData> dataParameter) {

    StateTaskInfo projection = new StateTaskInfo();
  ...
  public void toData(StateTaskData data, ParameterContext<StateTaskInfo> projectionParameter) {
    // don't set the data id
    StateTaskInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(StateTaskInfo projection) {
  ...
  public Class<StateTaskInfo> getProjectionClass() {
    return StateTaskInfo.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<StateTaskInfo> projectionParameter) {
