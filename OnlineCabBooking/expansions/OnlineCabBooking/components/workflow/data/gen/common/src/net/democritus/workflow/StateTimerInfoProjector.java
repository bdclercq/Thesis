...
public class StateTimerInfoProjector implements IDataElementProjector<StateTimerData, StateTimerInfo>, IDataProjectorRequired<StateTimerInfo> {
  ...
  public StateTimerInfoProjector(StateTimerCrudsInternal crudsInternal) {
    this.crudsInternal = crudsInternal;
  }

  public StateTimerInfo project(ParameterContext<StateTimerData> dataParameter) {

    StateTimerInfo projection = new StateTimerInfo();
  ...
  public void toData(StateTimerData data, ParameterContext<StateTimerInfo> projectionParameter) {
    // don't set the data id
    StateTimerInfo projection = projectionParameter.getValue();
  ...
  public DataRef getDataRef(StateTimerInfo projection) {
  ...
  public Class<StateTimerInfo> getProjectionClass() {
    return StateTimerInfo.class;
  }
  ...
  public CrudsResult<Void> checkRequired(ParameterContext<StateTimerInfo> projectionParameter) {
