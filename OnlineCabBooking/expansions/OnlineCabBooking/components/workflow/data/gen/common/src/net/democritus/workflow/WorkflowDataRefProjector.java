...
public class WorkflowDataRefProjector implements IDataElementProjector<WorkflowData, DataRef>, IDataProjectorRequired<DataRef> {
  ...
  // anchor:toData:start
  public void toData(WorkflowData data, ParameterContext<DataRef> projectionParameter) {
