...
public interface EngineNodeServiceCrudsLocal {
  ...
  <S extends EngineNodeServiceFindDetails, P> SearchResult<P> find(ParameterContext<SearchDetails<S>> searchParameter);
