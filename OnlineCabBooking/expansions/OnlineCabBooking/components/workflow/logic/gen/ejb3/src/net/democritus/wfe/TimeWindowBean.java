...
import net.democritus.wfe.TimeWindowCsvImporterImpl;
...
@Remote(TimeWindowRemote.class)
@Local(TimeWindowLocal.class)
// @anchor:annotations:end
@DeclareRoles({
// anchor:custom-declare-roles:start
// anchor:custom-declare-roles:end
})
public class TimeWindowBean /*@anchor:interfaces:start@*/implements TimeWindowRemote, TimeWindowLocal/*@anchor:interfaces:end@*/{
  ...
  private static final Logger logger = LoggerFactory.getLogger(TimeWindowBean.class);
  @Deprecated
  @PersistenceContext(unitName="OnlineCabBooking_workflow")
  private EntityManager entityManager;

  @EJB
  TimeWindowCrudsLocal timeWindowCrudsLocal;
  ...
  public CrudsResult<DataRef> create(ParameterContext<TimeWindowDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = timeWindowCrudsLocal.create(context.withParameter(details));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<TimeWindowDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = timeWindowCrudsLocal.modify(context.withParameter(details));
    if (result.isError()) {
      return result;
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    CrudsResult<DataRef> result = timeWindowCrudsLocal.createOrModify(projectionParameter);
    if (result.isError()) {
      return result;
    }
  ...
  public CrudsResult<Void> delete(ParameterContext<Long> idParameter) {
    ...
    try {
      ...
      CrudsResult<Void> result = timeWindowCrudsLocal.delete(context.withParameter(dataRef));
  ...
  public CrudsResult<DataRef> getId(ParameterContext<String> nameParameter) {
    return timeWindowCrudsLocal.getDataRefFromName(nameParameter);
  }

  public CrudsResult<String> getName(ParameterContext<Long> idParameter) {
    // @anchor:before-getName:start
    // @anchor:before-getName:end
    CrudsResult<DataRef> dataRefResult = timeWindowCrudsLocal.getDataRefFromId(idParameter);
  ...
  public DataRef getDataRef(Long id) {
    return timeWindowCrudsLocal.getDataRefFromId(ParameterContext.create(null, id)).getValue();
  }

  @Deprecated
  public TimeWindowInfo getInfo(Long id) {
    return getInfo(ParameterContext.create(null, id)).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public TimeWindowDetails getDetails(Long id) {
    return getDetailsFromDataRef(ParameterContext.create(null, idToDataRef(id))).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public TimeWindowDetails getDetails(DataRef dataRef) {
  ...
  public CrudsResult<DataRef> getDataRef(ParameterContext<Long> idParameter) {
    return timeWindowCrudsLocal.getDataRefFromId(idParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    return timeWindowCrudsLocal.resolveDataRef(dataRefParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<TimeWindowInfo> getInfo(ParameterContext<Long> idParameter) {
    DataRef dataRef = idToDataRef(idParameter.getValue());
  ...
  public CrudsResult<TimeWindowDetails> getDetails(ParameterContext<Long> idParameter) {
    ...
    CrudsResult<TimeWindowDetails> result = getDetailsFromDataRef(idParameter.construct(dataRef));
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<TimeWindowDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRefParameter) {
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    result = timeWindowCrudsLocal.getProjection(projectionRefParameter);
  ...
  public <S extends TimeWindowFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    ...
    result = timeWindowCrudsLocal.find(searchParameter);
  ...
  public ImportResult importFile(ParameterContext<ImportFile> parameter) {
    ...
    // @anchor:import-implementations:start
      ...
      importResult = new TimeWindowCsvImporterImpl().importFile(parameter);
