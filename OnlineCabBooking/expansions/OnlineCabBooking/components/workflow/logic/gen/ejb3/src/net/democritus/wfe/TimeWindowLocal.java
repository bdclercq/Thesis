...
/**
 * Local interface for the entity bean TimeWindow,
 * representing a known TimeWindow
 */
public interface TimeWindowLocal {
  ...
  TimeWindowInfo getInfo(Long id);
  TimeWindowDetails getDetails(DataRef dataRef);
  TimeWindowDetails getDetails(Long id);
