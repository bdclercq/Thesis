...
import net.democritus.workflow.StateTaskCsvImporterImpl;
...
@Remote(StateTaskRemote.class)
@Local(StateTaskLocal.class)
// @anchor:annotations:end
@DeclareRoles({
// anchor:custom-declare-roles:start
// anchor:custom-declare-roles:end
})
public class StateTaskBean /*@anchor:interfaces:start@*/implements StateTaskRemote, StateTaskLocal/*@anchor:interfaces:end@*/{
  ...
  private static final Logger logger = LoggerFactory.getLogger(StateTaskBean.class);
  @Deprecated
  @PersistenceContext(unitName="OnlineCabBooking_workflow")
  private EntityManager entityManager;

  @EJB
  StateTaskCrudsLocal stateTaskCrudsLocal;
  ...
  public CrudsResult<DataRef> create(ParameterContext<StateTaskDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = stateTaskCrudsLocal.create(context.withParameter(details));
  ...
  public CrudsResult<DataRef> modify(ParameterContext<StateTaskDetails> detailsParameter) {
    ...
    CrudsResult<DataRef> result = stateTaskCrudsLocal.modify(context.withParameter(details));
    if (result.isError()) {
      return result;
    }
  ...
  public <P> CrudsResult<DataRef> createOrModify(ParameterContext<P> projectionParameter) {
    ...
    CrudsResult<DataRef> result = stateTaskCrudsLocal.createOrModify(projectionParameter);
    if (result.isError()) {
      return result;
    }
  ...
  public CrudsResult<Void> delete(ParameterContext<Long> idParameter) {
    ...
    try {
      ...
      CrudsResult<Void> result = stateTaskCrudsLocal.delete(context.withParameter(dataRef));
  ...
  public CrudsResult<DataRef> getId(ParameterContext<String> nameParameter) {
    return stateTaskCrudsLocal.getDataRefFromName(nameParameter);
  }

  public CrudsResult<String> getName(ParameterContext<Long> idParameter) {
    // @anchor:before-getName:start
    // @anchor:before-getName:end
    CrudsResult<DataRef> dataRefResult = stateTaskCrudsLocal.getDataRefFromId(idParameter);
  ...
  public DataRef getDataRef(Long id) {
    return stateTaskCrudsLocal.getDataRefFromId(ParameterContext.create(null, id)).getValue();
  }

  @Deprecated
  public StateTaskInfo getInfo(Long id) {
    return getInfo(ParameterContext.create(null, id)).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public StateTaskDetails getDetails(Long id) {
    return getDetailsFromDataRef(ParameterContext.create(null, idToDataRef(id))).getValue();
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public StateTaskDetails getDetails(DataRef dataRef) {
  ...
  public CrudsResult<DataRef> getDataRef(ParameterContext<Long> idParameter) {
    return stateTaskCrudsLocal.getDataRefFromId(idParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<DataRef> resolveDataRef(ParameterContext<DataRef> dataRefParameter) {
    return stateTaskCrudsLocal.resolveDataRef(dataRefParameter);
  }

  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<StateTaskInfo> getInfo(ParameterContext<Long> idParameter) {
    DataRef dataRef = idToDataRef(idParameter.getValue());
  ...
  public CrudsResult<StateTaskDetails> getDetails(ParameterContext<Long> idParameter) {
    ...
    CrudsResult<StateTaskDetails> result = getDetailsFromDataRef(idParameter.construct(dataRef));
  ...
  @TransactionAttribute(TransactionAttributeType.SUPPORTS)
  public CrudsResult<StateTaskDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRefParameter) {
  ...
  public <T> CrudsResult<T> getProjection(ParameterContext<ProjectionRef> projectionRefParameter) {
    ...
    result = stateTaskCrudsLocal.getProjection(projectionRefParameter);
  ...
  public <S extends StateTaskFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter) {
    ...
    result = stateTaskCrudsLocal.find(searchParameter);
  ...
  public ImportResult importFile(ParameterContext<ImportFile> parameter) {
    ...
    // @anchor:import-implementations:start
      ...
      importResult = new StateTaskCsvImporterImpl().importFile(parameter);
