...
/**
 * Local interface for the entity bean StateTask,
 * representing a known StateTask
 */
public interface StateTaskLocal {
  ...
  StateTaskInfo getInfo(Long id);
  StateTaskDetails getDetails(DataRef dataRef);
  StateTaskDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<StateTaskDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<StateTaskDetails> detailsParameter);
  ...
  CrudsResult<StateTaskInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<StateTaskDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<StateTaskDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends StateTaskFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
  ...
  SearchResult<StateTaskDetails> getStateTasksByWorkflowId(ParameterContext<Long> workflowIdParameter);
