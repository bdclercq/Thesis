...
/**
 * Local interface for the entity bean StateTimer,
 * representing a known StateTimer
 */
public interface StateTimerLocal {
  ...
  StateTimerInfo getInfo(Long id);
  StateTimerDetails getDetails(DataRef dataRef);
  StateTimerDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<StateTimerDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<StateTimerDetails> detailsParameter);
  ...
  CrudsResult<StateTimerInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<StateTimerDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<StateTimerDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends StateTimerFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
