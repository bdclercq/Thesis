...
/**
 * Local interface for the entity bean TimeTask,
 * representing a known TimeTask
 */
public interface TimeTaskLocal {
  ...
  TimeTaskInfo getInfo(Long id);
  TimeTaskDetails getDetails(DataRef dataRef);
  TimeTaskDetails getDetails(Long id);

  // anchor:crud-methods:start
  CrudsResult<DataRef> create(ParameterContext<TimeTaskDetails> detailsParameter);
  CrudsResult<DataRef> modify(ParameterContext<TimeTaskDetails> detailsParameter);
  ...
  CrudsResult<TimeTaskInfo> getInfo(ParameterContext<Long> idParameter);
  CrudsResult<TimeTaskDetails> getDetails(ParameterContext<Long> idParameter);
  ...
  CrudsResult<TimeTaskDetails> getDetailsFromDataRef(ParameterContext<DataRef> dataRef);
  ...
  <S extends TimeTaskFindDetails, T> SearchResult<T> find(ParameterContext<SearchDetails<S>> searchParameter);
