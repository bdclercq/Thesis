...
public class TimeWindowGroupDataRefConverter implements IConverter<DataRef> {
  ...
  public Result<DataRef> fromString(String value) {
    try {
      ...
      if (value == null || value.isEmpty()) {
        ...
        result = Result.success(new DataRef(0L, value, "workflow", "net.democritus.wfe", "TimeWindowGroup"));
      }
