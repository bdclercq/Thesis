...
/**
 * Transport detailed class for the entity bean TimeWindow,
 */

public class TimeWindowInfo
  ...
  public List<String> getFieldOrder() {
    ...
    fieldOrder.add("Name");
    fieldOrder.add("StartTime");
    fieldOrder.add("StopTime");
    // anchor:field-order:end
    return fieldOrder;
  }

  public DataRef getDataRef() {
    return new DataRef(mId, mName, "workflow", "net.democritus.wfe", "TimeWindow");
  }
}
