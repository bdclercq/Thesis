...
define(function(require) {
  ...
  var engineNodeFindAllEngineNodesElement = nsxApplication.getElement("workflow", "engineNodeFindAllEngineNodes");
  ...
  function jsToFormModel(engineNodeFindAllEngineNodes, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeFindAllEngineNodes);
    var form = {
  ...
  function jsToViewModel(engineNodeFindAllEngineNodes) {
    var engineNodeFindAllEngineNodesViewModel = {
    ...
    return engineNodeFindAllEngineNodesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeFindAllEngineNodesViewModel) {
    var jsData = {
  ...
  var engineNodeFindAllEngineNodesMapper = {
  ...
  return engineNodeFindAllEngineNodesMapper;
});
