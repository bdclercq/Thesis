...
define(function (require) {
  ...
  var EngineNodeServiceSorting = require('workflow/engineNodeService/engineNodeService-sorting');
  var EngineNodeServiceInfoModel = require('workflow/engineNodeService/engineNodeService-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = EngineNodeServiceSorting.defineSorting();
    var dataUpdate = EngineNodeServiceEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: EngineNodeServiceInfoModel
    });

    var infoListView = "workflow/engineNodeService-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
