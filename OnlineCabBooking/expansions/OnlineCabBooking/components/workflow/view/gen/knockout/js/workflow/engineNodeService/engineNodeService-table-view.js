...
define(function (require) {
  ...
  var EngineNodeServiceFinders = require('workflow/engineNodeService/engineNodeService-finders');
  var EngineNodeServiceStdTable = require('workflow/engineNodeService/engineNodeService-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = EngineNodeServiceFinders.finderWith(constantFields);
    var finderOptions = EngineNodeServiceFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = EngineNodeServiceEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineEngineNodeServiceList(widget, input) {
    return EngineNodeServiceStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: EngineNodeServiceEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: EngineNodeServiceEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: EngineNodeServiceEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: EngineNodeServiceEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: EngineNodeServiceEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var engineNodeServiceList = defineEngineNodeServiceList(widget, listOptions);

    tableContext.selection = engineNodeServiceList.selection;
    ...
    var pagination = definePagination(toolbar, engineNodeServiceList.listModel);
    ...
    return {
      injector: widget,
      selection: engineNodeServiceList.selection
    };
  }
