...
define(function(require) {
  ...
  var engineNodeServiceFindByEngineNodeEqElement = nsxApplication.getElement("workflow", "engineNodeServiceFindByEngineNodeEq");
  ...
  var fieldOptions = {
    ...
    engineNode: {
      ...
      key: "workflow.EngineNodeServiceFindByEngineNodeEq.engineNode",
      isValueType: false
    }
  ...
  function jsToFormModel(engineNodeServiceFindByEngineNodeEq, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeServiceFindByEngineNodeEq);
    var form = {
  ...
  function jsToViewModel(engineNodeServiceFindByEngineNodeEq) {
    var engineNodeServiceFindByEngineNodeEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      engineNode: ko.observable(engineNodeServiceFindByEngineNodeEq.engineNode),
    ...
    return engineNodeServiceFindByEngineNodeEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeServiceFindByEngineNodeEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      engineNode: engineNodeServiceFindByEngineNodeEqViewModel.engineNode(),
  ...
  var engineNodeServiceFindByEngineNodeEqMapper = {
  ...
  return engineNodeServiceFindByEngineNodeEqMapper;
});
