...
define(function(require) {
  ...
  var engineServiceFindByCollectorEqElement = nsxApplication.getElement("workflow", "engineServiceFindByCollectorEq");
  ...
  var fieldOptions = {
    ...
    collector: {
      ...
      key: "workflow.EngineServiceFindByCollectorEq.collector",
      isValueType: false
    }
  ...
  function jsToFormModel(engineServiceFindByCollectorEq, fieldFilter) {
    var detailModel = jsToViewModel(engineServiceFindByCollectorEq);
    var form = {
  ...
  function jsToViewModel(engineServiceFindByCollectorEq) {
    var engineServiceFindByCollectorEqViewModel = {
      // anchor:value-fields-to-model:start
      collector: ko.observable(engineServiceFindByCollectorEq.collector),
    ...
    return engineServiceFindByCollectorEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineServiceFindByCollectorEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      collector: engineServiceFindByCollectorEqViewModel.collector(),
  ...
  var engineServiceFindByCollectorEqMapper = {
  ...
  return engineServiceFindByCollectorEqMapper;
});
