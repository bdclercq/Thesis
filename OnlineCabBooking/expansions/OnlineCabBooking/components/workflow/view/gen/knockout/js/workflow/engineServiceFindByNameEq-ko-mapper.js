...
define(function(require) {
  ...
  var engineServiceFindByNameEqElement = nsxApplication.getElement("workflow", "engineServiceFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.EngineServiceFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(engineServiceFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(engineServiceFindByNameEq);
    var form = {
  ...
  function jsToViewModel(engineServiceFindByNameEq) {
    var engineServiceFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(engineServiceFindByNameEq.name),
    ...
    return engineServiceFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineServiceFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: engineServiceFindByNameEqViewModel.name(),
  ...
  var engineServiceFindByNameEqMapper = {
  ...
  return engineServiceFindByNameEqMapper;
});
