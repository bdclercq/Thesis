...
define(function (require) {
  ...
  const StateTaskActions = require('workflow/stateTask/stateTask-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = StateTaskEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = StateTaskActions.deleteMultipleAction();
