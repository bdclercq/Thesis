...
define(function (require) {
  ...
  var StateTaskFinders = require('workflow/stateTask/stateTask-finders');
  var StateTaskStdTable = require('workflow/stateTask/stateTask-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = StateTaskFinders.finderWith(constantFields);
    var finderOptions = StateTaskFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = StateTaskEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineStateTaskList(widget, input) {
    return StateTaskStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: StateTaskEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: StateTaskEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: StateTaskEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: StateTaskEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: StateTaskEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var stateTaskList = defineStateTaskList(widget, listOptions);

    tableContext.selection = stateTaskList.selection;
    ...
    var pagination = definePagination(toolbar, stateTaskList.listModel);
    ...
    return {
      injector: widget,
      selection: stateTaskList.selection
    };
  }
