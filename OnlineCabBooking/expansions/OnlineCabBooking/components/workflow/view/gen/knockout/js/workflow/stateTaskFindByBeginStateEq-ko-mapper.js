...
define(function(require) {
  ...
  var stateTaskFindByBeginStateEqElement = nsxApplication.getElement("workflow", "stateTaskFindByBeginStateEq");
  ...
  var fieldOptions = {
    ...
    beginState: {
      ...
      key: "workflow.StateTaskFindByBeginStateEq.beginState",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTaskFindByBeginStateEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTaskFindByBeginStateEq);
    var form = {
  ...
  function jsToViewModel(stateTaskFindByBeginStateEq) {
    var stateTaskFindByBeginStateEqViewModel = {
      // anchor:value-fields-to-model:start
      beginState: ko.observable(stateTaskFindByBeginStateEq.beginState),
    ...
    return stateTaskFindByBeginStateEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTaskFindByBeginStateEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      beginState: stateTaskFindByBeginStateEqViewModel.beginState(),
  ...
  var stateTaskFindByBeginStateEqMapper = {
  ...
  return stateTaskFindByBeginStateEqMapper;
});
