...
define(function(require) {
  ...
  var stateTaskFindByFailedStateEqElement = nsxApplication.getElement("workflow", "stateTaskFindByFailedStateEq");
  ...
  var fieldOptions = {
    ...
    failedState: {
      ...
      key: "workflow.StateTaskFindByFailedStateEq.failedState",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTaskFindByFailedStateEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTaskFindByFailedStateEq);
    var form = {
  ...
  function jsToViewModel(stateTaskFindByFailedStateEq) {
    var stateTaskFindByFailedStateEqViewModel = {
      // anchor:value-fields-to-model:start
      failedState: ko.observable(stateTaskFindByFailedStateEq.failedState),
    ...
    return stateTaskFindByFailedStateEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTaskFindByFailedStateEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      failedState: stateTaskFindByFailedStateEqViewModel.failedState(),
  ...
  var stateTaskFindByFailedStateEqMapper = {
  ...
  return stateTaskFindByFailedStateEqMapper;
});
