...
define(function(require) {
  ...
  var stateTaskFindByWorkflowEqElement = nsxApplication.getElement("workflow", "stateTaskFindByWorkflowEq");
  ...
  var fieldOptions = {
    ...
    workflow: {
      ...
      key: "workflow.StateTaskFindByWorkflowEq.workflow",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTaskFindByWorkflowEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTaskFindByWorkflowEq);
    var form = {
  ...
  function jsToViewModel(stateTaskFindByWorkflowEq) {
    var stateTaskFindByWorkflowEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      workflow: ko.observable(stateTaskFindByWorkflowEq.workflow),
  ...
  var stateTaskFindByWorkflowEqMapper = {
  ...
  return stateTaskFindByWorkflowEqMapper;
});
