...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) StateTimer!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = StateTimerEvents.defineViewIntentListener();

      var config = {
        title: 'StateTimer',
        projection: 'details',
        projector: 'workflow/stateTimer/stateTimer-projector',
        modeller: 'workflow/stateTimer/stateTimer-details-instance-model',
        view: 'workflow/stateTimer-details-instance'
      };
