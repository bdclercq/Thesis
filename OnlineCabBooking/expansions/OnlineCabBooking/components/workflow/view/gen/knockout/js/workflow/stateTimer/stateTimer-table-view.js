...
define(function (require) {
  ...
  var StateTimerFinders = require('workflow/stateTimer/stateTimer-finders');
  var StateTimerStdTable = require('workflow/stateTimer/stateTimer-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = StateTimerFinders.finderWith(constantFields);
    var finderOptions = StateTimerFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = StateTimerEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineStateTimerList(widget, input) {
    return StateTimerStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: StateTimerEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: StateTimerEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: StateTimerEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: StateTimerEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: StateTimerEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var stateTimerList = defineStateTimerList(widget, listOptions);

    tableContext.selection = stateTimerList.selection;
    ...
    var pagination = definePagination(toolbar, stateTimerList.listModel);
    ...
    return {
      injector: widget,
      selection: stateTimerList.selection
    };
  }
