...
define(function(require) {
  ...
  var stateTimerFindByNameEqElement = nsxApplication.getElement("workflow", "stateTimerFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.StateTimerFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTimerFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTimerFindByNameEq);
    var form = {
  ...
  function jsToViewModel(stateTimerFindByNameEq) {
    var stateTimerFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(stateTimerFindByNameEq.name),
    ...
    return stateTimerFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTimerFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: stateTimerFindByNameEqViewModel.name(),
  ...
  var stateTimerFindByNameEqMapper = {
  ...
  return stateTimerFindByNameEqMapper;
});
