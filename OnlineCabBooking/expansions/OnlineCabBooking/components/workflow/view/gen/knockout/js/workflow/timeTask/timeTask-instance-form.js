...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "workflow.TimeTask.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "workflow.TimeTask.name",
      isValueType: false
    },
    {
      fieldName: "processor",
      type: FieldType.VALUE,
      key: "workflow.TimeTask.processor",
      isValueType: false
    },
    {
      fieldName: "implementation",
      type: FieldType.VALUE,
      key: "workflow.TimeTask.implementation",
      isValueType: false
    },
    {
      fieldName: "params",
      type: FieldType.VALUE,
      key: "workflow.TimeTask.params",
      isValueType: false
    },
    {
      fieldName: "triggerState",
      type: FieldType.VALUE,
      key: "workflow.TimeTask.triggerState",
      isValueType: false
    },
    {
      fieldName: "intervalPeriod",
      type: FieldType.VALUE,
      key: "workflow.TimeTask.intervalPeriod",
      isValueType: false
    },
    {
      fieldName: "requiredAction",
      type: FieldType.VALUE,
      key: "workflow.TimeTask.requiredAction",
      isValueType: false
    },
    {
      fieldName: "workflow",
      type: FieldType.DATAREF,
      key: "workflow.TimeTask.workflow",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || TimeTaskActions.editAction();
