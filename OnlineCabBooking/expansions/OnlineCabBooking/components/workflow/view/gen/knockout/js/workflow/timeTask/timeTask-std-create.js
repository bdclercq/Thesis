...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) TimeTask element!")
    });

    function render() {
      var createIntent = TimeTaskEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: TimeTaskActions.createAction()
      };
