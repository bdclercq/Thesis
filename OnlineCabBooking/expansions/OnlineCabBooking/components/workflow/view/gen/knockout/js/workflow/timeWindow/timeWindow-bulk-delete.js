...
define(function (require) {
  ...
  const TimeWindowActions = require('workflow/timeWindow/timeWindow-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = TimeWindowEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = TimeWindowActions.deleteMultipleAction();
