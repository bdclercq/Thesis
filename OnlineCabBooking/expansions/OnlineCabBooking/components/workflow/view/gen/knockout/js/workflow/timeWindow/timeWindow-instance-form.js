...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "workflow.TimeWindow.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "workflow.TimeWindow.name",
      isValueType: false
    },
    {
      fieldName: "startTime",
      type: FieldType.VALUE,
      key: "workflow.TimeWindow.startTime",
      isValueType: false
    },
    {
      fieldName: "stopTime",
      type: FieldType.VALUE,
      key: "workflow.TimeWindow.stopTime",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || TimeWindowActions.editAction();
