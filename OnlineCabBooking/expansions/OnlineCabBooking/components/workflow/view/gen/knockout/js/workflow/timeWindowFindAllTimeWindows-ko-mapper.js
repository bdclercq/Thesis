...
define(function(require) {
  ...
  var timeWindowFindAllTimeWindowsElement = nsxApplication.getElement("workflow", "timeWindowFindAllTimeWindows");
  ...
  function jsToFormModel(timeWindowFindAllTimeWindows, fieldFilter) {
    var detailModel = jsToViewModel(timeWindowFindAllTimeWindows);
    var form = {
  ...
  function jsToViewModel(timeWindowFindAllTimeWindows) {
    var timeWindowFindAllTimeWindowsViewModel = {
    ...
    return timeWindowFindAllTimeWindowsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeWindowFindAllTimeWindowsViewModel) {
    var jsData = {
  ...
  var timeWindowFindAllTimeWindowsMapper = {
  ...
  return timeWindowFindAllTimeWindowsMapper;
});
