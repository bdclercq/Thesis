...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "workflow.TimeWindowGroup.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "workflow.TimeWindowGroup.name",
      isValueType: false
    },
    {
      fieldName: "visible",
      type: FieldType.VALUE,
      key: "workflow.TimeWindowGroup.visible",
      isValueType: false
    },
    {
      fieldName: "timeWindows",
      type: FieldType.LIST,
      key: "workflow.TimeWindowGroup.timeWindows",
      isValueType: false
    }
   ...
   *   action: TimeWindowGroupAction<any>
   * }} options
   * @return {{
   *    instance: NsxForm,
   *    submit: Trigger<void>
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || TimeWindowGroupActions.editAction();
