...
define(function (require) {
  ...
  var TimeWindowGroupTableView = require('workflow/timeWindowGroup/timeWindowGroup-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.TimeWindowGroup.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.TimeWindowGroup.menu.title");
    ...
    var table = TimeWindowGroupTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
