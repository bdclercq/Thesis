...
define(function (require) {
  ...
  var TimeWindowGroupProjector = require('workflow/timeWindowGroup/timeWindowGroup-projector');
  ...
  function defineEditDialog(options) {
    ...
    when(editRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to edit a(n) TimeWindowGroup element!")
    });

    function render() {
      var editIntent = TimeWindowGroupEvents.defineEditIntentListener();
      var showDialog = Trigger.defineTrigger();

      var constants = ko.observable();
      var selection = ko.observable();
      var formView = "workflow/timeWindowGroup-form";
      var title = "Edit TimeWindowGroup";
      var layoutConfig = initLayoutConfig(constants)
      var formOptions = {
        resetOn: editIntent,
        action: TimeWindowGroupActions.editAction()
      };

      var detailsProjection = TimeWindowGroupProjector.defineProjector(selection, {
        projection: "details"
      });
