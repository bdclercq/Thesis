...
define(function (require) {
  ...
  var TimeWindowGroupSorting = require('workflow/timeWindowGroup/timeWindowGroup-sorting');
  var TimeWindowGroupInfoModel = require('workflow/timeWindowGroup/timeWindowGroup-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = TimeWindowGroupSorting.defineSorting();
    var dataUpdate = TimeWindowGroupEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: TimeWindowGroupInfoModel
    });

    var infoListView = "workflow/timeWindowGroup-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
