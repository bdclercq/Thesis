...
define(function (require) {
  ...
  var TimeWindowGroupFinders = require('workflow/timeWindowGroup/timeWindowGroup-finders');
  var TimeWindowGroupStdTable = require('workflow/timeWindowGroup/timeWindowGroup-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = TimeWindowGroupFinders.finderWith(constantFields);
    var finderOptions = TimeWindowGroupFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = TimeWindowGroupEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineTimeWindowGroupList(widget, input) {
    return TimeWindowGroupStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TimeWindowGroupEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: TimeWindowGroupEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: TimeWindowGroupEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: TimeWindowGroupEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TimeWindowGroupEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var timeWindowGroupList = defineTimeWindowGroupList(widget, listOptions);

    tableContext.selection = timeWindowGroupList.selection;
    ...
    var pagination = definePagination(toolbar, timeWindowGroupList.listModel);
    ...
    return {
      injector: widget,
      selection: timeWindowGroupList.selection
    };
  }
