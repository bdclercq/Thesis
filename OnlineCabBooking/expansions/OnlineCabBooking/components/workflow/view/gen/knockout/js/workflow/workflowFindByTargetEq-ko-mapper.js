...
define(function(require) {
  ...
  var workflowFindByTargetEqElement = nsxApplication.getElement("workflow", "workflowFindByTargetEq");
  ...
  var fieldOptions = {
    ...
    target: {
      ...
      key: "workflow.WorkflowFindByTargetEq.target",
      isValueType: false
    }
  ...
  function jsToFormModel(workflowFindByTargetEq, fieldFilter) {
    var detailModel = jsToViewModel(workflowFindByTargetEq);
    var form = {
  ...
  function jsToViewModel(workflowFindByTargetEq) {
    var workflowFindByTargetEqViewModel = {
      // anchor:value-fields-to-model:start
      target: ko.observable(workflowFindByTargetEq.target),
    ...
    return workflowFindByTargetEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(workflowFindByTargetEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      target: workflowFindByTargetEqViewModel.target(),
  ...
  var workflowFindByTargetEqMapper = {
  ...
  return workflowFindByTargetEqMapper;
});
