...
define(function (require) {
  ...
  var AccountFinders = require('account/account/account-finders');
  var AccountStdTable = require('account/account/account-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = AccountFinders.finderWith(constantFields);
    var finderOptions = AccountFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = AccountEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineAccountList(widget, input) {
    return AccountStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: AccountEvents.defineCreateIntentTrigger({
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: AccountEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: AccountEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: AccountEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var accountList = defineAccountList(widget, listOptions);

    tableContext.selection = accountList.selection;
    ...
    var pagination = definePagination(toolbar, accountList.listModel);
