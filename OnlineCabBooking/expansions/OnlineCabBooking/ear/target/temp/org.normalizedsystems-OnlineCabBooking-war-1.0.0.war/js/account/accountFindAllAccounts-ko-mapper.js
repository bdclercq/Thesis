...
define(function(require) {
  ...
  var accountFindAllAccountsElement = nsxApplication.getElement("account", "accountFindAllAccounts");
  ...
  function jsToFormModel(accountFindAllAccounts, fieldFilter) {
    var detailModel = jsToViewModel(accountFindAllAccounts);
    var form = {
  ...
  function jsToViewModel(accountFindAllAccounts) {
    var accountFindAllAccountsViewModel = {
    ...
    return accountFindAllAccountsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(accountFindAllAccountsViewModel) {
    var jsData = {
  ...
  var accountFindAllAccountsMapper = {
  ...
  return accountFindAllAccountsMapper;
});
