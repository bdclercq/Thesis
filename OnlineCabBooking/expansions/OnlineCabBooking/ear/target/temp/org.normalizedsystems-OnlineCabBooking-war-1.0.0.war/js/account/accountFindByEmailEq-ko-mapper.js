...
define(function(require) {
  ...
  var accountFindByEmailEqElement = nsxApplication.getElement("account", "accountFindByEmailEq");
  ...
  var fieldOptions = {
    ...
    email: {
      ...
      key: "account.AccountFindByEmailEq.email",
      isValueType: false
    }
  ...
  function jsToFormModel(accountFindByEmailEq, fieldFilter) {
    var detailModel = jsToViewModel(accountFindByEmailEq);
    var form = {
  ...
  function jsToViewModel(accountFindByEmailEq) {
    var accountFindByEmailEqViewModel = {
      // anchor:value-fields-to-model:start
      email: ko.observable(accountFindByEmailEq.email),
    ...
    return accountFindByEmailEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(accountFindByEmailEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      email: accountFindByEmailEqViewModel.email(),
  ...
  var accountFindByEmailEqMapper = {
  ...
  return accountFindByEmailEqMapper;
});
