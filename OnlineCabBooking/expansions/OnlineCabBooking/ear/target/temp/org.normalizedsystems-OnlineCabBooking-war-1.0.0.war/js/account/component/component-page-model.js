...
define(function (require) {
  ...
  var ComponentTableView = require('account/component/component-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.Component.page.title")
    };
    var viewModel = {};
    var title = translate("account.Component.menu.title");
    ...
    var table = ComponentTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
