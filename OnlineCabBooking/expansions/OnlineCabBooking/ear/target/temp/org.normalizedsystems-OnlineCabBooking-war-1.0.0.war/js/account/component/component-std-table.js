...
define(function (require) {
  ...
  var ComponentSorting = require('account/component/component-sorting');
  var ComponentInfoModel = require('account/component/component-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ComponentSorting.defineSorting();
    var dataUpdate = ComponentEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ComponentInfoModel
    });

    var infoListView = "account/component-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
