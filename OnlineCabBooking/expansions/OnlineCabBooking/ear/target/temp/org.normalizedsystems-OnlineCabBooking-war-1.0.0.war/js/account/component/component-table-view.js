...
define(function (require) {
  ...
  var ComponentFinders = require('account/component/component-finders');
  var ComponentStdTable = require('account/component/component-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ComponentFinders.finderWith(constantFields);
    var finderOptions = ComponentFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ComponentEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineComponentList(widget, input) {
    return ComponentStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ComponentEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ComponentEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ComponentEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ComponentEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ComponentEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var componentList = defineComponentList(widget, listOptions);

    tableContext.selection = componentList.selection;
    ...
    var pagination = definePagination(toolbar, componentList.listModel);
    ...
    return {
      injector: widget,
      selection: componentList.selection
    };
  }
