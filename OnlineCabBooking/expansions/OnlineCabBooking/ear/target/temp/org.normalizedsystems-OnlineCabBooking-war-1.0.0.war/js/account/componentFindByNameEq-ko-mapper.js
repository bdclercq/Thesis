...
define(function(require) {
  ...
  var componentFindByNameEqElement = nsxApplication.getElement("account", "componentFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.ComponentFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(componentFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(componentFindByNameEq);
    var form = {
  ...
  function jsToViewModel(componentFindByNameEq) {
    var componentFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(componentFindByNameEq.name),
    ...
    return componentFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(componentFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: componentFindByNameEqViewModel.name(),
  ...
  var componentFindByNameEqMapper = {
  ...
  return componentFindByNameEqMapper;
});
