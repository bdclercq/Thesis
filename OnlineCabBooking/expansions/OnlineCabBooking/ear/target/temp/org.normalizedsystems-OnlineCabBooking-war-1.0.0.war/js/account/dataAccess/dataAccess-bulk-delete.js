...
define(function (require) {
  ...
  const DataAccessActions = require('account/dataAccess/dataAccess-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = DataAccessEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = DataAccessActions.deleteMultipleAction();
