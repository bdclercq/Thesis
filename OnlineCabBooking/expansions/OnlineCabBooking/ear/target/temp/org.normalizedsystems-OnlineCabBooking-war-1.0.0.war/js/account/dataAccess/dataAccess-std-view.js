...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) DataAccess!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = DataAccessEvents.defineViewIntentListener();

      var config = {
        title: 'DataAccess',
        projection: 'details',
        projector: 'account/dataAccess/dataAccess-projector',
        modeller: 'account/dataAccess/dataAccess-details-instance-model',
        view: 'account/dataAccess-details-instance'
      };
