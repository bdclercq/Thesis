...
define(function(require) {
  ...
  var dataAccessFindAllDataAccesssElement = nsxApplication.getElement("account", "dataAccessFindAllDataAccesss");
  ...
  function jsToFormModel(dataAccessFindAllDataAccesss, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindAllDataAccesss);
    var form = {
  ...
  function jsToViewModel(dataAccessFindAllDataAccesss) {
    var dataAccessFindAllDataAccesssViewModel = {
    ...
    return dataAccessFindAllDataAccesssViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(dataAccessFindAllDataAccesssViewModel) {
    var jsData = {
  ...
  var dataAccessFindAllDataAccesssMapper = {
  ...
  return dataAccessFindAllDataAccesssMapper;
});
