...
define(function(require) {
  ...
  var dataAccessFindByForUserEqElement = nsxApplication.getElement("account", "dataAccessFindByForUserEq");
  ...
  var fieldOptions = {
    ...
    forUser: {
      ...
      key: "account.DataAccessFindByForUserEq.forUser",
      isValueType: false
    }
  ...
  function jsToFormModel(dataAccessFindByForUserEq, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindByForUserEq);
    var form = {
  ...
  function jsToViewModel(dataAccessFindByForUserEq) {
    var dataAccessFindByForUserEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      forUser: ko.observable(dataAccessFindByForUserEq.forUser),
  ...
  var dataAccessFindByForUserEqMapper = {
  ...
  return dataAccessFindByForUserEqMapper;
});
