...
define(function(require) {
  ...
  var dataAccessFindByForUserEq_ElementEqElement = nsxApplication.getElement("account", "dataAccessFindByForUserEq_ElementEq");
  ...
  var fieldOptions = {
    ...
    element: {
      ...
      key: "account.DataAccessFindByForUserEq_ElementEq.element",
      isValueType: false
    },
    forUser: {
      fieldName: "forUser",
      type: FieldType.DATAREF,
      key: "account.DataAccessFindByForUserEq_ElementEq.forUser",
      isValueType: false
    }
  ...
  function jsToFormModel(dataAccessFindByForUserEq_ElementEq, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindByForUserEq_ElementEq);
    var form = {
  ...
  function jsToViewModel(dataAccessFindByForUserEq_ElementEq) {
    var dataAccessFindByForUserEq_ElementEqViewModel = {
      // anchor:value-fields-to-model:start
      element: ko.observable(dataAccessFindByForUserEq_ElementEq.element),
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      forUser: ko.observable(dataAccessFindByForUserEq_ElementEq.forUser),
    ...
    return dataAccessFindByForUserEq_ElementEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(dataAccessFindByForUserEq_ElementEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      element: dataAccessFindByForUserEq_ElementEqViewModel.element(),
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      forUser: dataAccessFindByForUserEq_ElementEqViewModel.forUser(),
  ...
  var dataAccessFindByForUserEq_ElementEqMapper = {
  ...
  return dataAccessFindByForUserEq_ElementEqMapper;
});
