...
define(function(require) {
  ...
  var dataAccessFindByNameEqElement = nsxApplication.getElement("account", "dataAccessFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.DataAccessFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(dataAccessFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindByNameEq);
    var form = {
  ...
  function jsToViewModel(dataAccessFindByNameEq) {
    var dataAccessFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(dataAccessFindByNameEq.name),
    ...
    return dataAccessFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(dataAccessFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: dataAccessFindByNameEqViewModel.name(),
  ...
  var dataAccessFindByNameEqMapper = {
  ...
  return dataAccessFindByNameEqMapper;
});
