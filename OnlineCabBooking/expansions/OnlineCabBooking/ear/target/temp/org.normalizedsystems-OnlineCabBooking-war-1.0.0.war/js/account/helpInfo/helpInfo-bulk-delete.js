...
define(function (require) {
  ...
  const HelpInfoActions = require('account/helpInfo/helpInfo-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = HelpInfoEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = HelpInfoActions.deleteMultipleAction();
