...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(helpInfoDetails) {
      if (!!helpInfoDetails) {
        viewmodel.id(helpInfoDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(helpInfoDetails.name);
        viewmodel.description(helpInfoDetails.description);
