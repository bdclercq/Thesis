...
/**
 * Lists all the finders for the 'helpInfo' element
 */
define(function (require) {
  ...
  var helpInfoElement = nsxApplication.getElement("account", "helpInfo");
  var helpInfoAgent = nsxAgent.createAgent(helpInfoElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllHelpInfos";
    var component = "account";
    var element = "helpInfo";
    var translation = translate("account.helpInfo.findAllHelpInfos");
    ...
    function find(options){
      ...
      return helpInfoAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "account";
    var element = "helpInfo";
    var translation = translate("account.helpInfo.findByNameEq");
