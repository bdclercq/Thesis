...
define(function (require) {
  ...
  var HelpInfoSorting = require('account/helpInfo/helpInfo-sorting');
  var HelpInfoInfoModel = require('account/helpInfo/helpInfo-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = HelpInfoSorting.defineSorting();
    var dataUpdate = HelpInfoEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: HelpInfoInfoModel
    });

    var infoListView = "account/helpInfo-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
