...
define(function(require) {
  ...
  var helpInfoFindAllHelpInfosElement = nsxApplication.getElement("account", "helpInfoFindAllHelpInfos");
  ...
  function jsToFormModel(helpInfoFindAllHelpInfos, fieldFilter) {
    var detailModel = jsToViewModel(helpInfoFindAllHelpInfos);
    var form = {
  ...
  function jsToViewModel(helpInfoFindAllHelpInfos) {
    var helpInfoFindAllHelpInfosViewModel = {
    ...
    return helpInfoFindAllHelpInfosViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(helpInfoFindAllHelpInfosViewModel) {
    var jsData = {
  ...
  var helpInfoFindAllHelpInfosMapper = {
  ...
  return helpInfoFindAllHelpInfosMapper;
});
