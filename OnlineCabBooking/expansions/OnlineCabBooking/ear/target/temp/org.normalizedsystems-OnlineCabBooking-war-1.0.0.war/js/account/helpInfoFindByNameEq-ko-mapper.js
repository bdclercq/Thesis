...
define(function(require) {
  ...
  var helpInfoFindByNameEqElement = nsxApplication.getElement("account", "helpInfoFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.HelpInfoFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(helpInfoFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(helpInfoFindByNameEq);
    var form = {
  ...
  function jsToViewModel(helpInfoFindByNameEq) {
    var helpInfoFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(helpInfoFindByNameEq.name),
    ...
    return helpInfoFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(helpInfoFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: helpInfoFindByNameEqViewModel.name(),
  ...
  var helpInfoFindByNameEqMapper = {
  ...
  return helpInfoFindByNameEqMapper;
});
