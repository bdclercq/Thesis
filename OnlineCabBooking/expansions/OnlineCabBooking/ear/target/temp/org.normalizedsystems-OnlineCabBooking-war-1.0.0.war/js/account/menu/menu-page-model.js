...
define(function (require) {
  ...
  var MenuTableView = require('account/menu/menu-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.Menu.page.title")
    };
    var viewModel = {};
    var title = translate("account.Menu.menu.title");
    ...
    var table = MenuTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
