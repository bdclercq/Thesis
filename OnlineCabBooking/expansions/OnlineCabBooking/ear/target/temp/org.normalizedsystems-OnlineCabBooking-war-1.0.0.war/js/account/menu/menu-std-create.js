...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) Menu element!")
    });

    function render() {
      var createIntent = MenuEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: MenuActions.createAction()
      };
