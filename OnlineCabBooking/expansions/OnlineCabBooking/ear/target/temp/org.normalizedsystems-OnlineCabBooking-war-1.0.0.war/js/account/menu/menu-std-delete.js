...
define(function (require) {
  ...
  function defineDeleteDialog() {
    ...
    when(deleteRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to delete a(n) Menu element!")
    });

    function render() {
      var selection = { id: 0 };
      var deleteIntent = MenuEvents.defineDeleteIntentListener();
      ...
      var deleteAction = MenuActions.deleteAction();
