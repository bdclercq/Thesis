...
define(function (require) {
  ...
  var MenuFinders = require('account/menu/menu-finders');
  var MenuStdTable = require('account/menu/menu-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = MenuFinders.finderWith(constantFields);
    var finderOptions = MenuFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = MenuEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineMenuList(widget, input) {
    return MenuStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: MenuEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: MenuEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: MenuEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: MenuEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: MenuEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var menuList = defineMenuList(widget, listOptions);

    tableContext.selection = menuList.selection;
    ...
    var pagination = definePagination(toolbar, menuList.listModel);
