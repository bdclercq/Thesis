...
define(function(require) {
  ...
  var menuFindByPortalEqElement = nsxApplication.getElement("account", "menuFindByPortalEq");
  ...
  var fieldOptions = {
    ...
    portal: {
      ...
      key: "account.MenuFindByPortalEq.portal",
      isValueType: false
    }
  ...
  function jsToFormModel(menuFindByPortalEq, fieldFilter) {
    var detailModel = jsToViewModel(menuFindByPortalEq);
    var form = {
  ...
  function jsToViewModel(menuFindByPortalEq) {
    var menuFindByPortalEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      portal: ko.observable(menuFindByPortalEq.portal),
  ...
  return menuFindByPortalEqMapper;
});
