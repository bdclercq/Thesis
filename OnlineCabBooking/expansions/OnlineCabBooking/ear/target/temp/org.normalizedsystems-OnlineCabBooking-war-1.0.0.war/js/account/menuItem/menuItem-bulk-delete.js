...
define(function (require) {
  ...
  const MenuItemActions = require('account/menuItem/menuItem-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = MenuItemEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = MenuItemActions.deleteMultipleAction();
