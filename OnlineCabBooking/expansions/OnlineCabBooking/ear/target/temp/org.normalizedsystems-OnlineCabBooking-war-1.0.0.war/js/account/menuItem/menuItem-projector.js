...
define(function(require) {
  ...
  var menuItemMetaData = require("dataElement!account.menuItem");
  var menuItemAgent = menuItemMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "account.menuItem.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = MenuItemEvents.defineCreateUpdateListener();
    var dataEdit = MenuItemEvents.defineEditUpdateListener();
    var dataRefresh = MenuItemEvents.defineRefreshUpdateListener();
    var dataDelete = MenuItemEvents.defineDeleteUpdateListener();
    var dataFinder = MenuItemEvents.defineFinderUpdateListener();
