...
define(function (require) {
  ...
  var MenuItemSorting = require('account/menuItem/menuItem-sorting');
  var MenuItemInfoModel = require('account/menuItem/menuItem-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = MenuItemSorting.defineSorting();
    var dataUpdate = MenuItemEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: MenuItemInfoModel
    });

    var infoListView = "account/menuItem-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
