...
define(function (require) {
  ...
  var MenuItemFinders = require('account/menuItem/menuItem-finders');
  var MenuItemStdTable = require('account/menuItem/menuItem-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = MenuItemFinders.finderWith(constantFields);
    var finderOptions = MenuItemFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineMenuItemList(widget, input) {
    return MenuItemStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: MenuItemEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: MenuItemEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: MenuItemEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: MenuItemEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: MenuItemEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var menuItemList = defineMenuItemList(widget, listOptions);

    tableContext.selection = menuItemList.selection;
    ...
    var pagination = definePagination(toolbar, menuItemList.listModel);
    ...
    return {
      injector: widget,
      selection: menuItemList.selection
    };
  }
