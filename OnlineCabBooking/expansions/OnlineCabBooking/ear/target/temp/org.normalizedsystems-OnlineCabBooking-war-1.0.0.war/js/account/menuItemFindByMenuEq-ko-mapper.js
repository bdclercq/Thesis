...
define(function(require) {
  ...
  var menuItemFindByMenuEqElement = nsxApplication.getElement("account", "menuItemFindByMenuEq");
  ...
  var fieldOptions = {
    ...
    menu: {
      ...
      key: "account.MenuItemFindByMenuEq.menu",
      isValueType: false
    }
  ...
  function jsToFormModel(menuItemFindByMenuEq, fieldFilter) {
    var detailModel = jsToViewModel(menuItemFindByMenuEq);
    var form = {
  ...
  function jsToViewModel(menuItemFindByMenuEq) {
    var menuItemFindByMenuEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      menu: ko.observable(menuItemFindByMenuEq.menu),
  ...
  var menuItemFindByMenuEqMapper = {
  ...
  return menuItemFindByMenuEqMapper;
});
