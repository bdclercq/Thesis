...
define(function(require) {
  ...
  var menuItemFindByMenuEq_ScreenEqElement = nsxApplication.getElement("account", "menuItemFindByMenuEq_ScreenEq");
  ...
  var fieldOptions = {
    ...
    menu: {
      ...
      key: "account.MenuItemFindByMenuEq_ScreenEq.menu",
      isValueType: false
    },
    screen: {
      fieldName: "screen",
      type: FieldType.DATAREF,
      key: "account.MenuItemFindByMenuEq_ScreenEq.screen",
      isValueType: false
    }
  ...
  function jsToFormModel(menuItemFindByMenuEq_ScreenEq, fieldFilter) {
    var detailModel = jsToViewModel(menuItemFindByMenuEq_ScreenEq);
    var form = {
  ...
  function jsToViewModel(menuItemFindByMenuEq_ScreenEq) {
    var menuItemFindByMenuEq_ScreenEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      menu: ko.observable(menuItemFindByMenuEq_ScreenEq.menu),
      screen: ko.observable(menuItemFindByMenuEq_ScreenEq.screen),
    ...
    return menuItemFindByMenuEq_ScreenEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuItemFindByMenuEq_ScreenEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      menu: menuItemFindByMenuEq_ScreenEqViewModel.menu(),
      screen: menuItemFindByMenuEq_ScreenEqViewModel.screen(),
  ...
  var menuItemFindByMenuEq_ScreenEqMapper = {
  ...
  return menuItemFindByMenuEq_ScreenEqMapper;
});
