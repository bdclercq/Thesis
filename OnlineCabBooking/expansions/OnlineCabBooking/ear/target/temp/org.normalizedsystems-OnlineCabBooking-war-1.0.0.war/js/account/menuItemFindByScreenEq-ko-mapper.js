...
define(function(require) {
  ...
  var menuItemFindByScreenEqElement = nsxApplication.getElement("account", "menuItemFindByScreenEq");
  ...
  var fieldOptions = {
    ...
    screen: {
      ...
      key: "account.MenuItemFindByScreenEq.screen",
      isValueType: false
    }
  ...
  function jsToFormModel(menuItemFindByScreenEq, fieldFilter) {
    var detailModel = jsToViewModel(menuItemFindByScreenEq);
    var form = {
  ...
  function jsToViewModel(menuItemFindByScreenEq) {
    var menuItemFindByScreenEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      screen: ko.observable(menuItemFindByScreenEq.screen),
  ...
  var menuItemFindByScreenEqMapper = {
  ...
  return menuItemFindByScreenEqMapper;
});
