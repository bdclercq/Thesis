...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(portalDetails) {
      if (!!portalDetails) {
        viewmodel.id(portalDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(portalDetails.name);
        viewmodel.version(portalDetails.version);
        viewmodel.description(portalDetails.description);
