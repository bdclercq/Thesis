...
define(function (require) {
  ...
  const ProfileActions = require('account/profile/profile-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = ProfileEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = ProfileActions.deleteMultipleAction();
