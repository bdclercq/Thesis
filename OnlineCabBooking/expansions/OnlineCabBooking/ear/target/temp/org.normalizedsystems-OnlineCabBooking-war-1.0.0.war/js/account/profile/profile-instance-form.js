...
define(function (require) {
  ...
  var formFields = [
    ...
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "account.Profile.name",
      isValueType: false
    },
    {
      fieldName: "screens",
      type: FieldType.LIST,
      key: "account.Profile.screens",
      isValueType: false
    },
    {
      fieldName: "userGroup",
      type: FieldType.DATAREF,
      key: "account.Profile.userGroup",
      isValueType: false
    },
    {
      fieldName: "weight",
      type: FieldType.VALUE,
      key: "account.Profile.weight",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || ProfileActions.editAction();
