...
define(function (require) {
  ...
  var ProfileTableView = require('account/profile/profile-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.Profile.page.title")
    };
    var viewModel = {};
    var title = translate("account.Profile.menu.title");
    ...
    var table = ProfileTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
