...
define(function(require) {
  ...
  var profileMetaData = require("dataElement!account.profile");
  var profileAgent = profileMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "account.profile.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = ProfileEvents.defineCreateUpdateListener();
    var dataEdit = ProfileEvents.defineEditUpdateListener();
    var dataRefresh = ProfileEvents.defineRefreshUpdateListener();
    var dataDelete = ProfileEvents.defineDeleteUpdateListener();
    var dataFinder = ProfileEvents.defineFinderUpdateListener();
