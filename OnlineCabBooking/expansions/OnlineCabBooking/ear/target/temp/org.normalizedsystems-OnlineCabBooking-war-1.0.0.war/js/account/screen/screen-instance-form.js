...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "account.Screen.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "account.Screen.name",
      isValueType: false
    },
    {
      fieldName: "link",
      type: FieldType.VALUE,
      key: "account.Screen.link",
      isValueType: false
    },
    {
      fieldName: "sortOrder",
      type: FieldType.VALUE,
      key: "account.Screen.sortOrder",
      isValueType: false
    },
    {
      fieldName: "component",
      type: FieldType.DATAREF,
      key: "account.Screen.component",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || ScreenActions.editAction();
