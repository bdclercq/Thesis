...
define(function (require) {
  ...
  var ScreenFinders = require('account/screen/screen-finders');
  var ScreenStdTable = require('account/screen/screen-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ScreenFinders.finderWith(constantFields);
    var finderOptions = ScreenFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ScreenEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineScreenList(widget, input) {
    return ScreenStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ScreenEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ScreenEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ScreenEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ScreenEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ScreenEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var screenList = defineScreenList(widget, listOptions);

    tableContext.selection = screenList.selection;
    ...
    var pagination = definePagination(toolbar, screenList.listModel);
    ...
    return {
      injector: widget,
      selection: screenList.selection
    };
  }
