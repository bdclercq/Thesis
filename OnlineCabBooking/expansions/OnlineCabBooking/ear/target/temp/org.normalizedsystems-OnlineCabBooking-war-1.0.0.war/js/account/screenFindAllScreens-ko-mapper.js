...
define(function(require) {
  ...
  var screenFindAllScreensElement = nsxApplication.getElement("account", "screenFindAllScreens");
  ...
  function jsToFormModel(screenFindAllScreens, fieldFilter) {
    var detailModel = jsToViewModel(screenFindAllScreens);
    var form = {
  ...
  function jsToViewModel(screenFindAllScreens) {
    var screenFindAllScreensViewModel = {
    ...
    return screenFindAllScreensViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(screenFindAllScreensViewModel) {
    var jsData = {
  ...
  var screenFindAllScreensMapper = {
  ...
  return screenFindAllScreensMapper;
});
