  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        profile: defineLink(ProfileEvents),
    ...
    function updateViewmodel(screenProfileDetails) {
      if (!!screenProfileDetails) {
        viewmodel.id(screenProfileDetails.id);
        // anchor:update-viewModel:start
        viewmodel.screen.value(screenProfileDetails.screen);
        viewmodel.profile.value(screenProfileDetails.profile);
        viewmodel.screens(screenProfileDetails.screens);
