...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) ScreenProfile!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = ScreenProfileEvents.defineViewIntentListener();

      var config = {
        title: 'ScreenProfile',
        projection: 'details',
        projector: 'account/screenProfile/screenProfile-projector',
        modeller: 'account/screenProfile/screenProfile-details-instance-model',
        view: 'account/screenProfile-details-instance'
      };
