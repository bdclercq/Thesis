...
define(function (require) {
  ...
  var ScreenProfileFinders = require('account/screenProfile/screenProfile-finders');
  var ScreenProfileStdTable = require('account/screenProfile/screenProfile-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ScreenProfileFinders.finderWith(constantFields);
    var finderOptions = ScreenProfileFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ScreenProfileEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineScreenProfileList(widget, input) {
    return ScreenProfileStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ScreenProfileEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ScreenProfileEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ScreenProfileEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ScreenProfileEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ScreenProfileEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var screenProfileList = defineScreenProfileList(widget, listOptions);

    tableContext.selection = screenProfileList.selection;
    ...
    var pagination = definePagination(toolbar, screenProfileList.listModel);
    ...
    return {
      injector: widget,
      selection: screenProfileList.selection
    };
  }
