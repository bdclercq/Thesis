...
define(function (require) {
  ...
  const UserActions = require('account/user/user-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = UserEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = UserActions.deleteMultipleAction();
