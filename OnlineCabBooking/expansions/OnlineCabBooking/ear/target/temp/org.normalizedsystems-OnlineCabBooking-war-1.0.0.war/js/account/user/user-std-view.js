...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) User!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = UserEvents.defineViewIntentListener();

      var config = {
        title: 'User',
        projection: 'details',
        projector: 'account/user/user-projector',
        modeller: 'account/user/user-details-instance-model',
        view: 'account/user-details-instance'
      };
