...
define(function(require) {
  ...
  var userFindAllUsersElement = nsxApplication.getElement("account", "userFindAllUsers");
  ...
  function jsToFormModel(userFindAllUsers, fieldFilter) {
    var detailModel = jsToViewModel(userFindAllUsers);
    var form = {
  ...
  function jsToViewModel(userFindAllUsers) {
    var userFindAllUsersViewModel = {
    ...
    return userFindAllUsersViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userFindAllUsersViewModel) {
    var jsData = {
