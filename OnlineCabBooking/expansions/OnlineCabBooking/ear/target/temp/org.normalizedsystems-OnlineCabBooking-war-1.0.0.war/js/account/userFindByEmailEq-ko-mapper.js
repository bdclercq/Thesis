...
define(function(require) {
  ...
  var userFindByEmailEqElement = nsxApplication.getElement("account", "userFindByEmailEq");
  ...
  var fieldOptions = {
    ...
    email: {
      ...
      key: "account.UserFindByEmailEq.email",
      isValueType: false
    }
  ...
  function jsToFormModel(userFindByEmailEq, fieldFilter) {
    var detailModel = jsToViewModel(userFindByEmailEq);
    var form = {
  ...
  function jsToViewModel(userFindByEmailEq) {
    var userFindByEmailEqViewModel = {
      // anchor:value-fields-to-model:start
      email: ko.observable(userFindByEmailEq.email),
    ...
    return userFindByEmailEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userFindByEmailEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      email: userFindByEmailEqViewModel.email(),
  ...
  return userFindByEmailEqMapper;
});
