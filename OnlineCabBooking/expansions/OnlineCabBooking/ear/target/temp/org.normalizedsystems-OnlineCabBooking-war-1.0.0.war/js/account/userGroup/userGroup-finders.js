...
/**
 * Lists all the finders for the 'userGroup' element
 */
define(function (require) {
  ...
  var userGroupElement = nsxApplication.getElement("account", "userGroup");
  var userGroupAgent = nsxAgent.createAgent(userGroupElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllUserGroups";
    var component = "account";
    var element = "userGroup";
    var translation = translate("account.userGroup.findAllUserGroups");
    ...
    function find(options){
      ...
      return userGroupAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "account";
    var element = "userGroup";
    var translation = translate("account.userGroup.findByNameEq");
  ...
  function findByTypeEq(options) {
    var name = "findByTypeEq";
    var component = "account";
    var element = "userGroup";
    var translation = translate("account.userGroup.findByTypeEq");

    function find(options){
      var findOptions = {
        searchMethod: "findByTypeEq",
        details: options.details,
        rowsPerPage: options.rowsPerPage,
        page: options.page,
        projection: options.projection,
  ...
  findByTypeEq.fields = ["type"];
  findByTypeEq.fieldOperatorPairs = ["type:eq"];
  // anchor:finders:end
