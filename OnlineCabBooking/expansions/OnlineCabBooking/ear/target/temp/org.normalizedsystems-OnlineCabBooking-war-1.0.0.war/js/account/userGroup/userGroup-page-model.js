...
define(function (require) {
  ...
  var UserGroupTableView = require('account/userGroup/userGroup-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.UserGroup.page.title")
    };
    var viewModel = {};
    var title = translate("account.UserGroup.menu.title");
    ...
    var table = UserGroupTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
