...
define(function (require) {
  ...
  var UserGroupFinders = require('account/userGroup/userGroup-finders');
  var UserGroupStdTable = require('account/userGroup/userGroup-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = UserGroupFinders.finderWith(constantFields);
    var finderOptions = UserGroupFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineUserGroupList(widget, input) {
    return UserGroupStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: UserGroupEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: UserGroupEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: UserGroupEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: UserGroupEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: UserGroupEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var userGroupList = defineUserGroupList(widget, listOptions);

    tableContext.selection = userGroupList.selection;
    ...
    var pagination = definePagination(toolbar, userGroupList.listModel);
    ...
    return {
      injector: widget,
      selection: userGroupList.selection
    };
  }
