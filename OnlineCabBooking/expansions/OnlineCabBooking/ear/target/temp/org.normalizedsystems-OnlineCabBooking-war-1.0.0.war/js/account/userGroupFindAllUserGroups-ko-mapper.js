...
define(function(require) {
  ...
  var userGroupFindAllUserGroupsElement = nsxApplication.getElement("account", "userGroupFindAllUserGroups");
  ...
  function jsToFormModel(userGroupFindAllUserGroups, fieldFilter) {
    var detailModel = jsToViewModel(userGroupFindAllUserGroups);
    var form = {
  ...
  function jsToViewModel(userGroupFindAllUserGroups) {
    var userGroupFindAllUserGroupsViewModel = {
    ...
    return userGroupFindAllUserGroupsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userGroupFindAllUserGroupsViewModel) {
    var jsData = {
  ...
  var userGroupFindAllUserGroupsMapper = {
  ...
  return userGroupFindAllUserGroupsMapper;
});
