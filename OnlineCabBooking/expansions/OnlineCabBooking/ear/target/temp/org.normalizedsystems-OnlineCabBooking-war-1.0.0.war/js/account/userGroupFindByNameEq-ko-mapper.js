...
define(function(require) {
  ...
  var userGroupFindByNameEqElement = nsxApplication.getElement("account", "userGroupFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.UserGroupFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(userGroupFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(userGroupFindByNameEq);
    var form = {
  ...
  function jsToViewModel(userGroupFindByNameEq) {
    var userGroupFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(userGroupFindByNameEq.name),
    ...
    return userGroupFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(userGroupFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: userGroupFindByNameEqViewModel.name(),
  ...
  var userGroupFindByNameEqMapper = {
  ...
  return userGroupFindByNameEqMapper;
});
