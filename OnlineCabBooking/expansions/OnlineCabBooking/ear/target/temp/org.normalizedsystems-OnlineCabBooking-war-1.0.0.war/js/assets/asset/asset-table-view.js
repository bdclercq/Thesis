...
define(function (require) {
  ...
  var AssetFinders = require('assets/asset/asset-finders');
  var AssetStdTable = require('assets/asset/asset-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = AssetFinders.finderWith(constantFields);
    var finderOptions = AssetFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineAssetList(widget, input) {
    return AssetStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: AssetEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: AssetEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: AssetEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: AssetEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: AssetEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineSearchBar(toolbar, finders, input) {
    var value = ko.observable();

    var view = "nsx/knockout/search-field";
    var viewModel = {
      value: value,
      placeholder: translate("assets.asset.findByNameEq")
    };
    ...
    var fields = utils.getFieldOperators(input.constants).concat("name:eq");
    var finder = AssetFinders.finderWith(fields);

    function getFinderDetails() {
      return utils.combine(input.constants, {
        name: '%' + value() + '%'
      })
    }
  ...
  function defineTableView(input) {
    ...
    var assetList = defineAssetList(widget, listOptions);

    tableContext.selection = assetList.selection;
    ...
    var pagination = definePagination(toolbar, assetList.listModel);
    ...
    var searchBar = defineSearchBar(toolbar, finders, tableContext);
