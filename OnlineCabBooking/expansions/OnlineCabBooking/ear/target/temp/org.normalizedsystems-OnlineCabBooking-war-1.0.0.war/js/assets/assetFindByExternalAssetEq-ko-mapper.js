...
define(function(require) {
  ...
  var assetFindByExternalAssetEqElement = nsxApplication.getElement("assets", "assetFindByExternalAssetEq");
  ...
  var fieldOptions = {
    ...
    externalAsset: {
      ...
      key: "assets.AssetFindByExternalAssetEq.externalAsset",
      isValueType: false
    }
  ...
  function jsToFormModel(assetFindByExternalAssetEq, fieldFilter) {
    var detailModel = jsToViewModel(assetFindByExternalAssetEq);
    var form = {
  ...
  function jsToViewModel(assetFindByExternalAssetEq) {
    var assetFindByExternalAssetEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      externalAsset: ko.observable(assetFindByExternalAssetEq.externalAsset),
    ...
    return assetFindByExternalAssetEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(assetFindByExternalAssetEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      externalAsset: assetFindByExternalAssetEqViewModel.externalAsset(),
  ...
  var assetFindByExternalAssetEqMapper = {
  ...
  return assetFindByExternalAssetEqMapper;
});
