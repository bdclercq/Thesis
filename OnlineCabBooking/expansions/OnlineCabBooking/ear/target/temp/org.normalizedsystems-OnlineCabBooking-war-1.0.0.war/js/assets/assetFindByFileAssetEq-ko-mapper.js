...
define(function(require) {
  ...
  var assetFindByFileAssetEqElement = nsxApplication.getElement("assets", "assetFindByFileAssetEq");
  ...
  var fieldOptions = {
    ...
    fileAsset: {
      ...
      key: "assets.AssetFindByFileAssetEq.fileAsset",
      isValueType: false
    }
  ...
  function jsToFormModel(assetFindByFileAssetEq, fieldFilter) {
    var detailModel = jsToViewModel(assetFindByFileAssetEq);
    var form = {
  ...
  function jsToViewModel(assetFindByFileAssetEq) {
    var assetFindByFileAssetEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      fileAsset: ko.observable(assetFindByFileAssetEq.fileAsset),
  ...
  var assetFindByFileAssetEqMapper = {
  ...
  return assetFindByFileAssetEqMapper;
});
