...
define(function(require) {
  ...
  var assetFindByFileIdEqElement = nsxApplication.getElement("assets", "assetFindByFileIdEq");
  ...
  var fieldOptions = {
    ...
    fileId: {
      ...
      key: "assets.AssetFindByFileIdEq.fileId",
      isValueType: false
    }
  ...
  function jsToFormModel(assetFindByFileIdEq, fieldFilter) {
    var detailModel = jsToViewModel(assetFindByFileIdEq);
    var form = {
  ...
  function jsToViewModel(assetFindByFileIdEq) {
    var assetFindByFileIdEqViewModel = {
      // anchor:value-fields-to-model:start
      fileId: ko.observable(assetFindByFileIdEq.fileId),
    ...
    return assetFindByFileIdEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(assetFindByFileIdEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      fileId: assetFindByFileIdEqViewModel.fileId(),
  ...
  return assetFindByFileIdEqMapper;
});
