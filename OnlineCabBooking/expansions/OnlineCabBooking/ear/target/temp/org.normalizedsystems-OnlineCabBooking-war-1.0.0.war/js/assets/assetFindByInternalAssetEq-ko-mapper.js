...
define(function(require) {
  ...
  var assetFindByInternalAssetEqElement = nsxApplication.getElement("assets", "assetFindByInternalAssetEq");
  ...
  var fieldOptions = {
    ...
    internalAsset: {
      ...
      key: "assets.AssetFindByInternalAssetEq.internalAsset",
      isValueType: false
    }
  ...
  function jsToFormModel(assetFindByInternalAssetEq, fieldFilter) {
    var detailModel = jsToViewModel(assetFindByInternalAssetEq);
    var form = {
  ...
  function jsToViewModel(assetFindByInternalAssetEq) {
    var assetFindByInternalAssetEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      internalAsset: ko.observable(assetFindByInternalAssetEq.internalAsset),
    ...
    return assetFindByInternalAssetEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(assetFindByInternalAssetEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      internalAsset: assetFindByInternalAssetEqViewModel.internalAsset(),
  ...
  var assetFindByInternalAssetEqMapper = {
  ...
  return assetFindByInternalAssetEqMapper;
});
