...
define(function(require) {
  ...
  var externalAssetFindAllExternalAssetsElement = nsxApplication.getElement("assets", "externalAssetFindAllExternalAssets");
  ...
  function jsToFormModel(externalAssetFindAllExternalAssets, fieldFilter) {
    var detailModel = jsToViewModel(externalAssetFindAllExternalAssets);
    var form = {
  ...
  function jsToViewModel(externalAssetFindAllExternalAssets) {
    var externalAssetFindAllExternalAssetsViewModel = {
    ...
    return externalAssetFindAllExternalAssetsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(externalAssetFindAllExternalAssetsViewModel) {
    var jsData = {
  ...
  var externalAssetFindAllExternalAssetsMapper = {
  ...
  return externalAssetFindAllExternalAssetsMapper;
});
