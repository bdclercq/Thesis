...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(fileAssetDetails) {
      if (!!fileAssetDetails) {
        viewmodel.id(fileAssetDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(fileAssetDetails.name);
        viewmodel.uploadUri(fileAssetDetails.uploadUri);
