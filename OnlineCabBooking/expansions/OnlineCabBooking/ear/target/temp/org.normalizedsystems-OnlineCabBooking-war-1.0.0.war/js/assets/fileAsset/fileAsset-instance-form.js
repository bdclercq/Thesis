...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "assets.FileAsset.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "assets.FileAsset.name",
      isValueType: false
    },
    {
      fieldName: "uploadUri",
      type: FieldType.FILE,
      key: "assets.FileAsset.uploadUri",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || FileAssetActions.editAction();
