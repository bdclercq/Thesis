...
define(function (require) {
  ...
  var FileAssetSorting = require('assets/fileAsset/fileAsset-sorting');
  var FileAssetInfoModel = require('assets/fileAsset/fileAsset-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = FileAssetSorting.defineSorting();
    var dataUpdate = FileAssetEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: FileAssetInfoModel
    });

    var infoListView = "assets/fileAsset-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
