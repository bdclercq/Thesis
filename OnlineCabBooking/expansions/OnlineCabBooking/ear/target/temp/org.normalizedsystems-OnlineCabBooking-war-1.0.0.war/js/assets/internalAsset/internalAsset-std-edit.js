...
define(function (require) {
  ...
  var InternalAssetProjector = require('assets/internalAsset/internalAsset-projector');
  ...
  function defineEditDialog(options) {
    ...
    when(editRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to edit a(n) InternalAsset element!")
    });

    function render() {
      var editIntent = InternalAssetEvents.defineEditIntentListener();
      var showDialog = Trigger.defineTrigger();

      var constants = ko.observable();
      var selection = ko.observable();
      var formView = "assets/internalAsset-form";
      var title = "Edit InternalAsset";
      var layoutConfig = initLayoutConfig(constants)
      var formOptions = {
        resetOn: editIntent,
        action: InternalAssetActions.editAction()
      };

      var detailsProjection = InternalAssetProjector.defineProjector(selection, {
        projection: "details"
      });
