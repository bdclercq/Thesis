...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) InternalAsset!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = InternalAssetEvents.defineViewIntentListener();

      var config = {
        title: 'InternalAsset',
        projection: 'details',
        projector: 'assets/internalAsset/internalAsset-projector',
        modeller: 'assets/internalAsset/internalAsset-details-instance-model',
        view: 'assets/internalAsset-details-instance'
      };
