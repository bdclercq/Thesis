...
define(function (require) {
  ...
  function defineDeleteDialog() {
    ...
    when(deleteRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to delete a(n) InternalAssetChunk element!")
    });

    function render() {
      var selection = { id: 0 };
      var deleteIntent = InternalAssetChunkEvents.defineDeleteIntentListener();
      ...
      var deleteAction = InternalAssetChunkActions.deleteAction();
