...
define(function (require) {
  ...
  var InternalAssetChunkSorting = require('assets/internalAssetChunk/internalAssetChunk-sorting');
  var InternalAssetChunkInfoModel = require('assets/internalAssetChunk/internalAssetChunk-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = InternalAssetChunkSorting.defineSorting();
    var dataUpdate = InternalAssetChunkEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: InternalAssetChunkInfoModel
    });

    var infoListView = "assets/internalAssetChunk-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
