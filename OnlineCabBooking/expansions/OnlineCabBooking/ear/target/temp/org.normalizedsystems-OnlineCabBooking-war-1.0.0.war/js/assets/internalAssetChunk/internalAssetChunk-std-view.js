...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) InternalAssetChunk!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = InternalAssetChunkEvents.defineViewIntentListener();

      var config = {
        title: 'InternalAssetChunk',
        projection: 'details',
        projector: 'assets/internalAssetChunk/internalAssetChunk-projector',
        modeller: 'assets/internalAssetChunk/internalAssetChunk-details-instance-model',
        view: 'assets/internalAssetChunk-details-instance'
      };
