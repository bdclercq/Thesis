...
define(function(require) {
  ...
  var internalAssetChunkFindByNameEqElement = nsxApplication.getElement("assets", "internalAssetChunkFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "assets.InternalAssetChunkFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(internalAssetChunkFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(internalAssetChunkFindByNameEq);
    var form = {
  ...
  function jsToViewModel(internalAssetChunkFindByNameEq) {
    var internalAssetChunkFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(internalAssetChunkFindByNameEq.name),
    ...
    return internalAssetChunkFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(internalAssetChunkFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: internalAssetChunkFindByNameEqViewModel.name(),
  ...
  var internalAssetChunkFindByNameEqMapper = {
  ...
  return internalAssetChunkFindByNameEqMapper;
});
