...
define(function(require) {
  ...
  var internalAssetFindAllInternalAssetsElement = nsxApplication.getElement("assets", "internalAssetFindAllInternalAssets");
  ...
  function jsToFormModel(internalAssetFindAllInternalAssets, fieldFilter) {
    var detailModel = jsToViewModel(internalAssetFindAllInternalAssets);
    var form = {
  ...
  function jsToViewModel(internalAssetFindAllInternalAssets) {
    var internalAssetFindAllInternalAssetsViewModel = {
    ...
    return internalAssetFindAllInternalAssetsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(internalAssetFindAllInternalAssetsViewModel) {
    var jsData = {
  ...
  var internalAssetFindAllInternalAssetsMapper = {
  ...
  return internalAssetFindAllInternalAssetsMapper;
});
