...
define(function(require) {
  ...
  var internalAssetFindByNameEqElement = nsxApplication.getElement("assets", "internalAssetFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "assets.InternalAssetFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(internalAssetFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(internalAssetFindByNameEq);
    var form = {
  ...
  function jsToViewModel(internalAssetFindByNameEq) {
    var internalAssetFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(internalAssetFindByNameEq.name),
    ...
    return internalAssetFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(internalAssetFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: internalAssetFindByNameEqViewModel.name(),
  ...
  var internalAssetFindByNameEqMapper = {
  ...
  return internalAssetFindByNameEqMapper;
});
