...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(remoteAssetDetails) {
      if (!!remoteAssetDetails) {
        viewmodel.id(remoteAssetDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(remoteAssetDetails.name);
        viewmodel.url(remoteAssetDetails.url);
