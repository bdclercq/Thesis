...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "assets.RemoteAsset.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "assets.RemoteAsset.name",
      isValueType: false
    },
    {
      fieldName: "url",
      type: FieldType.VALUE,
      key: "assets.RemoteAsset.url",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || RemoteAssetActions.editAction();
