...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) RemoteAsset!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = RemoteAssetEvents.defineViewIntentListener();

      var config = {
        title: 'RemoteAsset',
        projection: 'details',
        projector: 'assets/remoteAsset/remoteAsset-projector',
        modeller: 'assets/remoteAsset/remoteAsset-details-instance-model',
        view: 'assets/remoteAsset-details-instance'
      };
