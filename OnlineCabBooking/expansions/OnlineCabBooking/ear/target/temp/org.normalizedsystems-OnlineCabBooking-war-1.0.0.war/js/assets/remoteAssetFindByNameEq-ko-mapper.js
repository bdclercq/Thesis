...
define(function(require) {
  ...
  var remoteAssetFindByNameEqElement = nsxApplication.getElement("assets", "remoteAssetFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "assets.RemoteAssetFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(remoteAssetFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(remoteAssetFindByNameEq);
    var form = {
  ...
  function jsToViewModel(remoteAssetFindByNameEq) {
    var remoteAssetFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(remoteAssetFindByNameEq.name),
    ...
    return remoteAssetFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(remoteAssetFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: remoteAssetFindByNameEqViewModel.name(),
  ...
  var remoteAssetFindByNameEqMapper = {
  ...
  return remoteAssetFindByNameEqMapper;
});
