...
define(function (require) {
  ...
  const AddressActions = require('onlineCabBookingComp/address/address-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = AddressEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = AddressActions.deleteMultipleAction();
