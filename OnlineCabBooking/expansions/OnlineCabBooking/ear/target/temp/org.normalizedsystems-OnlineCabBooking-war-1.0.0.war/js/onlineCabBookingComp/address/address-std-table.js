...
define(function (require) {
  ...
  var AddressSorting = require('onlineCabBookingComp/address/address-sorting');
  var AddressInfoModel = require('onlineCabBookingComp/address/address-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = AddressSorting.defineSorting();
    var dataUpdate = AddressEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: AddressInfoModel
    });

    var infoListView = "onlineCabBookingComp/address-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
