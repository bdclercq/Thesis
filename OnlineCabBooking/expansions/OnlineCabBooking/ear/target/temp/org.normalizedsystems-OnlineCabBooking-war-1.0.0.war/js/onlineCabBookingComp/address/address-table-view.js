...
define(function (require) {
  ...
  var AddressFinders = require('onlineCabBookingComp/address/address-finders');
  var AddressStdTable = require('onlineCabBookingComp/address/address-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = AddressFinders.finderWith(constantFields);
    var finderOptions = AddressFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineAddressList(widget, input) {
    return AddressStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: AddressEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: AddressEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: AddressEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: AddressEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: AddressEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var addressList = defineAddressList(widget, listOptions);

    tableContext.selection = addressList.selection;
    ...
    var pagination = definePagination(toolbar, addressList.listModel);
    ...
    return {
      injector: widget,
      selection: addressList.selection
    };
  }
