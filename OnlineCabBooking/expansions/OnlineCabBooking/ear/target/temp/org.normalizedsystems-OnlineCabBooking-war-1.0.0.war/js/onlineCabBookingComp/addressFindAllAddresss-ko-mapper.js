...
define(function(require) {
  ...
  var addressFindAllAddresssElement = nsxApplication.getElement("onlineCabBookingComp", "addressFindAllAddresss");
  ...
  function jsToFormModel(addressFindAllAddresss, fieldFilter) {
    var detailModel = jsToViewModel(addressFindAllAddresss);
    var form = {
  ...
  function jsToViewModel(addressFindAllAddresss) {
    var addressFindAllAddresssViewModel = {
    ...
    return addressFindAllAddresssViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(addressFindAllAddresssViewModel) {
    var jsData = {
  ...
  var addressFindAllAddresssMapper = {
  ...
  return addressFindAllAddresssMapper;
});
