...
define(function(require) {
  ...
  var addressFindByCityEqElement = nsxApplication.getElement("onlineCabBookingComp", "addressFindByCityEq");
  ...
  var fieldOptions = {
    ...
    city: {
      ...
      key: "onlineCabBookingComp.AddressFindByCityEq.city",
      isValueType: false
    }
  ...
  function jsToFormModel(addressFindByCityEq, fieldFilter) {
    var detailModel = jsToViewModel(addressFindByCityEq);
    var form = {
  ...
  function jsToViewModel(addressFindByCityEq) {
    var addressFindByCityEqViewModel = {
      // anchor:value-fields-to-model:start
      city: ko.observable(addressFindByCityEq.city),
    ...
    return addressFindByCityEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(addressFindByCityEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      city: addressFindByCityEqViewModel.city(),
  ...
  return addressFindByCityEqMapper;
});
