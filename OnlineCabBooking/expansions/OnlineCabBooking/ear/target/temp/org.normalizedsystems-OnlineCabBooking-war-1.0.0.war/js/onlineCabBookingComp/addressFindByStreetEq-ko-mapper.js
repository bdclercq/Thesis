...
define(function(require) {
  ...
  var addressFindByStreetEqElement = nsxApplication.getElement("onlineCabBookingComp", "addressFindByStreetEq");
  ...
  var fieldOptions = {
    ...
    street: {
      ...
      key: "onlineCabBookingComp.AddressFindByStreetEq.street",
      isValueType: false
    }
  ...
  function jsToFormModel(addressFindByStreetEq, fieldFilter) {
    var detailModel = jsToViewModel(addressFindByStreetEq);
    var form = {
  ...
  function jsToViewModel(addressFindByStreetEq) {
    var addressFindByStreetEqViewModel = {
      // anchor:value-fields-to-model:start
      street: ko.observable(addressFindByStreetEq.street),
    ...
    return addressFindByStreetEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(addressFindByStreetEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      street: addressFindByStreetEqViewModel.street(),
  ...
  var addressFindByStreetEqMapper = {
  ...
  return addressFindByStreetEqMapper;
});
