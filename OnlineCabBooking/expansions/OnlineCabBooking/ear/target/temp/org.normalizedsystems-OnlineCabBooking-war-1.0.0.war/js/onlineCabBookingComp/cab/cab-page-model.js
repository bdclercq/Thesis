...
define(function (require) {
  ...
  var CabTableView = require('onlineCabBookingComp/cab/cab-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.Cab.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.Cab.menu.title");
    ...
    var table = CabTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
