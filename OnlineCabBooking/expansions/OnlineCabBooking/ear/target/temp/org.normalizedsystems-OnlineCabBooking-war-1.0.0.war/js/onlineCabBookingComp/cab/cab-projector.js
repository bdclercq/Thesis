...
define(function(require) {
  ...
  var cabMetaData = require("dataElement!onlineCabBookingComp.cab");
  var cabAgent = cabMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "onlineCabBookingComp.cab.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = CabEvents.defineCreateUpdateListener();
    var dataEdit = CabEvents.defineEditUpdateListener();
    var dataRefresh = CabEvents.defineRefreshUpdateListener();
    var dataDelete = CabEvents.defineDeleteUpdateListener();
    var dataFinder = CabEvents.defineFinderUpdateListener();
