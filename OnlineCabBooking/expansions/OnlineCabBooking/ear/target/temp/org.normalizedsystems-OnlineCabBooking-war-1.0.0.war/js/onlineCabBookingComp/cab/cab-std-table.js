...
define(function (require) {
  ...
  var CabSorting = require('onlineCabBookingComp/cab/cab-sorting');
  var CabInfoModel = require('onlineCabBookingComp/cab/cab-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = CabSorting.defineSorting();
    var dataUpdate = CabEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: CabInfoModel
    });

    var infoListView = "onlineCabBookingComp/cab-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
