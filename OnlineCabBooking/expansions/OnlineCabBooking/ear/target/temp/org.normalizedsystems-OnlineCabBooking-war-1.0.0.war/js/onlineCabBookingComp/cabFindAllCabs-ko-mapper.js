...
define(function(require) {
  ...
  var cabFindAllCabsElement = nsxApplication.getElement("onlineCabBookingComp", "cabFindAllCabs");
  ...
  function jsToFormModel(cabFindAllCabs, fieldFilter) {
    var detailModel = jsToViewModel(cabFindAllCabs);
    var form = {
  ...
  function jsToViewModel(cabFindAllCabs) {
    var cabFindAllCabsViewModel = {
    ...
    return cabFindAllCabsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(cabFindAllCabsViewModel) {
    var jsData = {
