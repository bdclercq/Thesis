...
define(function(require) {
  ...
  var cabFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "cabFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.CabFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(cabFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(cabFindByNameEq);
    var form = {
  ...
  function jsToViewModel(cabFindByNameEq) {
    var cabFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(cabFindByNameEq.name),
    ...
    return cabFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(cabFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: cabFindByNameEqViewModel.name(),
