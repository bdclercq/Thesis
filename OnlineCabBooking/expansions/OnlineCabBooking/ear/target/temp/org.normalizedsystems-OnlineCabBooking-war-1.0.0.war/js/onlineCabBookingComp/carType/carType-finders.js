...
/**
 * Lists all the finders for the 'carType' element
 */
define(function (require) {
  ...
  var carTypeElement = nsxApplication.getElement("onlineCabBookingComp", "carType");
  var carTypeAgent = nsxAgent.createAgent(carTypeElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllCarTypes";
    var component = "onlineCabBookingComp";
    var element = "carType";
    var translation = translate("onlineCabBookingComp.carType.findAllCarTypes");
    ...
    function find(options){
      ...
      return carTypeAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "onlineCabBookingComp";
    var element = "carType";
    var translation = translate("onlineCabBookingComp.carType.findByNameEq");
  ...
  function findAll(options) {
    ...
    var component = "onlineCabBookingComp";
    var element = "carType";
    var translation = translate("onlineCabBookingComp.carType.findAllCarType");

    function find(options){
      var findOptions = {
        searchMethod: "findAllCarType",
        details: options.details,
        rowsPerPage: options.rowsPerPage,
        page: options.page,
        projection: options.projection,
