...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "onlineCabBookingComp.CarType.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "onlineCabBookingComp.CarType.name",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || CarTypeActions.editAction();
