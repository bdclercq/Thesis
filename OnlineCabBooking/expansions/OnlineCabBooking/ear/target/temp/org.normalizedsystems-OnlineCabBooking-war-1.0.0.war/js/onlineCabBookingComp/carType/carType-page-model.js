...
define(function (require) {
  ...
  var CarTypeTableView = require('onlineCabBookingComp/carType/carType-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.CarType.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.CarType.menu.title");
    ...
    var table = CarTypeTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
