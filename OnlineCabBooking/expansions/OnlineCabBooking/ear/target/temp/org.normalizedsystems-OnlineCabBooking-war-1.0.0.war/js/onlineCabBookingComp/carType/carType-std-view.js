...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) CarType!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = CarTypeEvents.defineViewIntentListener();

      var config = {
        title: 'CarType',
        projection: 'details',
        projector: 'onlineCabBookingComp/carType/carType-projector',
        modeller: 'onlineCabBookingComp/carType/carType-details-instance-model',
        view: 'onlineCabBookingComp/carType-details-instance'
      };
