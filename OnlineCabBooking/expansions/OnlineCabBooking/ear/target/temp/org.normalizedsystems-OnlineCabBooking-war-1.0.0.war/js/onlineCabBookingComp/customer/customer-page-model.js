...
define(function (require) {
  ...
  var CustomerTableView = require('onlineCabBookingComp/customer/customer-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.Customer.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.Customer.menu.title");
    ...
    var table = CustomerTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
