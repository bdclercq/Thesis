...
define(function (require) {
  ...
  var CustomerSorting = require('onlineCabBookingComp/customer/customer-sorting');
  var CustomerInfoModel = require('onlineCabBookingComp/customer/customer-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = CustomerSorting.defineSorting();
    var dataUpdate = CustomerEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: CustomerInfoModel
    });

    var infoListView = "onlineCabBookingComp/customer-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
