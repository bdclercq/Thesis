...
define(function (require) {
  ...
  var CustomerFinders = require('onlineCabBookingComp/customer/customer-finders');
  var CustomerStdTable = require('onlineCabBookingComp/customer/customer-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = CustomerFinders.finderWith(constantFields);
    var finderOptions = CustomerFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = CustomerEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineCustomerList(widget, input) {
    return CustomerStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: CustomerEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: CustomerEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: CustomerEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: CustomerEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: CustomerEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var customerList = defineCustomerList(widget, listOptions);

    tableContext.selection = customerList.selection;
    ...
    var pagination = definePagination(toolbar, customerList.listModel);
