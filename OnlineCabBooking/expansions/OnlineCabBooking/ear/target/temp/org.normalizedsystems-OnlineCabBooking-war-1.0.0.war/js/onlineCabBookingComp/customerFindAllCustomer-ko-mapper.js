...
define(function(require) {
  ...
  var customerFindAllCustomerElement = nsxApplication.getElement("onlineCabBookingComp", "customerFindAllCustomer");
  ...
  function jsToFormModel(customerFindAllCustomer, fieldFilter) {
    var detailModel = jsToViewModel(customerFindAllCustomer);
    var form = {
  ...
  function jsToViewModel(customerFindAllCustomer) {
    var customerFindAllCustomerViewModel = {
    ...
    return customerFindAllCustomerViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(customerFindAllCustomerViewModel) {
    var jsData = {
  ...
  var customerFindAllCustomerMapper = {
  ...
  return customerFindAllCustomerMapper;
});
