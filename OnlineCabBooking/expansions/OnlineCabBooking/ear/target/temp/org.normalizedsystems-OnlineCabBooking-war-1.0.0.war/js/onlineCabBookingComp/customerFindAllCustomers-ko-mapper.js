...
define(function(require) {
  ...
  var customerFindAllCustomersElement = nsxApplication.getElement("onlineCabBookingComp", "customerFindAllCustomers");
  ...
  function jsToFormModel(customerFindAllCustomers, fieldFilter) {
    var detailModel = jsToViewModel(customerFindAllCustomers);
    var form = {
  ...
  function jsToViewModel(customerFindAllCustomers) {
    var customerFindAllCustomersViewModel = {
    ...
    return customerFindAllCustomersViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(customerFindAllCustomersViewModel) {
    var jsData = {
  ...
  var customerFindAllCustomersMapper = {
  ...
  return customerFindAllCustomersMapper;
});
