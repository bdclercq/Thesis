...
define(function(require) {
  ...
  var driverMetaData = require("dataElement!onlineCabBookingComp.driver");
  var driverAgent = driverMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "onlineCabBookingComp.driver.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = DriverEvents.defineCreateUpdateListener();
    var dataEdit = DriverEvents.defineEditUpdateListener();
    var dataRefresh = DriverEvents.defineRefreshUpdateListener();
    var dataDelete = DriverEvents.defineDeleteUpdateListener();
    var dataFinder = DriverEvents.defineFinderUpdateListener();
