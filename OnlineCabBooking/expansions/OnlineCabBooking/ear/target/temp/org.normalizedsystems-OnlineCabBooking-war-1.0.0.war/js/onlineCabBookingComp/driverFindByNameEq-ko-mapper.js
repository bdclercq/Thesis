...
define(function(require) {
  ...
  var driverFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "driverFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.DriverFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(driverFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(driverFindByNameEq);
    var form = {
  ...
  function jsToViewModel(driverFindByNameEq) {
    var driverFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(driverFindByNameEq.name),
    ...
    return driverFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(driverFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: driverFindByNameEqViewModel.name(),
  ...
  return driverFindByNameEqMapper;
});
