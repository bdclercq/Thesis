...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(invoiceDetails) {
      if (!!invoiceDetails) {
        viewmodel.id(invoiceDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(invoiceDetails.name);
        viewmodel.payment.value(invoiceDetails.payment);
        viewmodel.customer.value(invoiceDetails.customer);
