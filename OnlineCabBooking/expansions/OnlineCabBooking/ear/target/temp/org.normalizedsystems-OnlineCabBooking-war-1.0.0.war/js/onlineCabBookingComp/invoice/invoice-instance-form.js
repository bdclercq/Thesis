...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "onlineCabBookingComp.Invoice.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "onlineCabBookingComp.Invoice.name",
      isValueType: false
    },
    {
      fieldName: "payment",
      type: FieldType.DATAREF,
      key: "onlineCabBookingComp.Invoice.payment",
      isValueType: false
    },
    {
      fieldName: "customer",
      type: FieldType.DATAREF,
      key: "onlineCabBookingComp.Invoice.customer",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || InvoiceActions.editAction();
