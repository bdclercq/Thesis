...
define(function(require) {
  ...
  var invoiceFindByCustomerNe_PaymentEqElement = nsxApplication.getElement("onlineCabBookingComp", "invoiceFindByCustomerNe_PaymentEq");
  ...
  var fieldOptions = {
    ...
    customer: {
      ...
      key: "onlineCabBookingComp.InvoiceFindByCustomerNe_PaymentEq.customer",
      isValueType: false
    },
    payment: {
      fieldName: "payment",
      type: FieldType.DATAREF,
      key: "onlineCabBookingComp.InvoiceFindByCustomerNe_PaymentEq.payment",
      isValueType: false
    }
  ...
  function jsToFormModel(invoiceFindByCustomerNe_PaymentEq, fieldFilter) {
    var detailModel = jsToViewModel(invoiceFindByCustomerNe_PaymentEq);
    var form = {
  ...
  function jsToViewModel(invoiceFindByCustomerNe_PaymentEq) {
    var invoiceFindByCustomerNe_PaymentEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      customer: ko.observable(invoiceFindByCustomerNe_PaymentEq.customer),
      payment: ko.observable(invoiceFindByCustomerNe_PaymentEq.payment),
    ...
    return invoiceFindByCustomerNe_PaymentEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(invoiceFindByCustomerNe_PaymentEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      customer: invoiceFindByCustomerNe_PaymentEqViewModel.customer(),
      payment: invoiceFindByCustomerNe_PaymentEqViewModel.payment(),
  ...
  var invoiceFindByCustomerNe_PaymentEqMapper = {
  ...
  return invoiceFindByCustomerNe_PaymentEqMapper;
});
