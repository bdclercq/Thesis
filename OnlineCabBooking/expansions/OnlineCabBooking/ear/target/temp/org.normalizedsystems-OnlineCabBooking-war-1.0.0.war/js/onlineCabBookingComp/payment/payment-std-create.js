...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) Payment element!")
    });

    function render() {
      var createIntent = PaymentEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: PaymentActions.createAction()
      };
