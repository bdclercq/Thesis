...
define(function (require) {
  ...
  var PersonTableView = require('onlineCabBookingComp/person/person-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.Person.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.Person.menu.title");
    ...
    var table = PersonTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
