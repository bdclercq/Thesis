...
define(function(require) {
  ...
  var personFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "personFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.PersonFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(personFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(personFindByNameEq);
    var form = {
  ...
  function jsToViewModel(personFindByNameEq) {
    var personFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(personFindByNameEq.name),
    ...
    return personFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(personFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: personFindByNameEqViewModel.name(),
  ...
  return personFindByNameEqMapper;
});
