...
define(function (require) {
  ...
  var TripBookingSorting = require('onlineCabBookingComp/tripBooking/tripBooking-sorting');
  var TripBookingInfoModel = require('onlineCabBookingComp/tripBooking/tripBooking-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = TripBookingSorting.defineSorting();
    var dataUpdate = TripBookingEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: TripBookingInfoModel
    });

    var infoListView = "onlineCabBookingComp/tripBooking-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
