...
define(function(require) {
  ...
  var tripBookingFindAllTripBookingElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingFindAllTripBooking");
  ...
  function jsToFormModel(tripBookingFindAllTripBooking, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingFindAllTripBooking);
    var form = {
  ...
  function jsToViewModel(tripBookingFindAllTripBooking) {
    var tripBookingFindAllTripBookingViewModel = {
    ...
    return tripBookingFindAllTripBookingViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingFindAllTripBookingViewModel) {
    var jsData = {
  ...
  var tripBookingFindAllTripBookingMapper = {
  ...
  return tripBookingFindAllTripBookingMapper;
});
