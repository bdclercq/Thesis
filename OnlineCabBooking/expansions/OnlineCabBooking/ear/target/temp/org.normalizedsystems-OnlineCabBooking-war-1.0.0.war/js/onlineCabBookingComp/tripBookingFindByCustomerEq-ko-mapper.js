...
define(function(require) {
  ...
  var tripBookingFindByCustomerEqElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingFindByCustomerEq");
  ...
  var fieldOptions = {
    ...
    customer: {
      ...
      key: "onlineCabBookingComp.TripBookingFindByCustomerEq.customer",
      isValueType: false
    }
  ...
  function jsToFormModel(tripBookingFindByCustomerEq, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingFindByCustomerEq);
    var form = {
  ...
  function jsToViewModel(tripBookingFindByCustomerEq) {
    var tripBookingFindByCustomerEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      customer: ko.observable(tripBookingFindByCustomerEq.customer),
  ...
  var tripBookingFindByCustomerEqMapper = {
  ...
  return tripBookingFindByCustomerEqMapper;
});
