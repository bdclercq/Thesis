...
define(function(require) {
  ...
  var tripBookingFindByFromDateTimeEqElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingFindByFromDateTimeEq");
  ...
  var fieldOptions = {
    ...
    fromDateTime: {
      ...
      type: FieldType.DATE,
      key: "onlineCabBookingComp.TripBookingFindByFromDateTimeEq.fromDateTime",
      isValueType: false
    }
  ...
  function jsToFormModel(tripBookingFindByFromDateTimeEq, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingFindByFromDateTimeEq);
    var form = {
  ...
  function jsToViewModel(tripBookingFindByFromDateTimeEq) {
    var tripBookingFindByFromDateTimeEqViewModel = {
      // anchor:value-fields-to-model:start
      fromDateTime: nsxKnockoutUtils.asObservableDate(tripBookingFindByFromDateTimeEq.fromDateTime),
    ...
    return tripBookingFindByFromDateTimeEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingFindByFromDateTimeEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      fromDateTime: nsxKnockoutUtils.fromObservableDate(tripBookingFindByFromDateTimeEqViewModel.fromDateTime),
  ...
  var tripBookingFindByFromDateTimeEqMapper = {
  ...
  return tripBookingFindByFromDateTimeEqMapper;
});
