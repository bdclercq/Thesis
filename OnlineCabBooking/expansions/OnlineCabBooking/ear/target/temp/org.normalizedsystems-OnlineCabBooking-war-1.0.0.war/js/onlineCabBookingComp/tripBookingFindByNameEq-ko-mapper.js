...
define(function(require) {
  ...
  var tripBookingFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.TripBookingFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(tripBookingFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingFindByNameEq);
    var form = {
  ...
  function jsToViewModel(tripBookingFindByNameEq) {
    var tripBookingFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(tripBookingFindByNameEq.name),
    ...
    return tripBookingFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: tripBookingFindByNameEqViewModel.name(),
  ...
  var tripBookingFindByNameEqMapper = {
  ...
  return tripBookingFindByNameEqMapper;
});
