...
define(function (require) {
  ...
  const TripBookingTaskStatusActions = require('onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = TripBookingTaskStatusEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = TripBookingTaskStatusActions.deleteMultipleAction();
