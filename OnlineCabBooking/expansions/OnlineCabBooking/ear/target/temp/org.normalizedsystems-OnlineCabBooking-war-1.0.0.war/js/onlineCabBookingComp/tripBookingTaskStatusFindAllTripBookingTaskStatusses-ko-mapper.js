...
define(function(require) {
  ...
  var tripBookingTaskStatusFindAllTripBookingTaskStatussesElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingTaskStatusFindAllTripBookingTaskStatusses");
  ...
  function jsToFormModel(tripBookingTaskStatusFindAllTripBookingTaskStatusses, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingTaskStatusFindAllTripBookingTaskStatusses);
    var form = {
  ...
  function jsToViewModel(tripBookingTaskStatusFindAllTripBookingTaskStatusses) {
    var tripBookingTaskStatusFindAllTripBookingTaskStatussesViewModel = {
    ...
    return tripBookingTaskStatusFindAllTripBookingTaskStatussesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingTaskStatusFindAllTripBookingTaskStatussesViewModel) {
    var jsData = {
  ...
  var tripBookingTaskStatusFindAllTripBookingTaskStatussesMapper = {
  ...
  return tripBookingTaskStatusFindAllTripBookingTaskStatussesMapper;
});
