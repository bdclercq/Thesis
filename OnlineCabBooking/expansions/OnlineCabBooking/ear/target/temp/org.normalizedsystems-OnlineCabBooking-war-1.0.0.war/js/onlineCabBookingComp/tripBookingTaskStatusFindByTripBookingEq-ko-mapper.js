...
define(function(require) {
  ...
  var tripBookingTaskStatusFindByTripBookingEqElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingTaskStatusFindByTripBookingEq");
  ...
  var fieldOptions = {
    ...
    tripBooking: {
      ...
      key: "onlineCabBookingComp.TripBookingTaskStatusFindByTripBookingEq.tripBooking",
      isValueType: false
    }
  ...
  function jsToFormModel(tripBookingTaskStatusFindByTripBookingEq, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingTaskStatusFindByTripBookingEq);
    var form = {
  ...
  function jsToViewModel(tripBookingTaskStatusFindByTripBookingEq) {
    var tripBookingTaskStatusFindByTripBookingEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      tripBooking: ko.observable(tripBookingTaskStatusFindByTripBookingEq.tripBooking),
    ...
    return tripBookingTaskStatusFindByTripBookingEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingTaskStatusFindByTripBookingEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      tripBooking: tripBookingTaskStatusFindByTripBookingEqViewModel.tripBooking(),
  ...
  var tripBookingTaskStatusFindByTripBookingEqMapper = {
  ...
  return tripBookingTaskStatusFindByTripBookingEqMapper;
});
