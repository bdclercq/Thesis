...
define(function (require) {
  ...
  const ExecutionActions = require('utils/execution/execution-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = ExecutionEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = ExecutionActions.deleteMultipleAction();
