...
/**
 * Lists all the finders for the 'execution' element
 */
define(function (require) {
  ...
  var executionElement = nsxApplication.getElement("utils", "execution");
  var executionAgent = nsxAgent.createAgent(executionElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllExecutions";
    var component = "utils";
    var element = "execution";
    var translation = translate("utils.execution.findAllExecutions");
    ...
    function find(options){
      ...
      return executionAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "utils";
    var element = "execution";
    var translation = translate("utils.execution.findByNameEq");
  ...
  function findByElementEq(options) {
    ...
    var component = "utils";
    var element = "execution";
    var translation = translate("utils.execution.findByElementEq");
