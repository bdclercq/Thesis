...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.component = SortableColumn.defineSortableColumn({
      fieldName: "component"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "component";
        }
      })
    });
    ...
    viewModel.packageName = SortableColumn.defineSortableColumn({
      fieldName: "packageName"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "packageName";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.component.select);
    selectSorting.addTrigger(viewModel.element.select);
    selectSorting.addTrigger(viewModel.packageName.select);
