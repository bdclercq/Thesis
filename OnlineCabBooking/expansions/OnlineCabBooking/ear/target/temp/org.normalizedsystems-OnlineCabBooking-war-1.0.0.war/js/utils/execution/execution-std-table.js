...
define(function (require) {
  ...
  var ExecutionSorting = require('utils/execution/execution-sorting');
  var ExecutionInfoModel = require('utils/execution/execution-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ExecutionSorting.defineSorting();
    var dataUpdate = ExecutionEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ExecutionInfoModel
    });

    var infoListView = "utils/execution-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
