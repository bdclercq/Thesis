...
define(function(require) {
  ...
  var executionFindAllExecutionsElement = nsxApplication.getElement("utils", "executionFindAllExecutions");
  ...
  function jsToFormModel(executionFindAllExecutions, fieldFilter) {
    var detailModel = jsToViewModel(executionFindAllExecutions);
    var form = {
  ...
  function jsToViewModel(executionFindAllExecutions) {
    var executionFindAllExecutionsViewModel = {
    ...
    return executionFindAllExecutionsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(executionFindAllExecutionsViewModel) {
    var jsData = {
  ...
  var executionFindAllExecutionsMapper = {
  ...
  return executionFindAllExecutionsMapper;
});
