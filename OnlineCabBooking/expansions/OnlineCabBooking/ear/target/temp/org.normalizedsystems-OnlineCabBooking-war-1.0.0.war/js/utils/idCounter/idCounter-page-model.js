...
define(function (require) {
  ...
  var IdCounterTableView = require('utils/idCounter/idCounter-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("utils.IdCounter.page.title")
    };
    var viewModel = {};
    var title = translate("utils.IdCounter.menu.title");
    ...
    var table = IdCounterTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
