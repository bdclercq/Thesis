...
define(function(require) {
  ...
  var idCounterMetaData = require("dataElement!utils.idCounter");
  var idCounterAgent = idCounterMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "utils.idCounter.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = IdCounterEvents.defineCreateUpdateListener();
    var dataEdit = IdCounterEvents.defineEditUpdateListener();
    var dataRefresh = IdCounterEvents.defineRefreshUpdateListener();
    var dataDelete = IdCounterEvents.defineDeleteUpdateListener();
    var dataFinder = IdCounterEvents.defineFinderUpdateListener();
