...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.counter = SortableColumn.defineSortableColumn({
      fieldName: "counter"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "counter";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.counter.select);
