...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) IdCounter!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = IdCounterEvents.defineViewIntentListener();

      var config = {
        title: 'IdCounter',
        projection: 'details',
        projector: 'utils/idCounter/idCounter-projector',
        modeller: 'utils/idCounter/idCounter-details-instance-model',
        view: 'utils/idCounter-details-instance'
      };
