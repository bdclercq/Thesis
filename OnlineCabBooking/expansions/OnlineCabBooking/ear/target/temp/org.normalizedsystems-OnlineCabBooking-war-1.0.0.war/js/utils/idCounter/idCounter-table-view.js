...
define(function (require) {
  ...
  var IdCounterEvents = require('utils/idCounter/idCounter-events');
  var IdCounterFinders = require('utils/idCounter/idCounter-finders');
  var IdCounterStdTable = require('utils/idCounter/idCounter-std-table');

  var IdCounterElement = require('nsx/nsx-application').getElement('utils', 'idCounter');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = IdCounterFinders.finderWith(constantFields);
    var finderOptions = IdCounterFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = IdCounterEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineIdCounterList(widget, input) {
    return IdCounterStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: IdCounterEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: IdCounterEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: IdCounterEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: IdCounterEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: IdCounterEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var idCounterList = defineIdCounterList(widget, listOptions);

    tableContext.selection = idCounterList.selection;
    ...
    var pagination = definePagination(toolbar, idCounterList.listModel);
    ...
    return {
      injector: widget,
      selection: idCounterList.selection
    };
  }
