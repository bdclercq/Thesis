...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(paramTargetValueDetails) {
      if (!!paramTargetValueDetails) {
        viewmodel.id(paramTargetValueDetails.id);
        // anchor:update-viewModel:start
        viewmodel.param(paramTargetValueDetails.param);
        viewmodel.target(paramTargetValueDetails.target);
        viewmodel.value(paramTargetValueDetails.value);
