...
define(function (require) {
  ...
  var ParamTargetValueFinders = require('utils/paramTargetValue/paramTargetValue-finders');
  var ParamTargetValueStdTable = require('utils/paramTargetValue/paramTargetValue-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ParamTargetValueFinders.finderWith(constantFields);
    var finderOptions = ParamTargetValueFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ParamTargetValueEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineParamTargetValueList(widget, input) {
    return ParamTargetValueStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ParamTargetValueEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ParamTargetValueEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ParamTargetValueEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ParamTargetValueEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ParamTargetValueEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var paramTargetValueList = defineParamTargetValueList(widget, listOptions);

    tableContext.selection = paramTargetValueList.selection;
    ...
    var pagination = definePagination(toolbar, paramTargetValueList.listModel);
    ...
    return {
      injector: widget,
      selection: paramTargetValueList.selection
    };
  }
