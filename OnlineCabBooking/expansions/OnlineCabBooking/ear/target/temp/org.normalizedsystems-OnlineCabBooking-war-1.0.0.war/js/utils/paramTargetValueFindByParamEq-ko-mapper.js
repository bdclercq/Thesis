...
define(function(require) {
  ...
  var paramTargetValueFindByParamEqElement = nsxApplication.getElement("utils", "paramTargetValueFindByParamEq");
  ...
  var fieldOptions = {
    ...
    param: {
      ...
      key: "utils.ParamTargetValueFindByParamEq.param",
      isValueType: false
    }
  ...
  function jsToFormModel(paramTargetValueFindByParamEq, fieldFilter) {
    var detailModel = jsToViewModel(paramTargetValueFindByParamEq);
    var form = {
  ...
  function jsToViewModel(paramTargetValueFindByParamEq) {
    var paramTargetValueFindByParamEqViewModel = {
      // anchor:value-fields-to-model:start
      param: ko.observable(paramTargetValueFindByParamEq.param),
    ...
    return paramTargetValueFindByParamEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(paramTargetValueFindByParamEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      param: paramTargetValueFindByParamEqViewModel.param(),
  ...
  var paramTargetValueFindByParamEqMapper = {
  ...
  return paramTargetValueFindByParamEqMapper;
});
