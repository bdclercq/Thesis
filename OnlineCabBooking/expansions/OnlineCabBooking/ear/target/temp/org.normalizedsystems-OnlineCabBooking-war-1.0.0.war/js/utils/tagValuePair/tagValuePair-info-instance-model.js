...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(tagValuePairDetails) {
      if (!!tagValuePairDetails) {
        viewmodel.id(tagValuePairDetails.id);
        // anchor:update-viewModel:start
        viewmodel.tag(tagValuePairDetails.tag);
        viewmodel.value(tagValuePairDetails.value);
