...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) TagValuePair!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = TagValuePairEvents.defineViewIntentListener();

      var config = {
        title: 'TagValuePair',
        projection: 'details',
        projector: 'utils/tagValuePair/tagValuePair-projector',
        modeller: 'utils/tagValuePair/tagValuePair-details-instance-model',
        view: 'utils/tagValuePair-details-instance'
      };
