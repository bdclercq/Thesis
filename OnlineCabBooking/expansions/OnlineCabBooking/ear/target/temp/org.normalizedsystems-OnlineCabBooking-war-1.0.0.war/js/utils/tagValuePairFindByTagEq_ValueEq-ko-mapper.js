...
define(function(require) {
  ...
  var tagValuePairFindByTagEq_ValueEqElement = nsxApplication.getElement("utils", "tagValuePairFindByTagEq_ValueEq");
  ...
  var fieldOptions = {
    ...
    tag: {
      ...
      key: "utils.TagValuePairFindByTagEq_ValueEq.tag",
      isValueType: false
    },
    value: {
      fieldName: "value",
      type: FieldType.VALUE,
      key: "utils.TagValuePairFindByTagEq_ValueEq.value",
      isValueType: false
    }
  ...
  function jsToFormModel(tagValuePairFindByTagEq_ValueEq, fieldFilter) {
    var detailModel = jsToViewModel(tagValuePairFindByTagEq_ValueEq);
    var form = {
  ...
  function jsToViewModel(tagValuePairFindByTagEq_ValueEq) {
    var tagValuePairFindByTagEq_ValueEqViewModel = {
      // anchor:value-fields-to-model:start
      tag: ko.observable(tagValuePairFindByTagEq_ValueEq.tag),
      value: ko.observable(tagValuePairFindByTagEq_ValueEq.value),
    ...
    return tagValuePairFindByTagEq_ValueEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tagValuePairFindByTagEq_ValueEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      tag: tagValuePairFindByTagEq_ValueEqViewModel.tag(),
      value: tagValuePairFindByTagEq_ValueEqViewModel.value(),
  ...
  var tagValuePairFindByTagEq_ValueEqMapper = {
  ...
  return tagValuePairFindByTagEq_ValueEqMapper;
});
