...
define(function(require) {
  ...
  var tagValuePairFindByValueEqElement = nsxApplication.getElement("utils", "tagValuePairFindByValueEq");
  ...
  var fieldOptions = {
    ...
    value: {
      ...
      key: "utils.TagValuePairFindByValueEq.value",
      isValueType: false
    }
  ...
  function jsToFormModel(tagValuePairFindByValueEq, fieldFilter) {
    var detailModel = jsToViewModel(tagValuePairFindByValueEq);
    var form = {
  ...
  function jsToViewModel(tagValuePairFindByValueEq) {
    var tagValuePairFindByValueEqViewModel = {
      // anchor:value-fields-to-model:start
      value: ko.observable(tagValuePairFindByValueEq.value),
    ...
    return tagValuePairFindByValueEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tagValuePairFindByValueEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      value: tagValuePairFindByValueEqViewModel.value(),
  ...
  var tagValuePairFindByValueEqMapper = {
  ...
  return tagValuePairFindByValueEqMapper;
});
