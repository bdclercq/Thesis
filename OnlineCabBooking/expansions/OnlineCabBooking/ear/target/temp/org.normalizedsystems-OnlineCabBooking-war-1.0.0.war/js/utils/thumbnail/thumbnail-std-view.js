...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Thumbnail!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = ThumbnailEvents.defineViewIntentListener();

      var config = {
        title: 'Thumbnail',
        projection: 'details',
        projector: 'utils/thumbnail/thumbnail-projector',
        modeller: 'utils/thumbnail/thumbnail-details-instance-model',
        view: 'utils/thumbnail-details-instance'
      };
