...
define(function (require) {
  ...
  var ThumbnailFinders = require('utils/thumbnail/thumbnail-finders');
  var ThumbnailStdTable = require('utils/thumbnail/thumbnail-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ThumbnailFinders.finderWith(constantFields);
    var finderOptions = ThumbnailFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineThumbnailList(widget, input) {
    return ThumbnailStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ThumbnailEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ThumbnailEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ThumbnailEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ThumbnailEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ThumbnailEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var thumbnailList = defineThumbnailList(widget, listOptions);

    tableContext.selection = thumbnailList.selection;
    ...
    var pagination = definePagination(toolbar, thumbnailList.listModel);
    ...
    return {
      injector: widget,
      selection: thumbnailList.selection
    };
  }
