...
define(function(require) {
  ...
  var thumbnailFindByNameEqElement = nsxApplication.getElement("utils", "thumbnailFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "utils.ThumbnailFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(thumbnailFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(thumbnailFindByNameEq);
    var form = {
  ...
  function jsToViewModel(thumbnailFindByNameEq) {
    var thumbnailFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(thumbnailFindByNameEq.name),
    ...
    return thumbnailFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(thumbnailFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: thumbnailFindByNameEqViewModel.name(),
  ...
  var thumbnailFindByNameEqMapper = {
  ...
  return thumbnailFindByNameEqMapper;
});
