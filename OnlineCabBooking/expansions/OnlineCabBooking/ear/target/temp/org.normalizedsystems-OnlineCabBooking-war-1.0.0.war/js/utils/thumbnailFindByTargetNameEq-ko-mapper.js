...
define(function(require) {
  ...
  var thumbnailFindByTargetNameEqElement = nsxApplication.getElement("utils", "thumbnailFindByTargetNameEq");
  ...
  var fieldOptions = {
    ...
    targetName: {
      ...
      key: "utils.ThumbnailFindByTargetNameEq.targetName",
      isValueType: false
    }
  ...
  function jsToFormModel(thumbnailFindByTargetNameEq, fieldFilter) {
    var detailModel = jsToViewModel(thumbnailFindByTargetNameEq);
    var form = {
  ...
  function jsToViewModel(thumbnailFindByTargetNameEq) {
    var thumbnailFindByTargetNameEqViewModel = {
      // anchor:value-fields-to-model:start
      targetName: ko.observable(thumbnailFindByTargetNameEq.targetName),
    ...
    return thumbnailFindByTargetNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(thumbnailFindByTargetNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      targetName: thumbnailFindByTargetNameEqViewModel.targetName(),
  ...
  var thumbnailFindByTargetNameEqMapper = {
  ...
  return thumbnailFindByTargetNameEqMapper;
});
