...
define(function(require) {
  ...
  var thumbnailFindByUriEqElement = nsxApplication.getElement("utils", "thumbnailFindByUriEq");
  ...
  var fieldOptions = {
    ...
    uri: {
      ...
      key: "utils.ThumbnailFindByUriEq.uri",
      isValueType: false
    }
  ...
  function jsToFormModel(thumbnailFindByUriEq, fieldFilter) {
    var detailModel = jsToViewModel(thumbnailFindByUriEq);
    var form = {
  ...
  function jsToViewModel(thumbnailFindByUriEq) {
    var thumbnailFindByUriEqViewModel = {
      // anchor:value-fields-to-model:start
      uri: ko.observable(thumbnailFindByUriEq.uri),
    ...
    return thumbnailFindByUriEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(thumbnailFindByUriEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      uri: thumbnailFindByUriEqViewModel.uri(),
  ...
  var thumbnailFindByUriEqMapper = {
  ...
  return thumbnailFindByUriEqMapper;
});
