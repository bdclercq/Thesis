...
define(function (require) {
  ...
  const ValidationActions = require('validation/validation/validation-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = ValidationEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = ValidationActions.deleteMultipleAction();
