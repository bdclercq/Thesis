...
/**
 * Lists all the finders for the 'validation' element
 */
define(function (require) {
  ...
  var validationElement = nsxApplication.getElement("validation", "validation");
  var validationAgent = nsxAgent.createAgent(validationElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllValidations";
    var component = "validation";
    var element = "validation";
    var translation = translate("validation.validation.findAllValidations");
    ...
    function find(options){
      ...
      return validationAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "validation";
    var element = "validation";
    var translation = translate("validation.validation.findByNameEq");
