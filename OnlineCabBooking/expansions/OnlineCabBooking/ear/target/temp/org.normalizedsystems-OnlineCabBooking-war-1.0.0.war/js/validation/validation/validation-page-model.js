...
define(function (require) {
  ...
  var ValidationTableView = require('validation/validation/validation-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("validation.Validation.page.title")
    };
    var viewModel = {};
    var title = translate("validation.Validation.menu.title");
    ...
    var table = ValidationTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
