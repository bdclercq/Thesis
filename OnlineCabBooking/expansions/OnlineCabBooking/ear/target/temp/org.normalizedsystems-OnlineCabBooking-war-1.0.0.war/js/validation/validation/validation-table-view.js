...
define(function (require) {
  ...
  var ValidationFinders = require('validation/validation/validation-finders');
  var ValidationStdTable = require('validation/validation/validation-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = ValidationFinders.finderWith(constantFields);
    var finderOptions = ValidationFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = ValidationEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineValidationList(widget, input) {
    return ValidationStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ValidationEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: ValidationEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: ValidationEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: ValidationEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: ValidationEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var validationList = defineValidationList(widget, listOptions);

    tableContext.selection = validationList.selection;
    ...
    var pagination = definePagination(toolbar, validationList.listModel);
    ...
    return {
      injector: widget,
      selection: validationList.selection
    };
  }
