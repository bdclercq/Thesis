...
define(function (require) {
  ...
  var EngineNodeTableView = require('workflow/engineNode/engineNode-table-view');
  ...
  var EngineNodeWaterfall = require('workflow/engineNode/engineNode-waterfall');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.EngineNode.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.EngineNode.menu.title");
    ...
    var table = EngineNodeTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
    ...
    var waterfall = EngineNodeWaterfall.defineWaterfall({
