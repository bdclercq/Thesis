...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) EngineNode!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = EngineNodeEvents.defineViewIntentListener();

      var config = {
        title: 'EngineNode',
        projection: 'details',
        projector: 'workflow/engineNode/engineNode-projector',
        modeller: 'workflow/engineNode/engineNode-details-instance-model',
        view: 'workflow/engineNode-details-instance'
      };
