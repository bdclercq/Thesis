...
define(function(require) {
  ...
  var engineNodeFindByLastActiveLtElement = nsxApplication.getElement("workflow", "engineNodeFindByLastActiveLt");
  ...
  var fieldOptions = {
    ...
    lastActive: {
      ...
      type: FieldType.DATE,
      key: "workflow.EngineNodeFindByLastActiveLt.lastActive",
      isValueType: false
    }
  ...
  function jsToFormModel(engineNodeFindByLastActiveLt, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeFindByLastActiveLt);
    var form = {
  ...
  function jsToViewModel(engineNodeFindByLastActiveLt) {
    var engineNodeFindByLastActiveLtViewModel = {
      // anchor:value-fields-to-model:start
      lastActive: nsxKnockoutUtils.asObservableDate(engineNodeFindByLastActiveLt.lastActive),
    ...
    return engineNodeFindByLastActiveLtViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeFindByLastActiveLtViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      lastActive: nsxKnockoutUtils.fromObservableDate(engineNodeFindByLastActiveLtViewModel.lastActive),
  ...
  var engineNodeFindByLastActiveLtMapper = {
  ...
  return engineNodeFindByLastActiveLtMapper;
});
