...
define(function(require) {
  ...
  var engineNodeFindByNameEqElement = nsxApplication.getElement("workflow", "engineNodeFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.EngineNodeFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(engineNodeFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeFindByNameEq);
    var form = {
  ...
  function jsToViewModel(engineNodeFindByNameEq) {
    var engineNodeFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(engineNodeFindByNameEq.name),
    ...
    return engineNodeFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: engineNodeFindByNameEqViewModel.name(),
  ...
  var engineNodeFindByNameEqMapper = {
  ...
  return engineNodeFindByNameEqMapper;
});
