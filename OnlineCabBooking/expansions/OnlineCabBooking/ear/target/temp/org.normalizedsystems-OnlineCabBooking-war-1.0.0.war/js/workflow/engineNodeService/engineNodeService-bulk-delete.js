...
define(function (require) {
  ...
  const EngineNodeServiceActions = require('workflow/engineNodeService/engineNodeService-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = EngineNodeServiceEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = EngineNodeServiceActions.deleteMultipleAction();
