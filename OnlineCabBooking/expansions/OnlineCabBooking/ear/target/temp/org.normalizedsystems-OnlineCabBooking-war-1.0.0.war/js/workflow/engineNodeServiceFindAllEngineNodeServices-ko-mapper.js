...
define(function(require) {
  ...
  var engineNodeServiceFindAllEngineNodeServicesElement = nsxApplication.getElement("workflow", "engineNodeServiceFindAllEngineNodeServices");
  ...
  function jsToFormModel(engineNodeServiceFindAllEngineNodeServices, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeServiceFindAllEngineNodeServices);
    var form = {
  ...
  function jsToViewModel(engineNodeServiceFindAllEngineNodeServices) {
    var engineNodeServiceFindAllEngineNodeServicesViewModel = {
    ...
    return engineNodeServiceFindAllEngineNodeServicesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeServiceFindAllEngineNodeServicesViewModel) {
    var jsData = {
  ...
  var engineNodeServiceFindAllEngineNodeServicesMapper = {
  ...
  return engineNodeServiceFindAllEngineNodeServicesMapper;
});
