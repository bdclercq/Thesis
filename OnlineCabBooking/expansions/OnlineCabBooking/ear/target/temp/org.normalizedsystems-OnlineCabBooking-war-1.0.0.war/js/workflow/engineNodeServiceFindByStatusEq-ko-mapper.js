...
define(function(require) {
  ...
  var engineNodeServiceFindByStatusEqElement = nsxApplication.getElement("workflow", "engineNodeServiceFindByStatusEq");
  ...
  var fieldOptions = {
    ...
    status: {
      ...
      key: "workflow.EngineNodeServiceFindByStatusEq.status",
      isValueType: false
    }
  ...
  function jsToFormModel(engineNodeServiceFindByStatusEq, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeServiceFindByStatusEq);
    var form = {
  ...
  function jsToViewModel(engineNodeServiceFindByStatusEq) {
    var engineNodeServiceFindByStatusEqViewModel = {
      // anchor:value-fields-to-model:start
      status: ko.observable(engineNodeServiceFindByStatusEq.status),
    ...
    return engineNodeServiceFindByStatusEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeServiceFindByStatusEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      status: engineNodeServiceFindByStatusEqViewModel.status(),
  ...
  var engineNodeServiceFindByStatusEqMapper = {
  ...
  return engineNodeServiceFindByStatusEqMapper;
});
