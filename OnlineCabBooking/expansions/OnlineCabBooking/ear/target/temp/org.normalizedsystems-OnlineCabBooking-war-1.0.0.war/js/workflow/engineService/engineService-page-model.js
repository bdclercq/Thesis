...
define(function (require) {
  ...
  var EngineServiceTableView = require('workflow/engineService/engineService-table-view');
  ...
  var EngineServiceWaterfall = require('workflow/engineService/engineService-waterfall');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.EngineService.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.EngineService.menu.title");
    ...
    var waterfall = EngineServiceWaterfall.defineWaterfall({
