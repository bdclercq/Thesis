...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) EngineService!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = EngineServiceEvents.defineViewIntentListener();

      var config = {
        title: 'EngineService',
        projection: 'details',
        projector: 'workflow/engineService/engineService-projector',
        modeller: 'workflow/engineService/engineService-details-instance-model',
        view: 'workflow/engineService-details-instance'
      };
