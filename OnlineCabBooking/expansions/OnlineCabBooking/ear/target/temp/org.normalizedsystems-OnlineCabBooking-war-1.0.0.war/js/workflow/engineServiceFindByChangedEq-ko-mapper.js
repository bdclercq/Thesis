...
define(function(require) {
  ...
  var engineServiceFindByChangedEqElement = nsxApplication.getElement("workflow", "engineServiceFindByChangedEq");
  ...
  var fieldOptions = {
    ...
    changed: {
      ...
      key: "workflow.EngineServiceFindByChangedEq.changed",
      isValueType: false
    }
  ...
  function jsToFormModel(engineServiceFindByChangedEq, fieldFilter) {
    var detailModel = jsToViewModel(engineServiceFindByChangedEq);
    var form = {
  ...
  function jsToViewModel(engineServiceFindByChangedEq) {
    var engineServiceFindByChangedEqViewModel = {
      // anchor:value-fields-to-model:start
      changed: ko.observable(engineServiceFindByChangedEq.changed),
    ...
    return engineServiceFindByChangedEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineServiceFindByChangedEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      changed: engineServiceFindByChangedEqViewModel.changed(),
  ...
  var engineServiceFindByChangedEqMapper = {
  ...
  return engineServiceFindByChangedEqMapper;
});
