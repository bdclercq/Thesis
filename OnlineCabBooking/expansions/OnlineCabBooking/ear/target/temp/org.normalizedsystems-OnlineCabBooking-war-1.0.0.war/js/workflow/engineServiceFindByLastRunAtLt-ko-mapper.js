...
define(function(require) {
  ...
  var engineServiceFindByLastRunAtLtElement = nsxApplication.getElement("workflow", "engineServiceFindByLastRunAtLt");
  ...
  var fieldOptions = {
    ...
    lastRunAt: {
      fieldName: "lastRunAt",
      type: FieldType.DATE,
      key: "workflow.EngineServiceFindByLastRunAtLt.lastRunAt",
      isValueType: true
    }
  ...
  function jsToFormModel(engineServiceFindByLastRunAtLt, fieldFilter) {
    var detailModel = jsToViewModel(engineServiceFindByLastRunAtLt);
    var form = {
  ...
  function jsToViewModel(engineServiceFindByLastRunAtLt) {
    var engineServiceFindByLastRunAtLtViewModel = {
      // anchor:value-fields-to-model:start
      lastRunAt: {
        value: nsxKnockoutUtils.asObservableDate(engineServiceFindByLastRunAtLt.lastRunAt)
      },
    ...
    return engineServiceFindByLastRunAtLtViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineServiceFindByLastRunAtLtViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      lastRunAt: wrapValue(
        nsxKnockoutUtils.fromObservableDate(engineServiceFindByLastRunAtLtViewModel.lastRunAt.value)
      ),
  ...
  var engineServiceFindByLastRunAtLtMapper = {
  ...
  return engineServiceFindByLastRunAtLtMapper;
});
