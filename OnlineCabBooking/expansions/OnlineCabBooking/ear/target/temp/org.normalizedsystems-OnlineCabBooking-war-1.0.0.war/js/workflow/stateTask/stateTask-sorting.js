...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.interimState = SortableColumn.defineSortableColumn({
      fieldName: "interimState"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "interimState";
        }
      })
    });

    viewModel.failedState = SortableColumn.defineSortableColumn({
      fieldName: "failedState"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "failedState";
        }
      })
    });

    viewModel.endState = SortableColumn.defineSortableColumn({
      fieldName: "endState"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "endState";
        }
      })
    });

    viewModel.maxConcurrentTasks = SortableColumn.defineSortableColumn({
      fieldName: "maxConcurrentTasks"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "maxConcurrentTasks";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.interimState.select);
    selectSorting.addTrigger(viewModel.failedState.select);
    selectSorting.addTrigger(viewModel.endState.select);
    selectSorting.addTrigger(viewModel.maxConcurrentTasks.select);
