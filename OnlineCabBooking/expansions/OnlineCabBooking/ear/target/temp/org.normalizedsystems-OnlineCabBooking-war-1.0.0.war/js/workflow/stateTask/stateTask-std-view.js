...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) StateTask!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = StateTaskEvents.defineViewIntentListener();

      var config = {
        title: 'StateTask',
        projection: 'details',
        projector: 'workflow/stateTask/stateTask-projector',
        modeller: 'workflow/stateTask/stateTask-details-instance-model',
        view: 'workflow/stateTask-details-instance'
      };
