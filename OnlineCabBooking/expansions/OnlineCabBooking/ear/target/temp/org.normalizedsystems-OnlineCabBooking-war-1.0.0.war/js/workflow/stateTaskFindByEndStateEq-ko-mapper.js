...
define(function(require) {
  ...
  var stateTaskFindByEndStateEqElement = nsxApplication.getElement("workflow", "stateTaskFindByEndStateEq");
  ...
  var fieldOptions = {
    ...
    endState: {
      ...
      key: "workflow.StateTaskFindByEndStateEq.endState",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTaskFindByEndStateEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTaskFindByEndStateEq);
    var form = {
  ...
  function jsToViewModel(stateTaskFindByEndStateEq) {
    var stateTaskFindByEndStateEqViewModel = {
      // anchor:value-fields-to-model:start
      endState: ko.observable(stateTaskFindByEndStateEq.endState),
    ...
    return stateTaskFindByEndStateEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTaskFindByEndStateEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      endState: stateTaskFindByEndStateEqViewModel.endState(),
  ...
  var stateTaskFindByEndStateEqMapper = {
  ...
  return stateTaskFindByEndStateEqMapper;
});
