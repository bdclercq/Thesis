...
define(function(require) {
  ...
  var stateTaskFindByNameEqElement = nsxApplication.getElement("workflow", "stateTaskFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.StateTaskFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTaskFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTaskFindByNameEq);
    var form = {
  ...
  function jsToViewModel(stateTaskFindByNameEq) {
    var stateTaskFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(stateTaskFindByNameEq.name),
    ...
    return stateTaskFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTaskFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: stateTaskFindByNameEqViewModel.name(),
  ...
  var stateTaskFindByNameEqMapper = {
  ...
  return stateTaskFindByNameEqMapper;
});
