...
define(function(require) {
  ...
  var stateTimerFindAllStateTimersElement = nsxApplication.getElement("workflow", "stateTimerFindAllStateTimers");
  ...
  function jsToFormModel(stateTimerFindAllStateTimers, fieldFilter) {
    var detailModel = jsToViewModel(stateTimerFindAllStateTimers);
    var form = {
  ...
  function jsToViewModel(stateTimerFindAllStateTimers) {
    var stateTimerFindAllStateTimersViewModel = {
    ...
    return stateTimerFindAllStateTimersViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTimerFindAllStateTimersViewModel) {
    var jsData = {
  ...
  var stateTimerFindAllStateTimersMapper = {
  ...
  return stateTimerFindAllStateTimersMapper;
});
