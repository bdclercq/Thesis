...
define(function(require) {
  ...
  var stateTimerFindByBeginStateEqElement = nsxApplication.getElement("workflow", "stateTimerFindByBeginStateEq");
  ...
  var fieldOptions = {
    ...
    beginState: {
      ...
      key: "workflow.StateTimerFindByBeginStateEq.beginState",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTimerFindByBeginStateEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTimerFindByBeginStateEq);
    var form = {
  ...
  function jsToViewModel(stateTimerFindByBeginStateEq) {
    var stateTimerFindByBeginStateEqViewModel = {
      // anchor:value-fields-to-model:start
      beginState: ko.observable(stateTimerFindByBeginStateEq.beginState),
    ...
    return stateTimerFindByBeginStateEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTimerFindByBeginStateEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      beginState: stateTimerFindByBeginStateEqViewModel.beginState(),
  ...
  var stateTimerFindByBeginStateEqMapper = {
  ...
  return stateTimerFindByBeginStateEqMapper;
});
