...
define(function(require) {
  ...
  var stateTimerFindByTargetStateEqElement = nsxApplication.getElement("workflow", "stateTimerFindByTargetStateEq");
  ...
  var fieldOptions = {
    ...
    targetState: {
      ...
      key: "workflow.StateTimerFindByTargetStateEq.targetState",
      isValueType: false
    }
  ...
  function jsToFormModel(stateTimerFindByTargetStateEq, fieldFilter) {
    var detailModel = jsToViewModel(stateTimerFindByTargetStateEq);
    var form = {
  ...
  function jsToViewModel(stateTimerFindByTargetStateEq) {
    var stateTimerFindByTargetStateEqViewModel = {
      // anchor:value-fields-to-model:start
      targetState: ko.observable(stateTimerFindByTargetStateEq.targetState),
    ...
    return stateTimerFindByTargetStateEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTimerFindByTargetStateEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      targetState: stateTimerFindByTargetStateEqViewModel.targetState(),
  ...
  var stateTimerFindByTargetStateEqMapper = {
  ...
  return stateTimerFindByTargetStateEqMapper;
});
