...
define(function (require) {
  ...
  var TimeTaskTableView = require('workflow/timeTask/timeTask-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.TimeTask.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.TimeTask.menu.title");
    ...
    var table = TimeTaskTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
