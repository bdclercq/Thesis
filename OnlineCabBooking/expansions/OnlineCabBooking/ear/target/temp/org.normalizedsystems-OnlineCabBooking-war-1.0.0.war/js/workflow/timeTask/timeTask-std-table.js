...
define(function (require) {
  ...
  var TimeTaskSorting = require('workflow/timeTask/timeTask-sorting');
  var TimeTaskInfoModel = require('workflow/timeTask/timeTask-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = TimeTaskSorting.defineSorting();
    var dataUpdate = TimeTaskEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: TimeTaskInfoModel
    });

    var infoListView = "workflow/timeTask-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
