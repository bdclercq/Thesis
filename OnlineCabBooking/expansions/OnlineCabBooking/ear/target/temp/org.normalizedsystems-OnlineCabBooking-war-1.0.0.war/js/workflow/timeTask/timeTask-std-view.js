...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) TimeTask!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = TimeTaskEvents.defineViewIntentListener();

      var config = {
        title: 'TimeTask',
        projection: 'details',
        projector: 'workflow/timeTask/timeTask-projector',
        modeller: 'workflow/timeTask/timeTask-details-instance-model',
        view: 'workflow/timeTask-details-instance'
      };
