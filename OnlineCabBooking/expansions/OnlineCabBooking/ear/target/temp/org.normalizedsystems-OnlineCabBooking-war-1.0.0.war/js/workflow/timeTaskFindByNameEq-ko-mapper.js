...
define(function(require) {
  ...
  var timeTaskFindByNameEqElement = nsxApplication.getElement("workflow", "timeTaskFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.TimeTaskFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(timeTaskFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(timeTaskFindByNameEq);
    var form = {
  ...
  function jsToViewModel(timeTaskFindByNameEq) {
    var timeTaskFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(timeTaskFindByNameEq.name),
    ...
    return timeTaskFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeTaskFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: timeTaskFindByNameEqViewModel.name(),
  ...
  var timeTaskFindByNameEqMapper = {
  ...
  return timeTaskFindByNameEqMapper;
});
