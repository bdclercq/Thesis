...
define(function(require) {
  ...
  var timeTaskFindByWorkflowEqElement = nsxApplication.getElement("workflow", "timeTaskFindByWorkflowEq");
  ...
  var fieldOptions = {
    ...
    workflow: {
      ...
      key: "workflow.TimeTaskFindByWorkflowEq.workflow",
      isValueType: false
    }
  ...
  function jsToFormModel(timeTaskFindByWorkflowEq, fieldFilter) {
    var detailModel = jsToViewModel(timeTaskFindByWorkflowEq);
    var form = {
  ...
  function jsToViewModel(timeTaskFindByWorkflowEq) {
    var timeTaskFindByWorkflowEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      workflow: ko.observable(timeTaskFindByWorkflowEq.workflow),
  ...
  var timeTaskFindByWorkflowEqMapper = {
  ...
  return timeTaskFindByWorkflowEqMapper;
});
