...
define(function (require) {
  ...
  var TimeWindowTableView = require('workflow/timeWindow/timeWindow-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.TimeWindow.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.TimeWindow.menu.title");
    ...
    var table = TimeWindowTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
