...
define(function (require) {
  ...
  var TimeWindowFinders = require('workflow/timeWindow/timeWindow-finders');
  var TimeWindowStdTable = require('workflow/timeWindow/timeWindow-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = TimeWindowFinders.finderWith(constantFields);
    var finderOptions = TimeWindowFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = TimeWindowEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineTimeWindowList(widget, input) {
    return TimeWindowStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TimeWindowEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: TimeWindowEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: TimeWindowEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: TimeWindowEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TimeWindowEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var timeWindowList = defineTimeWindowList(widget, listOptions);

    tableContext.selection = timeWindowList.selection;
    ...
    var pagination = definePagination(toolbar, timeWindowList.listModel);
    ...
    return {
      injector: widget,
      selection: timeWindowList.selection
    };
  }
