...
define(function(require) {
  ...
  var timeWindowFindByNameEqElement = nsxApplication.getElement("workflow", "timeWindowFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.TimeWindowFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(timeWindowFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(timeWindowFindByNameEq);
    var form = {
  ...
  function jsToViewModel(timeWindowFindByNameEq) {
    var timeWindowFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(timeWindowFindByNameEq.name),
    ...
    return timeWindowFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeWindowFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: timeWindowFindByNameEqViewModel.name(),
  ...
  var timeWindowFindByNameEqMapper = {
  ...
  return timeWindowFindByNameEqMapper;
});
