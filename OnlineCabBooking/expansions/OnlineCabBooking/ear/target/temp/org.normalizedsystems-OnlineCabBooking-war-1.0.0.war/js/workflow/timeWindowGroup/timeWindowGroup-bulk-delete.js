...
define(function (require) {
  ...
  const TimeWindowGroupActions = require('workflow/timeWindowGroup/timeWindowGroup-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = TimeWindowGroupEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = TimeWindowGroupActions.deleteMultipleAction();
