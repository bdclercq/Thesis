...
define(function (require) {
  ...
  const WorkflowActions = require('workflow/workflow/workflow-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = WorkflowEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = WorkflowActions.deleteMultipleAction();
