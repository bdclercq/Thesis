...
define(function (require) {
  ...
  var WorkflowTableView = require('workflow/workflow/workflow-table-view');
  ...
  var WorkflowWaterfall = require('workflow/workflow/workflow-waterfall');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.Workflow.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.Workflow.menu.title");
    ...
    var table = WorkflowTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
    ...
    var waterfall = WorkflowWaterfall.defineWaterfall({
