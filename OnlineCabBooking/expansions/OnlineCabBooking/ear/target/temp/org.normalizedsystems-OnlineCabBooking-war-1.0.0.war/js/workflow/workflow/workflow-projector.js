...
define(function(require) {
  ...
  var workflowMetaData = require("dataElement!workflow.workflow");
  var workflowAgent = workflowMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "workflow.workflow.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = WorkflowEvents.defineCreateUpdateListener();
    var dataEdit = WorkflowEvents.defineEditUpdateListener();
    var dataRefresh = WorkflowEvents.defineRefreshUpdateListener();
    var dataDelete = WorkflowEvents.defineDeleteUpdateListener();
    var dataFinder = WorkflowEvents.defineFinderUpdateListener();
