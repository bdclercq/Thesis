...
define(function(require) {
  ...
  var workflowFindByNameEqElement = nsxApplication.getElement("workflow", "workflowFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.WorkflowFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(workflowFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(workflowFindByNameEq);
    var form = {
  ...
  function jsToViewModel(workflowFindByNameEq) {
    var workflowFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(workflowFindByNameEq.name),
    ...
    return workflowFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(workflowFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: workflowFindByNameEqViewModel.name(),
  ...
  var workflowFindByNameEqMapper = {
  ...
  return workflowFindByNameEqMapper;
});
