...
define(function (require) {
  ...
  const AccountActions = require('account/account/account-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = AccountEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = AccountActions.deleteMultipleAction();
