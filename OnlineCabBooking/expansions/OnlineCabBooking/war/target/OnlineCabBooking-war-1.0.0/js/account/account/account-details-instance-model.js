  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(accountDetails) {
      if (!!accountDetails) {
        ...
        viewmodel.address(accountDetails.address);
        viewmodel.zipCode(accountDetails.zipCode);
        viewmodel.city(accountDetails.city);
        viewmodel.country(accountDetails.country);
        viewmodel.email(accountDetails.email);
        viewmodel.phone(accountDetails.phone);
        viewmodel.style(accountDetails.style);
