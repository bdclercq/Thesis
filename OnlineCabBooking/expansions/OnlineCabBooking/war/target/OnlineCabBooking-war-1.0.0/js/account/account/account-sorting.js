...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.refId = SortableColumn.defineSortableColumn({
      fieldName: "refId"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "refId";
        }
      })
    });
    ...
    viewModel.address = SortableColumn.defineSortableColumn({
      fieldName: "address"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "address";
        }
      })
    });

    viewModel.zipCode = SortableColumn.defineSortableColumn({
      fieldName: "zipCode"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "zipCode";
        }
      })
    });
    ...
    viewModel.country = SortableColumn.defineSortableColumn({
      fieldName: "country"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "country";
        }
      })
    });
    ...
    viewModel.phone = SortableColumn.defineSortableColumn({
      fieldName: "phone"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "phone";
        }
      })
    });

    viewModel.style = SortableColumn.defineSortableColumn({
      fieldName: "style"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "style";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.refId.select);
    selectSorting.addTrigger(viewModel.fullName.select);
    selectSorting.addTrigger(viewModel.address.select);
    selectSorting.addTrigger(viewModel.zipCode.select);
    selectSorting.addTrigger(viewModel.city.select);
    selectSorting.addTrigger(viewModel.country.select);
    selectSorting.addTrigger(viewModel.email.select);
    selectSorting.addTrigger(viewModel.phone.select);
    selectSorting.addTrigger(viewModel.style.select);
