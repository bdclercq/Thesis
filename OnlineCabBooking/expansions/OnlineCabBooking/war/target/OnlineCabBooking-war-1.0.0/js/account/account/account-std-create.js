...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) Account element!")
    });

    function render() {
      var createIntent = AccountEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: AccountActions.createAction()
      };
