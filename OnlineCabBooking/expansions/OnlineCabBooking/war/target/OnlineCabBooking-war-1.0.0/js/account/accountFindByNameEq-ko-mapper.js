...
define(function(require) {
  ...
  var accountFindByNameEqElement = nsxApplication.getElement("account", "accountFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.AccountFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(accountFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(accountFindByNameEq);
    var form = {
  ...
  function jsToViewModel(accountFindByNameEq) {
    var accountFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(accountFindByNameEq.name),
    ...
    return accountFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(accountFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: accountFindByNameEqViewModel.name(),
  ...
  return accountFindByNameEqMapper;
});
