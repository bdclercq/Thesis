...
define(function(require) {
  ...
  var accountFindByStatusEqElement = nsxApplication.getElement("account", "accountFindByStatusEq");
  ...
  var fieldOptions = {
    ...
    status: {
      ...
      key: "account.AccountFindByStatusEq.status",
      isValueType: false
    }
  ...
  function jsToFormModel(accountFindByStatusEq, fieldFilter) {
    var detailModel = jsToViewModel(accountFindByStatusEq);
    var form = {
  ...
  function jsToViewModel(accountFindByStatusEq) {
    var accountFindByStatusEqViewModel = {
      // anchor:value-fields-to-model:start
      status: ko.observable(accountFindByStatusEq.status),
    ...
    return accountFindByStatusEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(accountFindByStatusEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      status: accountFindByStatusEqViewModel.status(),
  ...
  var accountFindByStatusEqMapper = {
  ...
  return accountFindByStatusEqMapper;
});
