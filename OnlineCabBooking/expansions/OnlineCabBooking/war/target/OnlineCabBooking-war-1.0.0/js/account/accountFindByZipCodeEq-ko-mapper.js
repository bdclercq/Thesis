...
define(function(require) {
  ...
  var accountFindByZipCodeEqElement = nsxApplication.getElement("account", "accountFindByZipCodeEq");
  ...
  var fieldOptions = {
    ...
    zipCode: {
      ...
      key: "account.AccountFindByZipCodeEq.zipCode",
      isValueType: false
    }
  ...
  function jsToFormModel(accountFindByZipCodeEq, fieldFilter) {
    var detailModel = jsToViewModel(accountFindByZipCodeEq);
    var form = {
  ...
  function jsToViewModel(accountFindByZipCodeEq) {
    var accountFindByZipCodeEqViewModel = {
      // anchor:value-fields-to-model:start
      zipCode: ko.observable(accountFindByZipCodeEq.zipCode),
    ...
    return accountFindByZipCodeEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(accountFindByZipCodeEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      zipCode: accountFindByZipCodeEqViewModel.zipCode(),
  ...
  var accountFindByZipCodeEqMapper = {
  ...
  return accountFindByZipCodeEqMapper;
});
