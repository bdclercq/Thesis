...
/**
 * Lists all the finders for the 'component' element
 */
define(function (require) {
  ...
  var componentElement = nsxApplication.getElement("account", "component");
  var componentAgent = nsxAgent.createAgent(componentElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllComponents";
    var component = "account";
    var element = "component";
    var translation = translate("account.component.findAllComponents");
    ...
    function find(options){
      ...
      return componentAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "account";
    var element = "component";
    var translation = translate("account.component.findByNameEq");
