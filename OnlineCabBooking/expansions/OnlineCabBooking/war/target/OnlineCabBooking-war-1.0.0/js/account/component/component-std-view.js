...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Component!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = ComponentEvents.defineViewIntentListener();

      var config = {
        title: 'Component',
        projection: 'details',
        projector: 'account/component/component-projector',
        modeller: 'account/component/component-details-instance-model',
        view: 'account/component-details-instance'
      };
