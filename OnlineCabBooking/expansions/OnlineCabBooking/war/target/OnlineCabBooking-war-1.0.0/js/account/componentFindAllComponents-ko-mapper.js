...
define(function(require) {
  ...
  var componentFindAllComponentsElement = nsxApplication.getElement("account", "componentFindAllComponents");
  ...
  function jsToFormModel(componentFindAllComponents, fieldFilter) {
    var detailModel = jsToViewModel(componentFindAllComponents);
    var form = {
  ...
  function jsToViewModel(componentFindAllComponents) {
    var componentFindAllComponentsViewModel = {
    ...
    return componentFindAllComponentsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(componentFindAllComponentsViewModel) {
    var jsData = {
  ...
  var componentFindAllComponentsMapper = {
  ...
  return componentFindAllComponentsMapper;
});
