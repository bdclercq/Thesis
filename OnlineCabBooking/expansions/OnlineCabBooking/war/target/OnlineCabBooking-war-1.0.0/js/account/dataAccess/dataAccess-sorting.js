...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.element = SortableColumn.defineSortableColumn({
      fieldName: "element"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "element";
        }
      })
    });
    ...
    viewModel.functionality = SortableColumn.defineSortableColumn({
      fieldName: "functionality"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "functionality";
        }
      })
    });

    viewModel.authorized = SortableColumn.defineSortableColumn({
      fieldName: "authorized"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "authorized";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.element.select);
    selectSorting.addTrigger(viewModel.target.select);
    selectSorting.addTrigger(viewModel.functionality.select);
    selectSorting.addTrigger(viewModel.authorized.select);
