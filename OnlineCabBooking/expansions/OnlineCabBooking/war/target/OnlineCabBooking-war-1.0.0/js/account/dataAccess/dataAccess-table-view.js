...
define(function (require) {
  ...
  var DataAccessFinders = require('account/dataAccess/dataAccess-finders');
  var DataAccessStdTable = require('account/dataAccess/dataAccess-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = DataAccessFinders.finderWith(constantFields);
    var finderOptions = DataAccessFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = DataAccessEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineDataAccessList(widget, input) {
    return DataAccessStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: DataAccessEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: DataAccessEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: DataAccessEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: DataAccessEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: DataAccessEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var dataAccessList = defineDataAccessList(widget, listOptions);

    tableContext.selection = dataAccessList.selection;
    ...
    var pagination = definePagination(toolbar, dataAccessList.listModel);
    ...
    return {
      injector: widget,
      selection: dataAccessList.selection
    };
  }
