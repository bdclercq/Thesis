...
define(function(require) {
  ...
  var dataAccessFindByForProfileEqElement = nsxApplication.getElement("account", "dataAccessFindByForProfileEq");
  ...
  var fieldOptions = {
    ...
    forProfile: {
      ...
      key: "account.DataAccessFindByForProfileEq.forProfile",
      isValueType: false
    }
  ...
  function jsToFormModel(dataAccessFindByForProfileEq, fieldFilter) {
    var detailModel = jsToViewModel(dataAccessFindByForProfileEq);
    var form = {
  ...
  function jsToViewModel(dataAccessFindByForProfileEq) {
    var dataAccessFindByForProfileEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      forProfile: ko.observable(dataAccessFindByForProfileEq.forProfile),
    ...
    return dataAccessFindByForProfileEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(dataAccessFindByForProfileEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      forProfile: dataAccessFindByForProfileEqViewModel.forProfile(),
  ...
  var dataAccessFindByForProfileEqMapper = {
  ...
  return dataAccessFindByForProfileEqMapper;
});
