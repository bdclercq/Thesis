...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "account.HelpInfo.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "account.HelpInfo.name",
      isValueType: false
    },
    {
      fieldName: "description",
      type: FieldType.VALUE,
      key: "account.HelpInfo.description",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || HelpInfoActions.editAction();
