...
define(function(require) {
  ...
  var helpInfoMetaData = require("dataElement!account.helpInfo");
  var helpInfoAgent = helpInfoMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "account.helpInfo.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = HelpInfoEvents.defineCreateUpdateListener();
    var dataEdit = HelpInfoEvents.defineEditUpdateListener();
    var dataRefresh = HelpInfoEvents.defineRefreshUpdateListener();
    var dataDelete = HelpInfoEvents.defineDeleteUpdateListener();
    var dataFinder = HelpInfoEvents.defineFinderUpdateListener();
