...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) HelpInfo element!")
    });

    function render() {
      var createIntent = HelpInfoEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: HelpInfoActions.createAction()
      };
