...
define(function (require) {
  ...
  const MenuActions = require('account/menu/menu-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = MenuEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = MenuActions.deleteMultipleAction();
