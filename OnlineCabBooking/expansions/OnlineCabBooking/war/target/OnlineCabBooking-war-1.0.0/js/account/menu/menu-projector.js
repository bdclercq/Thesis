...
define(function(require) {
  ...
  var menuMetaData = require("dataElement!account.menu");
  var menuAgent = menuMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "account.menu.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = MenuEvents.defineCreateUpdateListener();
    var dataEdit = MenuEvents.defineEditUpdateListener();
    var dataRefresh = MenuEvents.defineRefreshUpdateListener();
    var dataDelete = MenuEvents.defineDeleteUpdateListener();
    var dataFinder = MenuEvents.defineFinderUpdateListener();
