...
define(function(require) {
  ...
  var menuFindAllMenusElement = nsxApplication.getElement("account", "menuFindAllMenus");
  ...
  function jsToFormModel(menuFindAllMenus, fieldFilter) {
    var detailModel = jsToViewModel(menuFindAllMenus);
    var form = {
  ...
  function jsToViewModel(menuFindAllMenus) {
    var menuFindAllMenusViewModel = {
    ...
    return menuFindAllMenusViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuFindAllMenusViewModel) {
    var jsData = {
