...
define(function(require) {
  ...
  var menuFindByPortalEq_ProfileEqElement = nsxApplication.getElement("account", "menuFindByPortalEq_ProfileEq");
  ...
  var fieldOptions = {
    ...
    portal: {
      ...
      key: "account.MenuFindByPortalEq_ProfileEq.portal",
      isValueType: false
    },
    profile: {
      fieldName: "profile",
      type: FieldType.DATAREF,
      key: "account.MenuFindByPortalEq_ProfileEq.profile",
      isValueType: false
    }
  ...
  function jsToFormModel(menuFindByPortalEq_ProfileEq, fieldFilter) {
    var detailModel = jsToViewModel(menuFindByPortalEq_ProfileEq);
    var form = {
  ...
  function jsToViewModel(menuFindByPortalEq_ProfileEq) {
    var menuFindByPortalEq_ProfileEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      portal: ko.observable(menuFindByPortalEq_ProfileEq.portal),
      profile: ko.observable(menuFindByPortalEq_ProfileEq.profile),
    ...
    return menuFindByPortalEq_ProfileEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuFindByPortalEq_ProfileEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      portal: menuFindByPortalEq_ProfileEqViewModel.portal(),
      profile: menuFindByPortalEq_ProfileEqViewModel.profile(),
  ...
  var menuFindByPortalEq_ProfileEqMapper = {
  ...
  return menuFindByPortalEq_ProfileEqMapper;
});
