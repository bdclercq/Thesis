  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        name: ko.observable(),
        menu: defineLink(MenuEvents),
        screen: defineLink(ScreenEvents),
        menuItem: defineLink(MenuItemEvents),
        submenuItems: ko.observable(),
    ...
    function updateViewmodel(menuItemDetails) {
      if (!!menuItemDetails) {
        viewmodel.id(menuItemDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(menuItemDetails.name);
        viewmodel.menu.value(menuItemDetails.menu);
        viewmodel.screen.value(menuItemDetails.screen);
        viewmodel.menuItem.value(menuItemDetails.menuItem);
        viewmodel.submenuItems(menuItemDetails.submenuItems);
        viewmodel.sortOrder(menuItemDetails.sortOrder);
