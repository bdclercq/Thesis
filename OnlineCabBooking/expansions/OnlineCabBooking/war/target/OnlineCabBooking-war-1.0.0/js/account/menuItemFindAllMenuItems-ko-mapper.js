...
define(function(require) {
  ...
  var menuItemFindAllMenuItemsElement = nsxApplication.getElement("account", "menuItemFindAllMenuItems");
  ...
  function jsToFormModel(menuItemFindAllMenuItems, fieldFilter) {
    var detailModel = jsToViewModel(menuItemFindAllMenuItems);
    var form = {
  ...
  function jsToViewModel(menuItemFindAllMenuItems) {
    var menuItemFindAllMenuItemsViewModel = {
    ...
    return menuItemFindAllMenuItemsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuItemFindAllMenuItemsViewModel) {
    var jsData = {
  ...
  var menuItemFindAllMenuItemsMapper = {
  ...
  return menuItemFindAllMenuItemsMapper;
});
