...
define(function(require) {
  ...
  var menuItemFindBySortOrderGtElement = nsxApplication.getElement("account", "menuItemFindBySortOrderGt");
  ...
  var fieldOptions = {
    ...
    sortOrder: {
      ...
      key: "account.MenuItemFindBySortOrderGt.sortOrder",
      isValueType: false
    }
  ...
  function jsToFormModel(menuItemFindBySortOrderGt, fieldFilter) {
    var detailModel = jsToViewModel(menuItemFindBySortOrderGt);
    var form = {
  ...
  function jsToViewModel(menuItemFindBySortOrderGt) {
    var menuItemFindBySortOrderGtViewModel = {
      // anchor:value-fields-to-model:start
      sortOrder: ko.observable(menuItemFindBySortOrderGt.sortOrder),
    ...
    return menuItemFindBySortOrderGtViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(menuItemFindBySortOrderGtViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      sortOrder: menuItemFindBySortOrderGtViewModel.sortOrder(),
  ...
  var menuItemFindBySortOrderGtMapper = {
  ...
  return menuItemFindBySortOrderGtMapper;
});
