...
define(function (require) {
  ...
  var PortalTableView = require('account/portal/portal-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.Portal.page.title")
    };
    var viewModel = {};
    var title = translate("account.Portal.menu.title");
    ...
    var table = PortalTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
