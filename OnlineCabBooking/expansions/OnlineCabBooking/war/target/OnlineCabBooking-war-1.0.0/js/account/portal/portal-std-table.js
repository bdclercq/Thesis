...
define(function (require) {
  ...
  var PortalSorting = require('account/portal/portal-sorting');
  var PortalInfoModel = require('account/portal/portal-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = PortalSorting.defineSorting();
    var dataUpdate = PortalEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: PortalInfoModel
    });

    var infoListView = "account/portal-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
