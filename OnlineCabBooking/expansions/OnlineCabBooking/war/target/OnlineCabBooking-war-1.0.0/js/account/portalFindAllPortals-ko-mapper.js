...
define(function(require) {
  ...
  var portalFindAllPortalsElement = nsxApplication.getElement("account", "portalFindAllPortals");
  ...
  function jsToFormModel(portalFindAllPortals, fieldFilter) {
    var detailModel = jsToViewModel(portalFindAllPortals);
    var form = {
  ...
  function jsToViewModel(portalFindAllPortals) {
    var portalFindAllPortalsViewModel = {
    ...
    return portalFindAllPortalsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(portalFindAllPortalsViewModel) {
    var jsData = {
  ...
  var portalFindAllPortalsMapper = {
  ...
  return portalFindAllPortalsMapper;
});
