...
define(function(require) {
  ...
  var portalFindByNameEqElement = nsxApplication.getElement("account", "portalFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.PortalFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(portalFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(portalFindByNameEq);
    var form = {
  ...
  function jsToViewModel(portalFindByNameEq) {
    var portalFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(portalFindByNameEq.name),
    ...
    return portalFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(portalFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: portalFindByNameEqViewModel.name(),
  ...
  return portalFindByNameEqMapper;
});
