...
/**
 * Lists all the finders for the 'profile' element
 */
define(function (require) {
  ...
  var profileElement = nsxApplication.getElement("account", "profile");
  var profileAgent = nsxAgent.createAgent(profileElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllProfiles";
    var component = "account";
    var element = "profile";
    var translation = translate("account.profile.findAllProfiles");
    ...
    function find(options){
      ...
      return profileAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "account";
    var element = "profile";
    var translation = translate("account.profile.findByNameEq");
  ...
  function findByUserGroupEq(options) {
    var name = "findByUserGroupEq";
    var component = "account";
    var element = "profile";
    var translation = translate("account.profile.findByUserGroupEq");

    function find(options){
      var findOptions = {
        searchMethod: "findByUserGroupEq",
        details: options.details,
        rowsPerPage: options.rowsPerPage,
        page: options.page,
        projection: options.projection,
  ...
  findByUserGroupEq.fields = ["userGroup"];
  findByUserGroupEq.fieldOperatorPairs = ["userGroup:eq"];
  // anchor:finders:end
  ...
  return {
    ...
    findByUserGroupEq: findByUserGroupEq,
