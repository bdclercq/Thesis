...
define(function (require) {
  ...
  function defineCreateDialog(options) {
    ...
    when(createRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to create a(n) Profile element!")
    });

    function render() {
      var createIntent = ProfileEvents.defineCreateIntentListener();
      ...
      var formOptions = {
        ...
        action: ProfileActions.createAction()
      };
