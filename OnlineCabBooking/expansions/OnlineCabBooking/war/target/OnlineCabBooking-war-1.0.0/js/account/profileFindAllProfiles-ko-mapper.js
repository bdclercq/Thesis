...
define(function(require) {
  ...
  var profileFindAllProfilesElement = nsxApplication.getElement("account", "profileFindAllProfiles");
  ...
  function jsToFormModel(profileFindAllProfiles, fieldFilter) {
    var detailModel = jsToViewModel(profileFindAllProfiles);
    var form = {
  ...
  function jsToViewModel(profileFindAllProfiles) {
    var profileFindAllProfilesViewModel = {
    ...
    return profileFindAllProfilesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(profileFindAllProfilesViewModel) {
    var jsData = {
  ...
  var profileFindAllProfilesMapper = {
  ...
  return profileFindAllProfilesMapper;
});
