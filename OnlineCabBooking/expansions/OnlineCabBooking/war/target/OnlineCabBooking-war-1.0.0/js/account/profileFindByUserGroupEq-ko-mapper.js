...
define(function(require) {
  ...
  var profileFindByUserGroupEqElement = nsxApplication.getElement("account", "profileFindByUserGroupEq");
  ...
  var fieldOptions = {
    ...
    userGroup: {
      ...
      key: "account.ProfileFindByUserGroupEq.userGroup",
      isValueType: false
    }
  ...
  function jsToFormModel(profileFindByUserGroupEq, fieldFilter) {
    var detailModel = jsToViewModel(profileFindByUserGroupEq);
    var form = {
  ...
  function jsToViewModel(profileFindByUserGroupEq) {
    var profileFindByUserGroupEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      userGroup: ko.observable(profileFindByUserGroupEq.userGroup),
  ...
  var profileFindByUserGroupEqMapper = {
  ...
  return profileFindByUserGroupEqMapper;
});
