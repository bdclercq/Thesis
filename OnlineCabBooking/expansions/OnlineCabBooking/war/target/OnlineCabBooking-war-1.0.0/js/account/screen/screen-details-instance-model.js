  ...
  function defineInstanceView(input, options) {
    ...
    function initViewmodel() {
      return {
        ...
        component: defineLink(ComponentEvents)
    ...
    function updateViewmodel(screenDetails) {
      if (!!screenDetails) {
        viewmodel.id(screenDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(screenDetails.name);
        viewmodel.link(screenDetails.link);
        viewmodel.sortOrder(screenDetails.sortOrder);
        viewmodel.component.value(screenDetails.component);
