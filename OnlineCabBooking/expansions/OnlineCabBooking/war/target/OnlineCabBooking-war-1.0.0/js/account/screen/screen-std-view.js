...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Screen!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = ScreenEvents.defineViewIntentListener();

      var config = {
        title: 'Screen',
        projection: 'details',
        projector: 'account/screen/screen-projector',
        modeller: 'account/screen/screen-details-instance-model',
        view: 'account/screen-details-instance'
      };
