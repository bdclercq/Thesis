...
define(function(require) {
  ...
  var screenFindByLinkEqElement = nsxApplication.getElement("account", "screenFindByLinkEq");
  ...
  var fieldOptions = {
    ...
    link: {
      ...
      key: "account.ScreenFindByLinkEq.link",
      isValueType: false
    }
  ...
  function jsToFormModel(screenFindByLinkEq, fieldFilter) {
    var detailModel = jsToViewModel(screenFindByLinkEq);
    var form = {
  ...
  function jsToViewModel(screenFindByLinkEq) {
    var screenFindByLinkEqViewModel = {
      // anchor:value-fields-to-model:start
      link: ko.observable(screenFindByLinkEq.link),
    ...
    return screenFindByLinkEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(screenFindByLinkEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      link: screenFindByLinkEqViewModel.link(),
  ...
  return screenFindByLinkEqMapper;
});
