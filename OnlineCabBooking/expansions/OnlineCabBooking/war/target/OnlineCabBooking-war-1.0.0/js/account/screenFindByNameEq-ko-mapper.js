...
define(function(require) {
  ...
  var screenFindByNameEqElement = nsxApplication.getElement("account", "screenFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "account.ScreenFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(screenFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(screenFindByNameEq);
    var form = {
  ...
  function jsToViewModel(screenFindByNameEq) {
    var screenFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(screenFindByNameEq.name),
    ...
    return screenFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(screenFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: screenFindByNameEqViewModel.name(),
  ...
  return screenFindByNameEqMapper;
});
