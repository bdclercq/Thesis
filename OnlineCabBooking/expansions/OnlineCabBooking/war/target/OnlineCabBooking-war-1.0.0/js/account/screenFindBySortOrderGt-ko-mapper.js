...
define(function(require) {
  ...
  var screenFindBySortOrderGtElement = nsxApplication.getElement("account", "screenFindBySortOrderGt");
  ...
  var fieldOptions = {
    ...
    sortOrder: {
      ...
      key: "account.ScreenFindBySortOrderGt.sortOrder",
      isValueType: false
    }
  ...
  function jsToFormModel(screenFindBySortOrderGt, fieldFilter) {
    var detailModel = jsToViewModel(screenFindBySortOrderGt);
    var form = {
  ...
  function jsToViewModel(screenFindBySortOrderGt) {
    var screenFindBySortOrderGtViewModel = {
      // anchor:value-fields-to-model:start
      sortOrder: ko.observable(screenFindBySortOrderGt.sortOrder),
    ...
    return screenFindBySortOrderGtViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(screenFindBySortOrderGtViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      sortOrder: screenFindBySortOrderGtViewModel.sortOrder(),
  ...
  var screenFindBySortOrderGtMapper = {
  ...
  return screenFindBySortOrderGtMapper;
});
