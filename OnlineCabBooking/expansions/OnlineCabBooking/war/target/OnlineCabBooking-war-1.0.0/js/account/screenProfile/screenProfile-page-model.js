...
define(function (require) {
  ...
  var ScreenProfileTableView = require('account/screenProfile/screenProfile-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.ScreenProfile.page.title")
    };
    var viewModel = {};
    var title = translate("account.ScreenProfile.menu.title");
    ...
    var table = ScreenProfileTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
