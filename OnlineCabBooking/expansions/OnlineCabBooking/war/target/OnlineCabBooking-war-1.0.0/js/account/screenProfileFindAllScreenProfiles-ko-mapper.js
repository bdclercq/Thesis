...
define(function(require) {
  ...
  var screenProfileFindAllScreenProfilesElement = nsxApplication.getElement("account", "screenProfileFindAllScreenProfiles");
  ...
  function jsToFormModel(screenProfileFindAllScreenProfiles, fieldFilter) {
    var detailModel = jsToViewModel(screenProfileFindAllScreenProfiles);
    var form = {
  ...
  function jsToViewModel(screenProfileFindAllScreenProfiles) {
    var screenProfileFindAllScreenProfilesViewModel = {
    ...
    return screenProfileFindAllScreenProfilesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(screenProfileFindAllScreenProfilesViewModel) {
    var jsData = {
  ...
  var screenProfileFindAllScreenProfilesMapper = {
  ...
  return screenProfileFindAllScreenProfilesMapper;
});
