...
define(function (require) {
  ...
  var UserTableView = require('account/user/user-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("account.User.page.title")
    };
    var viewModel = {};
    var title = translate("account.User.menu.title");
    ...
    var table = UserTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
