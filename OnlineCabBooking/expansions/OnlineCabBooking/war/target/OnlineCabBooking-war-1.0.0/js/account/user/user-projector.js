...
define(function(require) {
  ...
  var userMetaData = require("dataElement!account.user");
  var userAgent = userMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "account.user.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = UserEvents.defineCreateUpdateListener();
    var dataEdit = UserEvents.defineEditUpdateListener();
    var dataRefresh = UserEvents.defineRefreshUpdateListener();
    var dataDelete = UserEvents.defineDeleteUpdateListener();
    var dataFinder = UserEvents.defineFinderUpdateListener();
