...
define(function (require) {
  ...
  var UserSorting = require('account/user/user-sorting');
  var UserInfoModel = require('account/user/user-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = UserSorting.defineSorting();
    var dataUpdate = UserEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: UserInfoModel
    });

    var infoListView = "account/user-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
