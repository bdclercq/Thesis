...
define(function(require) {
  ...
  var userFindByProfileEqElement = nsxApplication.getElement("account", "userFindByProfileEq");
  ...
  var fieldOptions = {
    ...
    profile: {
      ...
      key: "account.UserFindByProfileEq.profile",
      isValueType: false
    }
  ...
  function jsToFormModel(userFindByProfileEq, fieldFilter) {
    var detailModel = jsToViewModel(userFindByProfileEq);
    var form = {
  ...
  function jsToViewModel(userFindByProfileEq) {
    var userFindByProfileEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      profile: ko.observable(userFindByProfileEq.profile),
  ...
  return userFindByProfileEqMapper;
});
