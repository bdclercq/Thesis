...
define(function (require) {
  ...
  const UserGroupActions = require('account/userGroup/userGroup-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = UserGroupEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = UserGroupActions.deleteMultipleAction();
