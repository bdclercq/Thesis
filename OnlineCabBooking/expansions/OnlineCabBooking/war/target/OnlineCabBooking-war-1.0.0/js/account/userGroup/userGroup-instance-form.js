...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "account.UserGroup.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "account.UserGroup.name",
      isValueType: false
    },
    {
      fieldName: "type",
      type: FieldType.VALUE,
      key: "account.UserGroup.type",
      isValueType: false
    },
    {
      fieldName: "lastModifiedAt",
      type: FieldType.DATE,
      key: "account.UserGroup.lastModifiedAt",
      isValueType: false
    },
    {
      fieldName: "enteredAt",
      type: FieldType.DATE,
      key: "account.UserGroup.enteredAt",
      isValueType: false
    },
    {
      fieldName: "disabled",
      type: FieldType.VALUE,
      key: "account.UserGroup.disabled",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || UserGroupActions.editAction();
