...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) UserGroup!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = UserGroupEvents.defineViewIntentListener();

      var config = {
        title: 'UserGroup',
        projection: 'details',
        projector: 'account/userGroup/userGroup-projector',
        modeller: 'account/userGroup/userGroup-details-instance-model',
        view: 'account/userGroup-details-instance'
      };
