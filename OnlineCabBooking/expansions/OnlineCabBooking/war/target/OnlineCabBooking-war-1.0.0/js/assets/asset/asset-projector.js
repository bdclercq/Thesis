...
define(function(require) {
  ...
  var assetMetaData = require("dataElement!assets.asset");
  var assetAgent = assetMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "assets.asset.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = AssetEvents.defineCreateUpdateListener();
    var dataEdit = AssetEvents.defineEditUpdateListener();
    var dataRefresh = AssetEvents.defineRefreshUpdateListener();
    var dataDelete = AssetEvents.defineDeleteUpdateListener();
    var dataFinder = AssetEvents.defineFinderUpdateListener();
