...
define(function(require) {
  ...
  var assetFindByNameEqElement = nsxApplication.getElement("assets", "assetFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "assets.AssetFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(assetFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(assetFindByNameEq);
    var form = {
  ...
  function jsToViewModel(assetFindByNameEq) {
    var assetFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(assetFindByNameEq.name),
    ...
    return assetFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(assetFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: assetFindByNameEqViewModel.name(),
  ...
  return assetFindByNameEqMapper;
});
