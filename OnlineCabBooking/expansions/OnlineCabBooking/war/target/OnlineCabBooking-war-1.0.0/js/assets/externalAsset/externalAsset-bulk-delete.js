...
define(function (require) {
  ...
  const ExternalAssetActions = require('assets/externalAsset/externalAsset-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = ExternalAssetEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = ExternalAssetActions.deleteMultipleAction();
