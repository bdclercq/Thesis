...
/**
 * Lists all the finders for the 'externalAsset' element
 */
define(function (require) {
  ...
  var externalAssetElement = nsxApplication.getElement("assets", "externalAsset");
  var externalAssetAgent = nsxAgent.createAgent(externalAssetElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllExternalAssets";
    var component = "assets";
    var element = "externalAsset";
    var translation = translate("assets.externalAsset.findAllExternalAssets");
    ...
    function find(options){
      ...
      return externalAssetAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "assets";
    var element = "externalAsset";
    var translation = translate("assets.externalAsset.findByNameEq");
