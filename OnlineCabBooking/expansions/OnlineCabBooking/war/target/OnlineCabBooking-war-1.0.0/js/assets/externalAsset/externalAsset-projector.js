...
define(function(require) {
  ...
  var externalAssetMetaData = require("dataElement!assets.externalAsset");
  var externalAssetAgent = externalAssetMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "assets.externalAsset.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = ExternalAssetEvents.defineCreateUpdateListener();
    var dataEdit = ExternalAssetEvents.defineEditUpdateListener();
    var dataRefresh = ExternalAssetEvents.defineRefreshUpdateListener();
    var dataDelete = ExternalAssetEvents.defineDeleteUpdateListener();
    var dataFinder = ExternalAssetEvents.defineFinderUpdateListener();
