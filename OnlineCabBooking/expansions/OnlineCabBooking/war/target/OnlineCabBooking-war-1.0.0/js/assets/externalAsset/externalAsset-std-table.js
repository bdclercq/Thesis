...
define(function (require) {
  ...
  var ExternalAssetSorting = require('assets/externalAsset/externalAsset-sorting');
  var ExternalAssetInfoModel = require('assets/externalAsset/externalAsset-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = ExternalAssetSorting.defineSorting();
    var dataUpdate = ExternalAssetEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: ExternalAssetInfoModel
    });

    var infoListView = "assets/externalAsset-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
