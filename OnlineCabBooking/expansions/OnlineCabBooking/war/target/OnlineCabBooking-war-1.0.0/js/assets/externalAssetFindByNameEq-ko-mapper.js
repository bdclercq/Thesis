...
define(function(require) {
  ...
  var externalAssetFindByNameEqElement = nsxApplication.getElement("assets", "externalAssetFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "assets.ExternalAssetFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(externalAssetFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(externalAssetFindByNameEq);
    var form = {
  ...
  function jsToViewModel(externalAssetFindByNameEq) {
    var externalAssetFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(externalAssetFindByNameEq.name),
    ...
    return externalAssetFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(externalAssetFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: externalAssetFindByNameEqViewModel.name(),
  ...
  var externalAssetFindByNameEqMapper = {
  ...
  return externalAssetFindByNameEqMapper;
});
