...
/**
 * Lists all the finders for the 'fileAsset' element
 */
define(function (require) {
  ...
  var fileAssetElement = nsxApplication.getElement("assets", "fileAsset");
  var fileAssetAgent = nsxAgent.createAgent(fileAssetElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllFileAssets";
    var component = "assets";
    var element = "fileAsset";
    var translation = translate("assets.fileAsset.findAllFileAssets");
    ...
    function find(options){
      ...
      return fileAssetAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "assets";
    var element = "fileAsset";
    var translation = translate("assets.fileAsset.findByNameEq");
