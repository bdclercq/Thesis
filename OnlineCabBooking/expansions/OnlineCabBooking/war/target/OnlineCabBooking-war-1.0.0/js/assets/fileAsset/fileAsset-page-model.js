...
define(function (require) {
  ...
  var FileAssetTableView = require('assets/fileAsset/fileAsset-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("assets.FileAsset.page.title")
    };
    var viewModel = {};
    var title = translate("assets.FileAsset.menu.title");
    ...
    var table = FileAssetTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
