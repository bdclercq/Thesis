...
define(function(require) {
  ...
  var fileAssetFindAllFileAssetsElement = nsxApplication.getElement("assets", "fileAssetFindAllFileAssets");
  ...
  function jsToFormModel(fileAssetFindAllFileAssets, fieldFilter) {
    var detailModel = jsToViewModel(fileAssetFindAllFileAssets);
    var form = {
  ...
  function jsToViewModel(fileAssetFindAllFileAssets) {
    var fileAssetFindAllFileAssetsViewModel = {
    ...
    return fileAssetFindAllFileAssetsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(fileAssetFindAllFileAssetsViewModel) {
    var jsData = {
  ...
  var fileAssetFindAllFileAssetsMapper = {
  ...
  return fileAssetFindAllFileAssetsMapper;
});
