...
define(function(require) {
  ...
  var fileAssetFindByNameEqElement = nsxApplication.getElement("assets", "fileAssetFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "assets.FileAssetFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(fileAssetFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(fileAssetFindByNameEq);
    var form = {
  ...
  function jsToViewModel(fileAssetFindByNameEq) {
    var fileAssetFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(fileAssetFindByNameEq.name),
    ...
    return fileAssetFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(fileAssetFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: fileAssetFindByNameEqViewModel.name(),
  ...
  var fileAssetFindByNameEqMapper = {
  ...
  return fileAssetFindByNameEqMapper;
});
