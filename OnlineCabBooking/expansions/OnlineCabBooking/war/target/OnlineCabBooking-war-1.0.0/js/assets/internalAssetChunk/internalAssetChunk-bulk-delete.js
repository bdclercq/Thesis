...
define(function (require) {
  ...
  const InternalAssetChunkActions = require('assets/internalAssetChunk/internalAssetChunk-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = InternalAssetChunkEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = InternalAssetChunkActions.deleteMultipleAction();
