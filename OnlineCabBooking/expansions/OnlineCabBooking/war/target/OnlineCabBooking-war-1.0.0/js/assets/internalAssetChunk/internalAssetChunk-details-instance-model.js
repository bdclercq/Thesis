...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(internalAssetChunkDetails) {
      if (!!internalAssetChunkDetails) {
        viewmodel.id(internalAssetChunkDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(internalAssetChunkDetails.name);
        viewmodel.content(internalAssetChunkDetails.content);
        viewmodel.internalAsset.value(internalAssetChunkDetails.internalAsset);
        viewmodel.byteSize(internalAssetChunkDetails.byteSize);
        viewmodel.position(internalAssetChunkDetails.position);
        viewmodel.isLast(internalAssetChunkDetails.isLast);
