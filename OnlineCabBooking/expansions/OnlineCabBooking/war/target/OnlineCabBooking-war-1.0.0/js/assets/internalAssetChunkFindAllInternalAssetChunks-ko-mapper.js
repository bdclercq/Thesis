...
define(function(require) {
  ...
  var internalAssetChunkFindAllInternalAssetChunksElement = nsxApplication.getElement("assets", "internalAssetChunkFindAllInternalAssetChunks");
  ...
  function jsToFormModel(internalAssetChunkFindAllInternalAssetChunks, fieldFilter) {
    var detailModel = jsToViewModel(internalAssetChunkFindAllInternalAssetChunks);
    var form = {
  ...
  function jsToViewModel(internalAssetChunkFindAllInternalAssetChunks) {
    var internalAssetChunkFindAllInternalAssetChunksViewModel = {
    ...
    return internalAssetChunkFindAllInternalAssetChunksViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(internalAssetChunkFindAllInternalAssetChunksViewModel) {
    var jsData = {
  ...
  var internalAssetChunkFindAllInternalAssetChunksMapper = {
  ...
  return internalAssetChunkFindAllInternalAssetChunksMapper;
});
