...
define(function(require) {
  ...
  var internalAssetChunkFindByInternalAssetEqElement = nsxApplication.getElement("assets", "internalAssetChunkFindByInternalAssetEq");
  ...
  var fieldOptions = {
    ...
    internalAsset: {
      ...
      key: "assets.InternalAssetChunkFindByInternalAssetEq.internalAsset",
      isValueType: false
    }
  ...
  function jsToFormModel(internalAssetChunkFindByInternalAssetEq, fieldFilter) {
    var detailModel = jsToViewModel(internalAssetChunkFindByInternalAssetEq);
    var form = {
  ...
  function jsToViewModel(internalAssetChunkFindByInternalAssetEq) {
    var internalAssetChunkFindByInternalAssetEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      internalAsset: ko.observable(internalAssetChunkFindByInternalAssetEq.internalAsset),
    ...
    return internalAssetChunkFindByInternalAssetEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(internalAssetChunkFindByInternalAssetEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      internalAsset: internalAssetChunkFindByInternalAssetEqViewModel.internalAsset(),
  ...
  var internalAssetChunkFindByInternalAssetEqMapper = {
  ...
  return internalAssetChunkFindByInternalAssetEqMapper;
});
