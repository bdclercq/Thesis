...
/**
 * Lists all the finders for the 'remoteAsset' element
 */
define(function (require) {
  ...
  var remoteAssetElement = nsxApplication.getElement("assets", "remoteAsset");
  var remoteAssetAgent = nsxAgent.createAgent(remoteAssetElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllRemoteAssets";
    var component = "assets";
    var element = "remoteAsset";
    var translation = translate("assets.remoteAsset.findAllRemoteAssets");
    ...
    function find(options){
      ...
      return remoteAssetAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "assets";
    var element = "remoteAsset";
    var translation = translate("assets.remoteAsset.findByNameEq");
