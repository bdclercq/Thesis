...
define(function (require) {
  ...
  var RemoteAssetProjector = require('assets/remoteAsset/remoteAsset-projector');
  ...
  function defineEditDialog(options) {
    ...
    when(editRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to edit a(n) RemoteAsset element!")
    });

    function render() {
      var editIntent = RemoteAssetEvents.defineEditIntentListener();
      var showDialog = Trigger.defineTrigger();

      var constants = ko.observable();
      var selection = ko.observable();
      var formView = "assets/remoteAsset-form";
      var title = "Edit RemoteAsset";
      var layoutConfig = initLayoutConfig(constants)
      var formOptions = {
        resetOn: editIntent,
        action: RemoteAssetActions.editAction()
      };

      var detailsProjection = RemoteAssetProjector.defineProjector(selection, {
        projection: "details"
      });
