...
define(function (require) {
  ...
  var RemoteAssetSorting = require('assets/remoteAsset/remoteAsset-sorting');
  var RemoteAssetInfoModel = require('assets/remoteAsset/remoteAsset-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = RemoteAssetSorting.defineSorting();
    var dataUpdate = RemoteAssetEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: RemoteAssetInfoModel
    });

    var infoListView = "assets/remoteAsset-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
