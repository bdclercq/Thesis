...
define(function (require) {
  ...
  var AddressTableView = require('onlineCabBookingComp/address/address-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.Address.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.Address.menu.title");
    ...
    var table = AddressTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
