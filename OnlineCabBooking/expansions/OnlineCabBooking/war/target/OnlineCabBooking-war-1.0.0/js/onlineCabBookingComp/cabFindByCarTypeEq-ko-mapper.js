...
define(function(require) {
  ...
  var cabFindByCarTypeEqElement = nsxApplication.getElement("onlineCabBookingComp", "cabFindByCarTypeEq");
  ...
  var fieldOptions = {
    ...
    carType: {
      ...
      key: "onlineCabBookingComp.CabFindByCarTypeEq.carType",
      isValueType: false
    }
  ...
  function jsToFormModel(cabFindByCarTypeEq, fieldFilter) {
    var detailModel = jsToViewModel(cabFindByCarTypeEq);
    var form = {
  ...
  function jsToViewModel(cabFindByCarTypeEq) {
    var cabFindByCarTypeEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      carType: ko.observable(cabFindByCarTypeEq.carType),
  ...
  return cabFindByCarTypeEqMapper;
});
