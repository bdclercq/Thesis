...
define(function (require) {
  ...
  var CarTypeSorting = require('onlineCabBookingComp/carType/carType-sorting');
  var CarTypeInfoModel = require('onlineCabBookingComp/carType/carType-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = CarTypeSorting.defineSorting();
    var dataUpdate = CarTypeEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: CarTypeInfoModel
    });

    var infoListView = "onlineCabBookingComp/carType-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
