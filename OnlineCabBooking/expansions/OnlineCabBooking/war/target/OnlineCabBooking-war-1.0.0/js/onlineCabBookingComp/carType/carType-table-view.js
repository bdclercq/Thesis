...
define(function (require) {
  ...
  var CarTypeFinders = require('onlineCabBookingComp/carType/carType-finders');
  var CarTypeStdTable = require('onlineCabBookingComp/carType/carType-std-table');

  var CarTypeElement = require('nsx/nsx-application').getElement('onlineCabBookingComp', 'carType');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = CarTypeFinders.finderWith(constantFields);
    var finderOptions = CarTypeFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = CarTypeEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineCarTypeList(widget, input) {
    return CarTypeStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: CarTypeEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: CarTypeEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: CarTypeEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: CarTypeEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: CarTypeEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var carTypeList = defineCarTypeList(widget, listOptions);

    tableContext.selection = carTypeList.selection;
    ...
    var pagination = definePagination(toolbar, carTypeList.listModel);
    ...
    return {
      injector: widget,
      selection: carTypeList.selection
    };
  }
