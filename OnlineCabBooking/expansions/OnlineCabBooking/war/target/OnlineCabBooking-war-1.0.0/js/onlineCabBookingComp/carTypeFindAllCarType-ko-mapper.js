...
define(function(require) {
  ...
  var carTypeFindAllCarTypeElement = nsxApplication.getElement("onlineCabBookingComp", "carTypeFindAllCarType");
  ...
  function jsToFormModel(carTypeFindAllCarType, fieldFilter) {
    var detailModel = jsToViewModel(carTypeFindAllCarType);
    var form = {
  ...
  function jsToViewModel(carTypeFindAllCarType) {
    var carTypeFindAllCarTypeViewModel = {
    ...
    return carTypeFindAllCarTypeViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(carTypeFindAllCarTypeViewModel) {
    var jsData = {
  ...
  var carTypeFindAllCarTypeMapper = {
  ...
  return carTypeFindAllCarTypeMapper;
});
