...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.journeyStatus = SortableColumn.defineSortableColumn({
      fieldName: "journeyStatus"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "journeyStatus";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.journeyStatus.select);
