...
define(function(require) {
  ...
  var customerFindByNameEqElement = nsxApplication.getElement("onlineCabBookingComp", "customerFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "onlineCabBookingComp.CustomerFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(customerFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(customerFindByNameEq);
    var form = {
  ...
  function jsToViewModel(customerFindByNameEq) {
    var customerFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(customerFindByNameEq.name),
    ...
    return customerFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(customerFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: customerFindByNameEqViewModel.name(),
  ...
  var customerFindByNameEqMapper = {
  ...
  return customerFindByNameEqMapper;
});
