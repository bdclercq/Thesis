...
define(function (require) {
  ...
  const DriverActions = require('onlineCabBookingComp/driver/driver-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = DriverEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = DriverActions.deleteMultipleAction();
