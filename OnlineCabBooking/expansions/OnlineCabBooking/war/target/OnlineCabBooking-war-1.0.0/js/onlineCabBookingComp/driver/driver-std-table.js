...
define(function (require) {
  ...
  var DriverSorting = require('onlineCabBookingComp/driver/driver-sorting');
  var DriverInfoModel = require('onlineCabBookingComp/driver/driver-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = DriverSorting.defineSorting();
    var dataUpdate = DriverEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: DriverInfoModel
    });

    var infoListView = "onlineCabBookingComp/driver-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
