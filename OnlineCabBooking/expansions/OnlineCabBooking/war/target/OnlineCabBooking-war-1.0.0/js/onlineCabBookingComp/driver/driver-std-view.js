...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) Driver!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = DriverEvents.defineViewIntentListener();

      var config = {
        title: 'Driver',
        projection: 'details',
        projector: 'onlineCabBookingComp/driver/driver-projector',
        modeller: 'onlineCabBookingComp/driver/driver-details-instance-model',
        view: 'onlineCabBookingComp/driver-details-instance'
      };
