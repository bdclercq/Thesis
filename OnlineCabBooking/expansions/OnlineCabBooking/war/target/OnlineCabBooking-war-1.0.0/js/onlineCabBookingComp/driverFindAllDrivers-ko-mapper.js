...
define(function(require) {
  ...
  var driverFindAllDriversElement = nsxApplication.getElement("onlineCabBookingComp", "driverFindAllDrivers");
  ...
  function jsToFormModel(driverFindAllDrivers, fieldFilter) {
    var detailModel = jsToViewModel(driverFindAllDrivers);
    var form = {
  ...
  function jsToViewModel(driverFindAllDrivers) {
    var driverFindAllDriversViewModel = {
    ...
    return driverFindAllDriversViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(driverFindAllDriversViewModel) {
    var jsData = {
  ...
  var driverFindAllDriversMapper = {
  ...
  return driverFindAllDriversMapper;
});
