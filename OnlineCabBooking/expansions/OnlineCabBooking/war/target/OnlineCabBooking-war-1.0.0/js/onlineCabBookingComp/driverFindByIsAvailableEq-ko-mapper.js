...
define(function(require) {
  ...
  var driverFindByIsAvailableEqElement = nsxApplication.getElement("onlineCabBookingComp", "driverFindByIsAvailableEq");
  ...
  var fieldOptions = {
    ...
    isAvailable: {
      ...
      key: "onlineCabBookingComp.DriverFindByIsAvailableEq.isAvailable",
      isValueType: false
    }
  ...
  function jsToFormModel(driverFindByIsAvailableEq, fieldFilter) {
    var detailModel = jsToViewModel(driverFindByIsAvailableEq);
    var form = {
  ...
  function jsToViewModel(driverFindByIsAvailableEq) {
    var driverFindByIsAvailableEqViewModel = {
      // anchor:value-fields-to-model:start
      isAvailable: ko.observable(!!driverFindByIsAvailableEq.isAvailable),
    ...
    return driverFindByIsAvailableEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(driverFindByIsAvailableEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      isAvailable: !!driverFindByIsAvailableEqViewModel.isAvailable(),
  ...
  var driverFindByIsAvailableEqMapper = {
  ...
  return driverFindByIsAvailableEqMapper;
});
