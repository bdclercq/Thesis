...
define(function(require) {
  ...
  var driverFindByLicenseNoEqElement = nsxApplication.getElement("onlineCabBookingComp", "driverFindByLicenseNoEq");
  ...
  var fieldOptions = {
    ...
    licenseNo: {
      ...
      key: "onlineCabBookingComp.DriverFindByLicenseNoEq.licenseNo",
      isValueType: false
    }
  ...
  function jsToFormModel(driverFindByLicenseNoEq, fieldFilter) {
    var detailModel = jsToViewModel(driverFindByLicenseNoEq);
    var form = {
  ...
  function jsToViewModel(driverFindByLicenseNoEq) {
    var driverFindByLicenseNoEqViewModel = {
      // anchor:value-fields-to-model:start
      licenseNo: ko.observable(driverFindByLicenseNoEq.licenseNo),
    ...
    return driverFindByLicenseNoEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(driverFindByLicenseNoEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      licenseNo: driverFindByLicenseNoEqViewModel.licenseNo(),
  ...
  var driverFindByLicenseNoEqMapper = {
  ...
  return driverFindByLicenseNoEqMapper;
});
