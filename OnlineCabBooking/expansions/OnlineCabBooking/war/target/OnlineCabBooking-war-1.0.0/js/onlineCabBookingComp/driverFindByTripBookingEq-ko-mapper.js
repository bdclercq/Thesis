...
define(function(require) {
  ...
  var driverFindByTripBookingEqElement = nsxApplication.getElement("onlineCabBookingComp", "driverFindByTripBookingEq");
  ...
  var fieldOptions = {
    ...
    tripBooking: {
      ...
      key: "onlineCabBookingComp.DriverFindByTripBookingEq.tripBooking",
      isValueType: false
    }
  ...
  function jsToFormModel(driverFindByTripBookingEq, fieldFilter) {
    var detailModel = jsToViewModel(driverFindByTripBookingEq);
    var form = {
  ...
  function jsToViewModel(driverFindByTripBookingEq) {
    var driverFindByTripBookingEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      tripBooking: ko.observable(driverFindByTripBookingEq.tripBooking),
  ...
  var driverFindByTripBookingEqMapper = {
  ...
  return driverFindByTripBookingEqMapper;
});
