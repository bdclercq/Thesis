...
define(function (require) {
  ...
  const InvoiceActions = require('onlineCabBookingComp/invoice/invoice-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = InvoiceEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = InvoiceActions.deleteMultipleAction();
