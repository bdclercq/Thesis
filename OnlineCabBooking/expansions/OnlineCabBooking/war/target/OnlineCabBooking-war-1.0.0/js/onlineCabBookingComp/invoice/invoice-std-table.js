...
define(function (require) {
  ...
  var InvoiceSorting = require('onlineCabBookingComp/invoice/invoice-sorting');
  var InvoiceInfoModel = require('onlineCabBookingComp/invoice/invoice-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = InvoiceSorting.defineSorting();
    var dataUpdate = InvoiceEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: InvoiceInfoModel
    });

    var infoListView = "onlineCabBookingComp/invoice-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
