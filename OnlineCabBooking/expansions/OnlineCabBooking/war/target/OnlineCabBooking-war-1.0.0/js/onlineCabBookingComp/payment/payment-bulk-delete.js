...
define(function (require) {
  ...
  const PaymentActions = require('onlineCabBookingComp/payment/payment-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = PaymentEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = PaymentActions.deleteMultipleAction();
