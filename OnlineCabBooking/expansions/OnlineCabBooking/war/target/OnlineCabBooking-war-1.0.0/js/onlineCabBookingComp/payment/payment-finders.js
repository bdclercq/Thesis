...
/**
 * Lists all the finders for the 'payment' element
 */
define(function (require) {
  ...
  var paymentElement = nsxApplication.getElement("onlineCabBookingComp", "payment");
  var paymentAgent = nsxAgent.createAgent(paymentElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllPayments";
    var component = "onlineCabBookingComp";
    var element = "payment";
    var translation = translate("onlineCabBookingComp.payment.findAllPayments");
    ...
    function find(options){
      ...
      return paymentAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "onlineCabBookingComp";
    var element = "payment";
    var translation = translate("onlineCabBookingComp.payment.findByNameEq");
