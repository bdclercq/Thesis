...
define(function (require) {
  ...
  var PaymentSorting = require('onlineCabBookingComp/payment/payment-sorting');
  var PaymentInfoModel = require('onlineCabBookingComp/payment/payment-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = PaymentSorting.defineSorting();
    var dataUpdate = PaymentEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: PaymentInfoModel
    });

    var infoListView = "onlineCabBookingComp/payment-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
