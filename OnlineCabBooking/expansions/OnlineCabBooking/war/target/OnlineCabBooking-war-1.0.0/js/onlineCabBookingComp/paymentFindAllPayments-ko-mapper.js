...
define(function(require) {
  ...
  var paymentFindAllPaymentsElement = nsxApplication.getElement("onlineCabBookingComp", "paymentFindAllPayments");
  ...
  function jsToFormModel(paymentFindAllPayments, fieldFilter) {
    var detailModel = jsToViewModel(paymentFindAllPayments);
    var form = {
  ...
  function jsToViewModel(paymentFindAllPayments) {
    var paymentFindAllPaymentsViewModel = {
    ...
    return paymentFindAllPaymentsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(paymentFindAllPaymentsViewModel) {
    var jsData = {
  ...
  var paymentFindAllPaymentsMapper = {
  ...
  return paymentFindAllPaymentsMapper;
});
