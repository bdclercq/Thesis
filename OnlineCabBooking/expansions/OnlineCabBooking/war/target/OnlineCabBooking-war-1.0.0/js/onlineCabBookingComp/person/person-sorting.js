...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.username = SortableColumn.defineSortableColumn({
      fieldName: "username"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "username";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.username.select);
