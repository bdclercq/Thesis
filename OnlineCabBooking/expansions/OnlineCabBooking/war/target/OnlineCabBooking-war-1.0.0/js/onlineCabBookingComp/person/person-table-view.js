...
define(function (require) {
  ...
  var PersonFinders = require('onlineCabBookingComp/person/person-finders');
  var PersonStdTable = require('onlineCabBookingComp/person/person-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = PersonFinders.finderWith(constantFields);
    var finderOptions = PersonFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = PersonEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function definePersonList(widget, input) {
    return PersonStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: PersonEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: PersonEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: PersonEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: PersonEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: PersonEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var personList = definePersonList(widget, listOptions);

    tableContext.selection = personList.selection;
    ...
    var pagination = definePagination(toolbar, personList.listModel);
    ...
    return {
      injector: widget,
      selection: personList.selection
    };
  }
