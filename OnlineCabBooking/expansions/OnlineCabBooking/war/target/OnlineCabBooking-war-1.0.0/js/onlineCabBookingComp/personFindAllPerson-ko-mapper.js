...
define(function(require) {
  ...
  var personFindAllPersonElement = nsxApplication.getElement("onlineCabBookingComp", "personFindAllPerson");
  ...
  function jsToFormModel(personFindAllPerson, fieldFilter) {
    var detailModel = jsToViewModel(personFindAllPerson);
    var form = {
  ...
  function jsToViewModel(personFindAllPerson) {
    var personFindAllPersonViewModel = {
    ...
    return personFindAllPersonViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(personFindAllPersonViewModel) {
    var jsData = {
  ...
  return personFindAllPersonMapper;
});
