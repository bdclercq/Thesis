...
define(function (require) {
  ...
  const TripBookingActions = require('onlineCabBookingComp/tripBooking/tripBooking-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = TripBookingEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = TripBookingActions.deleteMultipleAction();
