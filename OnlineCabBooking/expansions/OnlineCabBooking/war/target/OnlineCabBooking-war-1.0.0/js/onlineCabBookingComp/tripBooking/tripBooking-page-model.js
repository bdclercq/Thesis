...
define(function (require) {
  ...
  var TripBookingTableView = require('onlineCabBookingComp/tripBooking/tripBooking-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.TripBooking.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.TripBooking.menu.title");
    ...
    var table = TripBookingTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
