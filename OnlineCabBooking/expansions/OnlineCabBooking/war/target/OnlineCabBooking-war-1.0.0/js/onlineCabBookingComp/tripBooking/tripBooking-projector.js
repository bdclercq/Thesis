...
define(function(require) {
  ...
  var tripBookingMetaData = require("dataElement!onlineCabBookingComp.tripBooking");
  var tripBookingAgent = tripBookingMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "onlineCabBookingComp.tripBooking.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = TripBookingEvents.defineCreateUpdateListener();
    var dataEdit = TripBookingEvents.defineEditUpdateListener();
    var dataRefresh = TripBookingEvents.defineRefreshUpdateListener();
    var dataDelete = TripBookingEvents.defineDeleteUpdateListener();
    var dataFinder = TripBookingEvents.defineFinderUpdateListener();
