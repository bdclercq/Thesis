...
define(function (require) {
  ...
  var TripBookingFinders = require('onlineCabBookingComp/tripBooking/tripBooking-finders');
  var TripBookingStdTable = require('onlineCabBookingComp/tripBooking/tripBooking-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = TripBookingFinders.finderWith(constantFields);
    var finderOptions = TripBookingFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineTripBookingList(widget, input) {
    return TripBookingStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TripBookingEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: TripBookingEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: TripBookingEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: TripBookingEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TripBookingEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var tripBookingList = defineTripBookingList(widget, listOptions);

    tableContext.selection = tripBookingList.selection;
    ...
    var pagination = definePagination(toolbar, tripBookingList.listModel);
    ...
    return {
      injector: widget,
      selection: tripBookingList.selection
    };
  }
