...
define(function(require) {
  ...
  var tripBookingFindAllTripBookingsElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingFindAllTripBookings");
  ...
  function jsToFormModel(tripBookingFindAllTripBookings, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingFindAllTripBookings);
    var form = {
  ...
  function jsToViewModel(tripBookingFindAllTripBookings) {
    var tripBookingFindAllTripBookingsViewModel = {
    ...
    return tripBookingFindAllTripBookingsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingFindAllTripBookingsViewModel) {
    var jsData = {
  ...
  var tripBookingFindAllTripBookingsMapper = {
  ...
  return tripBookingFindAllTripBookingsMapper;
});
