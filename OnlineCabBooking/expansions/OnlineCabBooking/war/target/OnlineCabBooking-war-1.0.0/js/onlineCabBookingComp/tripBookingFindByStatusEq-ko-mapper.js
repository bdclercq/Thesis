...
define(function(require) {
  ...
  var tripBookingFindByStatusEqElement = nsxApplication.getElement("onlineCabBookingComp", "tripBookingFindByStatusEq");
  ...
  var fieldOptions = {
    ...
    status: {
      ...
      key: "onlineCabBookingComp.TripBookingFindByStatusEq.status",
      isValueType: false
    }
  ...
  function jsToFormModel(tripBookingFindByStatusEq, fieldFilter) {
    var detailModel = jsToViewModel(tripBookingFindByStatusEq);
    var form = {
  ...
  function jsToViewModel(tripBookingFindByStatusEq) {
    var tripBookingFindByStatusEqViewModel = {
      // anchor:value-fields-to-model:start
      status: ko.observable(tripBookingFindByStatusEq.status),
    ...
    return tripBookingFindByStatusEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(tripBookingFindByStatusEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      status: tripBookingFindByStatusEqViewModel.status(),
  ...
  var tripBookingFindByStatusEqMapper = {
  ...
  return tripBookingFindByStatusEqMapper;
});
