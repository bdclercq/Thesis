...
define(function (require) {
  ...
  var TripBookingTaskStatusTableView = require('onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("onlineCabBookingComp.TripBookingTaskStatus.page.title")
    };
    var viewModel = {};
    var title = translate("onlineCabBookingComp.TripBookingTaskStatus.menu.title");
    ...
    var table = TripBookingTaskStatusTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
