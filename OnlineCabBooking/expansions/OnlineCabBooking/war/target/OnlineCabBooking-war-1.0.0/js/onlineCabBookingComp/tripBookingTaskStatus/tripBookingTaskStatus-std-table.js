...
define(function (require) {
  ...
  var TripBookingTaskStatusSorting = require('onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-sorting');
  var TripBookingTaskStatusInfoModel = require('onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = TripBookingTaskStatusSorting.defineSorting();
    var dataUpdate = TripBookingTaskStatusEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: TripBookingTaskStatusInfoModel
    });

    var infoListView = "onlineCabBookingComp/tripBookingTaskStatus-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
