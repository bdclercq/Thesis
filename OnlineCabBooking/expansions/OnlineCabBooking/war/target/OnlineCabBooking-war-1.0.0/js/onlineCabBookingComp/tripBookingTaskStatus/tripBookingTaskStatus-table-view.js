...
define(function (require) {
  ...
  var TripBookingTaskStatusFinders = require('onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-finders');
  var TripBookingTaskStatusStdTable = require('onlineCabBookingComp/tripBookingTaskStatus/tripBookingTaskStatus-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = TripBookingTaskStatusFinders.finderWith(constantFields);
    var finderOptions = TripBookingTaskStatusFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = TripBookingTaskStatusEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineTripBookingTaskStatusList(widget, input) {
    return TripBookingTaskStatusStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TripBookingTaskStatusEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: TripBookingTaskStatusEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: TripBookingTaskStatusEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: TripBookingTaskStatusEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TripBookingTaskStatusEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var tripBookingTaskStatusList = defineTripBookingTaskStatusList(widget, listOptions);

    tableContext.selection = tripBookingTaskStatusList.selection;
    ...
    var pagination = definePagination(toolbar, tripBookingTaskStatusList.listModel);
    ...
    return {
      injector: widget,
      selection: tripBookingTaskStatusList.selection
    };
  }
