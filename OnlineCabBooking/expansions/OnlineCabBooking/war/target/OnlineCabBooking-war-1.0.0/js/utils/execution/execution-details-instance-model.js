...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(executionDetails) {
      if (!!executionDetails) {
        viewmodel.id(executionDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(executionDetails.name);
        viewmodel.component(executionDetails.component);
        viewmodel.element(executionDetails.element);
        viewmodel.packageName(executionDetails.packageName);
