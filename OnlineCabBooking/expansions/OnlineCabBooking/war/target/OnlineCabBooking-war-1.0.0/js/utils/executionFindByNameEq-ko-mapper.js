...
define(function(require) {
  ...
  var executionFindByNameEqElement = nsxApplication.getElement("utils", "executionFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "utils.ExecutionFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(executionFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(executionFindByNameEq);
    var form = {
  ...
  function jsToViewModel(executionFindByNameEq) {
    var executionFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(executionFindByNameEq.name),
    ...
    return executionFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(executionFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: executionFindByNameEqViewModel.name(),
  ...
  var executionFindByNameEqMapper = {
  ...
  return executionFindByNameEqMapper;
});
