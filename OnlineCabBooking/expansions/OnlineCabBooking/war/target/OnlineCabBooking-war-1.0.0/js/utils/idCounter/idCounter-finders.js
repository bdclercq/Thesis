...
/**
 * Lists all the finders for the 'idCounter' element
 */
define(function (require) {
  ...
  var idCounterElement = nsxApplication.getElement("utils", "idCounter");
  var idCounterAgent = nsxAgent.createAgent(idCounterElement);

  // anchor:finders:start
  function findAll(options) {
    var name = "findAllIdCounters";
    var component = "utils";
    var element = "idCounter";
    var translation = translate("utils.idCounter.findAllIdCounters");
    ...
    function find(options){
      ...
      return idCounterAgent.find(findOptions);
    }
  ...
  function findByNameEq(options) {
    ...
    var component = "utils";
    var element = "idCounter";
    var translation = translate("utils.idCounter.findByNameEq");
