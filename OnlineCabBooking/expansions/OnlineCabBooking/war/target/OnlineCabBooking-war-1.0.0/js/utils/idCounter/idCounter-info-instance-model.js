...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(idCounterDetails) {
      if (!!idCounterDetails) {
        viewmodel.id(idCounterDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(idCounterDetails.name);
        viewmodel.counter(idCounterDetails.counter);
