...
define(function (require) {
  ...
  var IdCounterActions = require('utils/idCounter/idCounter-actions');
  ...
  function defineDeleteDialog() {
    ...
    when(deleteRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to delete a(n) IdCounter element!")
    });

    function render() {
      var selection = { id: 0 };
      var deleteIntent = IdCounterEvents.defineDeleteIntentListener();
      ...
      var deleteAction = IdCounterActions.deleteAction();
