...
define(function (require) {
  ...
  var ParamTargetValueTableView = require('utils/paramTargetValue/paramTargetValue-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("utils.ParamTargetValue.page.title")
    };
    var viewModel = {};
    var title = translate("utils.ParamTargetValue.menu.title");
    ...
    var table = ParamTargetValueTableView.defineTableView({
      injector: page,
      selector: "main",
      constants: constants,
