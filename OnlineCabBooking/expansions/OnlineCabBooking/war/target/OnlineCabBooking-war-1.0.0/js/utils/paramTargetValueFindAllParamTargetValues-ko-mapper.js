...
define(function(require) {
  ...
  var paramTargetValueFindAllParamTargetValuesElement = nsxApplication.getElement("utils", "paramTargetValueFindAllParamTargetValues");
  ...
  function jsToFormModel(paramTargetValueFindAllParamTargetValues, fieldFilter) {
    var detailModel = jsToViewModel(paramTargetValueFindAllParamTargetValues);
    var form = {
  ...
  function jsToViewModel(paramTargetValueFindAllParamTargetValues) {
    var paramTargetValueFindAllParamTargetValuesViewModel = {
    ...
    return paramTargetValueFindAllParamTargetValuesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(paramTargetValueFindAllParamTargetValuesViewModel) {
    var jsData = {
  ...
  var paramTargetValueFindAllParamTargetValuesMapper = {
  ...
  return paramTargetValueFindAllParamTargetValuesMapper;
});
