...
define(function(require) {
  ...
  var paramTargetValueFindByTargetEqElement = nsxApplication.getElement("utils", "paramTargetValueFindByTargetEq");
  ...
  var fieldOptions = {
    ...
    target: {
      ...
      key: "utils.ParamTargetValueFindByTargetEq.target",
      isValueType: false
    }
  ...
  function jsToFormModel(paramTargetValueFindByTargetEq, fieldFilter) {
    var detailModel = jsToViewModel(paramTargetValueFindByTargetEq);
    var form = {
  ...
  function jsToViewModel(paramTargetValueFindByTargetEq) {
    var paramTargetValueFindByTargetEqViewModel = {
      // anchor:value-fields-to-model:start
      target: ko.observable(paramTargetValueFindByTargetEq.target),
    ...
    return paramTargetValueFindByTargetEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(paramTargetValueFindByTargetEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      target: paramTargetValueFindByTargetEqViewModel.target(),
  ...
  var paramTargetValueFindByTargetEqMapper = {
  ...
  return paramTargetValueFindByTargetEqMapper;
});
