...
define(function(require) {
  ...
  var paramTargetValueFindByValueEqElement = nsxApplication.getElement("utils", "paramTargetValueFindByValueEq");
  ...
  var fieldOptions = {
    ...
    value: {
      ...
      key: "utils.ParamTargetValueFindByValueEq.value",
      isValueType: false
    }
  ...
  function jsToFormModel(paramTargetValueFindByValueEq, fieldFilter) {
    var detailModel = jsToViewModel(paramTargetValueFindByValueEq);
    var form = {
  ...
  function jsToViewModel(paramTargetValueFindByValueEq) {
    var paramTargetValueFindByValueEqViewModel = {
      // anchor:value-fields-to-model:start
      value: ko.observable(paramTargetValueFindByValueEq.value),
    ...
    return paramTargetValueFindByValueEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(paramTargetValueFindByValueEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      value: paramTargetValueFindByValueEqViewModel.value(),
  ...
  var paramTargetValueFindByValueEqMapper = {
  ...
  return paramTargetValueFindByValueEqMapper;
});
