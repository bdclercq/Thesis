...
define(function (require) {
  ...
  var TagValuePairSorting = require('utils/tagValuePair/tagValuePair-sorting');
  var TagValuePairInfoModel = require('utils/tagValuePair/tagValuePair-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = TagValuePairSorting.defineSorting();
    var dataUpdate = TagValuePairEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: TagValuePairInfoModel
    });

    var infoListView = "utils/tagValuePair-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
