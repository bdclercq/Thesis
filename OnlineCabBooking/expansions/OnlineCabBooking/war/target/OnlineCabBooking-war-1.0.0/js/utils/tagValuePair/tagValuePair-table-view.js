...
define(function (require) {
  ...
  var TagValuePairFinders = require('utils/tagValuePair/tagValuePair-finders');
  var TagValuePairStdTable = require('utils/tagValuePair/tagValuePair-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = TagValuePairFinders.finderWith(constantFields);
    var finderOptions = TagValuePairFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = TagValuePairEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineTagValuePairList(widget, input) {
    return TagValuePairStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TagValuePairEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: TagValuePairEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: TagValuePairEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: TagValuePairEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TagValuePairEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var tagValuePairList = defineTagValuePairList(widget, listOptions);

    tableContext.selection = tagValuePairList.selection;
    ...
    var pagination = definePagination(toolbar, tagValuePairList.listModel);
    ...
    return {
      injector: widget,
      selection: tagValuePairList.selection
    };
  }
