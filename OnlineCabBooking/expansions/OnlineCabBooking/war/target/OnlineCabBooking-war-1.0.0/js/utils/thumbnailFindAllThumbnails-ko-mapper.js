...
define(function(require) {
  ...
  var thumbnailFindAllThumbnailsElement = nsxApplication.getElement("utils", "thumbnailFindAllThumbnails");
  ...
  function jsToFormModel(thumbnailFindAllThumbnails, fieldFilter) {
    var detailModel = jsToViewModel(thumbnailFindAllThumbnails);
    var form = {
  ...
  function jsToViewModel(thumbnailFindAllThumbnails) {
    var thumbnailFindAllThumbnailsViewModel = {
    ...
    return thumbnailFindAllThumbnailsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(thumbnailFindAllThumbnailsViewModel) {
    var jsData = {
  ...
  var thumbnailFindAllThumbnailsMapper = {
  ...
  return thumbnailFindAllThumbnailsMapper;
});
