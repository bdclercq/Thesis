...
define(function(require) {
  ...
  var thumbnailFindByUriEq_DepthEqElement = nsxApplication.getElement("utils", "thumbnailFindByUriEq_DepthEq");
  ...
  var fieldOptions = {
    ...
    depth: {
      ...
      key: "utils.ThumbnailFindByUriEq_DepthEq.depth",
      isValueType: false
    },
    uri: {
      fieldName: "uri",
      type: FieldType.VALUE,
      key: "utils.ThumbnailFindByUriEq_DepthEq.uri",
      isValueType: false
    }
  ...
  function jsToFormModel(thumbnailFindByUriEq_DepthEq, fieldFilter) {
    var detailModel = jsToViewModel(thumbnailFindByUriEq_DepthEq);
    var form = {
  ...
  function jsToViewModel(thumbnailFindByUriEq_DepthEq) {
    var thumbnailFindByUriEq_DepthEqViewModel = {
      // anchor:value-fields-to-model:start
      depth: ko.observable(thumbnailFindByUriEq_DepthEq.depth),
      uri: ko.observable(thumbnailFindByUriEq_DepthEq.uri),
    ...
    return thumbnailFindByUriEq_DepthEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(thumbnailFindByUriEq_DepthEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      depth: thumbnailFindByUriEq_DepthEqViewModel.depth(),
      uri: thumbnailFindByUriEq_DepthEqViewModel.uri(),
  ...
  var thumbnailFindByUriEq_DepthEqMapper = {
  ...
  return thumbnailFindByUriEq_DepthEqMapper;
});
