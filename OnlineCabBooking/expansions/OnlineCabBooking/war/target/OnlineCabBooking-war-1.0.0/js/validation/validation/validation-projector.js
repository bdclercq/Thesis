...
define(function(require) {
  ...
  var validationMetaData = require("dataElement!validation.validation");
  var validationAgent = validationMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "validation.validation.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = ValidationEvents.defineCreateUpdateListener();
    var dataEdit = ValidationEvents.defineEditUpdateListener();
    var dataRefresh = ValidationEvents.defineRefreshUpdateListener();
    var dataDelete = ValidationEvents.defineDeleteUpdateListener();
    var dataFinder = ValidationEvents.defineFinderUpdateListener();
