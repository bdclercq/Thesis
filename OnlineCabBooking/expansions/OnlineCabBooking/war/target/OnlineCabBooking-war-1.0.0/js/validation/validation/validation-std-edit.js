...
define(function (require) {
  ...
  var ValidationProjector = require('validation/validation/validation-projector');
  var ValidationForm = require('validation/validation/validation-instance-form');
  ...
  function defineEditDialog(options) {
    ...
    when(editRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to edit a(n) Validation element!")
    });

    function render() {
      var editIntent = ValidationEvents.defineEditIntentListener();
      var showDialog = Trigger.defineTrigger();

      var constants = ko.observable();
      var selection = ko.observable();
      var formView = "validation/validation-form";
      var title = "Edit Validation";
      var layoutConfig = initLayoutConfig(constants)
      var formOptions = {
        resetOn: editIntent,
        action: ValidationActions.editAction()
      };

      var detailsProjection = ValidationProjector.defineProjector(selection, {
        projection: "details"
      });
      ...
      var form = ValidationForm.defineForm({
