...
define(function (require) {
  ...
  const EngineNodeActions = require('workflow/engineNode/engineNode-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = EngineNodeEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = EngineNodeActions.deleteMultipleAction();
