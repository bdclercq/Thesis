...
define(function (require) {
  ...
  var formFields = [
    // anchor:field-configs:start
    {
      ...
      key: "workflow.EngineNode.id",
      isValueType: false
    },
    {
      fieldName: "name",
      type: FieldType.VALUE,
      key: "workflow.EngineNode.name",
      isValueType: false
    },
    {
      fieldName: "status",
      type: FieldType.VALUE,
      key: "workflow.EngineNode.status",
      isValueType: false
    },
    {
      fieldName: "hostname",
      type: FieldType.VALUE,
      key: "workflow.EngineNode.hostname",
      isValueType: false
    },
    {
      fieldName: "master",
      type: FieldType.VALUE,
      key: "workflow.EngineNode.master",
      isValueType: false
    },
    {
      fieldName: "lastActive",
      type: FieldType.DATE,
      key: "workflow.EngineNode.lastActive",
      isValueType: false
    },
    {
      fieldName: "activeSince",
      type: FieldType.DATE,
      key: "workflow.EngineNode.activeSince",
      isValueType: false
    }
  ...
  function defineForm(input, options) {
    ...
    var editAction = options.action || EngineNodeActions.editAction();
