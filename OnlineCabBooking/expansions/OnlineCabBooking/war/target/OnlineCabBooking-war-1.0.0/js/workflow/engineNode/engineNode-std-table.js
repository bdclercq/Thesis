...
define(function (require) {
  ...
  var EngineNodeSorting = require('workflow/engineNode/engineNode-sorting');
  var EngineNodeInfoModel = require('workflow/engineNode/engineNode-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = EngineNodeSorting.defineSorting();
    var dataUpdate = EngineNodeEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: EngineNodeInfoModel
    });

    var infoListView = "workflow/engineNode-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
