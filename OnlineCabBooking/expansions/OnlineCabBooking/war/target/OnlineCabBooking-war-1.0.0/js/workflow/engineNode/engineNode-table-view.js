...
define(function (require) {
  ...
  var EngineNodeFinders = require('workflow/engineNode/engineNode-finders');
  var EngineNodeStdTable = require('workflow/engineNode/engineNode-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = EngineNodeFinders.finderWith(constantFields);
    var finderOptions = EngineNodeFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineEngineNodeList(widget, input) {
    return EngineNodeStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: EngineNodeEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: EngineNodeEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: EngineNodeEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: EngineNodeEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: EngineNodeEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var engineNodeList = defineEngineNodeList(widget, listOptions);

    tableContext.selection = engineNodeList.selection;
    ...
    var pagination = definePagination(toolbar, engineNodeList.listModel);
    ...
    return {
      injector: widget,
      selection: engineNodeList.selection
    };
  }
