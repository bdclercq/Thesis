...
define(function(require) {
  ...
  var engineNodeFindByStatusEqElement = nsxApplication.getElement("workflow", "engineNodeFindByStatusEq");
  ...
  var fieldOptions = {
    ...
    status: {
      ...
      key: "workflow.EngineNodeFindByStatusEq.status",
      isValueType: false
    }
  ...
  function jsToFormModel(engineNodeFindByStatusEq, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeFindByStatusEq);
    var form = {
  ...
  function jsToViewModel(engineNodeFindByStatusEq) {
    var engineNodeFindByStatusEqViewModel = {
      // anchor:value-fields-to-model:start
      status: ko.observable(engineNodeFindByStatusEq.status),
    ...
    return engineNodeFindByStatusEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeFindByStatusEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      status: engineNodeFindByStatusEqViewModel.status(),
  ...
  var engineNodeFindByStatusEqMapper = {
  ...
  return engineNodeFindByStatusEqMapper;
});
