...
define(function (require) {
  ...
  var EngineNodeServiceTableView = require('workflow/engineNodeService/engineNodeService-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.EngineNodeService.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.EngineNodeService.menu.title");
