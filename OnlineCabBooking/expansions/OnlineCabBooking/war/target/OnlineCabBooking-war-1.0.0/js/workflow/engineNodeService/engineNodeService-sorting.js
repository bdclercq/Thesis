...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.nextRun = SortableColumn.defineSortableColumn({
      fieldName: "nextRun"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "nextRun";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.nextRun.select);
