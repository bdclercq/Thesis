...
define(function (require) {
  ...
  function defineViewDialog() {
    ...
    when(viewRightsRequest.refused).thenDo(function () {
      throw new Error("You do not have the rights to view a(n) EngineNodeService!")
    });

    function render() {
      var selection = ko.observable();
      var viewIntent = EngineNodeServiceEvents.defineViewIntentListener();

      var config = {
        title: 'EngineNodeService',
        projection: 'details',
        projector: 'workflow/engineNodeService/engineNodeService-projector',
        modeller: 'workflow/engineNodeService/engineNodeService-details-instance-model',
        view: 'workflow/engineNodeService-details-instance'
      };
