...
define(function(require) {
  ...
  var engineNodeServiceFindByNameEqElement = nsxApplication.getElement("workflow", "engineNodeServiceFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.EngineNodeServiceFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(engineNodeServiceFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(engineNodeServiceFindByNameEq);
    var form = {
  ...
  function jsToViewModel(engineNodeServiceFindByNameEq) {
    var engineNodeServiceFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(engineNodeServiceFindByNameEq.name),
    ...
    return engineNodeServiceFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineNodeServiceFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: engineNodeServiceFindByNameEqViewModel.name(),
  ...
  var engineNodeServiceFindByNameEqMapper = {
  ...
  return engineNodeServiceFindByNameEqMapper;
});
