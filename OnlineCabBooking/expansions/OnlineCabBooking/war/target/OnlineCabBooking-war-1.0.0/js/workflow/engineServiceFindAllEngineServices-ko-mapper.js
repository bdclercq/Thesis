...
define(function(require) {
  ...
  var engineServiceFindAllEngineServicesElement = nsxApplication.getElement("workflow", "engineServiceFindAllEngineServices");
  ...
  function jsToFormModel(engineServiceFindAllEngineServices, fieldFilter) {
    var detailModel = jsToViewModel(engineServiceFindAllEngineServices);
    var form = {
  ...
  function jsToViewModel(engineServiceFindAllEngineServices) {
    var engineServiceFindAllEngineServicesViewModel = {
    ...
    return engineServiceFindAllEngineServicesViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineServiceFindAllEngineServicesViewModel) {
    var jsData = {
  ...
  var engineServiceFindAllEngineServicesMapper = {
  ...
  return engineServiceFindAllEngineServicesMapper;
});
