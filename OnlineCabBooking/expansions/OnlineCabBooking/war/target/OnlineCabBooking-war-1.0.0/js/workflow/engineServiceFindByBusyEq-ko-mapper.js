...
define(function(require) {
  ...
  var engineServiceFindByBusyEqElement = nsxApplication.getElement("workflow", "engineServiceFindByBusyEq");
  ...
  var fieldOptions = {
    ...
    busy: {
      ...
      key: "workflow.EngineServiceFindByBusyEq.busy",
      isValueType: false
    }
  ...
  function jsToFormModel(engineServiceFindByBusyEq, fieldFilter) {
    var detailModel = jsToViewModel(engineServiceFindByBusyEq);
    var form = {
  ...
  function jsToViewModel(engineServiceFindByBusyEq) {
    var engineServiceFindByBusyEqViewModel = {
      // anchor:value-fields-to-model:start
      busy: ko.observable(engineServiceFindByBusyEq.busy),
    ...
    return engineServiceFindByBusyEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineServiceFindByBusyEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      busy: engineServiceFindByBusyEqViewModel.busy(),
  ...
  var engineServiceFindByBusyEqMapper = {
  ...
  return engineServiceFindByBusyEqMapper;
});
