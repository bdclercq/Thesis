...
define(function(require) {
  ...
  var engineServiceFindByWorkflowEqElement = nsxApplication.getElement("workflow", "engineServiceFindByWorkflowEq");
  ...
  var fieldOptions = {
    ...
    workflow: {
      ...
      key: "workflow.EngineServiceFindByWorkflowEq.workflow",
      isValueType: false
    }
  ...
  function jsToFormModel(engineServiceFindByWorkflowEq, fieldFilter) {
    var detailModel = jsToViewModel(engineServiceFindByWorkflowEq);
    var form = {
  ...
  function jsToViewModel(engineServiceFindByWorkflowEq) {
    var engineServiceFindByWorkflowEqViewModel = {
      // anchor:value-fields-to-model:start
      // anchor:value-fields-to-model:end

      // anchor:dataRef-fields-to-model:start
      workflow: ko.observable(engineServiceFindByWorkflowEq.workflow),
    ...
    return engineServiceFindByWorkflowEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(engineServiceFindByWorkflowEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      // anchor:value-fields-from-model:end

      // anchor:dataRef-fields-from-model:start
      workflow: engineServiceFindByWorkflowEqViewModel.workflow(),
  ...
  var engineServiceFindByWorkflowEqMapper = {
  ...
  return engineServiceFindByWorkflowEqMapper;
});
