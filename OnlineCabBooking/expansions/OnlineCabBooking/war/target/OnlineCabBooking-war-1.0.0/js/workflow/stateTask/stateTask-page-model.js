...
define(function (require) {
  ...
  var StateTaskTableView = require('workflow/stateTask/stateTask-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.StateTask.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.StateTask.menu.title");
