...
define(function(require) {
  ...
  var stateTaskFindAllStateTasksElement = nsxApplication.getElement("workflow", "stateTaskFindAllStateTasks");
  ...
  function jsToFormModel(stateTaskFindAllStateTasks, fieldFilter) {
    var detailModel = jsToViewModel(stateTaskFindAllStateTasks);
    var form = {
  ...
  function jsToViewModel(stateTaskFindAllStateTasks) {
    var stateTaskFindAllStateTasksViewModel = {
    ...
    return stateTaskFindAllStateTasksViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(stateTaskFindAllStateTasksViewModel) {
    var jsData = {
  ...
  var stateTaskFindAllStateTasksMapper = {
  ...
  return stateTaskFindAllStateTasksMapper;
});
