...
define(function (require) {
  ...
  var StateTimerTableView = require('workflow/stateTimer/stateTimer-table-view');
  ...
  function buildPage() {
    ...
    var headViewModel = {
      title: translate("workflow.StateTimer.page.title")
    };
    var viewModel = {};
    var title = translate("workflow.StateTimer.menu.title");
