...
define(function(require) {
  ...
  var stateTimerMetaData = require("dataElement!workflow.stateTimer");
  var stateTimerAgent = stateTimerMetaData.getAgent();
  ...
  var errorTrigger = require("nsx/error/error-trigger").defineTrigger({
    subject: "workflow.stateTimer.projection"
  });

  function defineProjector(dataRefObservable, options) {
    var projection = ko.observable({});
    var dataCreate = StateTimerEvents.defineCreateUpdateListener();
    var dataEdit = StateTimerEvents.defineEditUpdateListener();
    var dataRefresh = StateTimerEvents.defineRefreshUpdateListener();
    var dataDelete = StateTimerEvents.defineDeleteUpdateListener();
    var dataFinder = StateTimerEvents.defineFinderUpdateListener();
