...
define(function (require) {
  ...
  const TimeTaskActions = require('workflow/timeTask/timeTask-actions');
  ...
  function defineDeleteDialog() {
    ...
    function render() {
      ...
      const deleteIntent = TimeTaskEvents.defineDeleteMultipleIntentListener();
      ...
      let deleteAction = TimeTaskActions.deleteMultipleAction();
