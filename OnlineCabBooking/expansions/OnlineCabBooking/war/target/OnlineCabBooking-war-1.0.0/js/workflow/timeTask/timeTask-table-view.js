...
define(function (require) {
  ...
  var TimeTaskFinders = require('workflow/timeTask/timeTask-finders');
  var TimeTaskStdTable = require('workflow/timeTask/timeTask-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = TimeTaskFinders.finderWith(constantFields);
    var finderOptions = TimeTaskFinders.allFindersWith(constantFields);
    ...
    var finderUpdate = TimeTaskEvents.defineFinderUpdateTrigger();
  ...
  //region List
  // anchor:list:start
  function defineTimeTaskList(widget, input) {
    return TimeTaskStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TimeTaskEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: TimeTaskEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: TimeTaskEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: TimeTaskEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: TimeTaskEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var timeTaskList = defineTimeTaskList(widget, listOptions);

    tableContext.selection = timeTaskList.selection;
    ...
    var pagination = definePagination(toolbar, timeTaskList.listModel);
    ...
    return {
      injector: widget,
      selection: timeTaskList.selection
    };
  }
