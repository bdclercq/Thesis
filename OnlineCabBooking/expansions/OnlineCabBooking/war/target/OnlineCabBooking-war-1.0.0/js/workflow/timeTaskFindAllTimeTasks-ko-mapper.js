...
define(function(require) {
  ...
  var timeTaskFindAllTimeTasksElement = nsxApplication.getElement("workflow", "timeTaskFindAllTimeTasks");
  ...
  function jsToFormModel(timeTaskFindAllTimeTasks, fieldFilter) {
    var detailModel = jsToViewModel(timeTaskFindAllTimeTasks);
    var form = {
  ...
  function jsToViewModel(timeTaskFindAllTimeTasks) {
    var timeTaskFindAllTimeTasksViewModel = {
    ...
    return timeTaskFindAllTimeTasksViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeTaskFindAllTimeTasksViewModel) {
    var jsData = {
  ...
  var timeTaskFindAllTimeTasksMapper = {
  ...
  return timeTaskFindAllTimeTasksMapper;
});
