...
define(function(require) {
  ...
  var timeTaskFindByIntervalPeriodEqElement = nsxApplication.getElement("workflow", "timeTaskFindByIntervalPeriodEq");
  ...
  var fieldOptions = {
    ...
    intervalPeriod: {
      ...
      key: "workflow.TimeTaskFindByIntervalPeriodEq.intervalPeriod",
      isValueType: false
    }
  ...
  function jsToFormModel(timeTaskFindByIntervalPeriodEq, fieldFilter) {
    var detailModel = jsToViewModel(timeTaskFindByIntervalPeriodEq);
    var form = {
  ...
  function jsToViewModel(timeTaskFindByIntervalPeriodEq) {
    var timeTaskFindByIntervalPeriodEqViewModel = {
      // anchor:value-fields-to-model:start
      intervalPeriod: ko.observable(timeTaskFindByIntervalPeriodEq.intervalPeriod),
    ...
    return timeTaskFindByIntervalPeriodEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeTaskFindByIntervalPeriodEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      intervalPeriod: timeTaskFindByIntervalPeriodEqViewModel.intervalPeriod(),
  ...
  var timeTaskFindByIntervalPeriodEqMapper = {
  ...
  return timeTaskFindByIntervalPeriodEqMapper;
});
