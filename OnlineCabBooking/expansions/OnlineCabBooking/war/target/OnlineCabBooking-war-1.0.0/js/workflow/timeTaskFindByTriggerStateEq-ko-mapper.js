...
define(function(require) {
  ...
  var timeTaskFindByTriggerStateEqElement = nsxApplication.getElement("workflow", "timeTaskFindByTriggerStateEq");
  ...
  var fieldOptions = {
    ...
    triggerState: {
      ...
      key: "workflow.TimeTaskFindByTriggerStateEq.triggerState",
      isValueType: false
    }
  ...
  function jsToFormModel(timeTaskFindByTriggerStateEq, fieldFilter) {
    var detailModel = jsToViewModel(timeTaskFindByTriggerStateEq);
    var form = {
  ...
  function jsToViewModel(timeTaskFindByTriggerStateEq) {
    var timeTaskFindByTriggerStateEqViewModel = {
      // anchor:value-fields-to-model:start
      triggerState: ko.observable(timeTaskFindByTriggerStateEq.triggerState),
    ...
    return timeTaskFindByTriggerStateEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeTaskFindByTriggerStateEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      triggerState: timeTaskFindByTriggerStateEqViewModel.triggerState(),
  ...
  var timeTaskFindByTriggerStateEqMapper = {
  ...
  return timeTaskFindByTriggerStateEqMapper;
});
