...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(timeWindowDetails) {
      if (!!timeWindowDetails) {
        viewmodel.id(timeWindowDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(timeWindowDetails.name);
        viewmodel.startTime(timeWindowDetails.startTime);
        viewmodel.stopTime(timeWindowDetails.stopTime);
