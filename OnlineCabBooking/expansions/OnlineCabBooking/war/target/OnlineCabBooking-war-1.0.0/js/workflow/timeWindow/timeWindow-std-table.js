...
define(function (require) {
  ...
  var TimeWindowSorting = require('workflow/timeWindow/timeWindow-sorting');
  var TimeWindowInfoModel = require('workflow/timeWindow/timeWindow-info-instance-model');
  ...
  function defineTable(page, input) {
    var sorting = TimeWindowSorting.defineSorting();
    var dataUpdate = TimeWindowEvents.defineUpdateListener();
    ...
    var listView = ListView.defineListView({
      page: listModel.page,
      instanceView: TimeWindowInfoModel
    });

    var infoListView = "workflow/timeWindow-info-list"
    var viewModel = {
      heading: sorting,
      list: listView
    };
