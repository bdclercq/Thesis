...
define(function(require) {
  ...
  var timeWindowFindByStartTimeEqElement = nsxApplication.getElement("workflow", "timeWindowFindByStartTimeEq");
  ...
  var fieldOptions = {
    ...
    startTime: {
      ...
      key: "workflow.TimeWindowFindByStartTimeEq.startTime",
      isValueType: false
    }
  ...
  function jsToFormModel(timeWindowFindByStartTimeEq, fieldFilter) {
    var detailModel = jsToViewModel(timeWindowFindByStartTimeEq);
    var form = {
  ...
  function jsToViewModel(timeWindowFindByStartTimeEq) {
    var timeWindowFindByStartTimeEqViewModel = {
      // anchor:value-fields-to-model:start
      startTime: ko.observable(timeWindowFindByStartTimeEq.startTime),
    ...
    return timeWindowFindByStartTimeEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeWindowFindByStartTimeEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      startTime: timeWindowFindByStartTimeEqViewModel.startTime(),
  ...
  var timeWindowFindByStartTimeEqMapper = {
  ...
  return timeWindowFindByStartTimeEqMapper;
});
