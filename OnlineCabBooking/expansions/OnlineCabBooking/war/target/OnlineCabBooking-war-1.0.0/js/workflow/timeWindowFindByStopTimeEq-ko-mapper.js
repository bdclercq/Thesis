...
define(function(require) {
  ...
  var timeWindowFindByStopTimeEqElement = nsxApplication.getElement("workflow", "timeWindowFindByStopTimeEq");
  ...
  var fieldOptions = {
    ...
    stopTime: {
      ...
      key: "workflow.TimeWindowFindByStopTimeEq.stopTime",
      isValueType: false
    }
  ...
  function jsToFormModel(timeWindowFindByStopTimeEq, fieldFilter) {
    var detailModel = jsToViewModel(timeWindowFindByStopTimeEq);
    var form = {
  ...
  function jsToViewModel(timeWindowFindByStopTimeEq) {
    var timeWindowFindByStopTimeEqViewModel = {
      // anchor:value-fields-to-model:start
      stopTime: ko.observable(timeWindowFindByStopTimeEq.stopTime),
    ...
    return timeWindowFindByStopTimeEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeWindowFindByStopTimeEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      stopTime: timeWindowFindByStopTimeEqViewModel.stopTime(),
  ...
  var timeWindowFindByStopTimeEqMapper = {
  ...
  return timeWindowFindByStopTimeEqMapper;
});
