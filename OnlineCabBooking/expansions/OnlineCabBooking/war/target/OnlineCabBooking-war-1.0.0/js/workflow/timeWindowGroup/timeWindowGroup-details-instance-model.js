...
define(function (require) {
  ...
  function defineInstanceView(input, options) {
    ...
    function updateViewmodel(timeWindowGroupDetails) {
      if (!!timeWindowGroupDetails) {
        viewmodel.id(timeWindowGroupDetails.id);
        // anchor:update-viewModel:start
        viewmodel.name(timeWindowGroupDetails.name);
        viewmodel.visible(timeWindowGroupDetails.visible);
        viewmodel.timeWindows(timeWindowGroupDetails.timeWindows);
