...
define(function (require) {
  ...
  function defineSorting(input, options) {
    ...
    viewModel.visible = SortableColumn.defineSortableColumn({
      fieldName: "visible"
    }, {
      resetOn: Trigger.defineFilter({
        trigger: selectSorting,
        condition: function (sortField) {
          return sortField === null || sortField.fieldName !== "visible";
        }
      })
    });
    ...
    selectSorting.addTrigger(viewModel.visible.select);
