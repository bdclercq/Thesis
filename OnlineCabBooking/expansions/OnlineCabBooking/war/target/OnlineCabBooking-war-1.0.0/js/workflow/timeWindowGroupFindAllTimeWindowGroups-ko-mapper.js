...
define(function(require) {
  ...
  var timeWindowGroupFindAllTimeWindowGroupsElement = nsxApplication.getElement("workflow", "timeWindowGroupFindAllTimeWindowGroups");
  ...
  function jsToFormModel(timeWindowGroupFindAllTimeWindowGroups, fieldFilter) {
    var detailModel = jsToViewModel(timeWindowGroupFindAllTimeWindowGroups);
    var form = {
  ...
  function jsToViewModel(timeWindowGroupFindAllTimeWindowGroups) {
    var timeWindowGroupFindAllTimeWindowGroupsViewModel = {
    ...
    return timeWindowGroupFindAllTimeWindowGroupsViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeWindowGroupFindAllTimeWindowGroupsViewModel) {
    var jsData = {
  ...
  var timeWindowGroupFindAllTimeWindowGroupsMapper = {
  ...
  return timeWindowGroupFindAllTimeWindowGroupsMapper;
});
