...
define(function(require) {
  ...
  var timeWindowGroupFindByNameEqElement = nsxApplication.getElement("workflow", "timeWindowGroupFindByNameEq");
  ...
  var fieldOptions = {
    ...
    name: {
      ...
      key: "workflow.TimeWindowGroupFindByNameEq.name",
      isValueType: false
    }
  ...
  function jsToFormModel(timeWindowGroupFindByNameEq, fieldFilter) {
    var detailModel = jsToViewModel(timeWindowGroupFindByNameEq);
    var form = {
  ...
  function jsToViewModel(timeWindowGroupFindByNameEq) {
    var timeWindowGroupFindByNameEqViewModel = {
      // anchor:value-fields-to-model:start
      name: ko.observable(timeWindowGroupFindByNameEq.name),
    ...
    return timeWindowGroupFindByNameEqViewModel;
  }

  // this should be an instance of the model defined above
  function viewModelToJS(timeWindowGroupFindByNameEqViewModel) {
    var jsData = {
      // anchor:value-fields-from-model:start
      name: timeWindowGroupFindByNameEqViewModel.name(),
  ...
  var timeWindowGroupFindByNameEqMapper = {
  ...
  return timeWindowGroupFindByNameEqMapper;
});
