...
define(function (require) {
  ...
  var WorkflowFinders = require('workflow/workflow/workflow-finders');
  var WorkflowStdTable = require('workflow/workflow/workflow-std-table');
  ...
  function defineFinders(input) {
    ...
    var defaultFinder = WorkflowFinders.finderWith(constantFields);
    var finderOptions = WorkflowFinders.allFindersWith(constantFields);
  ...
  //region List
  // anchor:list:start
  function defineWorkflowList(widget, input) {
    return WorkflowStdTable.defineTable(widget, input);
  }
  ...
  function defineNewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: WorkflowEvents.defineCreateIntentTrigger({
  ...
  function defineRefreshButton(toolbar) {
    var buttonOptions = {
      trigger: WorkflowEvents.defineRefreshUpdateTrigger(),
  ...
  function defineViewInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-eye-open",
      layout: "view-button",
      trigger: WorkflowEvents.defineViewIntentTrigger({
  ...
  function defineEditInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      icon: "icon-pencil",
      layout: "edit-button",
      trigger: WorkflowEvents.defineEditIntentTrigger({
          selection: input.selection,
          constants: input.constants
        }),
      visible: ifBoth(
  ...
  function defineDeleteInstanceButton(toolbar, input) {
    ...
    var buttonOptions = {
      ...
      trigger: WorkflowEvents.defineDeleteIntentTrigger({
          selection: input.selection
        }),
      visible: ifBoth(
        accessRight.approved,
  ...
  function defineTableView(input) {
    ...
    var workflowList = defineWorkflowList(widget, listOptions);

    tableContext.selection = workflowList.selection;
    ...
    var pagination = definePagination(toolbar, workflowList.listModel);
    ...
    return {
      injector: widget,
      selection: workflowList.selection
    };
  }
